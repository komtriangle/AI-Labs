/* file "HomeAutomationListUserDataCommandJSON.cs" */
...
public class HomeAutomationListUserDataCommandJSON : CommandResultJSON
  {
    ...
    public HomeAutomationListUserDataCommandJSON()
      {
    ...
    public virtual int extraHomeAutomationListUserDataCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraHomeAutomationListUserDataCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraHomeAutomationListUserDataCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraHomeAutomationListUserDataCommandLookup(string field_name)
      {
    ...
    public override JSONValue extraCommandResultLookup(string field_name)
      {
        if ((String.Compare(field_name, 0, "DeviceSpecifier", 0, 15, false) == 0) && (field_name.Length == 15))
    ...
    public virtual void extraHomeAutomationListUserDataCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraHomeAutomationListUserDataCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public override void extraCommandResultAppendPair(string key, JSONValue new_component)
      {
        if ((String.Compare(key, 0, "DeviceSpecifier", 0, 15, false) == 0) && (key.Length == 15))
            {
    ...
    public static new HomeAutomationListUserDataCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        HomeAutomationListUserDataCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HomeAutomationListUserDataCommand", ignore_extras);
    ...
    public static new HomeAutomationListUserDataCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new HomeAutomationListUserDataCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        HomeAutomationListUserDataCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HomeAutomationListUserDataCommand", ignore_extras);
    ...
    public static new HomeAutomationListUserDataCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new HomeAutomationListUserDataCommandJSON from_text(string text, bool ignore_extras)
      {
        HomeAutomationListUserDataCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HomeAutomationListUserDataCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for HomeAutomationListUserDataCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new HomeAutomationListUserDataCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        HomeAutomationListUserDataCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HomeAutomationListUserDataCommand", ignore_extras);
    ...
    public new abstract class Generator : CommandResultJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getCommandResultJSONKey().Equals("HomeAutomationListUserDataCommand")))
                throw new Exception("The key field has a value other than `HomeAutomationListUserDataCommand'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraHomeAutomationListUserDataCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(HomeAutomationListUserDataCommandJSON result)
          {
        ...
        protected abstract void handle_result(HomeAutomationListUserDataCommandJSON new_result);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(HomeAutomationListUserDataCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public HomeAutomationListUserDataCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<HomeAutomationListUserDataCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<HomeAutomationListUserDataCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<HomeAutomationListUserDataCommandJSON> value;
  };
  };
