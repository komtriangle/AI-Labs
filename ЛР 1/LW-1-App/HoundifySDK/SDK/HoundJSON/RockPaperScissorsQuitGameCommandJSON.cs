/* file "RockPaperScissorsQuitGameCommandJSON.cs" */
...
public class RockPaperScissorsQuitGameCommandJSON : RockPaperScissorsCommandJSON
  {
    ...
    public RockPaperScissorsQuitGameCommandJSON()
      {
    ...
    public virtual int extraRockPaperScissorsQuitGameCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraRockPaperScissorsQuitGameCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraRockPaperScissorsQuitGameCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraRockPaperScissorsQuitGameCommandLookup(string field_name)
      {
        JSONValue result = (extraIndex.ContainsKey(field_name) ? extraIndex[field_name] : null);
        return result;
      }
    public override int extraRockPaperScissorsCommandComponentCount()
      {
        ...
        if (flagHasNativeData)
            ++result;
        result += extraRockPaperScissorsQuitGameCommandComponentCount();
        return result;
      }
    public override string extraRockPaperScissorsCommandComponentKey(int component_num)
      {
        ...
        return extraRockPaperScissorsQuitGameCommandComponentKey(remainder);
      }
    public override JSONValue extraRockPaperScissorsCommandComponentValue(int component_num)
      {
        ...
        return extraRockPaperScissorsQuitGameCommandComponentValue(remainder);
      }
    public override JSONValue extraRockPaperScissorsCommandLookup(string field_name)
      {
        ...
        return extraRockPaperScissorsQuitGameCommandLookup(field_name);
      }
    ...
    public virtual void extraRockPaperScissorsQuitGameCommandAppendPair(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public virtual void extraRockPaperScissorsQuitGameCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraRockPaperScissorsQuitGameCommandLookup(key);
        if (old_field == null)
          {
            extraRockPaperScissorsQuitGameCommandAppendPair(key, new_component);
          }
        else
          {
            int count = extraKeys.Count;
    ...
    public override void extraRockPaperScissorsCommandSetField(string key, JSONValue new_component)
      {
        ...
        extraRockPaperScissorsQuitGameCommandSetField(key, new_component);
      }
    ...
    public static new RockPaperScissorsQuitGameCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RockPaperScissorsQuitGameCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RockPaperScissorsQuitGameCommand", ignore_extras);
            generator.set_allow_incomplete(allow_incomplete);
            generator.set_allow_unpolished(allow_unpolished);
            if (allow_incomplete || allow_unpolished)
                json_value.write(generator);
    ...
    public static new RockPaperScissorsQuitGameCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RockPaperScissorsQuitGameCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RockPaperScissorsQuitGameCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RockPaperScissorsQuitGameCommand", ignore_extras);
    ...
    public static new RockPaperScissorsQuitGameCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RockPaperScissorsQuitGameCommandJSON from_text(string text, bool ignore_extras)
      {
        RockPaperScissorsQuitGameCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RockPaperScissorsQuitGameCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for RockPaperScissorsQuitGameCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new RockPaperScissorsQuitGameCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        RockPaperScissorsQuitGameCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RockPaperScissorsQuitGameCommand", ignore_extras);
    ...
    public new abstract class Generator : RockPaperScissorsCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getRockPaperScissorsCommandJSONKey().Equals("RockPaperScissorsQuitCommand")))
                throw new Exception("The key field has a value other than `RockPaperScissorsQuitCommand'.");
            RockPaperScissorsQuitGameCommandJSON result = new RockPaperScissorsQuitGameCommandJSON();
            Debug.Assert(result != null);
            finish(result);
            int extra_count = unknownFieldGenerator.field_names.Count;
            Debug.Assert(extra_count == unknownFieldGenerator.field_values.Count);
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraRockPaperScissorsQuitGameCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
            unknownFieldGenerator.field_names.Clear();
            unknownFieldGenerator.field_values.Clear();
            unknownFieldGenerator.index = new Dictionary<string, JSONValue >();
        ...
        protected override void handle_result(RockPaperScissorsCommandJSON new_result)
          {
            handle_result((RockPaperScissorsQuitGameCommandJSON )new_result);
          }
        protected void finish(RockPaperScissorsQuitGameCommandJSON result)
          {
        ...
        protected abstract void handle_result(RockPaperScissorsQuitGameCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the RockPaperScissorsQuitGameCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the RockPaperScissorsQuitGameCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the RockPaperScissorsQuitGameCommand class", false);
            unknownFieldGenerator = new UnknownFieldGenerator(false);
            set_what("the RockPaperScissorsQuitGameCommand class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(RockPaperScissorsQuitGameCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public RockPaperScissorsQuitGameCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<RockPaperScissorsQuitGameCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<RockPaperScissorsQuitGameCommandJSON>();
        base.set_what(what);
      }
    public HoldingArrayGenerator(bool ignore_extras)
      {
    ...
    public bool have_value;
    public List<RockPaperScissorsQuitGameCommandJSON> value;
  };
  };
