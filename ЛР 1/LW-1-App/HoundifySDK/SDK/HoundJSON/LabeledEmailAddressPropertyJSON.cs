/* file "LabeledEmailAddressPropertyJSON.cs" */
...
public class LabeledEmailAddressPropertyJSON : PropertyJSON
  {
    ...
    private void  fromJSONLabel(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field Label of LabeledEmailAddressPropertyJSON is not a string.");
    ...
    private void  fromJSONAliasLabels(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field AliasLabels of LabeledEmailAddressPropertyJSON is not an array.");
        ...
        for (int num1 = 0; num1 < count1; ++num1)
          {
            ...
            if (json_string == null)
                throw new Exception("The value for an element of field AliasLabels of LabeledEmailAddressPropertyJSON is not a string.");
    ...
    public LabeledEmailAddressPropertyJSON()
      {
        flagHasLabel = false;
    ...
    public virtual int extraLabeledEmailAddressPropertyComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraLabeledEmailAddressPropertyComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraLabeledEmailAddressPropertyComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraLabeledEmailAddressPropertyLookup(string field_name)
      {
    ...
    public override int extraPropertyComponentCount()
      {
        ...
        if (flagHasAliasLabels)
            ++result;
        result += extraLabeledEmailAddressPropertyComponentCount();
        return result;
      }
    public override string extraPropertyComponentKey(int component_num)
      {
        ...
        return extraLabeledEmailAddressPropertyComponentKey(remainder);
      }
    public override JSONValue extraPropertyComponentValue(int component_num)
      {
        ...
        return extraLabeledEmailAddressPropertyComponentValue(remainder);
      }
    public override JSONValue extraPropertyLookup(string field_name)
      {
        ...
        return extraLabeledEmailAddressPropertyLookup(field_name);
      }
    ...
    public virtual void extraLabeledEmailAddressPropertyAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraLabeledEmailAddressPropertySetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraLabeledEmailAddressPropertyLookup(key);
        if (old_field == null)
          {
            extraLabeledEmailAddressPropertyAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraPropertySetField(string key, JSONValue new_component)
      {
        ...
        extraLabeledEmailAddressPropertySetField(key, new_component);
      }
    ...
    public static new LabeledEmailAddressPropertyJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        LabeledEmailAddressPropertyJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type LabeledEmailAddressProperty", ignore_extras);
    ...
    public static new LabeledEmailAddressPropertyJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new LabeledEmailAddressPropertyJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        LabeledEmailAddressPropertyJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type LabeledEmailAddressProperty", ignore_extras);
    ...
    public static new LabeledEmailAddressPropertyJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new LabeledEmailAddressPropertyJSON from_text(string text, bool ignore_extras)
      {
        LabeledEmailAddressPropertyJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type LabeledEmailAddressProperty", ignore_extras);
            JSONParse.parse_json_value(text, "Text for LabeledEmailAddressPropertyJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new LabeledEmailAddressPropertyJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        LabeledEmailAddressPropertyJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type LabeledEmailAddressProperty", ignore_extras);
    ...
    public new abstract class Generator : PropertyJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getPropertyJSONKey().Equals("LabeledEmailAddress")))
                throw new Exception("The key field has a value other than `LabeledEmailAddress'.");
            LabeledEmailAddressPropertyJSON result = new LabeledEmailAddressPropertyJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraLabeledEmailAddressPropertyAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(PropertyJSON new_result)
          {
            handle_result((LabeledEmailAddressPropertyJSON )new_result);
          }
        protected void finish(LabeledEmailAddressPropertyJSON result)
          {
        ...
        protected abstract void handle_result(LabeledEmailAddressPropertyJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorLabel = new JSONHoldingStringGenerator("field \"Label\" of the LabeledEmailAddressProperty class");
            fieldGeneratorAliasLabels = new JSONHoldingStringArrayGenerator("field \"AliasLabels\" of the LabeledEmailAddressProperty class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the LabeledEmailAddressProperty class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(LabeledEmailAddressPropertyJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public LabeledEmailAddressPropertyJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<LabeledEmailAddressPropertyJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<LabeledEmailAddressPropertyJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<LabeledEmailAddressPropertyJSON> value;
  };
  };
