        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field ExtendedChannel of SiriusChannelCommandIntentJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field ExtendedChannel of SiriusChannelCommandIntentJSON is not an integer.");
              }
    ...
    public void setExtendedChannel(ushort new_value)
      {
        ...
        if (new_value < 1)
            throw new Exception("The value for field ExtendedChannel of SiriusChannelCommandIntentJSON is less than the lower bound (1) for that field.");
        if (new_value > 65535)
            throw new Exception("The value for field ExtendedChannel of SiriusChannelCommandIntentJSON is greater than the upper bound (65535) for that field.");
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            ...
            fieldGeneratorExtendedChannel = new FieldHoldingGeneratorExtendedChannel("field \"ExtendedChannel\" of the SiriusChannelCommandIntent class");
            fieldGeneratorTuningTarget = new TuningTargetJSON.HoldingGenerator("field \"TuningTarget\" of the SiriusChannelCommandIntent class", ignore_extras);
        ...
        public Generator() : base(false)
          {
            fieldGeneratorChannel = new FieldHoldingGeneratorChannel("field \"Channel\" of the SiriusChannelCommandIntent class");
            fieldGeneratorExtendedChannel = new FieldHoldingGeneratorExtendedChannel("field \"ExtendedChannel\" of the SiriusChannelCommandIntent class");
            fieldGeneratorTuningTarget = new TuningTargetJSON.HoldingGenerator("field \"TuningTarget\" of the SiriusChannelCommandIntent class", false);
