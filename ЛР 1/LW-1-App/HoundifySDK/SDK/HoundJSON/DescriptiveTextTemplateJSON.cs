/* file "DescriptiveTextTemplateJSON.cs" */
...
public class DescriptiveTextTemplateJSON : TemplateJSON
  {
    private bool flagHasTitle;
    private string storeTitle;
    private bool flagHasSecondaryTitle;
    private string storeSecondaryTitle;
    private bool flagHasSection1;
    private string storeSection1;
    private bool flagHasSection2;
    private string storeSection2;
    ...
    private JSONValue  extraSecondaryTitleToJSON()
      {
        JSONStringValue generated_string_SecondaryTitle = new JSONStringValue(storeSecondaryTitle);
        return generated_string_SecondaryTitle;
      }

    private JSONValue  extraSection1ToJSON()
      {
        JSONStringValue generated_string_Section1 = new JSONStringValue(storeSection1);
        return generated_string_Section1;
      }

    private JSONValue  extraSection2ToJSON()
      {
        JSONStringValue generated_string_Section2 = new JSONStringValue(storeSection2);
    ...
    private void  fromJSONTitle(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field Title of DescriptiveTextTemplateJSON is not a string.");
        setTitle(json_string.getData());
      }


    private void  fromJSONSecondaryTitle(JSONValue json_value, bool ignore_extras)
      {
        Debug.Assert(json_value != null);
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field SecondaryTitle of DescriptiveTextTemplateJSON is not a string.");
        setSecondaryTitle(json_string.getData());
      }


    private void  fromJSONSection1(JSONValue json_value, bool ignore_extras)
      {
        Debug.Assert(json_value != null);
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field Section1 of DescriptiveTextTemplateJSON is not a string.");
        setSection1(json_string.getData());
      }


    private void  fromJSONSection2(JSONValue json_value, bool ignore_extras)
      {
        Debug.Assert(json_value != null);
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field Section2 of DescriptiveTextTemplateJSON is not a string.");
        setSection2(json_string.getData());
      }
    ...
    private void  fromJSONFooter(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field Footer of DescriptiveTextTemplateJSON is not a string.");
    ...
    private void  fromJSONActionURIs(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field ActionURIs of DescriptiveTextTemplateJSON is not an array.");
        int count1 = json_array1.componentCount();
        if (count1 < 1)
            throw new Exception("The value for field ActionURIs of DescriptiveTextTemplateJSON has too few elements.");
        List< string > vector_ActionURIs1 = new List< string >(count1);
        for (int num1 = 0; num1 < count1; ++num1)
          {
            JSONStringValue json_string = json_array1.component(num1).string_value();
            if (json_string == null)
                throw new Exception("The value for an element of field ActionURIs of DescriptiveTextTemplateJSON is not a string.");
    ...
    public DescriptiveTextTemplateJSON()
      {
        flagHasTitle = false;
    ...
    public virtual int extraDescriptiveTextTemplateComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraDescriptiveTextTemplateComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraDescriptiveTextTemplateComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraDescriptiveTextTemplateLookup(string field_name)
      {
                ...
                if (String.Compare(field_name, 1, "ec", 0, 2, false) == 0)
                  {
                    switch (field_name[3])
                      {
                        case 'o':
                            if ((String.Compare(field_name, 4, "ndaryTitle", 0, 10, false) == 0) && (field_name.Length == 14))
                                return (flagHasSecondaryTitle ? extraSecondaryTitleToJSON() : null);
                            break;
                        case 't':
                            if (String.Compare(field_name, 4, "ion", 0, 3, false) == 0)
                              {
                                switch (field_name[7])
                                  {
                                    case '1':
    ...
    public void setSecondaryTitle(string new_value)
      {
        flagHasSecondaryTitle = true;
        storeSecondaryTitle = new_value;
      }
    public void unsetSecondaryTitle()
      {
        flagHasSecondaryTitle = false;
      }
    public void setSection1(string new_value)
      {
        flagHasSection1 = true;
        storeSection1 = new_value;
      }
    public void unsetSection1()
      {
        flagHasSection1 = false;
      }
    public void setSection2(string new_value)
      {
        flagHasSection2 = true;
        storeSection2 = new_value;
      }
    public void unsetSection2()
      {
        flagHasSection2 = false;
      }
    ...
    public virtual void extraDescriptiveTextTemplateAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraDescriptiveTextTemplateSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
        ...
        switch (key[0])
          {
            ...
            case 'F':
                ...
                break;
            case 'S':
                if (String.Compare(key, 1, "ec", 0, 2, false) == 0)
                  {
                    switch (key[3])
                      {
                        case 'o':
                            if ((String.Compare(key, 4, "ndaryTitle", 0, 10, false) == 0) && (key.Length == 14))
                                {
                            ...
                            break;
                        case 't':
                            if (String.Compare(key, 4, "ion", 0, 3, false) == 0)
                              {
                                switch (key[7])
                                  {
                                    case '1':
    ...
    public static new DescriptiveTextTemplateJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        DescriptiveTextTemplateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DescriptiveTextTemplate", ignore_extras);
    ...
    public static new DescriptiveTextTemplateJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new DescriptiveTextTemplateJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        DescriptiveTextTemplateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DescriptiveTextTemplate", ignore_extras);
    ...
    public static new DescriptiveTextTemplateJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new DescriptiveTextTemplateJSON from_text(string text, bool ignore_extras)
      {
        DescriptiveTextTemplateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DescriptiveTextTemplate", ignore_extras);
            JSONParse.parse_json_value(text, "Text for DescriptiveTextTemplateJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new DescriptiveTextTemplateJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        DescriptiveTextTemplateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DescriptiveTextTemplate", ignore_extras);
    ...
    public new abstract class Generator : TemplateJSON.Generator
      {
        ...
        private JSONHoldingStringGenerator fieldGeneratorSecondaryTitle;
        private JSONHoldingStringGenerator fieldGeneratorSection1;
        private JSONHoldingStringGenerator fieldGeneratorSection2;
        ...
        public Generator() : base(false)
          {
            ...
            fieldGeneratorSection2 = new JSONHoldingStringGenerator("field \"Section2\" of the DescriptiveTextTemplate class");
            fieldGeneratorFooter = new JSONHoldingStringGenerator("field \"Footer\" of the DescriptiveTextTemplate class");
            fieldGeneratorActionAndroidIntent = new AndroidIntentJSON.HoldingGenerator("field \"ActionAndroidIntent\" of the DescriptiveTextTemplate class", false);
            fieldGeneratorActionURIs = new JSONHoldingStringArrayGenerator("field \"ActionURIs\" of the DescriptiveTextTemplate class");
...
//@@@            Debug.Assert(!have_value);
        ...
        public DescriptiveTextTemplateJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<DescriptiveTextTemplateJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<DescriptiveTextTemplateJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<DescriptiveTextTemplateJSON> value;
  };
  };
