/* file "ImplicitPropertyOfJSON.cs" */
...
public class ImplicitPropertyOfJSON : DerivationJSON
  {
    ...
    public virtual int extraImplicitPropertyOfComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraImplicitPropertyOfComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraImplicitPropertyOfComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraImplicitPropertyOfLookup(string field_name)
      {
    ...
    public override int extraDerivationComponentCount()
      {
        ...
        if (flagHasProperty)
            ++result;
        result += extraImplicitPropertyOfComponentCount();
        return result;
      }
    public override string extraDerivationComponentKey(int component_num)
      {
        ...
        return extraImplicitPropertyOfComponentKey(remainder);
      }
    public override JSONValue extraDerivationComponentValue(int component_num)
      {
        ...
        return extraImplicitPropertyOfComponentValue(remainder);
      }
    public override JSONValue extraDerivationLookup(string field_name)
      {
        ...
        return extraImplicitPropertyOfLookup(field_name);
      }
    ...
    public virtual void extraImplicitPropertyOfAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraImplicitPropertyOfSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraImplicitPropertyOfLookup(key);
        if (old_field == null)
          {
            extraImplicitPropertyOfAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraDerivationSetField(string key, JSONValue new_component)
      {
        ...
        extraImplicitPropertyOfSetField(key, new_component);
      }
    ...
    public static new ImplicitPropertyOfJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ImplicitPropertyOfJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ImplicitPropertyOf", ignore_extras);
    ...
    public static new ImplicitPropertyOfJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new ImplicitPropertyOfJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ImplicitPropertyOfJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ImplicitPropertyOf", ignore_extras);
    ...
    public static new ImplicitPropertyOfJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new ImplicitPropertyOfJSON from_text(string text, bool ignore_extras)
      {
        ImplicitPropertyOfJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ImplicitPropertyOf", ignore_extras);
            JSONParse.parse_json_value(text, "Text for ImplicitPropertyOfJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new ImplicitPropertyOfJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        ImplicitPropertyOfJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ImplicitPropertyOf", ignore_extras);
    ...
    public new abstract class Generator : DerivationJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getDerivationJSONKey().Equals("ImplicitPropertyOf")))
                throw new Exception("The key field has a value other than `ImplicitPropertyOf'.");
            ImplicitPropertyOfJSON result = new ImplicitPropertyOfJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraImplicitPropertyOfAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(ImplicitPropertyOfJSON result)
          {
        ...
        protected abstract void handle_result(ImplicitPropertyOfJSON new_result);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(ImplicitPropertyOfJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public ImplicitPropertyOfJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<ImplicitPropertyOfJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<ImplicitPropertyOfJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<ImplicitPropertyOfJSON> value;
  };
  };
