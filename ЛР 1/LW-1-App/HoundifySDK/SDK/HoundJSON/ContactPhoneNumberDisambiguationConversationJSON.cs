/* file "ContactPhoneNumberDisambiguationConversationJSON.cs" */
...
public class ContactPhoneNumberDisambiguationConversationJSON : JSONBase
  {
    ...
    private void  fromJSONContacts(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field Contacts of ContactPhoneNumberDisambiguationConversationJSON is not an array.");
        int count1 = json_array1.componentCount();
        if (count1 < 1)
            throw new Exception("The value for field Contacts of ContactPhoneNumberDisambiguationConversationJSON has too few elements.");
    ...
    private void  fromJSONChoices(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONArrayValue json_array1 = json_value.array_value();
        if (json_array1 == null)
            throw new Exception("The value for field Choices of ContactPhoneNumberDisambiguationConversationJSON is not an array.");
        int count1 = json_array1.componentCount();
        if (count1 < 2)
            throw new Exception("The value for field Choices of ContactPhoneNumberDisambiguationConversationJSON has too few elements.");
    ...
    private void  fromJSONUserSpecifiedName(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field UserSpecifiedName of ContactPhoneNumberDisambiguationConversationJSON is not a string.");
    ...
    private void  fromJSONRequestedProperties(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONArrayValue json_array1 = json_value.array_value();
        if (json_array1 == null)
            throw new Exception("The value for field RequestedProperties of ContactPhoneNumberDisambiguationConversationJSON is not an array.");
        int count1 = json_array1.componentCount();
    ...
    public ContactPhoneNumberDisambiguationConversationJSON()
      {
    ...
    public virtual int extraContactPhoneNumberDisambiguationConversationComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraContactPhoneNumberDisambiguationConversationComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraContactPhoneNumberDisambiguationConversationComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraContactPhoneNumberDisambiguationConversationLookup(string field_name)
      {
    ...
    public virtual void extraContactPhoneNumberDisambiguationConversationAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraContactPhoneNumberDisambiguationConversationSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraContactPhoneNumberDisambiguationConversationLookup(key);
        if (old_field == null)
          {
            extraContactPhoneNumberDisambiguationConversationAppendPair(key, new_component);
          }
        else
          {
    ...
    public static ContactPhoneNumberDisambiguationConversationJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ContactPhoneNumberDisambiguationConversationJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ContactPhoneNumberDisambiguationConversation", ignore_extras);
    ...
    public static ContactPhoneNumberDisambiguationConversationJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static ContactPhoneNumberDisambiguationConversationJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ContactPhoneNumberDisambiguationConversationJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ContactPhoneNumberDisambiguationConversation", ignore_extras);
    ...
    public static ContactPhoneNumberDisambiguationConversationJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static ContactPhoneNumberDisambiguationConversationJSON from_text(string text, bool ignore_extras)
      {
        ContactPhoneNumberDisambiguationConversationJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ContactPhoneNumberDisambiguationConversation", ignore_extras);
            JSONParse.parse_json_value(text, "Text for ContactPhoneNumberDisambiguationConversationJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static ContactPhoneNumberDisambiguationConversationJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        ContactPhoneNumberDisambiguationConversationJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ContactPhoneNumberDisambiguationConversation", ignore_extras);
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        protected override void finish()
          {
            ContactPhoneNumberDisambiguationConversationJSON result = new ContactPhoneNumberDisambiguationConversationJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraContactPhoneNumberDisambiguationConversationAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(ContactPhoneNumberDisambiguationConversationJSON result)
          {
        ...
        protected abstract void handle_result(ContactPhoneNumberDisambiguationConversationJSON new_result);
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorContacts = new OneContactJSON.HoldingArrayGenerator("field \"Contacts\" of the ContactPhoneNumberDisambiguationConversation class", ignore_extras);
            fieldGeneratorChoices = new ContactPhoneNumberChoiceJSON.HoldingArrayGenerator("field \"Choices\" of the ContactPhoneNumberDisambiguationConversation class", ignore_extras);
            fieldGeneratorUserSpecifiedName = new JSONHoldingStringGenerator("field \"UserSpecifiedName\" of the ContactPhoneNumberDisambiguationConversation class");
            fieldGeneratorRequestedProperties = new PropertyJSON.HoldingArrayGenerator("field \"RequestedProperties\" of the ContactPhoneNumberDisambiguationConversation class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the ContactPhoneNumberDisambiguationConversation class");
            allow_incomplete = false;
            allow_unpolished = false;
          }
        public Generator()
          {
            fieldGeneratorContacts = new OneContactJSON.HoldingArrayGenerator("field \"Contacts\" of the ContactPhoneNumberDisambiguationConversation class", false);
            fieldGeneratorChoices = new ContactPhoneNumberChoiceJSON.HoldingArrayGenerator("field \"Choices\" of the ContactPhoneNumberDisambiguationConversation class", false);
            fieldGeneratorUserSpecifiedName = new JSONHoldingStringGenerator("field \"UserSpecifiedName\" of the ContactPhoneNumberDisambiguationConversation class");
            fieldGeneratorRequestedProperties = new PropertyJSON.HoldingArrayGenerator("field \"RequestedProperties\" of the ContactPhoneNumberDisambiguationConversation class", false);
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(ContactPhoneNumberDisambiguationConversationJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public ContactPhoneNumberDisambiguationConversationJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<ContactPhoneNumberDisambiguationConversationJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<ContactPhoneNumberDisambiguationConversationJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<ContactPhoneNumberDisambiguationConversationJSON> value;
  };
  };
