/* file "MusicChartsInformationNuggetJSON.cs" */
...
public class MusicChartsInformationNuggetJSON : MusicInformationNuggetJSON
  {
    ...
    private void  fromJSONChartTitle(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field ChartTitle of MusicChartsInformationNuggetJSON is not a string.");
    ...
    private void  fromJSONVideos(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field Videos of MusicChartsInformationNuggetJSON is not an array.");
    ...
    public MusicChartsInformationNuggetJSON()
      {
    ...
    public override string  getMusicNuggetKind()
      {
        return "MusicCharts";
      }
    ...
    public virtual int extraMusicChartsInformationNuggetComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraMusicChartsInformationNuggetComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraMusicChartsInformationNuggetComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraMusicChartsInformationNuggetLookup(string field_name)
      {
    ...
    public virtual void extraMusicChartsInformationNuggetAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraMusicChartsInformationNuggetSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new MusicChartsInformationNuggetJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        MusicChartsInformationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MusicChartsInformationNugget", ignore_extras);
    ...
    public static new MusicChartsInformationNuggetJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new MusicChartsInformationNuggetJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        MusicChartsInformationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MusicChartsInformationNugget", ignore_extras);
    ...
    public static new MusicChartsInformationNuggetJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new MusicChartsInformationNuggetJSON from_text(string text, bool ignore_extras)
      {
        MusicChartsInformationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MusicChartsInformationNugget", ignore_extras);
            JSONParse.parse_json_value(text, "Text for MusicChartsInformationNuggetJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new MusicChartsInformationNuggetJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        MusicChartsInformationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MusicChartsInformationNugget", ignore_extras);
    ...
    public new abstract class Generator : MusicInformationNuggetJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getMusicInformationNuggetJSONKey().Equals("MusicCharts")))
                throw new Exception("The key field has a value other than `MusicCharts'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraMusicChartsInformationNuggetAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(MusicInformationNuggetJSON new_result)
          {
            handle_result((MusicChartsInformationNuggetJSON )new_result);
          }
        protected void finish(MusicChartsInformationNuggetJSON result)
          {
        ...
        protected abstract void handle_result(MusicChartsInformationNuggetJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorSearchCriteria = new MusicChartsSearchCriteriaJSON.HoldingGenerator("field \"SearchCriteria\" of the MusicChartsInformationNugget class", ignore_extras);
            fieldGeneratorSearchCriteriaAdditional = new MusicChartsSearchCriteriaAdditionalJSON.HoldingGenerator("field \"SearchCriteriaAdditional\" of the MusicChartsInformationNugget class", ignore_extras);
            fieldGeneratorChartTitle = new JSONHoldingStringGenerator("field \"ChartTitle\" of the MusicChartsInformationNugget class");
            fieldGeneratorVideos = new MusicVideoJSON.HoldingArrayGenerator("field \"Videos\" of the MusicChartsInformationNugget class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the MusicChartsInformationNugget class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorSearchCriteria = new MusicChartsSearchCriteriaJSON.HoldingGenerator("field \"SearchCriteria\" of the MusicChartsInformationNugget class", false);
            fieldGeneratorSearchCriteriaAdditional = new MusicChartsSearchCriteriaAdditionalJSON.HoldingGenerator("field \"SearchCriteriaAdditional\" of the MusicChartsInformationNugget class", false);
            fieldGeneratorChartTitle = new JSONHoldingStringGenerator("field \"ChartTitle\" of the MusicChartsInformationNugget class");
            fieldGeneratorVideos = new MusicVideoJSON.HoldingArrayGenerator("field \"Videos\" of the MusicChartsInformationNugget class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(MusicChartsInformationNuggetJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public MusicChartsInformationNuggetJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<MusicChartsInformationNuggetJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<MusicChartsInformationNuggetJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<MusicChartsInformationNuggetJSON> value;
  };
  };
