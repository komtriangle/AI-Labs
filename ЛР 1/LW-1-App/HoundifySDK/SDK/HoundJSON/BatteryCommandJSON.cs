...
public class BatteryCommandJSON : DeviceControlCommandJSON
  {
    public enum TypeCommandType
      {
        CommandType_CheckBatteryState,
        CommandType_WhatsUsingBattery
      };
    ...
    public static TypeCommandType  stringToCommandType(string chars)
      {
        switch (chars[0])
          {
            case 'C':
                if ((String.Compare(chars, 1, "heckBatteryState", 0, 16, false) == 0) && (chars.Length == 17))
                    return TypeCommandType.CommandType_CheckBatteryState;
                break;
            case 'W':
                if ((String.Compare(chars, 1, "hatsUsingBattery", 0, 16, false) == 0) && (chars.Length == 17))
                    return TypeCommandType.CommandType_WhatsUsingBattery;
                break;
            default:
                break;
          }
    ...
    private void  fromJSONCommandType(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field CommandType of BatteryCommandJSON is not a string.");
        TypeCommandType the_enum;
        switch (json_string.getData()[0])
          {
            case 'C':
                if ((String.Compare(json_string.getData(), 1, "heckBatteryState", 0, 16, false) == 0) && (json_string.getData().Length == 17))
                      {
                        the_enum = TypeCommandType.CommandType_CheckBatteryState;
                        goto enum_is_done;
                      }
                break;
            case 'W':
                if ((String.Compare(json_string.getData(), 1, "hatsUsingBattery", 0, 16, false) == 0) && (json_string.getData().Length == 17))
                      {
                        the_enum = TypeCommandType.CommandType_WhatsUsingBattery;
                        goto enum_is_done;
                      }
                break;
            default:
        ...
        throw new Exception("The value for field CommandType of BatteryCommandJSON is not one of the legal strings.");
      enum_is_done:;
        setCommandType(the_enum);
      }


    public BatteryCommandJSON()
      {
    ...
    public virtual int extraBatteryCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraBatteryCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraBatteryCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraBatteryCommandLookup(string field_name)
      {
    ...
    public override int extraDeviceControlCommandComponentCount()
      {
        ...
        if (flagHasCommandType)
            ++result;
        result += extraBatteryCommandComponentCount();
        return result;
      }
    public override string extraDeviceControlCommandComponentKey(int component_num)
      {
        ...
        return extraBatteryCommandComponentKey(remainder);
      }
    public override JSONValue extraDeviceControlCommandComponentValue(int component_num)
      {
        ...
        return extraBatteryCommandComponentValue(remainder);
      }
    public override JSONValue extraDeviceControlCommandLookup(string field_name)
      {
        ...
        return extraBatteryCommandLookup(field_name);
      }
    ...
    public virtual void extraBatteryCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraBatteryCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraBatteryCommandLookup(key);
        if (old_field == null)
          {
            extraBatteryCommandAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraDeviceControlCommandSetField(string key, JSONValue new_component)
      {
        ...
        extraBatteryCommandSetField(key, new_component);
      }
        ...
        if (flagHasCommandType)
          {
            ...
            switch (storeCommandType)
              {
                case TypeCommandType.CommandType_CheckBatteryState:
                    handler.string_value("CheckBatteryState");
                    break;
                case TypeCommandType.CommandType_WhatsUsingBattery:
                    handler.string_value("WhatsUsingBattery");
                    break;
                default:
                    Debug.Assert(false);
                    break;
    ...
    public static new BatteryCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        BatteryCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BatteryCommand", ignore_extras);
    ...
    public static new BatteryCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new BatteryCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        BatteryCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BatteryCommand", ignore_extras);
    ...
    public static new BatteryCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new BatteryCommandJSON from_text(string text, bool ignore_extras)
      {
        BatteryCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BatteryCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for BatteryCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new BatteryCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        BatteryCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BatteryCommand", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorCommandType : JSONArrayGenerator
  {
    ...
    public List<TypeCommandType> value;
        ...
        protected override void finish()
          {
            if (!(getDeviceControlCommandJSONKey().Equals("BatteryCommand")))
                throw new Exception("The key field has a value other than `BatteryCommand'.");
            BatteryCommandJSON result = new BatteryCommandJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraBatteryCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(DeviceControlCommandJSON new_result)
          {
            handle_result((BatteryCommandJSON )new_result);
          }
        protected void finish(BatteryCommandJSON result)
          {
        ...
        protected abstract void handle_result(BatteryCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorCommandType = new FieldHoldingGeneratorCommandType("field \"CommandType\" of the BatteryCommand class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the BatteryCommand class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(BatteryCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public BatteryCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<BatteryCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<BatteryCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<BatteryCommandJSON> value;
  };
  };
