/* file "GuessThatLyricNotUnderstoodCommandJSON.cs" */
...
public class GuessThatLyricNotUnderstoodCommandJSON : GuessThatLyricCommandJSON
  {
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field Decade of GuessThatLyricNotUnderstoodCommandJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field Decade of GuessThatLyricNotUnderstoodCommandJSON is not an integer.");
              }
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field GuessedCorrectly of GuessThatLyricNotUnderstoodCommandJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field GuessedCorrectly of GuessThatLyricNotUnderstoodCommandJSON is not an integer.");
              }
            extracted_integer = json_rational.getInteger()        ;
          }
        else
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field HintsRemaining of GuessThatLyricNotUnderstoodCommandJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field HintsRemaining of GuessThatLyricNotUnderstoodCommandJSON is not an integer.");
              }
    ...
    private void  fromJSONDifficulty(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field Difficulty of GuessThatLyricNotUnderstoodCommandJSON is not a string.");
    ...
    private void  fromJSONCorrectAnswer(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field CorrectAnswer of GuessThatLyricNotUnderstoodCommandJSON is not a string.");
    ...
    private void  fromJSONQuestion(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field Question of GuessThatLyricNotUnderstoodCommandJSON is not a string.");
    ...
    private void  fromJSONSoundhoundLyricID(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field SoundhoundLyricID of GuessThatLyricNotUnderstoodCommandJSON is not a string.");
    ...
    private void  fromJSONGTLSoundhoundTrackID(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field GTLSoundhoundTrackID of GuessThatLyricNotUnderstoodCommandJSON is not a string.");
    ...
    private void  fromJSONCorrectTitle(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field CorrectTitle of GuessThatLyricNotUnderstoodCommandJSON is not a string.");
    ...
    private void  fromJSONCorrectArtist(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field CorrectArtist of GuessThatLyricNotUnderstoodCommandJSON is not a string.");
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field PlayerLost of GuessThatLyricNotUnderstoodCommandJSON is not true for false.");
              }
          }
    ...
    private void  fromJSONGuessedTracksList(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field GuessedTracksList of GuessThatLyricNotUnderstoodCommandJSON is not an array.");
    ...
    public GuessThatLyricNotUnderstoodCommandJSON()
      {
        flagHasDecade = false;
    ...
    public virtual int extraGuessThatLyricNotUnderstoodCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraGuessThatLyricNotUnderstoodCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraGuessThatLyricNotUnderstoodCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraGuessThatLyricNotUnderstoodCommandLookup(string field_name)
      {
    ...
    public override int extraGuessThatLyricCommandComponentCount()
      {
        int result = 0;
        result += extraGuessThatLyricNotUnderstoodCommandComponentCount();
        return result;
      }
    public override string extraGuessThatLyricCommandComponentKey(int component_num)
      {
        int remainder = component_num;
        return extraGuessThatLyricNotUnderstoodCommandComponentKey(remainder);
      }
    public override JSONValue extraGuessThatLyricCommandComponentValue(int component_num)
      {
        int remainder = component_num;
        return extraGuessThatLyricNotUnderstoodCommandComponentValue(remainder);
      }
    public override JSONValue extraGuessThatLyricCommandLookup(string field_name)
      {
        ...
        return extraGuessThatLyricNotUnderstoodCommandLookup(field_name);
      }
    ...
    public new void setDecade(BigInteger new_value)
      {
        flagHasDecade = true;
        if (new_value < 0)
            throw new Exception("The value for field Decade of GuessThatLyricNotUnderstoodCommandJSON is less than the lower bound (0) for that field.");
    ...
    public new void setGuessedCorrectly(BigInteger new_value)
      {
        ...
        if (new_value < 0)
            throw new Exception("The value for field GuessedCorrectly of GuessThatLyricNotUnderstoodCommandJSON is less than the lower bound (0) for that field.");
    ...
    public new void setHintsRemaining(sbyte new_value)
      {
        ...
        if (new_value < 0)
            throw new Exception("The value for field HintsRemaining of GuessThatLyricNotUnderstoodCommandJSON is less than the lower bound (0) for that field.");
        if (new_value > 4)
            throw new Exception("The value for field HintsRemaining of GuessThatLyricNotUnderstoodCommandJSON is greater than the upper bound (4) for that field.");
    ...
    public virtual void extraGuessThatLyricNotUnderstoodCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraGuessThatLyricNotUnderstoodCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraGuessThatLyricNotUnderstoodCommandLookup(key);
        if (old_field == null)
          {
            extraGuessThatLyricNotUnderstoodCommandAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraGuessThatLyricCommandSetField(string key, JSONValue new_component)
      {
        ...
        extraGuessThatLyricNotUnderstoodCommandSetField(key, new_component);
      }
    ...
    public static new GuessThatLyricNotUnderstoodCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        GuessThatLyricNotUnderstoodCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type GuessThatLyricNotUnderstoodCommand", ignore_extras);
    ...
    public static new GuessThatLyricNotUnderstoodCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new GuessThatLyricNotUnderstoodCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        GuessThatLyricNotUnderstoodCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type GuessThatLyricNotUnderstoodCommand", ignore_extras);
    ...
    public static new GuessThatLyricNotUnderstoodCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new GuessThatLyricNotUnderstoodCommandJSON from_text(string text, bool ignore_extras)
      {
        GuessThatLyricNotUnderstoodCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type GuessThatLyricNotUnderstoodCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for GuessThatLyricNotUnderstoodCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new GuessThatLyricNotUnderstoodCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        GuessThatLyricNotUnderstoodCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type GuessThatLyricNotUnderstoodCommand", ignore_extras);
    ...
    private class FieldHoldingArrayGeneratorHintsRemaining : JSONHoldingIntegerRangeArrayGenerator
        ...
        protected override void finish()
          {
            if (!(getGuessThatLyricCommandJSONKey().Equals("GuessThatLyricNotUnderstoodCommand")))
                throw new Exception("The key field has a value other than `GuessThatLyricNotUnderstoodCommand'.");
            GuessThatLyricNotUnderstoodCommandJSON result = new GuessThatLyricNotUnderstoodCommandJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraGuessThatLyricNotUnderstoodCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(GuessThatLyricCommandJSON new_result)
          {
            handle_result((GuessThatLyricNotUnderstoodCommandJSON )new_result);
          }
        protected void finish(GuessThatLyricNotUnderstoodCommandJSON result)
          {
        ...
        protected abstract void handle_result(GuessThatLyricNotUnderstoodCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorDecade = new FieldHoldingGeneratorDecade("field \"Decade\" of the GuessThatLyricNotUnderstoodCommand class");
            fieldGeneratorGuessedCorrectly = new FieldHoldingGeneratorGuessedCorrectly("field \"GuessedCorrectly\" of the GuessThatLyricNotUnderstoodCommand class");
            fieldGeneratorHintsRemaining = new FieldHoldingGeneratorHintsRemaining("field \"HintsRemaining\" of the GuessThatLyricNotUnderstoodCommand class");
            fieldGeneratorDifficulty = new JSONHoldingStringGenerator("field \"Difficulty\" of the GuessThatLyricNotUnderstoodCommand class");
            fieldGeneratorCorrectAnswer = new JSONHoldingStringGenerator("field \"CorrectAnswer\" of the GuessThatLyricNotUnderstoodCommand class");
            fieldGeneratorQuestion = new JSONHoldingStringGenerator("field \"Question\" of the GuessThatLyricNotUnderstoodCommand class");
            fieldGeneratorSoundhoundLyricID = new JSONHoldingStringGenerator("field \"SoundhoundLyricID\" of the GuessThatLyricNotUnderstoodCommand class");
            fieldGeneratorGTLSoundhoundTrackID = new JSONHoldingStringGenerator("field \"GTLSoundhoundTrackID\" of the GuessThatLyricNotUnderstoodCommand class");
            fieldGeneratorCorrectTitle = new JSONHoldingStringGenerator("field \"CorrectTitle\" of the GuessThatLyricNotUnderstoodCommand class");
            fieldGeneratorCorrectArtist = new JSONHoldingStringGenerator("field \"CorrectArtist\" of the GuessThatLyricNotUnderstoodCommand class");
            fieldGeneratorPlayerLost = new JSONHoldingBooleanGenerator("field \"PlayerLost\" of the GuessThatLyricNotUnderstoodCommand class");
            fieldGeneratorGuessedTracksList = new MusicTrackJSON.HoldingArrayGenerator("field \"GuessedTracksList\" of the GuessThatLyricNotUnderstoodCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the GuessThatLyricNotUnderstoodCommand class");
          }
        public Generator() : base(false)
          {
            ...
            fieldGeneratorCorrectArtist = new JSONHoldingStringGenerator("field \"CorrectArtist\" of the GuessThatLyricNotUnderstoodCommand class");
            fieldGeneratorPlayerLost = new JSONHoldingBooleanGenerator("field \"PlayerLost\" of the GuessThatLyricNotUnderstoodCommand class");
            fieldGeneratorGuessedTracksList = new MusicTrackJSON.HoldingArrayGenerator("field \"GuessedTracksList\" of the GuessThatLyricNotUnderstoodCommand class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(GuessThatLyricNotUnderstoodCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public GuessThatLyricNotUnderstoodCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<GuessThatLyricNotUnderstoodCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<GuessThatLyricNotUnderstoodCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<GuessThatLyricNotUnderstoodCommandJSON> value;
  };
  };
