/* file "CarControlLightsIntoModeCommandJSON.cs" */
...
public class CarControlLightsIntoModeCommandJSON : CarControlCommandJSON
  {
    ...
    public static TypeCommandType  stringToCommandType(string chars)
      {
        switch (chars[0])
          {
            case 'D':
                if ((String.Compare(chars, 1, "arkOut", 0, 6, false) == 0) && (chars.Length == 7))
                    return TypeCommandType.CommandType_DarkOut;
                break;
            case 'F':
                if ((String.Compare(chars, 1, "oggy", 0, 4, false) == 0) && (chars.Length == 5))
                    return TypeCommandType.CommandType_Foggy;
                break;
            default:
                break;
          }
    ...
    private void  fromJSONCommandType(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field CommandType of CarControlLightsIntoModeCommandJSON is not a string.");
        TypeCommandType the_enum;
        switch (json_string.getData()[0])
          {
            case 'D':
                if ((String.Compare(json_string.getData(), 1, "arkOut", 0, 6, false) == 0) && (json_string.getData().Length == 7))
                      {
                        the_enum = TypeCommandType.CommandType_DarkOut;
                        goto enum_is_done;
                      }
                break;
            case 'F':
                if ((String.Compare(json_string.getData(), 1, "oggy", 0, 4, false) == 0) && (json_string.getData().Length == 5))
                      {
                        the_enum = TypeCommandType.CommandType_Foggy;
                        goto enum_is_done;
                      }
                break;
            default:
        ...
        throw new Exception("The value for field CommandType of CarControlLightsIntoModeCommandJSON is not one of the legal strings.");
      enum_is_done:;
        setCommandType(the_enum);
      }


    public CarControlLightsIntoModeCommandJSON()
      {
    ...
    public virtual int extraCarControlLightsIntoModeCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraCarControlLightsIntoModeCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraCarControlLightsIntoModeCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraCarControlLightsIntoModeCommandLookup(string field_name)
      {
    ...
    public virtual void extraCarControlLightsIntoModeCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraCarControlLightsIntoModeCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new CarControlLightsIntoModeCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CarControlLightsIntoModeCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlLightsIntoModeCommand", ignore_extras);
    ...
    public static new CarControlLightsIntoModeCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new CarControlLightsIntoModeCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CarControlLightsIntoModeCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlLightsIntoModeCommand", ignore_extras);
    ...
    public static new CarControlLightsIntoModeCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new CarControlLightsIntoModeCommandJSON from_text(string text, bool ignore_extras)
      {
        CarControlLightsIntoModeCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlLightsIntoModeCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for CarControlLightsIntoModeCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new CarControlLightsIntoModeCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        CarControlLightsIntoModeCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlLightsIntoModeCommand", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorCommandType : JSONArrayGenerator
  {
    ...
    public List<TypeCommandType> value;
        ...
        protected override void finish()
          {
            if (!(getCarControlCommandJSONKey().Equals("CarControlLightsIntoModeCommand")))
                throw new Exception("The key field has a value other than `CarControlLightsIntoModeCommand'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraCarControlLightsIntoModeCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(CarControlLightsIntoModeCommandJSON result)
          {
        ...
        protected abstract void handle_result(CarControlLightsIntoModeCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorCommandType = new FieldHoldingGeneratorCommandType("field \"CommandType\" of the CarControlLightsIntoModeCommand class");
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(CarControlLightsIntoModeCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public CarControlLightsIntoModeCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<CarControlLightsIntoModeCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<CarControlLightsIntoModeCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<CarControlLightsIntoModeCommandJSON> value;
  };
  };
