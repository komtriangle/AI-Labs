/* file "VoiceActivityDetectionJSON.cs" */
...
public class VoiceActivityDetectionJSON : JSONBase
  {
        ...
        if (json_rational != null)
        ...
        else
          {
            ...
            if (json_integer != null)
              ...
              {
                throw new Exception("The value for field MaxSilenceSeconds of VoiceActivityDetectionJSON is not a number.");
              }
          }
        ...
        if (json_rational != null)
        ...
        else
          {
            ...
            if (json_integer != null)
              ...
              {
                throw new Exception("The value for field MaxSilenceAfterFullQuerySeconds of VoiceActivityDetectionJSON is not a number.");
              }
          }
        ...
        if (json_rational != null)
        ...
        else
          {
            ...
            if (json_integer != null)
              ...
              {
                throw new Exception("The value for field MaxSilenceAfterPartialQuerySeconds of VoiceActivityDetectionJSON is not a number.");
              }
          }
    ...
    public VoiceActivityDetectionJSON()
      {
    ...
    public virtual int extraVoiceActivityDetectionComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraVoiceActivityDetectionComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraVoiceActivityDetectionComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraVoiceActivityDetectionLookup(string field_name)
      {
    ...
    public void setMaxSilenceSeconds(double new_value)
      {
        ...
        if (new_value < 0)
            throw new Exception("The value for field MaxSilenceSeconds of VoiceActivityDetectionJSON is less than the lower bound (0) for that field.");
    ...
    public void setMaxSilenceSecondsText(string new_value)
      {
        ...
        if (!(JSONWriter.is_valid_number_format(new_value)))
            throw new Exception("The text value for field MaxSilenceSeconds of VoiceActivityDetectionJSON is not a valid number.");
    ...
    public void setMaxSilenceAfterFullQuerySeconds(double new_value)
      {
        ...
        if (new_value < 0)
            throw new Exception("The value for field MaxSilenceAfterFullQuerySeconds of VoiceActivityDetectionJSON is less than the lower bound (0) for that field.");
    ...
    public void setMaxSilenceAfterFullQuerySecondsText(string new_value)
      {
        flagHasMaxSilenceAfterFullQuerySeconds = true;
        if (!(JSONWriter.is_valid_number_format(new_value)))
            throw new Exception("The text value for field MaxSilenceAfterFullQuerySeconds of VoiceActivityDetectionJSON is not a valid number.");
        if (JSONWriter.compare_number_text_to_repeating_fraction(new_value, false, "", "", false, "") < 0)
            throw new Exception("The value for field MaxSilenceAfterFullQuerySeconds of VoiceActivityDetectionJSON is less than the lower bound (0) for that field.");
    ...
    public void setMaxSilenceAfterPartialQuerySeconds(double new_value)
      {
        ...
        if (new_value < 0)
            throw new Exception("The value for field MaxSilenceAfterPartialQuerySeconds of VoiceActivityDetectionJSON is less than the lower bound (0) for that field.");
    ...
    public void setMaxSilenceAfterPartialQuerySecondsText(string new_value)
      {
        flagHasMaxSilenceAfterPartialQuerySeconds = true;
        if (!(JSONWriter.is_valid_number_format(new_value)))
            throw new Exception("The text value for field MaxSilenceAfterPartialQuerySeconds of VoiceActivityDetectionJSON is not a valid number.");
        if (JSONWriter.compare_number_text_to_repeating_fraction(new_value, false, "", "", false, "") < 0)
            throw new Exception("The value for field MaxSilenceAfterPartialQuerySeconds of VoiceActivityDetectionJSON is less than the lower bound (0) for that field.");
    ...
    public virtual void extraVoiceActivityDetectionAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraVoiceActivityDetectionSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static VoiceActivityDetectionJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        VoiceActivityDetectionJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type VoiceActivityDetection", ignore_extras);
    ...
    public static VoiceActivityDetectionJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static VoiceActivityDetectionJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        VoiceActivityDetectionJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type VoiceActivityDetection", ignore_extras);
    ...
    public static VoiceActivityDetectionJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static VoiceActivityDetectionJSON from_text(string text, bool ignore_extras)
      {
        VoiceActivityDetectionJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type VoiceActivityDetection", ignore_extras);
            JSONParse.parse_json_value(text, "Text for VoiceActivityDetectionJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static VoiceActivityDetectionJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        VoiceActivityDetectionJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type VoiceActivityDetection", ignore_extras);
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        protected override void finish()
          {
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraVoiceActivityDetectionAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(VoiceActivityDetectionJSON result)
          {
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(VoiceActivityDetectionJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public VoiceActivityDetectionJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<VoiceActivityDetectionJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<VoiceActivityDetectionJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<VoiceActivityDetectionJSON> value;
  };
  };
