/* file "SetClientUberServerTokenCommandJSON.cs" */
...
public class SetClientUberServerTokenCommandJSON : UberCommandJSON
  {
        ...
        private void  fromJSONStatus(JSONValue json_value, bool ignore_extras)
          {
            ...
            if (json_string == null)
                throw new Exception("The value for field Status of TypeNativeDataJSON is not a string.");
        ...
        private void  fromJSONDescription(JSONValue json_value, bool ignore_extras)
          {
            ...
            JSONStringValue json_string = json_value.string_value();
            if (json_string == null)
                throw new Exception("The value for field Description of TypeNativeDataJSON is not a string.");
    ...
    public SetClientUberServerTokenCommandJSON()
      {
    ...
    public virtual int extraSetClientUberServerTokenCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSetClientUberServerTokenCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSetClientUberServerTokenCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSetClientUberServerTokenCommandLookup(string field_name)
      {
        JSONValue result = (extraIndex.ContainsKey(field_name) ? extraIndex[field_name] : null);
        return result;
      }
    public override int extraUberCommandComponentCount()
      {
        ...
        if (flagHasNativeData)
            ++result;
        result += extraSetClientUberServerTokenCommandComponentCount();
        return result;
      }
    public override string extraUberCommandComponentKey(int component_num)
      {
        ...
        return extraSetClientUberServerTokenCommandComponentKey(remainder);
      }
    public override JSONValue extraUberCommandComponentValue(int component_num)
      {
        ...
        return extraSetClientUberServerTokenCommandComponentValue(remainder);
      }
    public override JSONValue extraUberCommandLookup(string field_name)
      {
        ...
        return extraSetClientUberServerTokenCommandLookup(field_name);
      }
    ...
    public virtual void extraSetClientUberServerTokenCommandAppendPair(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public virtual void extraSetClientUberServerTokenCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraSetClientUberServerTokenCommandLookup(key);
        if (old_field == null)
          {
            extraSetClientUberServerTokenCommandAppendPair(key, new_component);
          }
        else
          {
            int count = extraKeys.Count;
    ...
    public override void extraUberCommandSetField(string key, JSONValue new_component)
      {
        ...
        extraSetClientUberServerTokenCommandSetField(key, new_component);
      }
    ...
    public static new SetClientUberServerTokenCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SetClientUberServerTokenCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SetClientUberServerTokenCommand", ignore_extras);
            generator.set_allow_incomplete(allow_incomplete);
            generator.set_allow_unpolished(allow_unpolished);
            if (allow_incomplete || allow_unpolished)
                json_value.write(generator);
    ...
    public static new SetClientUberServerTokenCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SetClientUberServerTokenCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SetClientUberServerTokenCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SetClientUberServerTokenCommand", ignore_extras);
    ...
    public static new SetClientUberServerTokenCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SetClientUberServerTokenCommandJSON from_text(string text, bool ignore_extras)
      {
        SetClientUberServerTokenCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SetClientUberServerTokenCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SetClientUberServerTokenCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new SetClientUberServerTokenCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SetClientUberServerTokenCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SetClientUberServerTokenCommand", ignore_extras);
    ...
    public new abstract class Generator : UberCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getUberCommandJSONKey().Equals("SetClientUberServerToken")))
                throw new Exception("The key field has a value other than `SetClientUberServerToken'.");
            SetClientUberServerTokenCommandJSON result = new SetClientUberServerTokenCommandJSON();
            Debug.Assert(result != null);
            finish(result);
            int extra_count = unknownFieldGenerator.field_names.Count;
            Debug.Assert(extra_count == unknownFieldGenerator.field_values.Count);
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSetClientUberServerTokenCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
            unknownFieldGenerator.field_names.Clear();
            unknownFieldGenerator.field_values.Clear();
            unknownFieldGenerator.index = new Dictionary<string, JSONValue >();
        ...
        protected override void handle_result(UberCommandJSON new_result)
          {
            handle_result((SetClientUberServerTokenCommandJSON )new_result);
          }
        protected void finish(SetClientUberServerTokenCommandJSON result)
          {
        ...
        protected abstract void handle_result(SetClientUberServerTokenCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the SetClientUberServerTokenCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the SetClientUberServerTokenCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the SetClientUberServerTokenCommand class", false);
            unknownFieldGenerator = new UnknownFieldGenerator(false);
            set_what("the SetClientUberServerTokenCommand class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(SetClientUberServerTokenCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public SetClientUberServerTokenCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SetClientUberServerTokenCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<SetClientUberServerTokenCommandJSON>();
        base.set_what(what);
      }
    public HoldingArrayGenerator(bool ignore_extras)
      {
    ...
    public bool have_value;
    public List<SetClientUberServerTokenCommandJSON> value;
  };
  };
