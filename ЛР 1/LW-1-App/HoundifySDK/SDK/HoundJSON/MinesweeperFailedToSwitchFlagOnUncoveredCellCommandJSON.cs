/* file "MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON.cs" */
...
public class MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON : CommandResultJSON
  {
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field IsFlagging of MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON is not true for false.");
              }
          }
    ...
    public MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON()
      {
        flagHasState = false;
    ...
    public override string  getCommandKind()
      {
        return "MinesweeperFailedToSwitchFlagOnUncoverCellCommand";
      }
    ...
    public virtual int extraMinesweeperFailedToSwitchFlagOnUncoveredCellCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraMinesweeperFailedToSwitchFlagOnUncoveredCellCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraMinesweeperFailedToSwitchFlagOnUncoveredCellCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraMinesweeperFailedToSwitchFlagOnUncoveredCellCommandLookup(string field_name)
      {
    ...
    public override int extraCommandResultComponentCount()
      {
        ...
        if (flagHasIsFlagging)
            ++result;
        result += extraMinesweeperFailedToSwitchFlagOnUncoveredCellCommandComponentCount();
        return result;
      }
    public override string extraCommandResultComponentKey(int component_num)
      {
        ...
        return extraMinesweeperFailedToSwitchFlagOnUncoveredCellCommandComponentKey(remainder);
      }
    public override JSONValue extraCommandResultComponentValue(int component_num)
      {
        ...
        return extraMinesweeperFailedToSwitchFlagOnUncoveredCellCommandComponentValue(remainder);
      }
    public override JSONValue extraCommandResultLookup(string field_name)
      {
        ...
        return extraMinesweeperFailedToSwitchFlagOnUncoveredCellCommandLookup(field_name);
      }
    ...
    public virtual void extraMinesweeperFailedToSwitchFlagOnUncoveredCellCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraMinesweeperFailedToSwitchFlagOnUncoveredCellCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraMinesweeperFailedToSwitchFlagOnUncoveredCellCommandLookup(key);
        if (old_field == null)
          {
            extraMinesweeperFailedToSwitchFlagOnUncoveredCellCommandAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraCommandResultSetField(string key, JSONValue new_component)
      {
        ...
        extraMinesweeperFailedToSwitchFlagOnUncoveredCellCommandSetField(key, new_component);
      }
    ...
    public static new MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MinesweeperFailedToSwitchFlagOnUncoveredCellCommand", ignore_extras);
    ...
    public static new MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MinesweeperFailedToSwitchFlagOnUncoveredCellCommand", ignore_extras);
    ...
    public static new MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON from_text(string text, bool ignore_extras)
      {
        MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MinesweeperFailedToSwitchFlagOnUncoveredCellCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MinesweeperFailedToSwitchFlagOnUncoveredCellCommand", ignore_extras);
    ...
    public new abstract class Generator : CommandResultJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getCommandResultJSONKey().Equals("MinesweeperFailedToSwitchFlagOnUncoverCellCommand")))
                throw new Exception("The key field has a value other than `MinesweeperFailedToSwitchFlagOnUncoverCellCommand'.");
            MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON result = new MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraMinesweeperFailedToSwitchFlagOnUncoveredCellCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(CommandResultJSON new_result)
          {
            handle_result((MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON )new_result);
          }
        protected void finish(MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON result)
          {
        ...
        protected abstract void handle_result(MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorState = new MinesweeperStateJSON.HoldingGenerator("field \"State\" of the MinesweeperFailedToSwitchFlagOnUncoveredCellCommand class", ignore_extras);
            fieldGeneratorCoordinate = new MinesweeperCoordinateJSON.HoldingGenerator("field \"Coordinate\" of the MinesweeperFailedToSwitchFlagOnUncoveredCellCommand class", ignore_extras);
            fieldGeneratorIsFlagging = new JSONHoldingBooleanGenerator("field \"IsFlagging\" of the MinesweeperFailedToSwitchFlagOnUncoveredCellCommand class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the MinesweeperFailedToSwitchFlagOnUncoveredCellCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorState = new MinesweeperStateJSON.HoldingGenerator("field \"State\" of the MinesweeperFailedToSwitchFlagOnUncoveredCellCommand class", false);
            fieldGeneratorCoordinate = new MinesweeperCoordinateJSON.HoldingGenerator("field \"Coordinate\" of the MinesweeperFailedToSwitchFlagOnUncoveredCellCommand class", false);
            fieldGeneratorIsFlagging = new JSONHoldingBooleanGenerator("field \"IsFlagging\" of the MinesweeperFailedToSwitchFlagOnUncoveredCellCommand class");
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<MinesweeperFailedToSwitchFlagOnUncoveredCellCommandJSON> value;
  };
  };
