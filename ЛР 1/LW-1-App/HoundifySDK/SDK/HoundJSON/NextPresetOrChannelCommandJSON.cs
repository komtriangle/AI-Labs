/* file "NextPresetOrChannelCommandJSON.cs" */
...
public class NextPresetOrChannelCommandJSON : RadioCommandJSON
  {
    ...
    public NextPresetOrChannelCommandJSON()
      {
    ...
    public virtual int extraNextPresetOrChannelCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraNextPresetOrChannelCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraNextPresetOrChannelCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraNextPresetOrChannelCommandLookup(string field_name)
      {
    ...
    public virtual void extraNextPresetOrChannelCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraNextPresetOrChannelCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new NextPresetOrChannelCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new NextPresetOrChannelCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        NextPresetOrChannelCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NextPresetOrChannelCommand", ignore_extras);
    ...
    public static new NextPresetOrChannelCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new NextPresetOrChannelCommandJSON from_text(string text, bool ignore_extras)
      {
        NextPresetOrChannelCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NextPresetOrChannelCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for NextPresetOrChannelCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new NextPresetOrChannelCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        NextPresetOrChannelCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NextPresetOrChannelCommand", ignore_extras);
    ...
    public new abstract class Generator : RadioCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getRadioCommandJSONKey().Equals("NextPresetOrChannel")))
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraNextPresetOrChannelCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(NextPresetOrChannelCommandJSON result)
          {
        ...
        protected abstract void handle_result(NextPresetOrChannelCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorPresetResult = new DynamicResponseJSON.HoldingGenerator("field \"PresetResult\" of the NextPresetOrChannelCommand class", ignore_extras);
            fieldGeneratorChannelResult = new DynamicResponseJSON.HoldingGenerator("field \"ChannelResult\" of the NextPresetOrChannelCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the NextPresetOrChannelCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorPresetResult = new DynamicResponseJSON.HoldingGenerator("field \"PresetResult\" of the NextPresetOrChannelCommand class", false);
            fieldGeneratorChannelResult = new DynamicResponseJSON.HoldingGenerator("field \"ChannelResult\" of the NextPresetOrChannelCommand class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(NextPresetOrChannelCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public NextPresetOrChannelCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<NextPresetOrChannelCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<NextPresetOrChannelCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<NextPresetOrChannelCommandJSON> value;
  };
  };
