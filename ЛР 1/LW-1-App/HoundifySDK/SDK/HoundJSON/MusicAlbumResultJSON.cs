...
public class MusicAlbumResultJSON : JSONBase
  {
    ...
    private SoundHoundAlbumIDJSON  storeSoundHoundId;
    ...
    private void  fromJSONAlbumName(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field AlbumName of MusicAlbumResultJSON is not a string.");
    ...
    private void  fromJSONArtistName(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field ArtistName of MusicAlbumResultJSON is not a string.");
    ...
    public SoundHoundAlbumIDJSON   getSoundHoundId()
      {
    ...
    public void setSoundHoundId(SoundHoundAlbumIDJSON  new_value)
      {
    ...
    public static MusicAlbumResultJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        MusicAlbumResultJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MusicAlbumResult", ignore_extras);
    ...
    public static MusicAlbumResultJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static MusicAlbumResultJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        MusicAlbumResultJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MusicAlbumResult", ignore_extras);
    ...
    public static MusicAlbumResultJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static MusicAlbumResultJSON from_text(string text, bool ignore_extras)
      {
        MusicAlbumResultJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MusicAlbumResult", ignore_extras);
            JSONParse.parse_json_value(text, "Text for MusicAlbumResultJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static MusicAlbumResultJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        MusicAlbumResultJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MusicAlbumResult", ignore_extras);
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        private SoundHoundAlbumIDJSON.HoldingGenerator fieldGeneratorSoundHoundId;
        ...
        protected void finish(MusicAlbumResultJSON result)
          {
        ...
        protected abstract void handle_result(MusicAlbumResultJSON new_result);
        ...
        public Generator(bool ignore_extras)
          {
            ...
            fieldGeneratorSoundHoundId = new SoundHoundAlbumIDJSON.HoldingGenerator("field \"SoundHoundId\" of the MusicAlbumResult class", ignore_extras);
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(MusicAlbumResultJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public MusicAlbumResultJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<MusicAlbumResultJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<MusicAlbumResultJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<MusicAlbumResultJSON> value;
  };
  };
