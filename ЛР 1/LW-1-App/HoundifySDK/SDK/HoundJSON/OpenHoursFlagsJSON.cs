...
public class OpenHoursFlagsJSON : JSONBase
  {
    ...
    private bool storeStartDateAndTime;
    private bool flagHasEndDateAndTime;
    private bool storeEndDateAndTime;
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field OpenNow of OpenHoursFlagsJSON is not true for false.");
              }
          }
        setOpenNow(the_bool);
      }
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field Open24Hrs of OpenHoursFlagsJSON is not true for false.");
              }
          }
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field OpenEveryday of OpenHoursFlagsJSON is not true for false.");
              }
          }
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field OpenMonday of OpenHoursFlagsJSON is not true for false.");
              }
          }
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field OpenTuesday of OpenHoursFlagsJSON is not true for false.");
              }
          }
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field OpenWednesday of OpenHoursFlagsJSON is not true for false.");
              }
          }
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field OpenThursday of OpenHoursFlagsJSON is not true for false.");
              }
          }
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field OpenFriday of OpenHoursFlagsJSON is not true for false.");
              }
          }
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field OpenSaturday of OpenHoursFlagsJSON is not true for false.");
              }
          }
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field OpenSunday of OpenHoursFlagsJSON is not true for false.");
              }
          }
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field OpenAfterTime of OpenHoursFlagsJSON is not true for false.");
              }
          }
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field OpenBeforeTime of OpenHoursFlagsJSON is not true for false.");
              }
          }
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field OpenTimeMentioned of OpenHoursFlagsJSON is not true for false.");
              }
          }
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field StartDateAndTime of OpenHoursFlagsJSON is not true for false.");
              }
          }
        setStartDateAndTime(the_bool);
      }
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field EndDateAndTime of OpenHoursFlagsJSON is not true for false.");
              }
          }
        setEndDateAndTime(the_bool);
      }


    public OpenHoursFlagsJSON()
      {
    ...
    public bool  getStartDateAndTime()
      {
    ...
    public virtual int extraOpenHoursFlagsComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraOpenHoursFlagsComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraOpenHoursFlagsComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraOpenHoursFlagsLookup(string field_name)
      {
    ...
    public void setStartDateAndTime(bool new_value)
      {
    ...
    public void setEndDateAndTime(bool new_value)
      {
    ...
    public virtual void extraOpenHoursFlagsAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraOpenHoursFlagsSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraOpenHoursFlagsLookup(key);
        if (old_field == null)
          {
            extraOpenHoursFlagsAppendPair(key, new_component);
          }
        else
          {
        ...
        if (flagHasStartDateAndTime)
          {
            ...
            handler.boolean_value(storeStartDateAndTime);
          }
        if (flagHasEndDateAndTime)
          {
            handler.start_pair("EndDateAndTime");
            handler.boolean_value(storeEndDateAndTime);
          }
      }
    ...
    public static OpenHoursFlagsJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        OpenHoursFlagsJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type OpenHoursFlags", ignore_extras);
    ...
    public static OpenHoursFlagsJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static OpenHoursFlagsJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        OpenHoursFlagsJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type OpenHoursFlags", ignore_extras);
    ...
    public static OpenHoursFlagsJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static OpenHoursFlagsJSON from_text(string text, bool ignore_extras)
      {
        OpenHoursFlagsJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type OpenHoursFlags", ignore_extras);
            JSONParse.parse_json_value(text, "Text for OpenHoursFlagsJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static OpenHoursFlagsJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        OpenHoursFlagsJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type OpenHoursFlags", ignore_extras);
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        private JSONHoldingBooleanGenerator fieldGeneratorStartDateAndTime;
        private JSONHoldingBooleanGenerator fieldGeneratorEndDateAndTime;
        ...
        protected override void finish()
          {
            OpenHoursFlagsJSON result = new OpenHoursFlagsJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraOpenHoursFlagsAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(OpenHoursFlagsJSON result)
          {
        ...
        protected abstract void handle_result(OpenHoursFlagsJSON new_result);
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorOpenNow = new JSONHoldingBooleanGenerator("field \"OpenNow\" of the OpenHoursFlags class");
            fieldGeneratorOpen24Hrs = new JSONHoldingBooleanGenerator("field \"Open24Hrs\" of the OpenHoursFlags class");
            fieldGeneratorOpenEveryday = new JSONHoldingBooleanGenerator("field \"OpenEveryday\" of the OpenHoursFlags class");
            fieldGeneratorOpenMonday = new JSONHoldingBooleanGenerator("field \"OpenMonday\" of the OpenHoursFlags class");
            fieldGeneratorOpenTuesday = new JSONHoldingBooleanGenerator("field \"OpenTuesday\" of the OpenHoursFlags class");
            fieldGeneratorOpenWednesday = new JSONHoldingBooleanGenerator("field \"OpenWednesday\" of the OpenHoursFlags class");
            fieldGeneratorOpenThursday = new JSONHoldingBooleanGenerator("field \"OpenThursday\" of the OpenHoursFlags class");
            fieldGeneratorOpenFriday = new JSONHoldingBooleanGenerator("field \"OpenFriday\" of the OpenHoursFlags class");
            fieldGeneratorOpenSaturday = new JSONHoldingBooleanGenerator("field \"OpenSaturday\" of the OpenHoursFlags class");
            fieldGeneratorOpenSunday = new JSONHoldingBooleanGenerator("field \"OpenSunday\" of the OpenHoursFlags class");
            fieldGeneratorOpenAfterTime = new JSONHoldingBooleanGenerator("field \"OpenAfterTime\" of the OpenHoursFlags class");
            fieldGeneratorOpenBeforeTime = new JSONHoldingBooleanGenerator("field \"OpenBeforeTime\" of the OpenHoursFlags class");
            fieldGeneratorOpenTimeMentioned = new JSONHoldingBooleanGenerator("field \"OpenTimeMentioned\" of the OpenHoursFlags class");
            fieldGeneratorStartDateAndTime = new JSONHoldingBooleanGenerator("field \"StartDateAndTime\" of the OpenHoursFlags class");
            fieldGeneratorEndDateAndTime = new JSONHoldingBooleanGenerator("field \"EndDateAndTime\" of the OpenHoursFlags class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the OpenHoursFlags class");
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(OpenHoursFlagsJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public OpenHoursFlagsJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<OpenHoursFlagsJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<OpenHoursFlagsJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<OpenHoursFlagsJSON> value;
  };
  };
