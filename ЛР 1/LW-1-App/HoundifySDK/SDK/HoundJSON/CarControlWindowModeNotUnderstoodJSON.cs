/* file "CarControlWindowModeNotUnderstoodJSON.cs" */
...
public class CarControlWindowModeNotUnderstoodJSON : CarControlCommandJSON
  {
    ...
    private void  fromJSONCommandType(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field CommandType of CarControlWindowModeNotUnderstoodJSON is not a string.");
        ...
        throw new Exception("The value for field CommandType of CarControlWindowModeNotUnderstoodJSON is not one of the legal strings.");
      enum_is_done:;
        setCommandType(the_enum);
      }


    public CarControlWindowModeNotUnderstoodJSON()
      {
    ...
    public virtual int extraCarControlWindowModeNotUnderstoodComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraCarControlWindowModeNotUnderstoodComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraCarControlWindowModeNotUnderstoodComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraCarControlWindowModeNotUnderstoodLookup(string field_name)
      {
    ...
    public override int extraCarControlCommandComponentCount()
      {
        ...
        if (flagHasCommandType)
            ++result;
        result += extraCarControlWindowModeNotUnderstoodComponentCount();
        return result;
      }
    public override string extraCarControlCommandComponentKey(int component_num)
      {
        ...
        return extraCarControlWindowModeNotUnderstoodComponentKey(remainder);
      }
    public override JSONValue extraCarControlCommandComponentValue(int component_num)
      {
        ...
        return extraCarControlWindowModeNotUnderstoodComponentValue(remainder);
      }
    public override JSONValue extraCarControlCommandLookup(string field_name)
      {
        ...
        return extraCarControlWindowModeNotUnderstoodLookup(field_name);
      }
    ...
    public virtual void extraCarControlWindowModeNotUnderstoodAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraCarControlWindowModeNotUnderstoodSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraCarControlWindowModeNotUnderstoodLookup(key);
        if (old_field == null)
          {
            extraCarControlWindowModeNotUnderstoodAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraCarControlCommandSetField(string key, JSONValue new_component)
      {
        ...
        extraCarControlWindowModeNotUnderstoodSetField(key, new_component);
      }
    ...
    public static new CarControlWindowModeNotUnderstoodJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CarControlWindowModeNotUnderstoodJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlWindowModeNotUnderstood", ignore_extras);
    ...
    public static new CarControlWindowModeNotUnderstoodJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new CarControlWindowModeNotUnderstoodJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CarControlWindowModeNotUnderstoodJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlWindowModeNotUnderstood", ignore_extras);
    ...
    public static new CarControlWindowModeNotUnderstoodJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new CarControlWindowModeNotUnderstoodJSON from_text(string text, bool ignore_extras)
      {
        CarControlWindowModeNotUnderstoodJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlWindowModeNotUnderstood", ignore_extras);
            JSONParse.parse_json_value(text, "Text for CarControlWindowModeNotUnderstoodJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new CarControlWindowModeNotUnderstoodJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        CarControlWindowModeNotUnderstoodJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlWindowModeNotUnderstood", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorCommandType : JSONArrayGenerator
  {
    ...
    public List<TypeCommandType> value;
        ...
        protected override void finish()
          {
            if (!(getCarControlCommandJSONKey().Equals("CarControlWindowModeNotUnderstood")))
                throw new Exception("The key field has a value other than `CarControlWindowModeNotUnderstood'.");
            CarControlWindowModeNotUnderstoodJSON result = new CarControlWindowModeNotUnderstoodJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraCarControlWindowModeNotUnderstoodAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(CarControlCommandJSON new_result)
          {
            handle_result((CarControlWindowModeNotUnderstoodJSON )new_result);
          }
        protected void finish(CarControlWindowModeNotUnderstoodJSON result)
          {
        ...
        protected abstract void handle_result(CarControlWindowModeNotUnderstoodJSON new_result);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(CarControlWindowModeNotUnderstoodJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public CarControlWindowModeNotUnderstoodJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<CarControlWindowModeNotUnderstoodJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<CarControlWindowModeNotUnderstoodJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<CarControlWindowModeNotUnderstoodJSON> value;
  };
  };
