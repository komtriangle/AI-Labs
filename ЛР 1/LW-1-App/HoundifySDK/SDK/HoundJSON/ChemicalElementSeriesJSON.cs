/* file "ChemicalElementSeriesJSON.cs" */
...
public class ChemicalElementSeriesJSON : JSONBase
  {
    ...
    private void  fromJSONElements(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field Elements of ChemicalElementSeriesJSON is not an array.");
        int count1 = json_array1.componentCount();
        if (count1 < 1)
            throw new Exception("The value for field Elements of ChemicalElementSeriesJSON has too few elements.");
    ...
    public ChemicalElementSeriesJSON()
      {
    ...
    public virtual int extraChemicalElementSeriesComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraChemicalElementSeriesComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraChemicalElementSeriesComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraChemicalElementSeriesLookup(string field_name)
      {
    ...
    public virtual void extraChemicalElementSeriesAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraChemicalElementSeriesSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraChemicalElementSeriesLookup(key);
        if (old_field == null)
          {
            extraChemicalElementSeriesAppendPair(key, new_component);
          }
        else
          {
    ...
    public virtual void write_fields_as_json(JSONHandler handler, bool partial_allowed)
      {
        ...
        Debug.Assert(partial_allowed || flagHasSeriesName);
        if (flagHasSeriesName)
          {
    ...
    public virtual string missing_field_error(bool allow_unpolished)
      {
        ...
        if (!(hasSeriesName()))
          {
            return "When parsing the object for %what%, the \"SeriesName\" field was missing.";
          }
        return null;
      }

    public static ChemicalElementSeriesJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ChemicalElementSeriesJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ChemicalElementSeries", ignore_extras);
    ...
    public static ChemicalElementSeriesJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static ChemicalElementSeriesJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ChemicalElementSeriesJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ChemicalElementSeries", ignore_extras);
    ...
    public static ChemicalElementSeriesJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static ChemicalElementSeriesJSON from_text(string text, bool ignore_extras)
      {
        ChemicalElementSeriesJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ChemicalElementSeries", ignore_extras);
            JSONParse.parse_json_value(text, "Text for ChemicalElementSeriesJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static ChemicalElementSeriesJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        ChemicalElementSeriesJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ChemicalElementSeries", ignore_extras);
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        protected override void finish()
          {
            ChemicalElementSeriesJSON result = new ChemicalElementSeriesJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraChemicalElementSeriesAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(ChemicalElementSeriesJSON result)
          {
            ...
            else if ((!(result.hasSeriesName())) && !allow_incomplete)
              {
                error("When parsing the object for %what%, the \"SeriesName\" field was missing.");
              }
          }
        protected abstract void handle_result(ChemicalElementSeriesJSON new_result);
            ...
            switch (field_name[0])
              {
                case 'E':
                    ...
                    break;
                case 'S':
                    if ((String.Compare(field_name, 1, "eriesName", 0, 9, false) == 0) && (field_name.Length == 10))
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorElements = new ChemicalElementJSON.HoldingArrayGenerator("field \"Elements\" of the ChemicalElementSeries class", ignore_extras);
            fieldGeneratorSeriesName = new ChemicalElementSeriesNameJSON.HoldingGenerator("field \"SeriesName\" of the ChemicalElementSeries class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the ChemicalElementSeries class");
            allow_incomplete = false;
            allow_unpolished = false;
          }
        public Generator()
          {
            fieldGeneratorElements = new ChemicalElementJSON.HoldingArrayGenerator("field \"Elements\" of the ChemicalElementSeries class", false);
            fieldGeneratorSeriesName = new ChemicalElementSeriesNameJSON.HoldingGenerator("field \"SeriesName\" of the ChemicalElementSeries class", false);
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(ChemicalElementSeriesJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public ChemicalElementSeriesJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<ChemicalElementSeriesJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<ChemicalElementSeriesJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<ChemicalElementSeriesJSON> value;
  };
  };
