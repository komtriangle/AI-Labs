...
public class RobotMoveCommandJSON : RobotCommandJSON
  {
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field Direction of RobotMoveCommandJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field Direction of RobotMoveCommandJSON is not an integer.");
              }
    ...
    private void  fromJSONDistanceUnit(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field DistanceUnit of RobotMoveCommandJSON is not a string.");
    ...
    public virtual int extraRobotMoveCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraRobotMoveCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraRobotMoveCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraRobotMoveCommandLookup(string field_name)
      {
    ...
    public void setDirection(short new_value)
      {
        ...
        if (new_value < -180)
            throw new Exception("The value for field Direction of RobotMoveCommandJSON is less than the lower bound (-180) for that field.");
        if (new_value > 180)
            throw new Exception("The value for field Direction of RobotMoveCommandJSON is greater than the upper bound (180) for that field.");
    ...
    public void setDistance(double new_value)
      {
        ...
        if (new_value < 0)
            throw new Exception("The value for field Distance of RobotMoveCommandJSON is less than the lower bound (0) for that field.");
    ...
    public void setDistanceText(string new_value)
      {
        ...
        if (!(JSONWriter.is_valid_number_format(new_value)))
            throw new Exception("The text value for field Distance of RobotMoveCommandJSON is not a valid number.");
    ...
    public virtual void extraRobotMoveCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraRobotMoveCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new RobotMoveCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RobotMoveCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RobotMoveCommand", ignore_extras);
    ...
    public static new RobotMoveCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RobotMoveCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RobotMoveCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RobotMoveCommand", ignore_extras);
    ...
    public static new RobotMoveCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RobotMoveCommandJSON from_text(string text, bool ignore_extras)
      {
        RobotMoveCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RobotMoveCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for RobotMoveCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new RobotMoveCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        RobotMoveCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RobotMoveCommand", ignore_extras);
...
//@@@            Debug.Assert(!have_value);
        ...
        public bool have_value;
        public RobotMoveCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<RobotMoveCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<RobotMoveCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<RobotMoveCommandJSON> value;
  };
  };
