...
public class SportsSportImageJSON : JSONBase
  {
    ...
    private void  fromJSONURL(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field URL of SportsSportImageJSON is not a string.");
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field Width of SportsSportImageJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field Width of SportsSportImageJSON is not an integer.");
              }
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field Height of SportsSportImageJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field Height of SportsSportImageJSON is not an integer.");
              }
            extracted_integer = json_rational.getInteger()        ;
          }
        else
    ...
    public virtual int extraSportsSportImageComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsSportImageComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsSportImageComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsSportImageLookup(string field_name)
      {
    ...
    public void setWidth(BigInteger new_value)
      {
        flagHasWidth = true;
        if (new_value < 1)
            throw new Exception("The value for field Width of SportsSportImageJSON is less than the lower bound (1) for that field.");
    ...
    public void setHeight(BigInteger new_value)
      {
        flagHasHeight = true;
        if (new_value < 1)
            throw new Exception("The value for field Height of SportsSportImageJSON is less than the lower bound (1) for that field.");
    ...
    public virtual void extraSportsSportImageAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSportsSportImageSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static SportsSportImageJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsSportImageJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsSportImage", ignore_extras);
    ...
    public static SportsSportImageJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static SportsSportImageJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsSportImageJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsSportImage", ignore_extras);
    ...
    public static SportsSportImageJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static SportsSportImageJSON from_text(string text, bool ignore_extras)
      {
        SportsSportImageJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsSportImage", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SportsSportImageJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static SportsSportImageJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SportsSportImageJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsSportImage", ignore_extras);
    ...
    private class FieldHoldingArrayGeneratorHeight : JSONHoldingIntegerLowerBoundOnlyArrayGenerator
        ...
        protected override void finish()
          {
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSportsSportImageAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(SportsSportImageJSON result)
          {
        ...
        protected abstract void handle_result(SportsSportImageJSON new_result);
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(SportsSportImageJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public SportsSportImageJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SportsSportImageJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<SportsSportImageJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SportsSportImageJSON> value;
  };
  };
