/* file "CarControlConvertibleCommandJSON.cs" */
...
public class CarControlConvertibleCommandJSON : CarControlCommandJSON
  {
    ...
    public static TypeCommandType  stringToCommandType(string chars)
      {
        switch (chars[0])
          {
            case 'D':
                if ((String.Compare(chars, 1, "eploy", 0, 5, false) == 0) && (chars.Length == 6))
                    return TypeCommandType.CommandType_Deploy;
                break;
            case 'R':
                if ((String.Compare(chars, 1, "etract", 0, 6, false) == 0) && (chars.Length == 7))
                    return TypeCommandType.CommandType_Retract;
                break;
            default:
                break;
          }
    ...
    private void  fromJSONCommandType(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field CommandType of CarControlConvertibleCommandJSON is not a string.");
        TypeCommandType the_enum;
        switch (json_string.getData()[0])
          {
            case 'D':
                if ((String.Compare(json_string.getData(), 1, "eploy", 0, 5, false) == 0) && (json_string.getData().Length == 6))
                      {
                        the_enum = TypeCommandType.CommandType_Deploy;
                        goto enum_is_done;
                      }
                break;
            case 'R':
                if ((String.Compare(json_string.getData(), 1, "etract", 0, 6, false) == 0) && (json_string.getData().Length == 7))
                      {
                        the_enum = TypeCommandType.CommandType_Retract;
                        goto enum_is_done;
                      }
                break;
            default:
        ...
        throw new Exception("The value for field CommandType of CarControlConvertibleCommandJSON is not one of the legal strings.");
      enum_is_done:;
        setCommandType(the_enum);
      }


    public CarControlConvertibleCommandJSON()
      {
    ...
    public virtual int extraCarControlConvertibleCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraCarControlConvertibleCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraCarControlConvertibleCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraCarControlConvertibleCommandLookup(string field_name)
      {
    ...
    public virtual void extraCarControlConvertibleCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraCarControlConvertibleCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new CarControlConvertibleCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CarControlConvertibleCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlConvertibleCommand", ignore_extras);
    ...
    public static new CarControlConvertibleCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new CarControlConvertibleCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CarControlConvertibleCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlConvertibleCommand", ignore_extras);
    ...
    public static new CarControlConvertibleCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new CarControlConvertibleCommandJSON from_text(string text, bool ignore_extras)
      {
        CarControlConvertibleCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlConvertibleCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for CarControlConvertibleCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new CarControlConvertibleCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        CarControlConvertibleCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlConvertibleCommand", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorCommandType : JSONArrayGenerator
  {
    ...
    public List<TypeCommandType> value;
        ...
        protected override void finish()
          {
            if (!(getCarControlCommandJSONKey().Equals("CarControlConvertibleCommand")))
                throw new Exception("The key field has a value other than `CarControlConvertibleCommand'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraCarControlConvertibleCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(CarControlConvertibleCommandJSON result)
          {
        ...
        protected abstract void handle_result(CarControlConvertibleCommandJSON new_result);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(CarControlConvertibleCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public CarControlConvertibleCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<CarControlConvertibleCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<CarControlConvertibleCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<CarControlConvertibleCommandJSON> value;
  };
  };
