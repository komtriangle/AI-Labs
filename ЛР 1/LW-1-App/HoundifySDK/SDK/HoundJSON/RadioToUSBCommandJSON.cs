...
public class RadioToUSBCommandJSON : RadioCommandJSON
  {
    ...
    public virtual int extraRadioToUSBCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraRadioToUSBCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraRadioToUSBCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraRadioToUSBCommandLookup(string field_name)
      {
    ...
    public virtual void extraRadioToUSBCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraRadioToUSBCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new RadioToUSBCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RadioToUSBCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RadioToUSBCommand", ignore_extras);
    ...
    public static new RadioToUSBCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RadioToUSBCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RadioToUSBCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RadioToUSBCommand", ignore_extras);
    ...
    public static new RadioToUSBCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RadioToUSBCommandJSON from_text(string text, bool ignore_extras)
      {
        RadioToUSBCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RadioToUSBCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for RadioToUSBCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new RadioToUSBCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        RadioToUSBCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RadioToUSBCommand", ignore_extras);
    ...
    public new abstract class Generator : RadioCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getRadioCommandJSONKey().Equals("RadioToUSB")))
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraRadioToUSBCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(RadioToUSBCommandJSON result)
          {
        ...
        protected abstract void handle_result(RadioToUSBCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorAlreadyOnResult = new DynamicResponseJSON.HoldingGenerator("field \"AlreadyOnResult\" of the RadioToUSBCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the RadioToUSBCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorAlreadyOnResult = new DynamicResponseJSON.HoldingGenerator("field \"AlreadyOnResult\" of the RadioToUSBCommand class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(RadioToUSBCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public RadioToUSBCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<RadioToUSBCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<RadioToUSBCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<RadioToUSBCommandJSON> value;
  };
  };
