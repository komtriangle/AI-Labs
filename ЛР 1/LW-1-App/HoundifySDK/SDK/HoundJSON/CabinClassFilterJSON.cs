...
public class CabinClassFilterJSON : JSONBase
  {
    private bool flagHasIncludes;
    private List< CabinClassJSON  > storeIncludes;
    private bool flagHasExcludes;
    private List< CabinClassJSON  > storeExcludes;
    ...
    private void  fromJSONIncludes(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field Includes of CabinClassFilterJSON is not an array.");
        int count1 = json_array1.componentCount();
        if (count1 < 1)
            throw new Exception("The value for field Includes of CabinClassFilterJSON has too few elements.");
        List< CabinClassJSON  > vector_Includes1 = new List< CabinClassJSON  >(count1);
    ...
    public CabinClassFilterJSON()
      {
        flagHasIncludes = false;
        flagHasExcludes = false;
        flagHasDefaultForOthers = false;
        storeIncludes = new List< CabinClassJSON  >();
        storeExcludes = new List< CabinClassJSON  >();
    ...
    public CabinClassJSON   elementOfIncludes(int element_num)
      {
        Debug.Assert(flagHasIncludes);
        return storeIncludes[element_num];
      }

    public List< CabinClassJSON  >  getIncludes()
      {
        Debug.Assert(flagHasIncludes);
    ...
    public CabinClassJSON   elementOfExcludes(int element_num)
      {
        Debug.Assert(flagHasExcludes);
        return storeExcludes[element_num];
      }

    public List< CabinClassJSON  >  getExcludes()
      {
        Debug.Assert(flagHasExcludes);
    ...
    public virtual int extraCabinClassFilterComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraCabinClassFilterComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraCabinClassFilterComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraCabinClassFilterLookup(string field_name)
      {
    ...
    public void appendIncludes(CabinClassJSON  to_append)
      {
        if (!flagHasIncludes)
          {
            flagHasIncludes = true;
    ...
    public void appendIncludes(CabinClassJSON.TypeValue new_value)
      {
    ...
    public void appendExcludes(CabinClassJSON.TypeValue new_value)
      {
    ...
    public virtual void extraCabinClassFilterAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraCabinClassFilterSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static CabinClassFilterJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CabinClassFilterJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CabinClassFilter", ignore_extras);
    ...
    public static CabinClassFilterJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static CabinClassFilterJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CabinClassFilterJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CabinClassFilter", ignore_extras);
    ...
    public static CabinClassFilterJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static CabinClassFilterJSON from_text(string text, bool ignore_extras)
      {
        CabinClassFilterJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CabinClassFilter", ignore_extras);
            JSONParse.parse_json_value(text, "Text for CabinClassFilterJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static CabinClassFilterJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        CabinClassFilterJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CabinClassFilter", ignore_extras);
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        private CabinClassJSON.HoldingArrayGenerator fieldGeneratorIncludes;
        private CabinClassJSON.HoldingArrayGenerator fieldGeneratorExcludes;
        ...
        protected override void finish()
          {
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraCabinClassFilterAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(CabinClassFilterJSON result)
          {
        ...
        protected abstract void handle_result(CabinClassFilterJSON new_result);
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorIncludes = new CabinClassJSON.HoldingArrayGenerator("field \"Includes\" of the CabinClassFilter class", ignore_extras);
            fieldGeneratorExcludes = new CabinClassJSON.HoldingArrayGenerator("field \"Excludes\" of the CabinClassFilter class", ignore_extras);
            fieldGeneratorDefaultForOthers = new IncludeExcludeStateJSON.HoldingGenerator("field \"DefaultForOthers\" of the CabinClassFilter class", ignore_extras);
        ...
        public Generator()
          {
            fieldGeneratorIncludes = new CabinClassJSON.HoldingArrayGenerator("field \"Includes\" of the CabinClassFilter class", false);
            fieldGeneratorExcludes = new CabinClassJSON.HoldingArrayGenerator("field \"Excludes\" of the CabinClassFilter class", false);
            fieldGeneratorDefaultForOthers = new IncludeExcludeStateJSON.HoldingGenerator("field \"DefaultForOthers\" of the CabinClassFilter class", false);
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(CabinClassFilterJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public CabinClassFilterJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<CabinClassFilterJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<CabinClassFilterJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<CabinClassFilterJSON> value;
  };
  };
