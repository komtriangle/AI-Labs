/* file "TimerStartModeCommandJSON.cs" */
...
public class TimerStartModeCommandJSON : TimerCommandJSON
  {
    ...
    public TimerStartModeCommandJSON()
      {
    ...
    public virtual int extraTimerStartModeCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraTimerStartModeCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraTimerStartModeCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraTimerStartModeCommandLookup(string field_name)
      {
    ...
    public virtual void extraTimerStartModeCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraTimerStartModeCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new TimerStartModeCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        TimerStartModeCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type TimerStartModeCommand", ignore_extras);
    ...
    public static new TimerStartModeCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new TimerStartModeCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        TimerStartModeCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type TimerStartModeCommand", ignore_extras);
    ...
    public static new TimerStartModeCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new TimerStartModeCommandJSON from_text(string text, bool ignore_extras)
      {
        TimerStartModeCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type TimerStartModeCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for TimerStartModeCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new TimerStartModeCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        TimerStartModeCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type TimerStartModeCommand", ignore_extras);
    ...
    public new abstract class Generator : TimerCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getTimerCommandJSONKey().Equals("TimerStartModeCommand")))
                throw new Exception("The key field has a value other than `TimerStartModeCommand'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraTimerStartModeCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(TimerStartModeCommandJSON result)
          {
        ...
        protected abstract void handle_result(TimerStartModeCommandJSON new_result);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(TimerStartModeCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public TimerStartModeCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<TimerStartModeCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<TimerStartModeCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<TimerStartModeCommandJSON> value;
  };
  };
