/* file "NoRecipientInfoCommandJSON.cs" */
...
public class NoRecipientInfoCommandJSON : CommunicationCommandJSON
  {
    public class TypeNativeDataJSON : JSONBase
      {
        ...
        private bool flagHasNameWithMissingInfo;
        private string storeNameWithMissingInfo;
        ...
        private void  fromJSONNameWithMissingInfo(JSONValue json_value, bool ignore_extras)
          {
            Debug.Assert(json_value != null);
            JSONStringValue json_string = json_value.string_value();
            if (json_string == null)
                throw new Exception("The value for field NameWithMissingInfo of TypeNativeDataJSON is not a string.");
            setNameWithMissingInfo(json_string.getData());
          }
        ...
        public bool  hasNameWithMissingInfo()
          {
            return flagHasNameWithMissingInfo;
          }

        public string  getNameWithMissingInfo()
          {
            Debug.Assert(flagHasNameWithMissingInfo);
        ...
        public void setNameWithMissingInfo(string new_value)
          {
            flagHasNameWithMissingInfo = true;
            storeNameWithMissingInfo = new_value;
          }
        public void unsetNameWithMissingInfo()
          {
            flagHasNameWithMissingInfo = false;
          }
        ...
        public virtual void write_fields_as_json(JSONHandler handler, bool partial_allowed)
          {
            ...
            Debug.Assert(partial_allowed || flagHasNameWithMissingInfo);
            if (flagHasNameWithMissingInfo)
              {
        ...
        public abstract class Generator : JSONObjectGenerator
          {
            ...
            private JSONHoldingStringGenerator fieldGeneratorNameWithMissingInfo;
                ...
                switch (field_name[0])
                  {
                    ...
                    case 'C':
                        ...
                        break;
                    case 'N':
                        if ((String.Compare(field_name, 1, "ameWithMissingInfo", 0, 18, false) == 0) && (field_name.Length == 19))
    ...
    public NoRecipientInfoCommandJSON()
      {
    ...
    public virtual int extraNoRecipientInfoCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraNoRecipientInfoCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraNoRecipientInfoCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraNoRecipientInfoCommandLookup(string field_name)
      {
        JSONValue result = (extraIndex.ContainsKey(field_name) ? extraIndex[field_name] : null);
        return result;
      }
    ...
    public virtual void extraNoRecipientInfoCommandAppendPair(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public virtual void extraNoRecipientInfoCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new NoRecipientInfoCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        NoRecipientInfoCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NoRecipientInfoCommand", ignore_extras);
            generator.set_allow_incomplete(allow_incomplete);
            generator.set_allow_unpolished(allow_unpolished);
            if (allow_incomplete || allow_unpolished)
                json_value.write(generator);
    ...
    public static new NoRecipientInfoCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new NoRecipientInfoCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        NoRecipientInfoCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NoRecipientInfoCommand", ignore_extras);
    ...
    public static new NoRecipientInfoCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new NoRecipientInfoCommandJSON from_text(string text, bool ignore_extras)
      {
        NoRecipientInfoCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NoRecipientInfoCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for NoRecipientInfoCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new NoRecipientInfoCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        NoRecipientInfoCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NoRecipientInfoCommand", ignore_extras);
    ...
    public new abstract class Generator : CommunicationCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getCommunicationCommandJSONKey().Equals("NoRecipientInfoCommand")))
                throw new Exception("The key field has a value other than `NoRecipientInfoCommand'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraNoRecipientInfoCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
            unknownFieldGenerator.field_names.Clear();
            unknownFieldGenerator.field_values.Clear();
            unknownFieldGenerator.index = new Dictionary<string, JSONValue >();
        ...
        protected void finish(NoRecipientInfoCommandJSON result)
          {
        ...
        protected abstract void handle_result(NoRecipientInfoCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the NoRecipientInfoCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the NoRecipientInfoCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the NoRecipientInfoCommand class", false);
            unknownFieldGenerator = new UnknownFieldGenerator(false);
            set_what("the NoRecipientInfoCommand class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(NoRecipientInfoCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public NoRecipientInfoCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<NoRecipientInfoCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<NoRecipientInfoCommandJSON>();
        base.set_what(what);
      }
    public HoldingArrayGenerator(bool ignore_extras)
      {
    ...
    public bool have_value;
    public List<NoRecipientInfoCommandJSON> value;
  };
  };
