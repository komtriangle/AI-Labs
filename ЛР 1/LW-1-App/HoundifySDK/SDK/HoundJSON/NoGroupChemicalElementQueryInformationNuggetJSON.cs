/* file "NoGroupChemicalElementQueryInformationNuggetJSON.cs" */
...
public class NoGroupChemicalElementQueryInformationNuggetJSON : InformationNuggetJSON
  {
    ...
    private void  fromJSONElementQueriedBy(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field ElementQueriedBy of NoGroupChemicalElementQueryInformationNuggetJSON is not a string.");
    ...
    public NoGroupChemicalElementQueryInformationNuggetJSON()
      {
    ...
    public override string  getNuggetKind()
      {
        return "NoGroupChemicalElementQueryInformationNugget";
      }
    ...
    public virtual int extraNoGroupChemicalElementQueryInformationNuggetComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraNoGroupChemicalElementQueryInformationNuggetComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraNoGroupChemicalElementQueryInformationNuggetComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraNoGroupChemicalElementQueryInformationNuggetLookup(string field_name)
      {
    ...
    public override int extraInformationNuggetComponentCount()
      {
        ...
        if (flagHasElementQueriedBy)
            ++result;
        result += extraNoGroupChemicalElementQueryInformationNuggetComponentCount();
        return result;
      }
    public override string extraInformationNuggetComponentKey(int component_num)
      {
        ...
        return extraNoGroupChemicalElementQueryInformationNuggetComponentKey(remainder);
      }
    public override JSONValue extraInformationNuggetComponentValue(int component_num)
      {
        ...
        return extraNoGroupChemicalElementQueryInformationNuggetComponentValue(remainder);
      }
    public override JSONValue extraInformationNuggetLookup(string field_name)
      {
        ...
        return extraNoGroupChemicalElementQueryInformationNuggetLookup(field_name);
      }
    ...
    public virtual void extraNoGroupChemicalElementQueryInformationNuggetAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraNoGroupChemicalElementQueryInformationNuggetSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraNoGroupChemicalElementQueryInformationNuggetLookup(key);
        if (old_field == null)
          {
            extraNoGroupChemicalElementQueryInformationNuggetAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraInformationNuggetSetField(string key, JSONValue new_component)
      {
        ...
        extraNoGroupChemicalElementQueryInformationNuggetSetField(key, new_component);
      }
    ...
    public static new NoGroupChemicalElementQueryInformationNuggetJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        NoGroupChemicalElementQueryInformationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NoGroupChemicalElementQueryInformationNugget", ignore_extras);
    ...
    public static new NoGroupChemicalElementQueryInformationNuggetJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new NoGroupChemicalElementQueryInformationNuggetJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        NoGroupChemicalElementQueryInformationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NoGroupChemicalElementQueryInformationNugget", ignore_extras);
    ...
    public static new NoGroupChemicalElementQueryInformationNuggetJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new NoGroupChemicalElementQueryInformationNuggetJSON from_text(string text, bool ignore_extras)
      {
        NoGroupChemicalElementQueryInformationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NoGroupChemicalElementQueryInformationNugget", ignore_extras);
            JSONParse.parse_json_value(text, "Text for NoGroupChemicalElementQueryInformationNuggetJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new NoGroupChemicalElementQueryInformationNuggetJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        NoGroupChemicalElementQueryInformationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NoGroupChemicalElementQueryInformationNugget", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorElementQueriedBy : JSONArrayGenerator
  {
    ...
    public List<TypeElementQueriedBy> value;
        ...
        protected override void finish()
          {
            if (!(getInformationNuggetJSONKey().Equals("NoGroupChemicalElementQueryInformationNugget")))
                throw new Exception("The key field has a value other than `NoGroupChemicalElementQueryInformationNugget'.");
            NoGroupChemicalElementQueryInformationNuggetJSON result = new NoGroupChemicalElementQueryInformationNuggetJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraNoGroupChemicalElementQueryInformationNuggetAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(InformationNuggetJSON new_result)
          {
            handle_result((NoGroupChemicalElementQueryInformationNuggetJSON )new_result);
          }
        protected void finish(NoGroupChemicalElementQueryInformationNuggetJSON result)
          {
        ...
        protected abstract void handle_result(NoGroupChemicalElementQueryInformationNuggetJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorElement = new ChemicalElementJSON.HoldingGenerator("field \"Element\" of the NoGroupChemicalElementQueryInformationNugget class", ignore_extras);
            fieldGeneratorElementQueriedBy = new FieldHoldingGeneratorElementQueriedBy("field \"ElementQueriedBy\" of the NoGroupChemicalElementQueryInformationNugget class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the NoGroupChemicalElementQueryInformationNugget class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorElement = new ChemicalElementJSON.HoldingGenerator("field \"Element\" of the NoGroupChemicalElementQueryInformationNugget class", false);
            fieldGeneratorElementQueriedBy = new FieldHoldingGeneratorElementQueriedBy("field \"ElementQueriedBy\" of the NoGroupChemicalElementQueryInformationNugget class");
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(NoGroupChemicalElementQueryInformationNuggetJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public NoGroupChemicalElementQueryInformationNuggetJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<NoGroupChemicalElementQueryInformationNuggetJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<NoGroupChemicalElementQueryInformationNuggetJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<NoGroupChemicalElementQueryInformationNuggetJSON> value;
  };
  };
