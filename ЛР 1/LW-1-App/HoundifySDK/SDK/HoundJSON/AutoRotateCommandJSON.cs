...
public class AutoRotateCommandJSON : DeviceControlCommandJSON
  {
    ...
    private void  fromJSONCommandType(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field CommandType of AutoRotateCommandJSON is not a string.");
        ...
        throw new Exception("The value for field CommandType of AutoRotateCommandJSON is not one of the legal strings.");
      enum_is_done:;
        setCommandType(the_enum);
      }


    public AutoRotateCommandJSON()
      {
    ...
    public virtual int extraAutoRotateCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraAutoRotateCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraAutoRotateCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraAutoRotateCommandLookup(string field_name)
      {
    ...
    public override int extraDeviceControlCommandComponentCount()
      {
        ...
        if (flagHasCommandType)
            ++result;
        result += extraAutoRotateCommandComponentCount();
        return result;
      }
    public override string extraDeviceControlCommandComponentKey(int component_num)
      {
        ...
        return extraAutoRotateCommandComponentKey(remainder);
      }
    public override JSONValue extraDeviceControlCommandComponentValue(int component_num)
      {
        ...
        return extraAutoRotateCommandComponentValue(remainder);
      }
    public override JSONValue extraDeviceControlCommandLookup(string field_name)
      {
        ...
        return extraAutoRotateCommandLookup(field_name);
      }
    ...
    public virtual void extraAutoRotateCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraAutoRotateCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraAutoRotateCommandLookup(key);
        if (old_field == null)
          {
            extraAutoRotateCommandAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraDeviceControlCommandSetField(string key, JSONValue new_component)
      {
        ...
        extraAutoRotateCommandSetField(key, new_component);
      }
    ...
    public static new AutoRotateCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        AutoRotateCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type AutoRotateCommand", ignore_extras);
    ...
    public static new AutoRotateCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new AutoRotateCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        AutoRotateCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type AutoRotateCommand", ignore_extras);
    ...
    public static new AutoRotateCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new AutoRotateCommandJSON from_text(string text, bool ignore_extras)
      {
        AutoRotateCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type AutoRotateCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for AutoRotateCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new AutoRotateCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        AutoRotateCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type AutoRotateCommand", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorCommandType : JSONArrayGenerator
  {
    ...
    public List<TypeCommandType> value;
        ...
        protected override void finish()
          {
            if (!(getDeviceControlCommandJSONKey().Equals("AutoRotateCommand")))
                throw new Exception("The key field has a value other than `AutoRotateCommand'.");
            AutoRotateCommandJSON result = new AutoRotateCommandJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraAutoRotateCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(DeviceControlCommandJSON new_result)
          {
            handle_result((AutoRotateCommandJSON )new_result);
          }
        protected void finish(AutoRotateCommandJSON result)
          {
        ...
        protected abstract void handle_result(AutoRotateCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorCommandType = new FieldHoldingGeneratorCommandType("field \"CommandType\" of the AutoRotateCommand class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the AutoRotateCommand class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(AutoRotateCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public AutoRotateCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<AutoRotateCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<AutoRotateCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<AutoRotateCommandJSON> value;
  };
  };
