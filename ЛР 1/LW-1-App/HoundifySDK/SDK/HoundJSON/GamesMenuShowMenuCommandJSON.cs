/* file "GamesMenuShowMenuCommandJSON.cs" */
...
public class GamesMenuShowMenuCommandJSON : GamesMenuCommandJSON
  {
    public class TypeNativeDataJSON : JSONBase
      {
        private bool flagHasGames;
        private List< GameJSON  > storeGames;
        ...
        private void  fromJSONGames(JSONValue json_value, bool ignore_extras)
          {
            ...
            if (json_array1 == null)
                throw new Exception("The value for field Games of TypeNativeDataJSON is not an array.");
            int count1 = json_array1.componentCount();
            if (count1 < 1)
                throw new Exception("The value for field Games of TypeNativeDataJSON has too few elements.");
            List< GameJSON  > vector_Games1 = new List< GameJSON  >(count1);
            for (int num1 = 0; num1 < count1; ++num1)
              {
                GameJSON convert_classy = GameJSON.from_json(json_array1.component(num1), ignore_extras, true);
        ...
        public GameJSON   elementOfGames(int element_num)
          {
            Debug.Assert(flagHasGames);
        ...
        public void appendGames(GameJSON  to_append)
          {
            if (!flagHasGames)
              {
                flagHasGames = true;
        ...
        public static TypeNativeDataJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
      {
        ...
        public abstract class Generator : JSONObjectGenerator
          {
            private GameJSON.HoldingArrayGenerator fieldGeneratorGames;
            ...
            protected virtual JSONHandler start_known_field(string field_name)
              {
                if ((String.Compare(field_name, 0, "Games", 0, 5, false) == 0) && (field_name.Length == 5))
                    return fieldGeneratorGames;
                return null;
              }
            public Generator(bool ignore_extras)
              {
                fieldGeneratorGames = new GameJSON.HoldingArrayGenerator("field \"Games\" of the TypeNativeData class", ignore_extras);
            ...
            public Generator()
              {
                fieldGeneratorGames = new GameJSON.HoldingArrayGenerator("field \"Games\" of the TypeNativeData class", false);
    ...
    public GamesMenuShowMenuCommandJSON()
      {
    ...
    public override string  getGamesMenuCommandKind()
      {
    ...
    public virtual int extraGamesMenuShowMenuCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraGamesMenuShowMenuCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraGamesMenuShowMenuCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraGamesMenuShowMenuCommandLookup(string field_name)
      {
        JSONValue result = (extraIndex.ContainsKey(field_name) ? extraIndex[field_name] : null);
        return result;
      }
    public override int extraGamesMenuCommandComponentCount()
      {
        ...
        if (flagHasNativeData)
            ++result;
        result += extraGamesMenuShowMenuCommandComponentCount();
        return result;
      }
    public override string extraGamesMenuCommandComponentKey(int component_num)
      {
        ...
        return extraGamesMenuShowMenuCommandComponentKey(remainder);
      }
    public override JSONValue extraGamesMenuCommandComponentValue(int component_num)
      {
        ...
        return extraGamesMenuShowMenuCommandComponentValue(remainder);
      }
    public override JSONValue extraGamesMenuCommandLookup(string field_name)
      {
        ...
        return extraGamesMenuShowMenuCommandLookup(field_name);
      }
    ...
    public virtual void extraGamesMenuShowMenuCommandAppendPair(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public virtual void extraGamesMenuShowMenuCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraGamesMenuShowMenuCommandLookup(key);
        if (old_field == null)
          {
            extraGamesMenuShowMenuCommandAppendPair(key, new_component);
          }
        else
          {
            int count = extraKeys.Count;
    ...
    public override void extraGamesMenuCommandSetField(string key, JSONValue new_component)
      {
        ...
        extraGamesMenuShowMenuCommandSetField(key, new_component);
      }
    ...
    public static new GamesMenuShowMenuCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        GamesMenuShowMenuCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type GamesMenuShowMenuCommand", ignore_extras);
            generator.set_allow_incomplete(allow_incomplete);
            generator.set_allow_unpolished(allow_unpolished);
            if (allow_incomplete || allow_unpolished)
                json_value.write(generator);
    ...
    public static new GamesMenuShowMenuCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new GamesMenuShowMenuCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        GamesMenuShowMenuCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type GamesMenuShowMenuCommand", ignore_extras);
    ...
    public static new GamesMenuShowMenuCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new GamesMenuShowMenuCommandJSON from_text(string text, bool ignore_extras)
      {
        GamesMenuShowMenuCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type GamesMenuShowMenuCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for GamesMenuShowMenuCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new GamesMenuShowMenuCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        GamesMenuShowMenuCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type GamesMenuShowMenuCommand", ignore_extras);
    ...
    public new abstract class Generator : GamesMenuCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getGamesMenuCommandJSONKey().Equals("GamesMenuShowMenuCommand")))
                throw new Exception("The key field has a value other than `GamesMenuShowMenuCommand'.");
            GamesMenuShowMenuCommandJSON result = new GamesMenuShowMenuCommandJSON();
            Debug.Assert(result != null);
            finish(result);
            int extra_count = unknownFieldGenerator.field_names.Count;
            Debug.Assert(extra_count == unknownFieldGenerator.field_values.Count);
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraGamesMenuShowMenuCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
            unknownFieldGenerator.field_names.Clear();
            unknownFieldGenerator.field_values.Clear();
            unknownFieldGenerator.index = new Dictionary<string, JSONValue >();
        ...
        protected override void handle_result(GamesMenuCommandJSON new_result)
          {
            handle_result((GamesMenuShowMenuCommandJSON )new_result);
          }
        protected void finish(GamesMenuShowMenuCommandJSON result)
          {
        ...
        protected abstract void handle_result(GamesMenuShowMenuCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the GamesMenuShowMenuCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the GamesMenuShowMenuCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the GamesMenuShowMenuCommand class", false);
            unknownFieldGenerator = new UnknownFieldGenerator(false);
            set_what("the GamesMenuShowMenuCommand class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(GamesMenuShowMenuCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public GamesMenuShowMenuCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<GamesMenuShowMenuCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<GamesMenuShowMenuCommandJSON>();
        base.set_what(what);
      }
    public HoldingArrayGenerator(bool ignore_extras)
      {
    ...
    public bool have_value;
    public List<GamesMenuShowMenuCommandJSON> value;
  };
  };
