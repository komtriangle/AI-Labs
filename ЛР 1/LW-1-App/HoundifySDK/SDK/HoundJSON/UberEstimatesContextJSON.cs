/* file "UberEstimatesContextJSON.cs" */
...
public class UberEstimatesContextJSON : JSONBase
  {
    ...
    public UberEstimatesContextJSON()
      {
    ...
    public virtual int extraUberEstimatesContextComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraUberEstimatesContextComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraUberEstimatesContextComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraUberEstimatesContextLookup(string field_name)
      {
    ...
    public virtual void extraUberEstimatesContextAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraUberEstimatesContextSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static UberEstimatesContextJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        UberEstimatesContextJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UberEstimatesContext", ignore_extras);
    ...
    public static UberEstimatesContextJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static UberEstimatesContextJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        UberEstimatesContextJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UberEstimatesContext", ignore_extras);
    ...
    public static UberEstimatesContextJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static UberEstimatesContextJSON from_text(string text, bool ignore_extras)
      {
        UberEstimatesContextJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UberEstimatesContext", ignore_extras);
            JSONParse.parse_json_value(text, "Text for UberEstimatesContextJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static UberEstimatesContextJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        UberEstimatesContextJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UberEstimatesContext", ignore_extras);
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        protected override void finish()
          {
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraUberEstimatesContextAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(UberEstimatesContextJSON result)
          {
        ...
        protected abstract void handle_result(UberEstimatesContextJSON new_result);
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorUberEstimatesSpec = new UberEstimatesSpecJSON.HoldingGenerator("field \"UberEstimatesSpec\" of the UberEstimatesContext class", ignore_extras);
            fieldGeneratorUberProducts = new UberCompositeProductsJSON.HoldingGenerator("field \"UberProducts\" of the UberEstimatesContext class", ignore_extras);
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(UberEstimatesContextJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public UberEstimatesContextJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<UberEstimatesContextJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<UberEstimatesContextJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<UberEstimatesContextJSON> value;
  };
  };
