...
public class CarControlClimateClientConfigurationJSON : JSONBase
  {
    private bool flagHasEnableQualitativeTemperatureResponse;
    private bool storeEnableQualitativeTemperatureResponse;
    ...
    private void  fromJSONEnableQualitativeTemperatureResponse(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field EnableQualitativeTemperatureResponse of CarControlClimateClientConfigurationJSON is not true for false.");
              }
          }
        setEnableQualitativeTemperatureResponse(the_bool);
      }
    ...
    public CarControlClimateClientConfigurationJSON()
      {
        flagHasEnableQualitativeTemperatureResponse = false;
    ...
    public bool  hasEnableQualitativeTemperatureResponse()
      {
        return flagHasEnableQualitativeTemperatureResponse;
      }

    public bool  getEnableQualitativeTemperatureResponse()
      {
        Debug.Assert(flagHasEnableQualitativeTemperatureResponse);
        return storeEnableQualitativeTemperatureResponse;
      }
    ...
    public void setEnableQualitativeTemperatureResponse(bool new_value)
      {
        flagHasEnableQualitativeTemperatureResponse = true;
        storeEnableQualitativeTemperatureResponse = new_value;
      }
    public void unsetEnableQualitativeTemperatureResponse()
      {
        flagHasEnableQualitativeTemperatureResponse = false;
      }
    ...
    public virtual void write_fields_as_json(JSONHandler handler, bool partial_allowed)
      {
        if (flagHasEnableQualitativeTemperatureResponse)
          {
            handler.start_pair("EnableQualitativeTemperatureResponse");
            handler.boolean_value(storeEnableQualitativeTemperatureResponse);
          }
    ...
    public static CarControlClimateClientConfigurationJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        private JSONHoldingBooleanGenerator fieldGeneratorEnableQualitativeTemperatureResponse;
        ...
        protected void finish(CarControlClimateClientConfigurationJSON result)
          {
            if (fieldGeneratorEnableQualitativeTemperatureResponse.have_value)
              {
                result.setEnableQualitativeTemperatureResponse(fieldGeneratorEnableQualitativeTemperatureResponse.value);
                fieldGeneratorEnableQualitativeTemperatureResponse.have_value = false;
              }
        ...
        protected virtual JSONHandler start_known_field(string field_name)
          {
            if (String.Compare(field_name, 0, "Enable", 0, 6, false) == 0)
              {
                switch (field_name[6])
                  {
                    case 'I':
                        if ((String.Compare(field_name, 7, "ncrementalChangeIntent", 0, 22, false) == 0) && (field_name.Length == 29))
                            return fieldGeneratorEnableIncrementalChangeIntent;
                        break;
                    case 'Q':
                        if ((String.Compare(field_name, 7, "ualitativeTemperatureResponse", 0, 29, false) == 0) && (field_name.Length == 36))
                            return fieldGeneratorEnableQualitativeTemperatureResponse;
                        break;
                    default:
                        break;
                  }
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorEnableQualitativeTemperatureResponse = new JSONHoldingBooleanGenerator("field \"EnableQualitativeTemperatureResponse\" of the CarControlClimateClientConfiguration class");
        ...
        public override void reset()
          {
            fieldGeneratorEnableQualitativeTemperatureResponse.reset();
