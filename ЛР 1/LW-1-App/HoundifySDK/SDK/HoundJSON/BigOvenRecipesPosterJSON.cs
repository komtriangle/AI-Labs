/* file "BigOvenRecipesPosterJSON.cs" */
...
public class BigOvenRecipesPosterJSON : JSONBase
  {
    ...
    private void  fromJSONUserName(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field UserName of BigOvenRecipesPosterJSON is not a string.");
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field UserID of BigOvenRecipesPosterJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field UserID of BigOvenRecipesPosterJSON is not an integer.");
              }
    ...
    private void  fromJSONFirstName(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field FirstName of BigOvenRecipesPosterJSON is not a string.");
    ...
    private void  fromJSONLastName(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field LastName of BigOvenRecipesPosterJSON is not a string.");
    ...
    private void  fromJSONPhotoUrl(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field PhotoUrl of BigOvenRecipesPosterJSON is not a string.");
        setPhotoUrl(json_string.getData());
      }


    public BigOvenRecipesPosterJSON()
      {
    ...
    public virtual int extraBigOvenRecipesPosterComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraBigOvenRecipesPosterComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraBigOvenRecipesPosterComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraBigOvenRecipesPosterLookup(string field_name)
      {
    ...
    public void setUserID(BigInteger new_value)
      {
        flagHasUserID = true;
        if (new_value < 0)
            throw new Exception("The value for field UserID of BigOvenRecipesPosterJSON is less than the lower bound (0) for that field.");
    ...
    public virtual void extraBigOvenRecipesPosterAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraBigOvenRecipesPosterSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraBigOvenRecipesPosterLookup(key);
        if (old_field == null)
          {
            extraBigOvenRecipesPosterAppendPair(key, new_component);
          }
        else
          {
    ...
    public static BigOvenRecipesPosterJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        BigOvenRecipesPosterJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BigOvenRecipesPoster", ignore_extras);
    ...
    public static BigOvenRecipesPosterJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static BigOvenRecipesPosterJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        BigOvenRecipesPosterJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BigOvenRecipesPoster", ignore_extras);
    ...
    public static BigOvenRecipesPosterJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static BigOvenRecipesPosterJSON from_text(string text, bool ignore_extras)
      {
        BigOvenRecipesPosterJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BigOvenRecipesPoster", ignore_extras);
            JSONParse.parse_json_value(text, "Text for BigOvenRecipesPosterJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static BigOvenRecipesPosterJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        BigOvenRecipesPosterJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BigOvenRecipesPoster", ignore_extras);
    ...
    private class FieldHoldingArrayGeneratorUserID : JSONHoldingIntegerLowerBoundOnlyArrayGenerator
        ...
        protected override void finish()
          {
            BigOvenRecipesPosterJSON result = new BigOvenRecipesPosterJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraBigOvenRecipesPosterAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(BigOvenRecipesPosterJSON result)
          {
        ...
        protected abstract void handle_result(BigOvenRecipesPosterJSON new_result);
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorUserName = new JSONHoldingStringGenerator("field \"UserName\" of the BigOvenRecipesPoster class");
            fieldGeneratorUserID = new FieldHoldingGeneratorUserID("field \"UserID\" of the BigOvenRecipesPoster class");
            fieldGeneratorFirstName = new JSONHoldingStringGenerator("field \"FirstName\" of the BigOvenRecipesPoster class");
            fieldGeneratorLastName = new JSONHoldingStringGenerator("field \"LastName\" of the BigOvenRecipesPoster class");
            fieldGeneratorPhotoUrl = new JSONHoldingStringGenerator("field \"PhotoUrl\" of the BigOvenRecipesPoster class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the BigOvenRecipesPoster class");
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(BigOvenRecipesPosterJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public BigOvenRecipesPosterJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<BigOvenRecipesPosterJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<BigOvenRecipesPosterJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<BigOvenRecipesPosterJSON> value;
  };
  };
