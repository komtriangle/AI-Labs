...
public class CallNumberCommandJSON : PhoneCommandJSON
  {
    ...
    private void  fromJSONNumber(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field Number of CallNumberCommandJSON is not a string.");
    ...
    public virtual int extraCallNumberCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraCallNumberCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraCallNumberCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraCallNumberCommandLookup(string field_name)
      {
    ...
    public virtual void extraCallNumberCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraCallNumberCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new CallNumberCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
    ...
    public static new CallNumberCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    ...
    public static new CallNumberCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new CallNumberCommandJSON from_text(string text, bool ignore_extras)
      {
        CallNumberCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CallNumberCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for CallNumberCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new CallNumberCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        CallNumberCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CallNumberCommand", ignore_extras);
    ...
    public new abstract class Generator : PhoneCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getPhoneCommandJSONKey().Equals("CallNumber")))
                throw new Exception("The key field has a value other than `CallNumber'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraCallNumberCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(CallNumberCommandJSON result)
          {
        ...
        protected abstract void handle_result(CallNumberCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorNumber = new JSONHoldingStringGenerator("field \"Number\" of the CallNumberCommand class");
            fieldGeneratorNumberDerivation = new DerivationJSON.HoldingGenerator("field \"NumberDerivation\" of the CallNumberCommand class", ignore_extras);
        ...
        public Generator() : base(false)
          {
            fieldGeneratorNumber = new JSONHoldingStringGenerator("field \"Number\" of the CallNumberCommand class");
            fieldGeneratorNumberDerivation = new DerivationJSON.HoldingGenerator("field \"NumberDerivation\" of the CallNumberCommand class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(CallNumberCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public CallNumberCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<CallNumberCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<CallNumberCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<CallNumberCommandJSON> value;
  };
  };
