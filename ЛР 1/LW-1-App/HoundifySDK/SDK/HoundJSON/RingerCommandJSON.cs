...
public class RingerCommandJSON : DeviceControlCommandJSON
  {
    ...
    public static TypeCommandType  stringToCommandType(string chars)
      {
        switch (chars[0])
          {
            case 'C':
                if ((String.Compare(chars, 1, "heckRingerState", 0, 15, false) == 0) && (chars.Length == 16))
                    return TypeCommandType.CommandType_CheckRingerState;
                break;
            case 'M':
                if ((String.Compare(chars, 1, "uteMode", 0, 7, false) == 0) && (chars.Length == 8))
                    return TypeCommandType.CommandType_MuteMode;
                break;
            case 'R':
                if ((String.Compare(chars, 1, "ingingMode", 0, 10, false) == 0) && (chars.Length == 11))
                    return TypeCommandType.CommandType_RingingMode;
                break;
            case 'T':
                if (String.Compare(chars, 1, "urnVibrateO", 0, 11, false) == 0)
                  {
                    switch (chars[12])
                      {
                        case 'f':
                            if ((String.Compare(chars, 13, "f", 0, 1, false) == 0) && (chars.Length == 14))
                                return TypeCommandType.CommandType_TurnVibrateOff;
                            break;
                        case 'n':
                            if (chars.Length == 13)
                                return TypeCommandType.CommandType_TurnVibrateOn;
                            break;
                        default:
                            break;
                      }
                ...
                break;
            case 'V':
                if ((String.Compare(chars, 1, "ibrateMode", 0, 10, false) == 0) && (chars.Length == 11))
                    return TypeCommandType.CommandType_VibrateMode;
                break;
            default:
                break;
          }
    ...
    private void  fromJSONCommandType(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field CommandType of RingerCommandJSON is not a string.");
        TypeCommandType the_enum;
        switch (json_string.getData()[0])
          {
            case 'C':
                if ((String.Compare(json_string.getData(), 1, "heckRingerState", 0, 15, false) == 0) && (json_string.getData().Length == 16))
                      {
                        the_enum = TypeCommandType.CommandType_CheckRingerState;
                        goto enum_is_done;
                      }
                break;
            case 'M':
                if ((String.Compare(json_string.getData(), 1, "uteMode", 0, 7, false) == 0) && (json_string.getData().Length == 8))
                      {
                        the_enum = TypeCommandType.CommandType_MuteMode;
                        goto enum_is_done;
                      }
                break;
            case 'R':
                if ((String.Compare(json_string.getData(), 1, "ingingMode", 0, 10, false) == 0) && (json_string.getData().Length == 11))
                      {
                        the_enum = TypeCommandType.CommandType_RingingMode;
                        goto enum_is_done;
                      }
                break;
            case 'T':
                if (String.Compare(json_string.getData(), 1, "urnVibrateO", 0, 11, false) == 0)
                  {
                    switch (json_string.getData()[12])
                      {
                        case 'f':
                            if ((String.Compare(json_string.getData(), 13, "f", 0, 1, false) == 0) && (json_string.getData().Length == 14))
                                  {
                                    the_enum = TypeCommandType.CommandType_TurnVibrateOff;
                                    goto enum_is_done;
                                  }
                            break;
                        case 'n':
                            if (json_string.getData().Length == 13)
                                  {
                                    the_enum = TypeCommandType.CommandType_TurnVibrateOn;
                                    goto enum_is_done;
                                  }
                            break;
                        default:
                ...
                break;
            case 'V':
                if ((String.Compare(json_string.getData(), 1, "ibrateMode", 0, 10, false) == 0) && (json_string.getData().Length == 11))
                      {
                        the_enum = TypeCommandType.CommandType_VibrateMode;
                        goto enum_is_done;
                      }
                break;
            default:
        ...
        throw new Exception("The value for field CommandType of RingerCommandJSON is not one of the legal strings.");
      enum_is_done:;
        setCommandType(the_enum);
      }


    public RingerCommandJSON()
      {
    ...
    public virtual int extraRingerCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraRingerCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraRingerCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraRingerCommandLookup(string field_name)
      {
    ...
    public virtual void extraRingerCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraRingerCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new RingerCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RingerCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RingerCommand", ignore_extras);
    ...
    public static new RingerCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RingerCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RingerCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RingerCommand", ignore_extras);
    ...
    public static new RingerCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RingerCommandJSON from_text(string text, bool ignore_extras)
      {
        RingerCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RingerCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for RingerCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new RingerCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        RingerCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RingerCommand", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorCommandType : JSONArrayGenerator
  {
    ...
    public List<TypeCommandType> value;
        ...
        protected override void finish()
          {
            if (!(getDeviceControlCommandJSONKey().Equals("RingerCommand")))
                throw new Exception("The key field has a value other than `RingerCommand'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraRingerCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(RingerCommandJSON result)
          {
        ...
        protected abstract void handle_result(RingerCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorCommandType = new FieldHoldingGeneratorCommandType("field \"CommandType\" of the RingerCommand class");
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(RingerCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public RingerCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<RingerCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<RingerCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<RingerCommandJSON> value;
  };
  };
