/* file "RockPaperScissorsStartGameCommandJSON.cs" */
...
public class RockPaperScissorsStartGameCommandJSON : RockPaperScissorsCommandJSON
  {
    ...
    public RockPaperScissorsStartGameCommandJSON()
      {
    ...
    public virtual int extraRockPaperScissorsStartGameCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraRockPaperScissorsStartGameCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraRockPaperScissorsStartGameCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraRockPaperScissorsStartGameCommandLookup(string field_name)
      {
        JSONValue result = (extraIndex.ContainsKey(field_name) ? extraIndex[field_name] : null);
        return result;
      }
    ...
    public virtual void extraRockPaperScissorsStartGameCommandAppendPair(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public virtual void extraRockPaperScissorsStartGameCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new RockPaperScissorsStartGameCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RockPaperScissorsStartGameCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RockPaperScissorsStartGameCommand", ignore_extras);
            generator.set_allow_incomplete(allow_incomplete);
            generator.set_allow_unpolished(allow_unpolished);
            if (allow_incomplete || allow_unpolished)
                json_value.write(generator);
    ...
    public static new RockPaperScissorsStartGameCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RockPaperScissorsStartGameCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RockPaperScissorsStartGameCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RockPaperScissorsStartGameCommand", ignore_extras);
    ...
    public static new RockPaperScissorsStartGameCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RockPaperScissorsStartGameCommandJSON from_text(string text, bool ignore_extras)
      {
        RockPaperScissorsStartGameCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RockPaperScissorsStartGameCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for RockPaperScissorsStartGameCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new RockPaperScissorsStartGameCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        RockPaperScissorsStartGameCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RockPaperScissorsStartGameCommand", ignore_extras);
    ...
    public new abstract class Generator : RockPaperScissorsCommandJSON.Generator
      {
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the RockPaperScissorsStartGameCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the RockPaperScissorsStartGameCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the RockPaperScissorsStartGameCommand class", false);
            unknownFieldGenerator = new UnknownFieldGenerator(false);
            set_what("the RockPaperScissorsStartGameCommand class");
          }
...
//@@@            Debug.Assert(!have_value);
        ...
        public bool have_value;
        public RockPaperScissorsStartGameCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<RockPaperScissorsStartGameCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<RockPaperScissorsStartGameCommandJSON>();
        base.set_what(what);
      }
    public HoldingArrayGenerator(bool ignore_extras)
      {
    ...
    public bool have_value;
    public List<RockPaperScissorsStartGameCommandJSON> value;
  };
  };
