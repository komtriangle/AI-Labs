/* file "ContactAddressDisambiguationConversationJSON.cs" */
...
public class ContactAddressDisambiguationConversationJSON : JSONBase
  {
    ...
    private void  fromJSONContacts(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field Contacts of ContactAddressDisambiguationConversationJSON is not an array.");
        int count1 = json_array1.componentCount();
        if (count1 < 1)
            throw new Exception("The value for field Contacts of ContactAddressDisambiguationConversationJSON has too few elements.");
    ...
    private void  fromJSONChoices(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONArrayValue json_array1 = json_value.array_value();
        if (json_array1 == null)
            throw new Exception("The value for field Choices of ContactAddressDisambiguationConversationJSON is not an array.");
        int count1 = json_array1.componentCount();
        if (count1 < 2)
            throw new Exception("The value for field Choices of ContactAddressDisambiguationConversationJSON has too few elements.");
    ...
    private void  fromJSONUserSpecifiedName(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field UserSpecifiedName of ContactAddressDisambiguationConversationJSON is not a string.");
    ...
    private void  fromJSONRequestedProperties(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONArrayValue json_array1 = json_value.array_value();
        if (json_array1 == null)
            throw new Exception("The value for field RequestedProperties of ContactAddressDisambiguationConversationJSON is not an array.");
        int count1 = json_array1.componentCount();
    ...
    public ContactAddressDisambiguationConversationJSON()
      {
    ...
    public virtual int extraContactAddressDisambiguationConversationComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraContactAddressDisambiguationConversationComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraContactAddressDisambiguationConversationComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraContactAddressDisambiguationConversationLookup(string field_name)
      {
    ...
    public virtual void extraContactAddressDisambiguationConversationAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraContactAddressDisambiguationConversationSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraContactAddressDisambiguationConversationLookup(key);
        if (old_field == null)
          {
            extraContactAddressDisambiguationConversationAppendPair(key, new_component);
          }
        else
          {
    ...
    public static ContactAddressDisambiguationConversationJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ContactAddressDisambiguationConversationJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ContactAddressDisambiguationConversation", ignore_extras);
    ...
    public static ContactAddressDisambiguationConversationJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static ContactAddressDisambiguationConversationJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ContactAddressDisambiguationConversationJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ContactAddressDisambiguationConversation", ignore_extras);
    ...
    public static ContactAddressDisambiguationConversationJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static ContactAddressDisambiguationConversationJSON from_text(string text, bool ignore_extras)
      {
        ContactAddressDisambiguationConversationJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ContactAddressDisambiguationConversation", ignore_extras);
            JSONParse.parse_json_value(text, "Text for ContactAddressDisambiguationConversationJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static ContactAddressDisambiguationConversationJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        ContactAddressDisambiguationConversationJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ContactAddressDisambiguationConversation", ignore_extras);
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        protected override void finish()
          {
            ContactAddressDisambiguationConversationJSON result = new ContactAddressDisambiguationConversationJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraContactAddressDisambiguationConversationAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(ContactAddressDisambiguationConversationJSON result)
          {
        ...
        protected abstract void handle_result(ContactAddressDisambiguationConversationJSON new_result);
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorContacts = new OneContactJSON.HoldingArrayGenerator("field \"Contacts\" of the ContactAddressDisambiguationConversation class", ignore_extras);
            fieldGeneratorChoices = new ContactAddressChoiceJSON.HoldingArrayGenerator("field \"Choices\" of the ContactAddressDisambiguationConversation class", ignore_extras);
            fieldGeneratorUserSpecifiedName = new JSONHoldingStringGenerator("field \"UserSpecifiedName\" of the ContactAddressDisambiguationConversation class");
            fieldGeneratorRequestedProperties = new PropertyJSON.HoldingArrayGenerator("field \"RequestedProperties\" of the ContactAddressDisambiguationConversation class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the ContactAddressDisambiguationConversation class");
            allow_incomplete = false;
            allow_unpolished = false;
          }
        public Generator()
          {
            fieldGeneratorContacts = new OneContactJSON.HoldingArrayGenerator("field \"Contacts\" of the ContactAddressDisambiguationConversation class", false);
            fieldGeneratorChoices = new ContactAddressChoiceJSON.HoldingArrayGenerator("field \"Choices\" of the ContactAddressDisambiguationConversation class", false);
            fieldGeneratorUserSpecifiedName = new JSONHoldingStringGenerator("field \"UserSpecifiedName\" of the ContactAddressDisambiguationConversation class");
            fieldGeneratorRequestedProperties = new PropertyJSON.HoldingArrayGenerator("field \"RequestedProperties\" of the ContactAddressDisambiguationConversation class", false);
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(ContactAddressDisambiguationConversationJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public ContactAddressDisambiguationConversationJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<ContactAddressDisambiguationConversationJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<ContactAddressDisambiguationConversationJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<ContactAddressDisambiguationConversationJSON> value;
  };
  };
