/* file "HomeAutomationDeviceParsingItemJSON.cs" */
...
public class HomeAutomationDeviceParsingItemJSON : JSONBase
  {
    ...
    private void  fromJSONName(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field Name of HomeAutomationDeviceParsingItemJSON is not a string.");
    ...
    private void  fromJSONActualNames(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field ActualNames of HomeAutomationDeviceParsingItemJSON is not an array.");
        int count1 = json_array1.componentCount();
        if (count1 < 1)
            throw new Exception("The value for field ActualNames of HomeAutomationDeviceParsingItemJSON has too few elements.");
        List< string > vector_ActualNames1 = new List< string >(count1);
        for (int num1 = 0; num1 < count1; ++num1)
          {
            JSONStringValue json_string = json_array1.component(num1).string_value();
            if (json_string == null)
                throw new Exception("The value for an element of field ActualNames of HomeAutomationDeviceParsingItemJSON is not a string.");
    ...
    private void  fromJSONSpokenPrefix(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field SpokenPrefix of HomeAutomationDeviceParsingItemJSON is not a string.");
        setSpokenPrefix(json_string.getData());
      }


    public HomeAutomationDeviceParsingItemJSON()
      {
        flagHasName = false;
    ...
    public virtual int extraHomeAutomationDeviceParsingItemComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraHomeAutomationDeviceParsingItemComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraHomeAutomationDeviceParsingItemComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraHomeAutomationDeviceParsingItemLookup(string field_name)
      {
    ...
    public virtual void extraHomeAutomationDeviceParsingItemAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraHomeAutomationDeviceParsingItemSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static HomeAutomationDeviceParsingItemJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        HomeAutomationDeviceParsingItemJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HomeAutomationDeviceParsingItem", ignore_extras);
    ...
    public static HomeAutomationDeviceParsingItemJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static HomeAutomationDeviceParsingItemJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        HomeAutomationDeviceParsingItemJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HomeAutomationDeviceParsingItem", ignore_extras);
    ...
    public static HomeAutomationDeviceParsingItemJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static HomeAutomationDeviceParsingItemJSON from_text(string text, bool ignore_extras)
      {
        HomeAutomationDeviceParsingItemJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HomeAutomationDeviceParsingItem", ignore_extras);
            JSONParse.parse_json_value(text, "Text for HomeAutomationDeviceParsingItemJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static HomeAutomationDeviceParsingItemJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        HomeAutomationDeviceParsingItemJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HomeAutomationDeviceParsingItem", ignore_extras);
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        protected override void finish()
          {
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraHomeAutomationDeviceParsingItemAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected abstract void handle_result(HomeAutomationDeviceParsingItemJSON new_result);
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorName = new JSONHoldingStringGenerator("field \"Name\" of the HomeAutomationDeviceParsingItem class");
            fieldGeneratorActualNames = new JSONHoldingStringArrayGenerator("field \"ActualNames\" of the HomeAutomationDeviceParsingItem class");
            fieldGeneratorSpokenPrefix = new JSONHoldingStringGenerator("field \"SpokenPrefix\" of the HomeAutomationDeviceParsingItem class");
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(HomeAutomationDeviceParsingItemJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public HomeAutomationDeviceParsingItemJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<HomeAutomationDeviceParsingItemJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<HomeAutomationDeviceParsingItemJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<HomeAutomationDeviceParsingItemJSON> value;
  };
  };
