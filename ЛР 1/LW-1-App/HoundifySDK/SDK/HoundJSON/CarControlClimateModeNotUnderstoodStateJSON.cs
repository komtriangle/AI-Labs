/* file "CarControlClimateModeNotUnderstoodStateJSON.cs" */
...
public class CarControlClimateModeNotUnderstoodStateJSON : JSONBase
  {
    ...
    public static TypeCommandKind  stringToCommandKind(string chars)
      {
        if ((String.Compare(chars, 0, "CarControlClimateModeNotUnderstood", 0, 34, false) == 0) && (chars.Length == 34))
    ...
    private void  fromJSONCommandKind(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field CommandKind of CarControlClimateModeNotUnderstoodStateJSON is not a string.");
        if (!(json_string.getData().Equals("CarControlClimateModeNotUnderstood")))
            throw new Exception("The value for field CommandKind of CarControlClimateModeNotUnderstoodStateJSON is not `CarControlClimateModeNotUnderstood'.");
        setCommandKind();
      }
    ...
    private void  fromJSONProposedAction(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field ProposedAction of CarControlClimateModeNotUnderstoodStateJSON is not a string.");
        ...
        throw new Exception("The value for field ProposedAction of CarControlClimateModeNotUnderstoodStateJSON is not one of the legal strings.");
      enum_is_done:;
        setProposedAction(the_enum);
      }


    public CarControlClimateModeNotUnderstoodStateJSON()
      {
    ...
    public virtual int extraCarControlClimateModeNotUnderstoodStateComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraCarControlClimateModeNotUnderstoodStateComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraCarControlClimateModeNotUnderstoodStateComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraCarControlClimateModeNotUnderstoodStateLookup(string field_name)
      {
    ...
    public virtual void extraCarControlClimateModeNotUnderstoodStateAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraCarControlClimateModeNotUnderstoodStateSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraCarControlClimateModeNotUnderstoodStateLookup(key);
        if (old_field == null)
          {
            extraCarControlClimateModeNotUnderstoodStateAppendPair(key, new_component);
          }
        else
          {
    ...
    public static CarControlClimateModeNotUnderstoodStateJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CarControlClimateModeNotUnderstoodStateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlClimateModeNotUnderstoodState", ignore_extras);
    ...
    public static CarControlClimateModeNotUnderstoodStateJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static CarControlClimateModeNotUnderstoodStateJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CarControlClimateModeNotUnderstoodStateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlClimateModeNotUnderstoodState", ignore_extras);
    ...
    public static CarControlClimateModeNotUnderstoodStateJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static CarControlClimateModeNotUnderstoodStateJSON from_text(string text, bool ignore_extras)
      {
        CarControlClimateModeNotUnderstoodStateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlClimateModeNotUnderstoodState", ignore_extras);
            JSONParse.parse_json_value(text, "Text for CarControlClimateModeNotUnderstoodStateJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static CarControlClimateModeNotUnderstoodStateJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        CarControlClimateModeNotUnderstoodStateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlClimateModeNotUnderstoodState", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorProposedAction : JSONArrayGenerator
  {
    ...
    public List<TypeProposedAction> value;
        ...
        protected override void finish()
          {
            CarControlClimateModeNotUnderstoodStateJSON result = new CarControlClimateModeNotUnderstoodStateJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraCarControlClimateModeNotUnderstoodStateAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(CarControlClimateModeNotUnderstoodStateJSON result)
          {
        ...
        protected abstract void handle_result(CarControlClimateModeNotUnderstoodStateJSON new_result);
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(CarControlClimateModeNotUnderstoodStateJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public CarControlClimateModeNotUnderstoodStateJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<CarControlClimateModeNotUnderstoodStateJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<CarControlClimateModeNotUnderstoodStateJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<CarControlClimateModeNotUnderstoodStateJSON> value;
  };
  };
