...
public class DurationDataJSON : JSONBase
  {
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field Seconds of DurationDataJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field Seconds of DurationDataJSON is not an integer.");
              }
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field Minutes of DurationDataJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field Minutes of DurationDataJSON is not an integer.");
              }
            extracted_integer = json_rational.getInteger()        ;
          }
        else
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field Hours of DurationDataJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field Hours of DurationDataJSON is not an integer.");
              }
            extracted_integer = json_rational.getInteger()        ;
          }
        else
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field Days of DurationDataJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field Days of DurationDataJSON is not an integer.");
              }
            extracted_integer = json_rational.getInteger()        ;
          }
        else
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field Months of DurationDataJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field Months of DurationDataJSON is not an integer.");
              }
            extracted_integer = json_rational.getInteger()        ;
          }
        else
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field Years of DurationDataJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field Years of DurationDataJSON is not an integer.");
              }
            extracted_integer = json_rational.getInteger()        ;
          }
        else
    ...
    public virtual int extraDurationDataComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraDurationDataComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraDurationDataComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraDurationDataLookup(string field_name)
      {
    ...
    public virtual void extraDurationDataAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraDurationDataSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraDurationDataLookup(key);
        if (old_field == null)
          {
            extraDurationDataAppendPair(key, new_component);
          }
        else
          {
    ...
    public static DurationDataJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        DurationDataJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DurationData", ignore_extras);
    ...
    public static DurationDataJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static DurationDataJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        DurationDataJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DurationData", ignore_extras);
    ...
    public static DurationDataJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static DurationDataJSON from_text(string text, bool ignore_extras)
      {
        DurationDataJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DurationData", ignore_extras);
            JSONParse.parse_json_value(text, "Text for DurationDataJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static DurationDataJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        DurationDataJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DurationData", ignore_extras);
    ...
    private class FieldHoldingArrayGeneratorYears : JSONHoldingIntegerUnboundRangeArrayGenerator
        ...
        protected override void finish()
          {
            DurationDataJSON result = new DurationDataJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraDurationDataAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(DurationDataJSON result)
          {
        ...
        protected abstract void handle_result(DurationDataJSON new_result);
        protected virtual JSONHandler start_known_field(string field_name)
          {
            switch (field_name[0])
              {
                case 'D':
                    if ((String.Compare(field_name, 1, "ays", 0, 3, false) == 0) && (field_name.Length == 4))
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorSeconds = new FieldHoldingGeneratorSeconds("field \"Seconds\" of the DurationData class");
            fieldGeneratorMinutes = new FieldHoldingGeneratorMinutes("field \"Minutes\" of the DurationData class");
            fieldGeneratorHours = new FieldHoldingGeneratorHours("field \"Hours\" of the DurationData class");
            fieldGeneratorDays = new FieldHoldingGeneratorDays("field \"Days\" of the DurationData class");
            fieldGeneratorMonths = new FieldHoldingGeneratorMonths("field \"Months\" of the DurationData class");
            fieldGeneratorYears = new FieldHoldingGeneratorYears("field \"Years\" of the DurationData class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the DurationData class");
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(DurationDataJSON  result)
          {
//@@@            Debug.Assert(!have_value);
    ...
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<DurationDataJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<DurationDataJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<DurationDataJSON> value;
  };
  };
