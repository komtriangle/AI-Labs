...
public class SMSClientStateJSON : ClientVerticalStateJSON
  {
    ...
    private JSONValue  extraSMSToJSON()
      {
        JSONValueHandler handler_SMS = new JSONValueHandler();
    ...
    private void  fromJSONCompositionStep(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field CompositionStep of SMSClientStateJSON is not a string.");
        ...
        throw new Exception("The value for field CompositionStep of SMSClientStateJSON is not one of the legal strings.");
      enum_is_done:;
    ...
    private void  fromJSONDisambiguateChoiceIds(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONArrayValue json_array1 = json_value.array_value();
        if (json_array1 == null)
            throw new Exception("The value for field DisambiguateChoiceIds of SMSClientStateJSON is not an array.");
        int count1 = json_array1.componentCount();
        ...
        for (int num1 = 0; num1 < count1; ++num1)
          {
            JSONStringValue json_string = json_array1.component(num1).string_value();
            if (json_string == null)
                throw new Exception("The value for an element of field DisambiguateChoiceIds of SMSClientStateJSON is not a string.");
        ...
        switch (key[0])
          {
            ...
            case 'L':
                ...
                break;
            case 'S':
                if ((String.Compare(key, 1, "MS", 0, 2, false) == 0) && (key.Length == 3))
                    {
    ...
    public static new SMSClientStateJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SMSClientStateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SMSClientState", ignore_extras);
    ...
    public static new SMSClientStateJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SMSClientStateJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SMSClientStateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SMSClientState", ignore_extras);
    ...
    public static new SMSClientStateJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SMSClientStateJSON from_text(string text, bool ignore_extras)
      {
        SMSClientStateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SMSClientState", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SMSClientStateJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new SMSClientStateJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SMSClientStateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SMSClientState", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorCompositionStep : JSONArrayGenerator
  {
    ...
    public List<TypeCompositionStep> value;
        ...
        protected override void finish()
          {
            if (!(getClientVerticalStateJSONKey().Equals("SMSClientState")))
                throw new Exception("The key field has a value other than `SMSClientState'.");
        ...
        protected abstract void handle_result(SMSClientStateJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            ...
            fieldGeneratorSMS = new SMSJSON.HoldingGenerator("field \"SMS\" of the SMSClientState class", ignore_extras);
            fieldGeneratorLastEditedTextFieldType = new SMSFieldTypeJSON.HoldingGenerator("field \"LastEditedTextFieldType\" of the SMSClientState class", ignore_extras);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(SMSClientStateJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public SMSClientStateJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SMSClientStateJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<SMSClientStateJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SMSClientStateJSON> value;
  };
  };
