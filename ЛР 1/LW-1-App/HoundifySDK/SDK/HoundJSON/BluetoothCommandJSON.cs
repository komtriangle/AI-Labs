...
public class BluetoothCommandJSON : DeviceControlCommandJSON
  {
    public enum TypeCommandType
      {
        CommandType_TurnBluetoothOn,
        CommandType_TurnBluetoothOff,
        CommandType_CheckBluetoothState,
        CommandType_ToggleBluetoothState,
        CommandType_ShowBluetoothDevices
      };
    ...
    public static TypeCommandType  stringToCommandType(string chars)
      {
        switch (chars[0])
          {
            case 'C':
                if ((String.Compare(chars, 1, "heckBluetoothState", 0, 18, false) == 0) && (chars.Length == 19))
                    return TypeCommandType.CommandType_CheckBluetoothState;
                break;
            case 'S':
                if ((String.Compare(chars, 1, "howBluetoothDevices", 0, 19, false) == 0) && (chars.Length == 20))
                    return TypeCommandType.CommandType_ShowBluetoothDevices;
                break;
            case 'T':
                switch (chars[1])
                  {
                    case 'o':
                        if ((String.Compare(chars, 2, "ggleBluetoothState", 0, 18, false) == 0) && (chars.Length == 20))
                            return TypeCommandType.CommandType_ToggleBluetoothState;
                        break;
                    case 'u':
                        if (String.Compare(chars, 2, "rnBluetoothO", 0, 12, false) == 0)
                          {
                            switch (chars[14])
                              {
                                case 'f':
                                    if ((String.Compare(chars, 15, "f", 0, 1, false) == 0) && (chars.Length == 16))
                                        return TypeCommandType.CommandType_TurnBluetoothOff;
                                    break;
                                case 'n':
                                    if (chars.Length == 15)
                                        return TypeCommandType.CommandType_TurnBluetoothOn;
                                    break;
                                default:
                                    break;
                              }
    ...
    private void  fromJSONCommandType(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field CommandType of BluetoothCommandJSON is not a string.");
        TypeCommandType the_enum;
        switch (json_string.getData()[0])
          {
            case 'C':
                if ((String.Compare(json_string.getData(), 1, "heckBluetoothState", 0, 18, false) == 0) && (json_string.getData().Length == 19))
                      {
                        the_enum = TypeCommandType.CommandType_CheckBluetoothState;
                        goto enum_is_done;
                      }
                break;
            case 'S':
                if ((String.Compare(json_string.getData(), 1, "howBluetoothDevices", 0, 19, false) == 0) && (json_string.getData().Length == 20))
                      {
                        the_enum = TypeCommandType.CommandType_ShowBluetoothDevices;
                        goto enum_is_done;
                      }
                break;
            case 'T':
                switch (json_string.getData()[1])
                  {
                    case 'o':
                        if ((String.Compare(json_string.getData(), 2, "ggleBluetoothState", 0, 18, false) == 0) && (json_string.getData().Length == 20))
                              {
                                the_enum = TypeCommandType.CommandType_ToggleBluetoothState;
                                goto enum_is_done;
                              }
                        break;
                    case 'u':
                        if (String.Compare(json_string.getData(), 2, "rnBluetoothO", 0, 12, false) == 0)
                          {
                            switch (json_string.getData()[14])
                              {
                                case 'f':
                                    if ((String.Compare(json_string.getData(), 15, "f", 0, 1, false) == 0) && (json_string.getData().Length == 16))
                                          {
                                            the_enum = TypeCommandType.CommandType_TurnBluetoothOff;
                                            goto enum_is_done;
                                          }
                                    break;
                                case 'n':
                                    if (json_string.getData().Length == 15)
                                          {
                                            the_enum = TypeCommandType.CommandType_TurnBluetoothOn;
                                            goto enum_is_done;
                                          }
                                    break;
                                default:
        ...
        throw new Exception("The value for field CommandType of BluetoothCommandJSON is not one of the legal strings.");
      enum_is_done:;
        setCommandType(the_enum);
      }


    public BluetoothCommandJSON()
      {
    ...
    public virtual int extraBluetoothCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraBluetoothCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraBluetoothCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraBluetoothCommandLookup(string field_name)
      {
    ...
    public override int extraDeviceControlCommandComponentCount()
      {
        ...
        if (flagHasCommandType)
            ++result;
        result += extraBluetoothCommandComponentCount();
        return result;
      }
    public override string extraDeviceControlCommandComponentKey(int component_num)
      {
        ...
        return extraBluetoothCommandComponentKey(remainder);
      }
    public override JSONValue extraDeviceControlCommandComponentValue(int component_num)
      {
        ...
        return extraBluetoothCommandComponentValue(remainder);
      }
    public override JSONValue extraDeviceControlCommandLookup(string field_name)
      {
        ...
        return extraBluetoothCommandLookup(field_name);
      }
    ...
    public virtual void extraBluetoothCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraBluetoothCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraBluetoothCommandLookup(key);
        if (old_field == null)
          {
            extraBluetoothCommandAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraDeviceControlCommandSetField(string key, JSONValue new_component)
      {
        ...
        extraBluetoothCommandSetField(key, new_component);
      }
        ...
        if (flagHasCommandType)
          {
            ...
            switch (storeCommandType)
              {
                case TypeCommandType.CommandType_TurnBluetoothOn:
                    handler.string_value("TurnBluetoothOn");
                    break;
                case TypeCommandType.CommandType_TurnBluetoothOff:
                    handler.string_value("TurnBluetoothOff");
                    break;
                case TypeCommandType.CommandType_CheckBluetoothState:
                    handler.string_value("CheckBluetoothState");
                    break;
                case TypeCommandType.CommandType_ToggleBluetoothState:
                    handler.string_value("ToggleBluetoothState");
                    break;
                case TypeCommandType.CommandType_ShowBluetoothDevices:
                    handler.string_value("ShowBluetoothDevices");
                    break;
                default:
                    Debug.Assert(false);
                    break;
    ...
    public static new BluetoothCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        BluetoothCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BluetoothCommand", ignore_extras);
    ...
    public static new BluetoothCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new BluetoothCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        BluetoothCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BluetoothCommand", ignore_extras);
    ...
    public static new BluetoothCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new BluetoothCommandJSON from_text(string text, bool ignore_extras)
      {
        BluetoothCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BluetoothCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for BluetoothCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new BluetoothCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        BluetoothCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BluetoothCommand", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorCommandType : JSONArrayGenerator
  {
    ...
    public List<TypeCommandType> value;
        ...
        protected override void finish()
          {
            if (!(getDeviceControlCommandJSONKey().Equals("BluetoothCommand")))
                throw new Exception("The key field has a value other than `BluetoothCommand'.");
            BluetoothCommandJSON result = new BluetoothCommandJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraBluetoothCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(DeviceControlCommandJSON new_result)
          {
            handle_result((BluetoothCommandJSON )new_result);
          }
        protected void finish(BluetoothCommandJSON result)
          {
        ...
        protected abstract void handle_result(BluetoothCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorCommandType = new FieldHoldingGeneratorCommandType("field \"CommandType\" of the BluetoothCommand class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the BluetoothCommand class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(BluetoothCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public BluetoothCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<BluetoothCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<BluetoothCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<BluetoothCommandJSON> value;
  };
  };
