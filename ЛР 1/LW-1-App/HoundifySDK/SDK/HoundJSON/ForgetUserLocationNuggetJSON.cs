/* file "ForgetUserLocationNuggetJSON.cs" */
...
public class ForgetUserLocationNuggetJSON : UserMemoryNuggetJSON
  {
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field IsOwned of ForgetUserLocationNuggetJSON is not true for false.");
              }
          }
        setIsOwned(the_bool);
      }
    ...
    private void  fromJSONWhat(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field What of ForgetUserLocationNuggetJSON is not a string.");
    ...
    public ForgetUserLocationNuggetJSON()
      {
    ...
    public virtual int extraForgetUserLocationNuggetComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraForgetUserLocationNuggetComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraForgetUserLocationNuggetComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraForgetUserLocationNuggetLookup(string field_name)
      {
    ...
    public virtual void extraForgetUserLocationNuggetAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraForgetUserLocationNuggetSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new ForgetUserLocationNuggetJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ForgetUserLocationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ForgetUserLocationNugget", ignore_extras);
    ...
    public static new ForgetUserLocationNuggetJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new ForgetUserLocationNuggetJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ForgetUserLocationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ForgetUserLocationNugget", ignore_extras);
    ...
    public static new ForgetUserLocationNuggetJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new ForgetUserLocationNuggetJSON from_text(string text, bool ignore_extras)
      {
        ForgetUserLocationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ForgetUserLocationNugget", ignore_extras);
            JSONParse.parse_json_value(text, "Text for ForgetUserLocationNuggetJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new ForgetUserLocationNuggetJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        ForgetUserLocationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ForgetUserLocationNugget", ignore_extras);
    ...
    public new abstract class Generator : UserMemoryNuggetJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getUserMemoryNuggetJSONKey().Equals("ForgetUserLocation")))
                throw new Exception("The key field has a value other than `ForgetUserLocation'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraForgetUserLocationNuggetAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(ForgetUserLocationNuggetJSON result)
          {
        ...
        protected abstract void handle_result(ForgetUserLocationNuggetJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            ...
            fieldGeneratorSpecialLocation = new UserMemorySpecialLocationJSON.HoldingGenerator("field \"SpecialLocation\" of the ForgetUserLocationNugget class", ignore_extras);
        ...
        public Generator() : base(false)
          {
            fieldGeneratorIsOwned = new JSONHoldingBooleanGenerator("field \"IsOwned\" of the ForgetUserLocationNugget class");
            fieldGeneratorWhat = new JSONHoldingStringGenerator("field \"What\" of the ForgetUserLocationNugget class");
            fieldGeneratorSpecialLocation = new UserMemorySpecialLocationJSON.HoldingGenerator("field \"SpecialLocation\" of the ForgetUserLocationNugget class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(ForgetUserLocationNuggetJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public ForgetUserLocationNuggetJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<ForgetUserLocationNuggetJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<ForgetUserLocationNuggetJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<ForgetUserLocationNuggetJSON> value;
  };
  };
