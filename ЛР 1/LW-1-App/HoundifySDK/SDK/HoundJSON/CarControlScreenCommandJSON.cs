/* file "CarControlScreenCommandJSON.cs" */
...
public class CarControlScreenCommandJSON : CarControlCommandJSON
  {
    ...
    public static TypeCommandType  stringToCommandType(string chars)
      {
        if (String.Compare(chars, 0, "Show", 0, 4, false) == 0)
          {
            switch (chars[4])
              {
                case 'A':
                    if ((String.Compare(chars, 5, "udioScreen", 0, 10, false) == 0) && (chars.Length == 15))
                        return TypeCommandType.CommandType_ShowAudioScreen;
                    break;
                case 'C':
                    if ((String.Compare(chars, 5, "limateControlScreen", 0, 19, false) == 0) && (chars.Length == 24))
                        return TypeCommandType.CommandType_ShowClimateControlScreen;
                    break;
                case 'D':
                    if ((String.Compare(chars, 5, "ebugScreen", 0, 10, false) == 0) && (chars.Length == 15))
                        return TypeCommandType.CommandType_ShowDebugScreen;
                    break;
                case 'H':
                    if ((String.Compare(chars, 5, "omeScreen", 0, 9, false) == 0) && (chars.Length == 14))
                        return TypeCommandType.CommandType_ShowHomeScreen;
                    break;
                case 'M':
                    if ((String.Compare(chars, 5, "apScreen", 0, 8, false) == 0) && (chars.Length == 13))
                        return TypeCommandType.CommandType_ShowMapScreen;
                    break;
                case 'P':
                    if ((String.Compare(chars, 5, "honeScreen", 0, 10, false) == 0) && (chars.Length == 15))
                        return TypeCommandType.CommandType_ShowPhoneScreen;
                    break;
                case 'R':
                    if ((String.Compare(chars, 5, "adioScreen", 0, 10, false) == 0) && (chars.Length == 15))
                        return TypeCommandType.CommandType_ShowRadioScreen;
                    break;
                case 'S':
                    if ((String.Compare(chars, 5, "potifyScreen", 0, 12, false) == 0) && (chars.Length == 17))
                        return TypeCommandType.CommandType_ShowSpotifyScreen;
                    break;
                case 'U':
                    if ((String.Compare(chars, 5, "SBAudioScreen", 0, 13, false) == 0) && (chars.Length == 18))
                        return TypeCommandType.CommandType_ShowUSBAudioScreen;
                    break;
                default:
                    break;
              }
    ...
    private void  fromJSONCommandType(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field CommandType of CarControlScreenCommandJSON is not a string.");
        TypeCommandType the_enum;
        if (String.Compare(json_string.getData(), 0, "Show", 0, 4, false) == 0)
          {
            switch (json_string.getData()[4])
              {
                case 'A':
                    if ((String.Compare(json_string.getData(), 5, "udioScreen", 0, 10, false) == 0) && (json_string.getData().Length == 15))
                          {
                            the_enum = TypeCommandType.CommandType_ShowAudioScreen;
                            goto enum_is_done;
                          }
                    break;
                case 'C':
                    if ((String.Compare(json_string.getData(), 5, "limateControlScreen", 0, 19, false) == 0) && (json_string.getData().Length == 24))
                          {
                    ...
                    break;
                case 'D':
                    if ((String.Compare(json_string.getData(), 5, "ebugScreen", 0, 10, false) == 0) && (json_string.getData().Length == 15))
                          {
                            the_enum = TypeCommandType.CommandType_ShowDebugScreen;
                            goto enum_is_done;
                          }
                    break;
                case 'H':
                    if ((String.Compare(json_string.getData(), 5, "omeScreen", 0, 9, false) == 0) && (json_string.getData().Length == 14))
                          {
                            the_enum = TypeCommandType.CommandType_ShowHomeScreen;
                            goto enum_is_done;
                          }
                    break;
                case 'M':
                    if ((String.Compare(json_string.getData(), 5, "apScreen", 0, 8, false) == 0) && (json_string.getData().Length == 13))
                          {
                            the_enum = TypeCommandType.CommandType_ShowMapScreen;
                            goto enum_is_done;
                          }
                    break;
                case 'P':
                    if ((String.Compare(json_string.getData(), 5, "honeScreen", 0, 10, false) == 0) && (json_string.getData().Length == 15))
                          {
                            the_enum = TypeCommandType.CommandType_ShowPhoneScreen;
                            goto enum_is_done;
                          }
                    break;
                case 'R':
                    if ((String.Compare(json_string.getData(), 5, "adioScreen", 0, 10, false) == 0) && (json_string.getData().Length == 15))
                          {
                            the_enum = TypeCommandType.CommandType_ShowRadioScreen;
                            goto enum_is_done;
                          }
                    break;
                case 'S':
                    if ((String.Compare(json_string.getData(), 5, "potifyScreen", 0, 12, false) == 0) && (json_string.getData().Length == 17))
                          {
                            the_enum = TypeCommandType.CommandType_ShowSpotifyScreen;
                            goto enum_is_done;
                          }
                    break;
                case 'U':
                    if ((String.Compare(json_string.getData(), 5, "SBAudioScreen", 0, 13, false) == 0) && (json_string.getData().Length == 18))
                          {
                            the_enum = TypeCommandType.CommandType_ShowUSBAudioScreen;
                            goto enum_is_done;
                          }
                    break;
                default:
        ...
        throw new Exception("The value for field CommandType of CarControlScreenCommandJSON is not one of the legal strings.");
      enum_is_done:;
        setCommandType(the_enum);
      }


    public CarControlScreenCommandJSON()
      {
    ...
    public virtual int extraCarControlScreenCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraCarControlScreenCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraCarControlScreenCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraCarControlScreenCommandLookup(string field_name)
      {
    ...
    public virtual void extraCarControlScreenCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraCarControlScreenCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new CarControlScreenCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new CarControlScreenCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CarControlScreenCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlScreenCommand", ignore_extras);
    ...
    public static new CarControlScreenCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new CarControlScreenCommandJSON from_text(string text, bool ignore_extras)
      {
        CarControlScreenCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlScreenCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for CarControlScreenCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new CarControlScreenCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        CarControlScreenCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlScreenCommand", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorCommandType : JSONArrayGenerator
  {
    ...
    public List<TypeCommandType> value;
        ...
        protected override void finish()
          {
            if (!(getCarControlCommandJSONKey().Equals("CarControlScreenCommand")))
                throw new Exception("The key field has a value other than `CarControlScreenCommand'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraCarControlScreenCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(CarControlScreenCommandJSON result)
          {
        ...
        protected abstract void handle_result(CarControlScreenCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorCommandType = new FieldHoldingGeneratorCommandType("field \"CommandType\" of the CarControlScreenCommand class");
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(CarControlScreenCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public CarControlScreenCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<CarControlScreenCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<CarControlScreenCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<CarControlScreenCommandJSON> value;
  };
  };
