...
public class SportsGameCricketJSON : SportsGameJSON
  {
    public enum TypeCricketGameFormatKnownValues
      {
    ...
    public struct TypeCricketGameFormat
      {
        public bool in_known_list;
        public string string_value;
        public TypeCricketGameFormatKnownValues list_value;
      };

    public static TypeCricketGameFormatKnownValues  stringToCricketGameFormat(string chars)
      {
        switch (chars[0])
          {
            case 'F':
                if ((String.Compare(chars, 1, "irstClass", 0, 9, false) == 0) && (chars.Length == 10))
                    return TypeCricketGameFormatKnownValues.CricketGameFormat_FirstClass;
                break;
            case 'L':
                if ((String.Compare(chars, 1, "istA", 0, 4, false) == 0) && (chars.Length == 5))
                    return TypeCricketGameFormatKnownValues.CricketGameFormat_ListA;
                break;
            case 'O':
                if ((String.Compare(chars, 1, "DI", 0, 2, false) == 0) && (chars.Length == 3))
                    return TypeCricketGameFormatKnownValues.CricketGameFormat_ODI;
                break;
            case 'T':
                switch (chars[1])
                  {
                        ...
                        if (String.Compare(chars, 2, "0", 0, 1, false) == 0)
                          {
                            if (chars.Length == 3)
                              {
                                return TypeCricketGameFormatKnownValues.CricketGameFormat_T20;
                              }
                            switch (chars[3])
                              {
                                case 'I':
                                    if (chars.Length == 4)
                                        return TypeCricketGameFormatKnownValues.CricketGameFormat_T20I;
                                    break;
                                default:
                                    break;
                              }
                    ...
                    case 'e':
                        if ((String.Compare(chars, 2, "st", 0, 2, false) == 0) && (chars.Length == 4))
                            return TypeCricketGameFormatKnownValues.CricketGameFormat_Test;
                        break;
                    default:
                        break;
                  }
        ...
        return TypeCricketGameFormatKnownValues.CricketGameFormat__none;
      }

    public static string  stringFromCricketGameFormat(TypeCricketGameFormatKnownValues the_enum)
      {
        switch (the_enum)
          {
            case TypeCricketGameFormatKnownValues.CricketGameFormat_ODI:
                return "ODI";
            case TypeCricketGameFormatKnownValues.CricketGameFormat_T20:
                return "T20";
            case TypeCricketGameFormatKnownValues.CricketGameFormat_T20I:
                return "T20I";
            case TypeCricketGameFormatKnownValues.CricketGameFormat_Test:
                return "Test";
            case TypeCricketGameFormatKnownValues.CricketGameFormat_ListA:
                return "ListA";
            case TypeCricketGameFormatKnownValues.CricketGameFormat_FirstClass:
                return "FirstClass";
            default:
                Debug.Assert(false);
                return null;
    ...
    private bool flagHasCricketGameFormat;
    private TypeCricketGameFormat storeCricketGameFormat;
    ...
    private JSONValue  extraCricketGameFormatToJSON()
      {
        JSONStringValue generated_string_CricketGameFormat;
        if (!(storeCricketGameFormat.in_known_list))
          {
        generated_string_CricketGameFormat = new JSONStringValue(storeCricketGameFormat.string_value);
          }
        else
          {
    ...
    private void  fromJSONCricketGameFormat(JSONValue json_value, bool ignore_extras)
      {
        Debug.Assert(json_value != null);
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field CricketGameFormat of SportsGameCricketJSON is not a string.");
        TypeCricketGameFormat the_open_enum = new TypeCricketGameFormat();
        switch (json_string.getData()[0])
          {
                ...
                if ((String.Compare(json_string.getData(), 1, "irstClass", 0, 9, false) == 0) && (json_string.getData().Length == 10))
                      {
                        ...
                        the_open_enum.list_value = TypeCricketGameFormatKnownValues.CricketGameFormat_FirstClass;
            ...
            case 'L':
                if ((String.Compare(json_string.getData(), 1, "istA", 0, 4, false) == 0) && (json_string.getData().Length == 5))
                      {
                        the_open_enum.in_known_list = true;
                        the_open_enum.list_value = TypeCricketGameFormatKnownValues.CricketGameFormat_ListA;
                        goto open_enum_is_done;
                      }
                break;
            case 'O':
                if ((String.Compare(json_string.getData(), 1, "DI", 0, 2, false) == 0) && (json_string.getData().Length == 3))
                      {
                        the_open_enum.in_known_list = true;
                        the_open_enum.list_value = TypeCricketGameFormatKnownValues.CricketGameFormat_ODI;
                        goto open_enum_is_done;
                      }
                break;
            case 'T':
                switch (json_string.getData()[1])
                  {
                            ...
                            if (json_string.getData().Length == 3)
                              {
                                  {
                                    the_open_enum.in_known_list = true;
                                    the_open_enum.list_value = TypeCricketGameFormatKnownValues.CricketGameFormat_T20;
                                    goto open_enum_is_done;
                                  }
                              }
                            switch (json_string.getData()[3])
                              {
                                case 'I':
                                    if (json_string.getData().Length == 4)
                                          {
                                            the_open_enum.in_known_list = true;
                                            the_open_enum.list_value = TypeCricketGameFormatKnownValues.CricketGameFormat_T20I;
                                            goto open_enum_is_done;
                                          }
                                    break;
                                default:
                    ...
                    case 'e':
                        if ((String.Compare(json_string.getData(), 2, "st", 0, 2, false) == 0) && (json_string.getData().Length == 4))
                              {
                                the_open_enum.in_known_list = true;
                                the_open_enum.list_value = TypeCricketGameFormatKnownValues.CricketGameFormat_Test;
                                goto open_enum_is_done;
                              }
                        break;
                    default:
    ...
    private void  fromJSONInnings(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field Innings of SportsGameCricketJSON is not an array.");
        int count1 = json_array1.componentCount();
        if (count1 < 1)
            throw new Exception("The value for field Innings of SportsGameCricketJSON has too few elements.");
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field WinningTeamIndex of SportsGameCricketJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field WinningTeamIndex of SportsGameCricketJSON is not an integer.");
              }
            extracted_integer = (sbyte)(json_rational.getLongInt())        ;
          }
        else
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field WinningTeamRunDifference of SportsGameCricketJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field WinningTeamRunDifference of SportsGameCricketJSON is not an integer.");
              }
            extracted_integer = json_rational.getInteger()        ;
          }
        else
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field WinningTeamWicketDifference of SportsGameCricketJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field WinningTeamWicketDifference of SportsGameCricketJSON is not an integer.");
              }
            extracted_integer = (sbyte)(json_rational.getLongInt())        ;
          }
        else
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field Draw of SportsGameCricketJSON is not true for false.");
              }
          }
        setDraw(the_bool);
      }
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field Tie of SportsGameCricketJSON is not true for false.");
              }
          }
        setTie(the_bool);
      }
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field DLSMethod of SportsGameCricketJSON is not true for false.");
              }
          }
    ...
    public override string  getSportsGameKind()
      {
        return "Cricket";
      }

    public bool  hasCricketGameFormat()
      {
        return flagHasCricketGameFormat;
      }

    public TypeCricketGameFormat  getCricketGameFormat()
      {
        Debug.Assert(flagHasCricketGameFormat);
        return storeCricketGameFormat;
      }

    public string  getCricketGameFormatAsString()
      {
    ...
    public virtual int extraSportsGameCricketComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsGameCricketComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsGameCricketComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsGameCricketLookup(string field_name)
      {
        JSONValue result = (extraIndex.ContainsKey(field_name) ? extraIndex[field_name] : null);
        return result;
      }
    ...
    public override JSONValue extraSportsGameLookup(string field_name)
      {
        switch (field_name[0])
          {
            case 'C':
                if ((String.Compare(field_name, 1, "ricketGameFormat", 0, 16, false) == 0) && (field_name.Length == 17))
    ...
    public void setCricketGameFormat(TypeCricketGameFormat new_value)
      {
        flagHasCricketGameFormat = true;
        storeCricketGameFormat = new_value;
      }
    public void setCricketGameFormat(string chars)
      {
        TypeCricketGameFormatKnownValues known = stringToCricketGameFormat(chars);
        TypeCricketGameFormat new_value = new TypeCricketGameFormat();
        if (known == TypeCricketGameFormatKnownValues.CricketGameFormat__none)
          {
    ...
    public void setCricketGameFormat(TypeCricketGameFormatKnownValues new_value)
      {
        TypeCricketGameFormat new_full_value = new TypeCricketGameFormat();
        Debug.Assert(new_value != TypeCricketGameFormatKnownValues.CricketGameFormat__none);
        new_full_value.in_known_list = true;
        new_full_value.list_value = new_value;
        setCricketGameFormat(new_full_value);
      }
    public void unsetCricketGameFormat()
      {
        flagHasCricketGameFormat = false;
      }
    ...
    public void setWinningTeamIndex(sbyte new_value)
      {
        ...
        if (new_value < 0)
            throw new Exception("The value for field WinningTeamIndex of SportsGameCricketJSON is less than the lower bound (0) for that field.");
        if (new_value > 1)
            throw new Exception("The value for field WinningTeamIndex of SportsGameCricketJSON is greater than the upper bound (1) for that field.");
    ...
    public void setWinningTeamRunDifference(BigInteger new_value)
      {
        ...
        if (new_value < 1)
            throw new Exception("The value for field WinningTeamRunDifference of SportsGameCricketJSON is less than the lower bound (1) for that field.");
    ...
    public void setWinningTeamWicketDifference(sbyte new_value)
      {
        ...
        if (new_value < 1)
            throw new Exception("The value for field WinningTeamWicketDifference of SportsGameCricketJSON is less than the lower bound (1) for that field.");
        if (new_value > 10)
            throw new Exception("The value for field WinningTeamWicketDifference of SportsGameCricketJSON is greater than the upper bound (10) for that field.");
    ...
    public virtual void extraSportsGameCricketAppendPair(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public virtual void extraSportsGameCricketSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public override void extraSportsGameAppendPair(string key, JSONValue new_component)
      {
        switch (key[0])
          {
            case 'C':
                if ((String.Compare(key, 1, "ricketGameFormat", 0, 16, false) == 0) && (key.Length == 17))
                    {
    ...
    public static new SportsGameCricketJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsGameCricketJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsGameCricket", ignore_extras);
            generator.set_allow_incomplete(allow_incomplete);
            generator.set_allow_unpolished(allow_unpolished);
            if (allow_incomplete || allow_unpolished)
                json_value.write(generator);
    ...
    public static new SportsGameCricketJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsGameCricketJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsGameCricketJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsGameCricket", ignore_extras);
    ...
    public static new SportsGameCricketJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsGameCricketJSON from_text(string text, bool ignore_extras)
      {
        SportsGameCricketJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsGameCricket", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SportsGameCricketJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new SportsGameCricketJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SportsGameCricketJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsGameCricket", ignore_extras);
    ...
    public new abstract class Generator : SportsGameJSON.Generator
      {
    private abstract class FieldGeneratorCricketGameFormat : JSONStringGenerator
          {
            protected FieldGeneratorCricketGameFormat(string what)
              {
                set_what(what);
              }
            protected FieldGeneratorCricketGameFormat()
              {
              }
            ...
            protected abstract void handle_result(TypeCricketGameFormat result);
          };
    private class FieldHoldingGeneratorCricketGameFormat : FieldGeneratorCricketGameFormat
  {
    protected override void handle_result(TypeCricketGameFormat result)
      {
//@@@        Debug.Assert(!have_value);
        have_value = true;
        value = result;
    ...
    public FieldHoldingGeneratorCricketGameFormat(String what)
      {
        have_value = false;
        base.set_what(what);
      }
    ...
    public bool have_value;
    public TypeCricketGameFormat value;
  };
    private class FieldHoldingArrayGeneratorCricketGameFormat : JSONArrayGenerator
  {
    protected class ElementHandler : FieldGeneratorCricketGameFormat
      {
        private FieldHoldingArrayGeneratorCricketGameFormat top;
        ...
        public ElementHandler(FieldHoldingArrayGeneratorCricketGameFormat init_top)
          {
            top = init_top;
          }
      };
    ...
    protected virtual void handle_result(List<TypeCricketGameFormat> result)
      {
      }

    public FieldHoldingArrayGeneratorCricketGameFormat(string what)
      {
        element_handler = new ElementHandler(this);
        have_value = false;
        value = new List<TypeCricketGameFormat>();
        base.set_what(what);
      }
    public FieldHoldingArrayGeneratorCricketGameFormat()
      {
        element_handler = new ElementHandler(this);
        have_value = false;
        value = new List<TypeCricketGameFormat>();
    ...
    public bool have_value;
    public List<TypeCricketGameFormat> value;
  };
        private FieldHoldingGeneratorCricketGameFormat fieldGeneratorCricketGameFormat;
    ...
    private class FieldHoldingArrayGeneratorWinningTeamWicketDifference : JSONHoldingIntegerRangeArrayGenerator
        ...
        protected override void finish()
          {
            if (!(getSportsGameJSONKey().Equals("Cricket")))
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSportsGameCricketAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
            unknownFieldGenerator.field_names.Clear();
            unknownFieldGenerator.field_values.Clear();
            unknownFieldGenerator.index = new Dictionary<string, JSONValue >();
        ...
        protected override void handle_result(SportsGameJSON new_result)
          {
            handle_result((SportsGameCricketJSON )new_result);
          }
        protected void finish(SportsGameCricketJSON result)
          {
        ...
        protected abstract void handle_result(SportsGameCricketJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorCricketGameFormat = new FieldHoldingGeneratorCricketGameFormat("field \"CricketGameFormat\" of the SportsGameCricket class");
            fieldGeneratorInnings = new TypeInningsJSON.HoldingArrayGenerator("field \"Innings\" of the SportsGameCricket class", ignore_extras);
            fieldGeneratorWinningTeamIndex = new FieldHoldingGeneratorWinningTeamIndex("field \"WinningTeamIndex\" of the SportsGameCricket class");
            fieldGeneratorWinningTeamRunDifference = new FieldHoldingGeneratorWinningTeamRunDifference("field \"WinningTeamRunDifference\" of the SportsGameCricket class");
            fieldGeneratorWinningTeamWicketDifference = new FieldHoldingGeneratorWinningTeamWicketDifference("field \"WinningTeamWicketDifference\" of the SportsGameCricket class");
            fieldGeneratorDraw = new JSONHoldingBooleanGenerator("field \"Draw\" of the SportsGameCricket class");
            fieldGeneratorTie = new JSONHoldingBooleanGenerator("field \"Tie\" of the SportsGameCricket class");
            fieldGeneratorTieBreakingMethodUsed = new SportsCricketTieBreakingMethodJSON.HoldingGenerator("field \"TieBreakingMethodUsed\" of the SportsGameCricket class", ignore_extras);
            fieldGeneratorDLSMethod = new JSONHoldingBooleanGenerator("field \"DLSMethod\" of the SportsGameCricket class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
        ...
        public Generator() : base(false)
          {
            fieldGeneratorCricketGameFormat = new FieldHoldingGeneratorCricketGameFormat("field \"CricketGameFormat\" of the SportsGameCricket class");
            fieldGeneratorInnings = new TypeInningsJSON.HoldingArrayGenerator("field \"Innings\" of the SportsGameCricket class", false);
            fieldGeneratorWinningTeamIndex = new FieldHoldingGeneratorWinningTeamIndex("field \"WinningTeamIndex\" of the SportsGameCricket class");
            fieldGeneratorWinningTeamRunDifference = new FieldHoldingGeneratorWinningTeamRunDifference("field \"WinningTeamRunDifference\" of the SportsGameCricket class");
            fieldGeneratorWinningTeamWicketDifference = new FieldHoldingGeneratorWinningTeamWicketDifference("field \"WinningTeamWicketDifference\" of the SportsGameCricket class");
            fieldGeneratorDraw = new JSONHoldingBooleanGenerator("field \"Draw\" of the SportsGameCricket class");
            fieldGeneratorTie = new JSONHoldingBooleanGenerator("field \"Tie\" of the SportsGameCricket class");
            fieldGeneratorTieBreakingMethodUsed = new SportsCricketTieBreakingMethodJSON.HoldingGenerator("field \"TieBreakingMethodUsed\" of the SportsGameCricket class", false);
            fieldGeneratorDLSMethod = new JSONHoldingBooleanGenerator("field \"DLSMethod\" of the SportsGameCricket class");
            unknownFieldGenerator = new UnknownFieldGenerator(false);
            set_what("the SportsGameCricket class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(SportsGameCricketJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public SportsGameCricketJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SportsGameCricketJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<SportsGameCricketJSON>();
        base.set_what(what);
      }
    public HoldingArrayGenerator(bool ignore_extras)
      {
    ...
    public bool have_value;
    public List<SportsGameCricketJSON> value;
  };
  };
