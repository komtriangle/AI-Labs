/* file "SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON.cs" */
...
public class SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON : JSONBase
  {
    ...
    public SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON()
      {
    ...
    public virtual int extraSportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerLookup(string field_name)
      {
    ...
    public void setRank(BigInteger new_value)
      {
        flagHasRank = true;
        if (new_value < 1)
            throw new Exception("The value for field Rank of SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON is less than the lower bound (1) for that field.");
        storeRank = new_value;
      }
    ...
    public virtual void extraSportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsEventSchedulesAndResultsInstanceMedalWinner", ignore_extras);
    ...
    public static SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsEventSchedulesAndResultsInstanceMedalWinner", ignore_extras);
    ...
    public static SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON from_text(string text, bool ignore_extras)
      {
        SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsEventSchedulesAndResultsInstanceMedalWinner", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsEventSchedulesAndResultsInstanceMedalWinner", ignore_extras);
    ...
    private class FieldHoldingArrayGeneratorRank : JSONHoldingIntegerLowerBoundOnlyArrayGenerator
        ...
        protected override void finish()
          {
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON result)
          {
        ...
        protected abstract void handle_result(SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON new_result);
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SportsOlympicsEventSchedulesAndResultsInstanceMedalWinnerJSON> value;
  };
  };
