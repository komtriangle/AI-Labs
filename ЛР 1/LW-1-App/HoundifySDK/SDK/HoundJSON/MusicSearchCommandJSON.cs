/* file "MusicSearchCommandJSON.cs" */
...
public class MusicSearchCommandJSON : MusicCommandJSON
  {
    private bool flagHasNativeData;
    private MusicSearchCommandNativeDataJSON  storeNativeData;
    ...
    public new MusicSearchCommandNativeDataJSON   getNativeData()
      {
    ...
    public virtual int extraMusicSearchCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraMusicSearchCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraMusicSearchCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraMusicSearchCommandLookup(string field_name)
      {
    ...
    public virtual void extraMusicSearchCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraMusicSearchCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new MusicSearchCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        MusicSearchCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MusicSearchCommand", ignore_extras);
    ...
    public static new MusicSearchCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new MusicSearchCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        MusicSearchCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MusicSearchCommand", ignore_extras);
    ...
    public static new MusicSearchCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new MusicSearchCommandJSON from_text(string text, bool ignore_extras)
      {
        MusicSearchCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MusicSearchCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for MusicSearchCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new MusicSearchCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        MusicSearchCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MusicSearchCommand", ignore_extras);
    ...
    public new abstract class Generator : MusicCommandJSON.Generator
      {
        private MusicSearchCommandNativeDataJSON.HoldingGenerator fieldGeneratorNativeData;
        ...
        protected override void finish()
          {
            if (!(getMusicCommandJSONKey().Equals("MusicSearchCommand")))
                throw new Exception("The key field has a value other than `MusicSearchCommand'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraMusicSearchCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(MusicSearchCommandJSON result)
          {
        ...
        protected abstract void handle_result(MusicSearchCommandJSON new_result);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(MusicSearchCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public MusicSearchCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<MusicSearchCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<MusicSearchCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<MusicSearchCommandJSON> value;
  };
  };
