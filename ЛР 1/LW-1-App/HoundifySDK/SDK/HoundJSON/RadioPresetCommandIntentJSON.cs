/* file "RadioPresetCommandIntentJSON.cs" */
...
public class RadioPresetCommandIntentJSON : RadioCommandIntentJSON
  {
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field PresetNumber of RadioPresetCommandIntentJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field PresetNumber of RadioPresetCommandIntentJSON is not an integer.");
              }
    ...
    public RadioPresetCommandIntentJSON()
      {
    ...
    public virtual int extraRadioPresetCommandIntentComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraRadioPresetCommandIntentComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraRadioPresetCommandIntentComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraRadioPresetCommandIntentLookup(string field_name)
      {
    ...
    public void setPresetNumber(sbyte new_value)
      {
        ...
        if (new_value < 1)
            throw new Exception("The value for field PresetNumber of RadioPresetCommandIntentJSON is less than the lower bound (1) for that field.");
        if (new_value > 18)
            throw new Exception("The value for field PresetNumber of RadioPresetCommandIntentJSON is greater than the upper bound (18) for that field.");
    ...
    public virtual void extraRadioPresetCommandIntentAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraRadioPresetCommandIntentSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new RadioPresetCommandIntentJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RadioPresetCommandIntentJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RadioPresetCommandIntent", ignore_extras);
    ...
    public static new RadioPresetCommandIntentJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RadioPresetCommandIntentJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RadioPresetCommandIntentJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RadioPresetCommandIntent", ignore_extras);
    ...
    public static new RadioPresetCommandIntentJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RadioPresetCommandIntentJSON from_text(string text, bool ignore_extras)
      {
        RadioPresetCommandIntentJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RadioPresetCommandIntent", ignore_extras);
            JSONParse.parse_json_value(text, "Text for RadioPresetCommandIntentJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new RadioPresetCommandIntentJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        RadioPresetCommandIntentJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RadioPresetCommandIntent", ignore_extras);
    ...
    private class FieldHoldingArrayGeneratorPresetNumber : JSONHoldingIntegerRangeArrayGenerator
        ...
        protected override void finish()
          {
            if (!(getRadioCommandIntentJSONKey().Equals("RadioPreset")))
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraRadioPresetCommandIntentAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(RadioPresetCommandIntentJSON result)
          {
        ...
        protected abstract void handle_result(RadioPresetCommandIntentJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorPresetNumber = new FieldHoldingGeneratorPresetNumber("field \"PresetNumber\" of the RadioPresetCommandIntent class");
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(RadioPresetCommandIntentJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public RadioPresetCommandIntentJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<RadioPresetCommandIntentJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<RadioPresetCommandIntentJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<RadioPresetCommandIntentJSON> value;
  };
  };
