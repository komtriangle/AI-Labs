/* file "DisconnectOAuth2CommandJSON.cs" */
...
public class DisconnectOAuth2CommandJSON : OAuth2CommandJSON
  {
    ...
    public static TypeStatusKnownValues  stringToStatus(string chars)
      {
        switch (chars[0])
          {
            case 'd':
                if ((String.Compare(chars, 1, "isconnected", 0, 11, false) == 0) && (chars.Length == 12))
                    return TypeStatusKnownValues.Status_disconnected;
                break;
            case 'f':
    ...
    public static string  stringFromStatus(TypeStatusKnownValues the_enum)
      {
        switch (the_enum)
          {
            case TypeStatusKnownValues.Status_disconnected:
                return "disconnected";
    ...
    private JSONValue  extraStatusToJSON()
      {
        ...
        switch (storeStatus.list_value)
          {
            case TypeStatusKnownValues.Status_disconnected:
                generated_string_Status = new JSONStringValue("disconnected");
                break;
            case TypeStatusKnownValues.Status_failed:
    ...
    private void  fromJSONStatus(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field Status of DisconnectOAuth2CommandJSON is not a string.");
        TypeStatus the_open_enum = new TypeStatus();
        switch (json_string.getData()[0])
          {
            case 'd':
                if ((String.Compare(json_string.getData(), 1, "isconnected", 0, 11, false) == 0) && (json_string.getData().Length == 12))
                      {
                        the_open_enum.in_known_list = true;
                        the_open_enum.list_value = TypeStatusKnownValues.Status_disconnected;
    ...
    public DisconnectOAuth2CommandJSON()
      {
    ...
    public override string  getOAuth2CommandKind()
      {
        return "DisconnectOAuth2Command";
      }
    ...
    public virtual int extraDisconnectOAuth2CommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraDisconnectOAuth2CommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraDisconnectOAuth2CommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraDisconnectOAuth2CommandLookup(string field_name)
      {
    ...
    public override int extraOAuth2CommandComponentCount()
      {
        ...
        if (flagHasStatus)
            ++result;
        result += extraDisconnectOAuth2CommandComponentCount();
        return result;
      }
    public override string extraOAuth2CommandComponentKey(int component_num)
      {
        ...
        return extraDisconnectOAuth2CommandComponentKey(remainder);
      }
    public override JSONValue extraOAuth2CommandComponentValue(int component_num)
      {
        ...
        return extraDisconnectOAuth2CommandComponentValue(remainder);
      }
    public override JSONValue extraOAuth2CommandLookup(string field_name)
      {
        ...
        return extraDisconnectOAuth2CommandLookup(field_name);
      }
    ...
    public virtual void extraDisconnectOAuth2CommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraDisconnectOAuth2CommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraDisconnectOAuth2CommandLookup(key);
        if (old_field == null)
          {
            extraDisconnectOAuth2CommandAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraOAuth2CommandSetField(string key, JSONValue new_component)
      {
        ...
        extraDisconnectOAuth2CommandSetField(key, new_component);
      }
            ...
            if (storeStatus.in_known_list)
              {
                switch (storeStatus.list_value)
                  {
                    case TypeStatusKnownValues.Status_disconnected:
                        handler.string_value("disconnected");
                        break;
                    case TypeStatusKnownValues.Status_failed:
    ...
    public static new DisconnectOAuth2CommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        DisconnectOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DisconnectOAuth2Command", ignore_extras);
    ...
    public static new DisconnectOAuth2CommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new DisconnectOAuth2CommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        DisconnectOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DisconnectOAuth2Command", ignore_extras);
    ...
    public static new DisconnectOAuth2CommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new DisconnectOAuth2CommandJSON from_text(string text, bool ignore_extras)
      {
        DisconnectOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DisconnectOAuth2Command", ignore_extras);
            JSONParse.parse_json_value(text, "Text for DisconnectOAuth2CommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new DisconnectOAuth2CommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        DisconnectOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DisconnectOAuth2Command", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorStatus : JSONArrayGenerator
  {
    ...
    public List<TypeStatus> value;
        ...
        protected override void finish()
          {
            if (!(getOAuth2CommandJSONKey().Equals("DisconnectOAuth2Command")))
                throw new Exception("The key field has a value other than `DisconnectOAuth2Command'.");
            DisconnectOAuth2CommandJSON result = new DisconnectOAuth2CommandJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraDisconnectOAuth2CommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(OAuth2CommandJSON new_result)
          {
            handle_result((DisconnectOAuth2CommandJSON )new_result);
          }
        protected void finish(DisconnectOAuth2CommandJSON result)
          {
        ...
        protected abstract void handle_result(DisconnectOAuth2CommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorServiceType = new OAuth2ServiceTypeJSON.HoldingGenerator("field \"ServiceType\" of the DisconnectOAuth2Command class", ignore_extras);
            fieldGeneratorStatus = new FieldHoldingGeneratorStatus("field \"Status\" of the DisconnectOAuth2Command class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the DisconnectOAuth2Command class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorServiceType = new OAuth2ServiceTypeJSON.HoldingGenerator("field \"ServiceType\" of the DisconnectOAuth2Command class", false);
            fieldGeneratorStatus = new FieldHoldingGeneratorStatus("field \"Status\" of the DisconnectOAuth2Command class");
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(DisconnectOAuth2CommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public DisconnectOAuth2CommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<DisconnectOAuth2CommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<DisconnectOAuth2CommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<DisconnectOAuth2CommandJSON> value;
  };
  };
