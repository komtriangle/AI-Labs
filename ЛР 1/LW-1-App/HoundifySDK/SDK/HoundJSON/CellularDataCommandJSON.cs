/* file "CellularDataCommandJSON.cs" */
...
public class CellularDataCommandJSON : DeviceControlCommandJSON
  {
    ...
    public static TypeCommandType  stringToCommandType(string chars)
      {
        switch (chars[0])
          {
            case 'C':
                if ((String.Compare(chars, 1, "heckDataState", 0, 13, false) == 0) && (chars.Length == 14))
                    return TypeCommandType.CommandType_CheckDataState;
                break;
            case 'T':
                switch (chars[1])
                  {
                    case 'o':
                        if ((String.Compare(chars, 2, "ggleDataState", 0, 13, false) == 0) && (chars.Length == 15))
                            return TypeCommandType.CommandType_ToggleDataState;
                        break;
                    case 'u':
                        if (String.Compare(chars, 2, "rnDataO", 0, 7, false) == 0)
                          {
                            switch (chars[9])
                              {
                                case 'f':
                                    if ((String.Compare(chars, 10, "f", 0, 1, false) == 0) && (chars.Length == 11))
                                        return TypeCommandType.CommandType_TurnDataOff;
                                    break;
                                case 'n':
                                    if (chars.Length == 10)
                                        return TypeCommandType.CommandType_TurnDataOn;
                                    break;
                                default:
                                    break;
                              }
    ...
    public static string  stringFromCommandType(TypeCommandType the_enum)
      {
        switch (the_enum)
          {
            case TypeCommandType.CommandType_TurnDataOn:
                return "TurnDataOn";
            case TypeCommandType.CommandType_TurnDataOff:
                return "TurnDataOff";
            case TypeCommandType.CommandType_CheckDataState:
                return "CheckDataState";
            case TypeCommandType.CommandType_ToggleDataState:
    ...
    private void  fromJSONCommandType(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field CommandType of CellularDataCommandJSON is not a string.");
        TypeCommandType the_enum;
        switch (json_string.getData()[0])
          {
            case 'C':
                if ((String.Compare(json_string.getData(), 1, "heckDataState", 0, 13, false) == 0) && (json_string.getData().Length == 14))
                      {
                        the_enum = TypeCommandType.CommandType_CheckDataState;
                        goto enum_is_done;
                      }
                break;
            case 'T':
                switch (json_string.getData()[1])
                  {
                    case 'o':
                        if ((String.Compare(json_string.getData(), 2, "ggleDataState", 0, 13, false) == 0) && (json_string.getData().Length == 15))
                              {
                                the_enum = TypeCommandType.CommandType_ToggleDataState;
                                goto enum_is_done;
                              }
                        break;
                    case 'u':
                        if (String.Compare(json_string.getData(), 2, "rnDataO", 0, 7, false) == 0)
                          {
                            switch (json_string.getData()[9])
                              {
                                case 'f':
                                    if ((String.Compare(json_string.getData(), 10, "f", 0, 1, false) == 0) && (json_string.getData().Length == 11))
                                          {
                                            the_enum = TypeCommandType.CommandType_TurnDataOff;
                                            goto enum_is_done;
                                          }
                                    break;
                                case 'n':
                                    if (json_string.getData().Length == 10)
                                          {
                                            the_enum = TypeCommandType.CommandType_TurnDataOn;
                                            goto enum_is_done;
                                          }
                                    break;
                                default:
        ...
        throw new Exception("The value for field CommandType of CellularDataCommandJSON is not one of the legal strings.");
      enum_is_done:;
        setCommandType(the_enum);
      }


    public CellularDataCommandJSON()
      {
    ...
    public virtual int extraCellularDataCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraCellularDataCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraCellularDataCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraCellularDataCommandLookup(string field_name)
      {
    ...
    public virtual void extraCellularDataCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraCellularDataCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new CellularDataCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CellularDataCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CellularDataCommand", ignore_extras);
    ...
    public static new CellularDataCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new CellularDataCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CellularDataCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CellularDataCommand", ignore_extras);
    ...
    public static new CellularDataCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new CellularDataCommandJSON from_text(string text, bool ignore_extras)
      {
        CellularDataCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CellularDataCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for CellularDataCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new CellularDataCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        CellularDataCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CellularDataCommand", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorCommandType : JSONArrayGenerator
  {
    ...
    public List<TypeCommandType> value;
        ...
        protected override void finish()
          {
            if (!(getDeviceControlCommandJSONKey().Equals("CellularDataCommand")))
                throw new Exception("The key field has a value other than `CellularDataCommand'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraCellularDataCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(CellularDataCommandJSON result)
          {
        ...
        protected abstract void handle_result(CellularDataCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorCommandType = new FieldHoldingGeneratorCommandType("field \"CommandType\" of the CellularDataCommand class");
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(CellularDataCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public CellularDataCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<CellularDataCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<CellularDataCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<CellularDataCommandJSON> value;
  };
  };
