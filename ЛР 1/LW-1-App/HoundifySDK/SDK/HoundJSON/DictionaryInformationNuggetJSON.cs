/* file "DictionaryInformationNuggetJSON.cs" */
...
public class DictionaryInformationNuggetJSON : InformationNuggetJSON
  {
    public class TypeNativeDataJSON : JSONBase
      {
        public class TypeRequestKindListJSON : JSONBase
          {
            public enum TypeRequestKindKnownValues
              {
            ...
            public struct TypeRequestKind
              {
                public bool in_known_list;
                public string string_value;
                public TypeRequestKindKnownValues list_value;
              };

            public static TypeRequestKindKnownValues  stringToRequestKind(string chars)
              {
                switch (chars[0])
                  {
                    case 'A':
                        if ((String.Compare(chars, 1, "ntonym", 0, 6, false) == 0) && (chars.Length == 7))
                            return TypeRequestKindKnownValues.RequestKind_Antonym;
                        break;
                    case 'D':
                        if ((String.Compare(chars, 1, "efinition", 0, 9, false) == 0) && (chars.Length == 10))
                            return TypeRequestKindKnownValues.RequestKind_Definition;
                        break;
                    case 'S':
                        switch (chars[1])
                          {
                            case 'p':
                                if (String.Compare(chars, 2, "elling", 0, 6, false) == 0)
                                  {
                                    if (chars.Length == 8)
                                      {
                                        return TypeRequestKindKnownValues.RequestKind_Spelling;
                                      }
                                    switch (chars[8])
                                      {
                                        case 'C':
                                            if ((String.Compare(chars, 9, "onfirm", 0, 6, false) == 0) && (chars.Length == 15))
                                                return TypeRequestKindKnownValues.RequestKind_SpellingConfirm;
                                            break;
                                        default:
                                            break;
                                      }
                                ...
                                break;
                            case 'y':
                                if ((String.Compare(chars, 2, "nonym", 0, 5, false) == 0) && (chars.Length == 7))
                                    return TypeRequestKindKnownValues.RequestKind_Synonym;
                                break;
                            default:
                                break;
                          }
                ...
                return TypeRequestKindKnownValues.RequestKind__none;
              }

            public static string  stringFromRequestKind(TypeRequestKindKnownValues the_enum)
              {
                switch (the_enum)
                  {
                    case TypeRequestKindKnownValues.RequestKind_Definition:
                        return "Definition";
                    case TypeRequestKindKnownValues.RequestKind_Synonym:
                        return "Synonym";
                    case TypeRequestKindKnownValues.RequestKind_Antonym:
                        return "Antonym";
                    case TypeRequestKindKnownValues.RequestKind_Spelling:
                        return "Spelling";
                    case TypeRequestKindKnownValues.RequestKind_SpellingConfirm:
            ...
            private TypeRequestKind storeRequestKind;
            ...
            private void  fromJSONRequestKind(JSONValue json_value, bool ignore_extras)
              {
                ...
                if (json_string == null)
                    throw new Exception("The value for field RequestKind of TypeRequestKindListJSON is not a string.");
                TypeRequestKind the_open_enum = new TypeRequestKind();
                switch (json_string.getData()[0])
                  {
                    case 'A':
                        if ((String.Compare(json_string.getData(), 1, "ntonym", 0, 6, false) == 0) && (json_string.getData().Length == 7))
                              {
                                the_open_enum.in_known_list = true;
                                the_open_enum.list_value = TypeRequestKindKnownValues.RequestKind_Antonym;
                                goto open_enum_is_done;
                              }
                        break;
                    case 'D':
                        if ((String.Compare(json_string.getData(), 1, "efinition", 0, 9, false) == 0) && (json_string.getData().Length == 10))
                              {
                                the_open_enum.in_known_list = true;
                                the_open_enum.list_value = TypeRequestKindKnownValues.RequestKind_Definition;
                                goto open_enum_is_done;
                              }
                        break;
                    case 'S':
                        switch (json_string.getData()[1])
                          {
                            case 'p':
                                if (String.Compare(json_string.getData(), 2, "elling", 0, 6, false) == 0)
                                  {
                                    if (json_string.getData().Length == 8)
                                      {
                                          {
                                            the_open_enum.in_known_list = true;
                                            the_open_enum.list_value = TypeRequestKindKnownValues.RequestKind_Spelling;
                                            goto open_enum_is_done;
                                          }
                                      }
                                    switch (json_string.getData()[8])
                                      {
                                        case 'C':
                                            if ((String.Compare(json_string.getData(), 9, "onfirm", 0, 6, false) == 0) && (json_string.getData().Length == 15))
                                                  {
                                                    the_open_enum.in_known_list = true;
                                                    the_open_enum.list_value = TypeRequestKindKnownValues.RequestKind_SpellingConfirm;
                                                    goto open_enum_is_done;
                                                  }
                                            break;
                                        default:
                                ...
                                break;
                            case 'y':
                                if ((String.Compare(json_string.getData(), 2, "nonym", 0, 5, false) == 0) && (json_string.getData().Length == 7))
                                      {
                                        the_open_enum.in_known_list = true;
                                        the_open_enum.list_value = TypeRequestKindKnownValues.RequestKind_Synonym;
                                        goto open_enum_is_done;
                                      }
                                break;
                            default:
            ...
            public TypeRequestKind  getRequestKind()
              {
            ...
            public void setRequestKind(TypeRequestKind new_value)
              {
            ...
            public void setRequestKind(string chars)
              {
                ...
                TypeRequestKind new_value = new TypeRequestKind();
                if (known == TypeRequestKindKnownValues.RequestKind__none)
                  {
            ...
            public void setRequestKind(TypeRequestKindKnownValues new_value)
              {
                TypeRequestKind new_full_value = new TypeRequestKind();
                Debug.Assert(new_value != TypeRequestKindKnownValues.RequestKind__none);
            ...
            public static TypeRequestKindListJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
          {
            ...
            public abstract class Generator : JSONObjectGenerator
              {
            private abstract class FieldGeneratorRequestKind : JSONStringGenerator
                  {
                    protected FieldGeneratorRequestKind(string what)
                      {
                        set_what(what);
                      }
                    protected FieldGeneratorRequestKind()
                      {
                      }
                    ...
                    protected abstract void handle_result(TypeRequestKind result);
                  };
            private class FieldHoldingGeneratorRequestKind : FieldGeneratorRequestKind
          {
            protected override void handle_result(TypeRequestKind result)
              {
        //@@@        Debug.Assert(!have_value);
            ...
            public FieldHoldingGeneratorRequestKind(String what)
              {
                have_value = false;
                base.set_what(what);
              }
            ...
            public TypeRequestKind value;
          };
            private class FieldHoldingArrayGeneratorRequestKind : JSONArrayGenerator
          {
            protected class ElementHandler : FieldGeneratorRequestKind
              {
                private FieldHoldingArrayGeneratorRequestKind top;
                ...
                public ElementHandler(FieldHoldingArrayGeneratorRequestKind init_top)
                  {
                    top = init_top;
                  }
              };
            ...
            protected virtual void handle_result(List<TypeRequestKind> result)
              {
              }

            public FieldHoldingArrayGeneratorRequestKind(string what)
              {
                element_handler = new ElementHandler(this);
                have_value = false;
                value = new List<TypeRequestKind>();
                base.set_what(what);
              }
            public FieldHoldingArrayGeneratorRequestKind()
              {
                element_handler = new ElementHandler(this);
                have_value = false;
                value = new List<TypeRequestKind>();
            ...
            public bool have_value;
            public List<TypeRequestKind> value;
          };
                private FieldHoldingGeneratorRequestKind fieldGeneratorRequestKind;
                ...
                public Generator(bool ignore_extras)
                  {
                    fieldGeneratorRequestKind = new FieldHoldingGeneratorRequestKind("field \"RequestKind\" of the TypeRequestKindList class");
        ...
        public class TypePOSListJSON : JSONBase
          {
            public enum TypePOSKnownValues
              {
                POS_all,
                POS_noun,
                POS_verb,
            ...
            public struct TypePOS
              {
                public bool in_known_list;
                public string string_value;
                public TypePOSKnownValues list_value;
              };

            public static TypePOSKnownValues  stringToPOS(string chars)
              {
                switch (chars[0])
                  {
                    case 'a':
                        switch (chars[1])
                          {
                                ...
                                switch (chars[2])
                                  {
                                    case 'j':
                                        if ((String.Compare(chars, 3, "ective", 0, 6, false) == 0) && (chars.Length == 9))
                                            return TypePOSKnownValues.POS_adjective;
                                        break;
                                    case 'v':
                                        if ((String.Compare(chars, 3, "erb", 0, 3, false) == 0) && (chars.Length == 6))
                                            return TypePOSKnownValues.POS_adverb;
                                        break;
                                    default:
                                        break;
                                  }
                            ...
                            case 'l':
                                if ((String.Compare(chars, 2, "l", 0, 1, false) == 0) && (chars.Length == 3))
                                    return TypePOSKnownValues.POS_all;
                                break;
                            case 'r':
                                if ((String.Compare(chars, 2, "ticle", 0, 5, false) == 0) && (chars.Length == 7))
                                    return TypePOSKnownValues.POS_article;
                                break;
                            default:
                                break;
                          }
                    ...
                    case 'c':
                        if ((String.Compare(chars, 1, "onjunction", 0, 10, false) == 0) && (chars.Length == 11))
                            return TypePOSKnownValues.POS_conjunction;
                        break;
                    case 'n':
                        if ((String.Compare(chars, 1, "oun", 0, 3, false) == 0) && (chars.Length == 4))
                            return TypePOSKnownValues.POS_noun;
                        break;
                    case 'p':
                            ...
                            switch (chars[2])
                              {
                                case 'e':
                                    if ((String.Compare(chars, 3, "position", 0, 8, false) == 0) && (chars.Length == 11))
                                        return TypePOSKnownValues.POS_preposition;
                                    break;
                                case 'o':
                                    if ((String.Compare(chars, 3, "noun", 0, 4, false) == 0) && (chars.Length == 7))
                                        return TypePOSKnownValues.POS_pronoun;
                                    break;
                                default:
                                    break;
                              }
                    ...
                    case 's':
                        if ((String.Compare(chars, 1, "lang", 0, 4, false) == 0) && (chars.Length == 5))
                            return TypePOSKnownValues.POS_slang;
                        break;
                    case 'v':
                        if ((String.Compare(chars, 1, "erb", 0, 3, false) == 0) && (chars.Length == 4))
                            return TypePOSKnownValues.POS_verb;
                        break;
                    default:
                        break;
                  }
                return TypePOSKnownValues.POS__none;
              }

            public static string  stringFromPOS(TypePOSKnownValues the_enum)
              {
                switch (the_enum)
                  {
                    case TypePOSKnownValues.POS_all:
                        return "all";
                    case TypePOSKnownValues.POS_noun:
                        return "noun";
                    case TypePOSKnownValues.POS_verb:
                        return "verb";
                    case TypePOSKnownValues.POS_adjective:
                        return "adjective";
                    case TypePOSKnownValues.POS_adverb:
                        return "adverb";
                    case TypePOSKnownValues.POS_article:
                        return "article";
                    case TypePOSKnownValues.POS_preposition:
                        return "preposition";
                    case TypePOSKnownValues.POS_pronoun:
                        return "pronoun";
                    case TypePOSKnownValues.POS_slang:
                        return "slang";
                    case TypePOSKnownValues.POS_conjunction:
                        return "conjunction";
                    default:
                        Debug.Assert(false);
                        return null;
            ...
            private void  fromJSONPOS(JSONValue json_value, bool ignore_extras)
              {
                ...
                JSONStringValue json_string = json_value.string_value();
                if (json_string == null)
                    throw new Exception("The value for field POS of TypePOSListJSON is not a string.");
                TypePOS the_open_enum = new TypePOS();
                switch (json_string.getData()[0])
                  {
                    case 'a':
                        switch (json_string.getData()[1])
                          {
                                ...
                                switch (json_string.getData()[2])
                                  {
                                    case 'j':
                                        if ((String.Compare(json_string.getData(), 3, "ective", 0, 6, false) == 0) && (json_string.getData().Length == 9))
                                              {
                                                the_open_enum.in_known_list = true;
                                                the_open_enum.list_value = TypePOSKnownValues.POS_adjective;
                                                goto open_enum_is_done;
                                              }
                                        break;
                                    case 'v':
                                        if ((String.Compare(json_string.getData(), 3, "erb", 0, 3, false) == 0) && (json_string.getData().Length == 6))
                                              {
                                                the_open_enum.in_known_list = true;
                                                the_open_enum.list_value = TypePOSKnownValues.POS_adverb;
                                                goto open_enum_is_done;
                                              }
                                        break;
                                    default:
                            ...
                            case 'l':
                                if ((String.Compare(json_string.getData(), 2, "l", 0, 1, false) == 0) && (json_string.getData().Length == 3))
                                      {
                                        the_open_enum.in_known_list = true;
                                        the_open_enum.list_value = TypePOSKnownValues.POS_all;
                                        goto open_enum_is_done;
                                      }
                                break;
                            case 'r':
                                if ((String.Compare(json_string.getData(), 2, "ticle", 0, 5, false) == 0) && (json_string.getData().Length == 7))
                                      {
                                        the_open_enum.in_known_list = true;
                                        the_open_enum.list_value = TypePOSKnownValues.POS_article;
                                        goto open_enum_is_done;
                                      }
                                break;
                            default:
                    ...
                    case 'c':
                        if ((String.Compare(json_string.getData(), 1, "onjunction", 0, 10, false) == 0) && (json_string.getData().Length == 11))
                              {
                                the_open_enum.in_known_list = true;
                                the_open_enum.list_value = TypePOSKnownValues.POS_conjunction;
                                goto open_enum_is_done;
                              }
                        break;
                    case 'n':
                        if ((String.Compare(json_string.getData(), 1, "oun", 0, 3, false) == 0) && (json_string.getData().Length == 4))
                              {
                                the_open_enum.in_known_list = true;
                                the_open_enum.list_value = TypePOSKnownValues.POS_noun;
                                goto open_enum_is_done;
                              }
                        break;
                    case 'p':
                            ...
                            switch (json_string.getData()[2])
                              {
                                case 'e':
                                    if ((String.Compare(json_string.getData(), 3, "position", 0, 8, false) == 0) && (json_string.getData().Length == 11))
                                          {
                                            the_open_enum.in_known_list = true;
                                            the_open_enum.list_value = TypePOSKnownValues.POS_preposition;
                                            goto open_enum_is_done;
                                          }
                                    break;
                                case 'o':
                                    if ((String.Compare(json_string.getData(), 3, "noun", 0, 4, false) == 0) && (json_string.getData().Length == 7))
                                          {
                                            the_open_enum.in_known_list = true;
                                            the_open_enum.list_value = TypePOSKnownValues.POS_pronoun;
                                            goto open_enum_is_done;
                                          }
                                    break;
                                default:
                    ...
                    case 's':
                        if ((String.Compare(json_string.getData(), 1, "lang", 0, 4, false) == 0) && (json_string.getData().Length == 5))
                              {
                                the_open_enum.in_known_list = true;
                                the_open_enum.list_value = TypePOSKnownValues.POS_slang;
                                goto open_enum_is_done;
                              }
                        break;
                    case 'v':
                        if ((String.Compare(json_string.getData(), 1, "erb", 0, 3, false) == 0) && (json_string.getData().Length == 4))
                              {
                                the_open_enum.in_known_list = true;
                                the_open_enum.list_value = TypePOSKnownValues.POS_verb;
                                goto open_enum_is_done;
                              }
                        break;
                    default:
            ...
            public void setPOS(TypePOS new_value)
              {
                flagHasPOS = true;
                storePOS = new_value;
              }
            public void setPOS(string chars)
              {
                ...
                TypePOS new_value = new TypePOS();
                if (known == TypePOSKnownValues.POS__none)
                  {
                    new_value.in_known_list = false;
                    new_value.string_value = chars;
                  }
            ...
            public void setPOS(TypePOSKnownValues new_value)
              {
                TypePOS new_full_value = new TypePOS();
                Debug.Assert(new_value != TypePOSKnownValues.POS__none);
                new_full_value.in_known_list = true;
                new_full_value.list_value = new_value;
            ...
            public static TypePOSListJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
          {
            ...
            public abstract class Generator : JSONObjectGenerator
              {
            private abstract class FieldGeneratorPOS : JSONStringGenerator
                  {
                    protected FieldGeneratorPOS(string what)
                      {
                        set_what(what);
                      }
                    protected FieldGeneratorPOS()
                      {
                      }
                    protected override void handle_result(string result)
                      {
                    ...
                    protected abstract void handle_result(TypePOS result);
                  };
            private class FieldHoldingGeneratorPOS : FieldGeneratorPOS
          {
            protected override void handle_result(TypePOS result)
              {
        //@@@        Debug.Assert(!have_value);
                have_value = true;
                value = result;
            ...
            public FieldHoldingGeneratorPOS(String what)
              {
                have_value = false;
                base.set_what(what);
              }
            ...
            public bool have_value;
            public TypePOS value;
          };
            private class FieldHoldingArrayGeneratorPOS : JSONArrayGenerator
          {
            protected class ElementHandler : FieldGeneratorPOS
              {
                private FieldHoldingArrayGeneratorPOS top;
                ...
                public ElementHandler(FieldHoldingArrayGeneratorPOS init_top)
                  {
                    top = init_top;
                  }
              };
            ...
            protected virtual void handle_result(List<TypePOS> result)
              {
              }

            public FieldHoldingArrayGeneratorPOS(string what)
              {
                element_handler = new ElementHandler(this);
                have_value = false;
                value = new List<TypePOS>();
                base.set_what(what);
              }
            public FieldHoldingArrayGeneratorPOS()
              {
                element_handler = new ElementHandler(this);
                have_value = false;
                value = new List<TypePOS>();
            ...
            public bool have_value;
            public List<TypePOS> value;
          };
                private FieldHoldingGeneratorPOS fieldGeneratorPOS;
                ...
                public Generator(bool ignore_extras)
                  {
                    fieldGeneratorPOS = new FieldHoldingGeneratorPOS("field \"POS\" of the TypePOSList class");
    ...
    private void  fromJSONNativeData(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONArrayValue json_array1 = json_value.array_value();
        if (json_array1 == null)
            throw new Exception("The value for field NativeData of DictionaryInformationNuggetJSON is not an array.");
        int count1 = json_array1.componentCount();
        if (count1 < 1)
            throw new Exception("The value for field NativeData of DictionaryInformationNuggetJSON has too few elements.");
    ...
    public DictionaryInformationNuggetJSON()
      {
    ...
    public static new DictionaryInformationNuggetJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        DictionaryInformationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DictionaryInformationNugget", ignore_extras);
            generator.set_allow_incomplete(allow_incomplete);
            generator.set_allow_unpolished(allow_unpolished);
            if (allow_incomplete || allow_unpolished)
                json_value.write(generator);
    ...
    public static new DictionaryInformationNuggetJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new DictionaryInformationNuggetJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        DictionaryInformationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DictionaryInformationNugget", ignore_extras);
    ...
    public static new DictionaryInformationNuggetJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new DictionaryInformationNuggetJSON from_text(string text, bool ignore_extras)
      {
        DictionaryInformationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DictionaryInformationNugget", ignore_extras);
            JSONParse.parse_json_value(text, "Text for DictionaryInformationNuggetJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new DictionaryInformationNuggetJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        DictionaryInformationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DictionaryInformationNugget", ignore_extras);
    ...
    public new abstract class Generator : InformationNuggetJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getInformationNuggetJSONKey().Equals("Dictionary")))
                throw new Exception("The key field has a value other than `Dictionary'.");
            DictionaryInformationNuggetJSON result = new DictionaryInformationNuggetJSON();
            Debug.Assert(result != null);
            finish(result);
            handle_result(result);
          }
        protected override void handle_result(InformationNuggetJSON new_result)
          {
            handle_result((DictionaryInformationNuggetJSON )new_result);
          }
        protected void finish(DictionaryInformationNuggetJSON result)
          {
        ...
        protected abstract void handle_result(DictionaryInformationNuggetJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingArrayGenerator("field \"NativeData\" of the DictionaryInformationNugget class", ignore_extras);
            set_what("the DictionaryInformationNugget class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingArrayGenerator("field \"NativeData\" of the DictionaryInformationNugget class", false);
            set_what("the DictionaryInformationNugget class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(DictionaryInformationNuggetJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public DictionaryInformationNuggetJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<DictionaryInformationNuggetJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<DictionaryInformationNuggetJSON>();
        base.set_what(what);
      }
    public HoldingArrayGenerator(bool ignore_extras)
      {
    ...
    public bool have_value;
    public List<DictionaryInformationNuggetJSON> value;
  };
  };
