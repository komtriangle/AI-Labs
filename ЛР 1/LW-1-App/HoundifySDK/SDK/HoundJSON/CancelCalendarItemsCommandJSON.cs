    ...
    private void  fromJSONAttendees(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONArrayValue json_array1 = json_value.array_value();
        if (json_array1 == null)
            throw new Exception("The value for field Attendees of CancelCalendarItemsCommandJSON is not an array.");
        int count1 = json_array1.componentCount();
        List< string > vector_Attendees1 = new List< string >(count1);
        for (int num1 = 0; num1 < count1; ++num1)
          {
            JSONStringValue json_string = json_array1.component(num1).string_value();
            if (json_string == null)
                throw new Exception("The value for an element of field Attendees of CancelCalendarItemsCommandJSON is not a string.");
            vector_Attendees1.Add(json_string.getData());
          }
        initAttendees();
    ...
    private void  fromJSONSelfAttendeeStatus(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field SelfAttendeeStatus of CancelCalendarItemsCommandJSON is not a string.");
        TypeSelfAttendeeStatus the_enum;
        switch (json_string.getData()[0])
          {
            case 'A':
        ...
        throw new Exception("The value for field SelfAttendeeStatus of CancelCalendarItemsCommandJSON is not one of the legal strings.");
      enum_is_done:;
        setSelfAttendeeStatus(the_enum);
      }
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            ...
            fieldGeneratorLocationSpecifier = new CalendarLocationJSON.HoldingGenerator("field \"LocationSpecifier\" of the CancelCalendarItemsCommand class", ignore_extras);
            ...
            fieldGeneratorAttendees = new JSONHoldingStringArrayGenerator("field \"Attendees\" of the CancelCalendarItemsCommand class");
            fieldGeneratorSelfAttendeeStatus = new FieldHoldingGeneratorSelfAttendeeStatus("field \"SelfAttendeeStatus\" of the CancelCalendarItemsCommand class");
        ...
        public Generator() : base(false)
          {
            ...
            fieldGeneratorExactLocation = new JSONHoldingStringGenerator("field \"ExactLocation\" of the CancelCalendarItemsCommand class");
            fieldGeneratorPartialLocation = new JSONHoldingStringGenerator("field \"PartialLocation\" of the CancelCalendarItemsCommand class");
            fieldGeneratorLocationSpecifier = new CalendarLocationJSON.HoldingGenerator("field \"LocationSpecifier\" of the CancelCalendarItemsCommand class", false);
