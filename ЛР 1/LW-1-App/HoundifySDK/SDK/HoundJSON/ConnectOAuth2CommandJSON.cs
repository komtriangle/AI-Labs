/* file "ConnectOAuth2CommandJSON.cs" */
...
public class ConnectOAuth2CommandJSON : OAuth2CommandJSON
  {
    ...
    public static TypeStatusKnownValues  stringToStatus(string chars)
      {
        switch (chars[0])
          {
            case 'c':
                if ((String.Compare(chars, 1, "onnected", 0, 8, false) == 0) && (chars.Length == 9))
                    return TypeStatusKnownValues.Status_connected;
                break;
            case 'f':
    ...
    public static string  stringFromStatus(TypeStatusKnownValues the_enum)
      {
        switch (the_enum)
          {
            case TypeStatusKnownValues.Status_connected:
                return "connected";
    ...
    private JSONValue  extraStatusToJSON()
      {
        ...
        switch (storeStatus.list_value)
          {
            case TypeStatusKnownValues.Status_connected:
                generated_string_Status = new JSONStringValue("connected");
                break;
            case TypeStatusKnownValues.Status_failed:
    ...
    private JSONValue  extraRefreshTokenToJSON()
      {
        JSONStringValue generated_string_RefreshToken = new JSONStringValue(storeRefreshToken);
        return generated_string_RefreshToken;
      }

    private JSONValue  extraAccessTokenToJSON()
      {
        JSONStringValue generated_string_AccessToken = new JSONStringValue(storeAccessToken);
        return generated_string_AccessToken;
      }

    private JSONValue  extraAccessTokenExpirationTimestampToJSON()
      {
        JSONIntegerValue generated_integer_AccessTokenExpirationTimestamp = new JSONIntegerValue(storeAccessTokenExpirationTimestamp);
        return generated_integer_AccessTokenExpirationTimestamp;
      }
    ...
    private void  fromJSONStatus(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field Status of ConnectOAuth2CommandJSON is not a string.");
        TypeStatus the_open_enum = new TypeStatus();
        switch (json_string.getData()[0])
          {
            case 'c':
                if ((String.Compare(json_string.getData(), 1, "onnected", 0, 8, false) == 0) && (json_string.getData().Length == 9))
                      {
                        the_open_enum.in_known_list = true;
                        the_open_enum.list_value = TypeStatusKnownValues.Status_connected;
    ...
    private void  fromJSONRefreshToken(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field RefreshToken of ConnectOAuth2CommandJSON is not a string.");
    ...
    private void  fromJSONAccessToken(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field AccessToken of ConnectOAuth2CommandJSON is not a string.");
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field AccessTokenExpirationTimestamp of ConnectOAuth2CommandJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field AccessTokenExpirationTimestamp of ConnectOAuth2CommandJSON is not an integer.");
              }
    ...
    public ConnectOAuth2CommandJSON()
      {
    ...
    public virtual int extraConnectOAuth2CommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraConnectOAuth2CommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraConnectOAuth2CommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraConnectOAuth2CommandLookup(string field_name)
      {
    ...
    public override int extraOAuth2CommandComponentCount()
      {
        ...
        if (flagHasAccessTokenExpirationTimestamp)
            ++result;
        result += extraConnectOAuth2CommandComponentCount();
        return result;
      }
    public override string extraOAuth2CommandComponentKey(int component_num)
      {
        ...
        if (flagHasAccessTokenExpirationTimestamp)
          {
            if (remainder == 0)
                return "AccessTokenExpirationTimestamp";
            --remainder;
          }
        return extraConnectOAuth2CommandComponentKey(remainder);
      }
    public override JSONValue extraOAuth2CommandComponentValue(int component_num)
      {
        ...
        if (flagHasRefreshToken)
          {
            if (remainder == 0)
                return extraRefreshTokenToJSON();
            --remainder;
          }
        if (flagHasAccessToken)
          {
            if (remainder == 0)
                return extraAccessTokenToJSON();
            --remainder;
          }
        if (flagHasAccessTokenExpirationTimestamp)
          {
            if (remainder == 0)
                return extraAccessTokenExpirationTimestampToJSON();
            --remainder;
          }
        return extraConnectOAuth2CommandComponentValue(remainder);
      }
    public override JSONValue extraOAuth2CommandLookup(string field_name)
      {
        switch (field_name[0])
          {
                ...
                if (String.Compare(field_name, 1, "ccessToken", 0, 10, false) == 0)
                  {
                    if (field_name.Length == 11)
                      {
                        return (flagHasAccessToken ? extraAccessTokenToJSON() : null);
                      }
                    switch (field_name[11])
                      {
                        case 'E':
                            if ((String.Compare(field_name, 12, "xpirationTimestamp", 0, 18, false) == 0) && (field_name.Length == 30))
                                return (flagHasAccessTokenExpirationTimestamp ? extraAccessTokenExpirationTimestampToJSON() : null);
                            break;
                        default:
                            break;
                      }
            ...
            case 'R':
                if ((String.Compare(field_name, 1, "efreshToken", 0, 11, false) == 0) && (field_name.Length == 12))
                    return (flagHasRefreshToken ? extraRefreshTokenToJSON() : null);
                break;
            case 'S':
                switch (field_name[1])
                  {
        ...
        return extraConnectOAuth2CommandLookup(field_name);
      }
    ...
    public void setAccessTokenExpirationTimestamp(BigInteger new_value)
      {
        ...
        if (new_value < 0)
            throw new Exception("The value for field AccessTokenExpirationTimestamp of ConnectOAuth2CommandJSON is less than the lower bound (0) for that field.");
    ...
    public virtual void extraConnectOAuth2CommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraConnectOAuth2CommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraConnectOAuth2CommandLookup(key);
        if (old_field == null)
          {
            extraConnectOAuth2CommandAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraOAuth2CommandAppendPair(string key, JSONValue new_component)
      {
        switch (key[0])
          {
            case 'A':
                if (String.Compare(key, 1, "ccessToken", 0, 10, false) == 0)
                  {
                    if (key.Length == 11)
                      {
                        {
                        fromJSONAccessToken(new_component, false);
                        return;
                        }
                      }
                    switch (key[11])
                      {
                        case 'E':
                            if ((String.Compare(key, 12, "xpirationTimestamp", 0, 18, false) == 0) && (key.Length == 30))
                                {
                                fromJSONAccessTokenExpirationTimestamp(new_component, false);
                                return;
                                }
                            break;
                        default:
                ...
                break;
            case 'R':
                if ((String.Compare(key, 1, "efreshToken", 0, 11, false) == 0) && (key.Length == 12))
                    {
                    fromJSONRefreshToken(new_component, false);
                    return;
                    }
                break;
            case 'S':
    ...
    public override void extraOAuth2CommandSetField(string key, JSONValue new_component)
      {
        ...
        extraConnectOAuth2CommandSetField(key, new_component);
      }
            ...
            if (storeStatus.in_known_list)
              {
                switch (storeStatus.list_value)
                  {
                    case TypeStatusKnownValues.Status_connected:
                        handler.string_value("connected");
                        break;
                    case TypeStatusKnownValues.Status_failed:
    ...
    public static new ConnectOAuth2CommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ConnectOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ConnectOAuth2Command", ignore_extras);
    ...
    public static new ConnectOAuth2CommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new ConnectOAuth2CommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ConnectOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ConnectOAuth2Command", ignore_extras);
    ...
    public static new ConnectOAuth2CommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new ConnectOAuth2CommandJSON from_text(string text, bool ignore_extras)
      {
        ConnectOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ConnectOAuth2Command", ignore_extras);
            JSONParse.parse_json_value(text, "Text for ConnectOAuth2CommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new ConnectOAuth2CommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        ConnectOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ConnectOAuth2Command", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorStatus : JSONArrayGenerator
  {
    ...
    private class FieldHoldingArrayGeneratorAccessTokenExpirationTimestamp : JSONHoldingIntegerLowerBoundOnlyArrayGenerator
        ...
        protected override void finish()
          {
            if (!(getOAuth2CommandJSONKey().Equals("ConnectOAuth2Command")))
                throw new Exception("The key field has a value other than `ConnectOAuth2Command'.");
            ConnectOAuth2CommandJSON result = new ConnectOAuth2CommandJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraConnectOAuth2CommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(OAuth2CommandJSON new_result)
          {
            handle_result((ConnectOAuth2CommandJSON )new_result);
          }
        protected void finish(ConnectOAuth2CommandJSON result)
          {
        ...
        protected abstract void handle_result(ConnectOAuth2CommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorServiceType = new OAuth2ServiceTypeJSON.HoldingGenerator("field \"ServiceType\" of the ConnectOAuth2Command class", ignore_extras);
            fieldGeneratorStatus = new FieldHoldingGeneratorStatus("field \"Status\" of the ConnectOAuth2Command class");
            fieldGeneratorRefreshToken = new JSONHoldingStringGenerator("field \"RefreshToken\" of the ConnectOAuth2Command class");
            fieldGeneratorAccessToken = new JSONHoldingStringGenerator("field \"AccessToken\" of the ConnectOAuth2Command class");
            fieldGeneratorAccessTokenExpirationTimestamp = new FieldHoldingGeneratorAccessTokenExpirationTimestamp("field \"AccessTokenExpirationTimestamp\" of the ConnectOAuth2Command class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the ConnectOAuth2Command class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorServiceType = new OAuth2ServiceTypeJSON.HoldingGenerator("field \"ServiceType\" of the ConnectOAuth2Command class", false);
            fieldGeneratorStatus = new FieldHoldingGeneratorStatus("field \"Status\" of the ConnectOAuth2Command class");
            fieldGeneratorRefreshToken = new JSONHoldingStringGenerator("field \"RefreshToken\" of the ConnectOAuth2Command class");
            fieldGeneratorAccessToken = new JSONHoldingStringGenerator("field \"AccessToken\" of the ConnectOAuth2Command class");
            fieldGeneratorAccessTokenExpirationTimestamp = new FieldHoldingGeneratorAccessTokenExpirationTimestamp("field \"AccessTokenExpirationTimestamp\" of the ConnectOAuth2Command class");
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(ConnectOAuth2CommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public ConnectOAuth2CommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<ConnectOAuth2CommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<ConnectOAuth2CommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<ConnectOAuth2CommandJSON> value;
  };
  };
