/* file "StockGlobalIndicesHistoricalJSON.cs" */
...
public class StockGlobalIndicesHistoricalJSON : JSONBase
  {
    ...
    private List< StockGlobalIndicesHistoricalQuoteJSON  > storeValues;
    ...
    private void  fromJSONOutcome(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field Outcome of StockGlobalIndicesHistoricalJSON is not a string.");
    ...
    private void  fromJSONMessage(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (!or_done)
            throw new Exception("The value for field Message of StockGlobalIndicesHistoricalJSON is not one of the allowed values.");
    ...
    private void  fromJSONDelay(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (!or_done)
            throw new Exception("The value for field Delay of StockGlobalIndicesHistoricalJSON is not one of the allowed values.");
        setDelay(or_result);
        switch (or_result.key)
          {
            case 0:
    ...
    private void  fromJSONValues(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field Values of StockGlobalIndicesHistoricalJSON is not an array.");
        int count1 = json_array1.componentCount();
        List< StockGlobalIndicesHistoricalQuoteJSON  > vector_Values1 = new List< StockGlobalIndicesHistoricalQuoteJSON  >(count1);
        for (int num1 = 0; num1 < count1; ++num1)
          {
            StockGlobalIndicesHistoricalQuoteJSON convert_classy = StockGlobalIndicesHistoricalQuoteJSON.from_json(json_array1.component(num1), ignore_extras, true);
    ...
    public StockGlobalIndicesHistoricalJSON()
      {
        flagHasOutcome = false;
        flagHasMessage = false;
        flagHasDelay = false;
        flagHasValues = false;
        storeValues = new List< StockGlobalIndicesHistoricalQuoteJSON  >();
    ...
    public StockGlobalIndicesHistoricalQuoteJSON   elementOfValues(int element_num)
      {
        Debug.Assert(flagHasValues);
        return storeValues[element_num];
      }

    public List< StockGlobalIndicesHistoricalQuoteJSON  >  getValues()
      {
        Debug.Assert(flagHasValues);
        return storeValues;
      }
    ...
    public virtual int extraStockGlobalIndicesHistoricalComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraStockGlobalIndicesHistoricalComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraStockGlobalIndicesHistoricalComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraStockGlobalIndicesHistoricalLookup(string field_name)
      {
    ...
    public void appendValues(StockGlobalIndicesHistoricalQuoteJSON  to_append)
      {
        if (!flagHasValues)
          {
            flagHasValues = true;
    ...
    public virtual void extraStockGlobalIndicesHistoricalAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraStockGlobalIndicesHistoricalSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static StockGlobalIndicesHistoricalJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
    ...
    public static StockGlobalIndicesHistoricalJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    ...
    public static StockGlobalIndicesHistoricalJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static StockGlobalIndicesHistoricalJSON from_text(string text, bool ignore_extras)
      {
        StockGlobalIndicesHistoricalJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type StockGlobalIndicesHistorical", ignore_extras);
            JSONParse.parse_json_value(text, "Text for StockGlobalIndicesHistoricalJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static StockGlobalIndicesHistoricalJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        StockGlobalIndicesHistoricalJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type StockGlobalIndicesHistorical", ignore_extras);
    ...
    private class FieldHoldingArrayGeneratorDelay : JSONArrayGenerator
  {
    ...
    public List<TypeDelay> value;
        ...
        private StockGlobalIndicesHistoricalQuoteJSON.HoldingArrayGenerator fieldGeneratorValues;
        ...
        protected override void finish()
          {
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraStockGlobalIndicesHistoricalAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(StockGlobalIndicesHistoricalJSON result)
          {
        ...
        protected abstract void handle_result(StockGlobalIndicesHistoricalJSON new_result);
        ...
        public Generator(bool ignore_extras)
          {
            ...
            fieldGeneratorMessage = new FieldHoldingGeneratorMessage("field \"Message\" of the StockGlobalIndicesHistorical class", ignore_extras);
            fieldGeneratorDelay = new FieldHoldingGeneratorDelay("field \"Delay\" of the StockGlobalIndicesHistorical class", ignore_extras);
            fieldGeneratorValues = new StockGlobalIndicesHistoricalQuoteJSON.HoldingArrayGenerator("field \"Values\" of the StockGlobalIndicesHistorical class", ignore_extras);
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(StockGlobalIndicesHistoricalJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public StockGlobalIndicesHistoricalJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<StockGlobalIndicesHistoricalJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<StockGlobalIndicesHistoricalJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<StockGlobalIndicesHistoricalJSON> value;
  };
  };
