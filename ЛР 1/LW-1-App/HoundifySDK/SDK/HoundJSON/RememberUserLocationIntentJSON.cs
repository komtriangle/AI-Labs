/* file "RememberUserLocationIntentJSON.cs" */
...
public class RememberUserLocationIntentJSON : UserMemoryIntentJSON
  {
    ...
    private LocationIntentJSON  storeLocation;
    ...
    private void  fromJSONWhat(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field What of RememberUserLocationIntentJSON is not a string.");
    ...
    public RememberUserLocationIntentJSON()
      {
    ...
    public override string  getUserMemoryIntentKind()
      {
    ...
    public LocationIntentJSON   getLocation()
      {
    ...
    public virtual int extraRememberUserLocationIntentComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraRememberUserLocationIntentComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraRememberUserLocationIntentComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraRememberUserLocationIntentLookup(string field_name)
      {
    ...
    public virtual void extraRememberUserLocationIntentAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraRememberUserLocationIntentSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new RememberUserLocationIntentJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RememberUserLocationIntentJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RememberUserLocationIntent", ignore_extras);
    ...
    public static new RememberUserLocationIntentJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RememberUserLocationIntentJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RememberUserLocationIntentJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RememberUserLocationIntent", ignore_extras);
    ...
    public static new RememberUserLocationIntentJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RememberUserLocationIntentJSON from_text(string text, bool ignore_extras)
      {
        RememberUserLocationIntentJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RememberUserLocationIntent", ignore_extras);
            JSONParse.parse_json_value(text, "Text for RememberUserLocationIntentJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new RememberUserLocationIntentJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        RememberUserLocationIntentJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RememberUserLocationIntent", ignore_extras);
    ...
    public new abstract class Generator : UserMemoryIntentJSON.Generator
      {
        ...
        private LocationIntentJSON.HoldingGenerator fieldGeneratorLocation;
        ...
        protected override void finish()
          {
            if (!(getUserMemoryIntentJSONKey().Equals("RememberUserLocation")))
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraRememberUserLocationIntentAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(UserMemoryIntentJSON new_result)
          {
            handle_result((RememberUserLocationIntentJSON )new_result);
          }
        protected void finish(RememberUserLocationIntentJSON result)
          {
        ...
        protected abstract void handle_result(RememberUserLocationIntentJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            ...
            fieldGeneratorSpecialLocation = new UserMemorySpecialLocationJSON.HoldingGenerator("field \"SpecialLocation\" of the RememberUserLocationIntent class", ignore_extras);
            fieldGeneratorLocation = new LocationIntentJSON.HoldingGenerator("field \"Location\" of the RememberUserLocationIntent class", ignore_extras);
        ...
        public Generator() : base(false)
          {
            fieldGeneratorIsOwned = new JSONHoldingBooleanGenerator("field \"IsOwned\" of the RememberUserLocationIntent class");
            fieldGeneratorWhat = new JSONHoldingStringGenerator("field \"What\" of the RememberUserLocationIntent class");
            fieldGeneratorSpecialLocation = new UserMemorySpecialLocationJSON.HoldingGenerator("field \"SpecialLocation\" of the RememberUserLocationIntent class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(RememberUserLocationIntentJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public RememberUserLocationIntentJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<RememberUserLocationIntentJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<RememberUserLocationIntentJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<RememberUserLocationIntentJSON> value;
  };
  };
