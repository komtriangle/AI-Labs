/* file "LocationHelpCommandJSON.cs" */
...
public class LocationHelpCommandJSON : DeviceControlCommandJSON
  {
    ...
    private void  fromJSONCommandType(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field CommandType of LocationHelpCommandJSON is not a string.");
        ...
        throw new Exception("The value for field CommandType of LocationHelpCommandJSON is not one of the legal strings.");
      enum_is_done:;
        setCommandType(the_enum);
      }


    public LocationHelpCommandJSON()
      {
    ...
    public virtual int extraLocationHelpCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraLocationHelpCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraLocationHelpCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraLocationHelpCommandLookup(string field_name)
      {
    ...
    public virtual void extraLocationHelpCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraLocationHelpCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new LocationHelpCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        LocationHelpCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type LocationHelpCommand", ignore_extras);
    ...
    public static new LocationHelpCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new LocationHelpCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        LocationHelpCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type LocationHelpCommand", ignore_extras);
    ...
    public static new LocationHelpCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new LocationHelpCommandJSON from_text(string text, bool ignore_extras)
      {
        LocationHelpCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type LocationHelpCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for LocationHelpCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new LocationHelpCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        LocationHelpCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type LocationHelpCommand", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorCommandType : JSONArrayGenerator
  {
    ...
    public List<TypeCommandType> value;
        ...
        protected override void finish()
          {
            if (!(getDeviceControlCommandJSONKey().Equals("LocationHelpCommand")))
                throw new Exception("The key field has a value other than `LocationHelpCommand'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraLocationHelpCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(LocationHelpCommandJSON result)
          {
        ...
        protected abstract void handle_result(LocationHelpCommandJSON new_result);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(LocationHelpCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public LocationHelpCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<LocationHelpCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<LocationHelpCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<LocationHelpCommandJSON> value;
  };
  };
