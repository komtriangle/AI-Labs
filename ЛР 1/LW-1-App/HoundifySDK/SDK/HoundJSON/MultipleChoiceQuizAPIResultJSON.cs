/* file "MultipleChoiceQuizAPIResultJSON.cs" */
...
public class MultipleChoiceQuizAPIResultJSON : CommandResultJSON
  {
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field OperationSucceeded of MultipleChoiceQuizAPIResultJSON is not true for false.");
              }
          }
    ...
    private void  fromJSONErrorMessage(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field ErrorMessage of MultipleChoiceQuizAPIResultJSON is not a string.");
    ...
    private void  fromJSONWarnings(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field Warnings of MultipleChoiceQuizAPIResultJSON is not an array.");
        ...
        for (int num1 = 0; num1 < count1; ++num1)
          {
            ...
            if (json_string == null)
                throw new Exception("The value for an element of field Warnings of MultipleChoiceQuizAPIResultJSON is not a string.");
    ...
    public MultipleChoiceQuizAPIResultJSON()
      {
    ...
    public override string  getCommandKind()
      {
        return "MultipleChoiceQuizAPIResult";
      }
    ...
    public virtual int extraMultipleChoiceQuizAPIResultComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraMultipleChoiceQuizAPIResultComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraMultipleChoiceQuizAPIResultComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraMultipleChoiceQuizAPIResultLookup(string field_name)
      {
    ...
    public override int extraCommandResultComponentCount()
      {
        ...
        if (flagHasQuestionList)
            ++result;
        result += extraMultipleChoiceQuizAPIResultComponentCount();
        return result;
      }
    public override string extraCommandResultComponentKey(int component_num)
      {
        ...
        return extraMultipleChoiceQuizAPIResultComponentKey(remainder);
      }
    public override JSONValue extraCommandResultComponentValue(int component_num)
      {
        ...
        return extraMultipleChoiceQuizAPIResultComponentValue(remainder);
      }
    public override JSONValue extraCommandResultLookup(string field_name)
      {
        switch (field_name[0])
          {
            ...
            case 'O':
                ...
                break;
            case 'Q':
                if ((String.Compare(field_name, 1, "uestionList", 0, 11, false) == 0) && (field_name.Length == 12))
        ...
        return extraMultipleChoiceQuizAPIResultLookup(field_name);
      }
    ...
    public virtual void extraMultipleChoiceQuizAPIResultAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraMultipleChoiceQuizAPIResultSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraMultipleChoiceQuizAPIResultLookup(key);
        if (old_field == null)
          {
            extraMultipleChoiceQuizAPIResultAppendPair(key, new_component);
          }
        else
          {
        ...
        switch (key[0])
          {
            ...
            case 'O':
                ...
                break;
            case 'Q':
                if ((String.Compare(key, 1, "uestionList", 0, 11, false) == 0) && (key.Length == 12))
                    {
    ...
    public override void extraCommandResultSetField(string key, JSONValue new_component)
      {
        ...
        extraMultipleChoiceQuizAPIResultSetField(key, new_component);
      }
    ...
    public static new MultipleChoiceQuizAPIResultJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        MultipleChoiceQuizAPIResultJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MultipleChoiceQuizAPIResult", ignore_extras);
    ...
    public static new MultipleChoiceQuizAPIResultJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new MultipleChoiceQuizAPIResultJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        MultipleChoiceQuizAPIResultJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MultipleChoiceQuizAPIResult", ignore_extras);
    ...
    public static new MultipleChoiceQuizAPIResultJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new MultipleChoiceQuizAPIResultJSON from_text(string text, bool ignore_extras)
      {
        MultipleChoiceQuizAPIResultJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MultipleChoiceQuizAPIResult", ignore_extras);
            JSONParse.parse_json_value(text, "Text for MultipleChoiceQuizAPIResultJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new MultipleChoiceQuizAPIResultJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        MultipleChoiceQuizAPIResultJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MultipleChoiceQuizAPIResult", ignore_extras);
    ...
    public new abstract class Generator : CommandResultJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getCommandResultJSONKey().Equals("MultipleChoiceQuizAPIResult")))
                throw new Exception("The key field has a value other than `MultipleChoiceQuizAPIResult'.");
            MultipleChoiceQuizAPIResultJSON result = new MultipleChoiceQuizAPIResultJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraMultipleChoiceQuizAPIResultAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(CommandResultJSON new_result)
          {
            handle_result((MultipleChoiceQuizAPIResultJSON )new_result);
          }
        protected void finish(MultipleChoiceQuizAPIResultJSON result)
          {
        ...
        protected abstract void handle_result(MultipleChoiceQuizAPIResultJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorOperationSucceeded = new JSONHoldingBooleanGenerator("field \"OperationSucceeded\" of the MultipleChoiceQuizAPIResult class");
            fieldGeneratorErrorMessage = new JSONHoldingStringGenerator("field \"ErrorMessage\" of the MultipleChoiceQuizAPIResult class");
            fieldGeneratorWarnings = new JSONHoldingStringArrayGenerator("field \"Warnings\" of the MultipleChoiceQuizAPIResult class");
            fieldGeneratorQuestionList = new MultipleChoiceQuizQuestionListJSON.HoldingGenerator("field \"QuestionList\" of the MultipleChoiceQuizAPIResult class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the MultipleChoiceQuizAPIResult class");
          }
        public Generator() : base(false)
          {
            ...
            fieldGeneratorErrorMessage = new JSONHoldingStringGenerator("field \"ErrorMessage\" of the MultipleChoiceQuizAPIResult class");
            fieldGeneratorWarnings = new JSONHoldingStringArrayGenerator("field \"Warnings\" of the MultipleChoiceQuizAPIResult class");
            fieldGeneratorQuestionList = new MultipleChoiceQuizQuestionListJSON.HoldingGenerator("field \"QuestionList\" of the MultipleChoiceQuizAPIResult class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(MultipleChoiceQuizAPIResultJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public MultipleChoiceQuizAPIResultJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<MultipleChoiceQuizAPIResultJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<MultipleChoiceQuizAPIResultJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<MultipleChoiceQuizAPIResultJSON> value;
  };
  };
