/* file "FlightTravelLocationFilterJSON.cs" */
...
public class FlightTravelLocationFilterJSON : JSONBase
  {
    private bool flagHasIncludes;
    private List< FlightTravelLocationJSON  > storeIncludes;
    private bool flagHasExcludes;
    private List< FlightTravelLocationJSON  > storeExcludes;
    ...
    private void  fromJSONIncludes(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field Includes of FlightTravelLocationFilterJSON is not an array.");
        int count1 = json_array1.componentCount();
        if (count1 < 1)
            throw new Exception("The value for field Includes of FlightTravelLocationFilterJSON has too few elements.");
        List< FlightTravelLocationJSON  > vector_Includes1 = new List< FlightTravelLocationJSON  >(count1);
    ...
    public FlightTravelLocationFilterJSON()
      {
        flagHasIncludes = false;
        flagHasExcludes = false;
        flagHasDefaultForOthers = false;
        storeIncludes = new List< FlightTravelLocationJSON  >();
        storeExcludes = new List< FlightTravelLocationJSON  >();
    ...
    public FlightTravelLocationJSON   elementOfIncludes(int element_num)
      {
        Debug.Assert(flagHasIncludes);
        return storeIncludes[element_num];
      }

    public List< FlightTravelLocationJSON  >  getIncludes()
      {
        Debug.Assert(flagHasIncludes);
    ...
    public FlightTravelLocationJSON   elementOfExcludes(int element_num)
      {
        Debug.Assert(flagHasExcludes);
        return storeExcludes[element_num];
      }

    public List< FlightTravelLocationJSON  >  getExcludes()
      {
        Debug.Assert(flagHasExcludes);
    ...
    public virtual int extraFlightTravelLocationFilterComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraFlightTravelLocationFilterComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraFlightTravelLocationFilterComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraFlightTravelLocationFilterLookup(string field_name)
      {
    ...
    public void appendIncludes(FlightTravelLocationJSON  to_append)
      {
        if (!flagHasIncludes)
          {
            flagHasIncludes = true;
    ...
    public virtual void extraFlightTravelLocationFilterAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraFlightTravelLocationFilterSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraFlightTravelLocationFilterLookup(key);
        if (old_field == null)
          {
            extraFlightTravelLocationFilterAppendPair(key, new_component);
          }
        else
          {
    ...
    public static FlightTravelLocationFilterJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        FlightTravelLocationFilterJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type FlightTravelLocationFilter", ignore_extras);
    ...
    public static FlightTravelLocationFilterJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static FlightTravelLocationFilterJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        FlightTravelLocationFilterJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type FlightTravelLocationFilter", ignore_extras);
    ...
    public static FlightTravelLocationFilterJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static FlightTravelLocationFilterJSON from_text(string text, bool ignore_extras)
      {
        FlightTravelLocationFilterJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type FlightTravelLocationFilter", ignore_extras);
            JSONParse.parse_json_value(text, "Text for FlightTravelLocationFilterJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static FlightTravelLocationFilterJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        FlightTravelLocationFilterJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type FlightTravelLocationFilter", ignore_extras);
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        private FlightTravelLocationJSON.HoldingArrayGenerator fieldGeneratorIncludes;
        private FlightTravelLocationJSON.HoldingArrayGenerator fieldGeneratorExcludes;
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorIncludes = new FlightTravelLocationJSON.HoldingArrayGenerator("field \"Includes\" of the FlightTravelLocationFilter class", ignore_extras);
            fieldGeneratorExcludes = new FlightTravelLocationJSON.HoldingArrayGenerator("field \"Excludes\" of the FlightTravelLocationFilter class", ignore_extras);
            fieldGeneratorDefaultForOthers = new IncludeExcludeStateJSON.HoldingGenerator("field \"DefaultForOthers\" of the FlightTravelLocationFilter class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the FlightTravelLocationFilter class");
            allow_incomplete = false;
            allow_unpolished = false;
          }
        public Generator()
          {
            fieldGeneratorIncludes = new FlightTravelLocationJSON.HoldingArrayGenerator("field \"Includes\" of the FlightTravelLocationFilter class", false);
            fieldGeneratorExcludes = new FlightTravelLocationJSON.HoldingArrayGenerator("field \"Excludes\" of the FlightTravelLocationFilter class", false);
            fieldGeneratorDefaultForOthers = new IncludeExcludeStateJSON.HoldingGenerator("field \"DefaultForOthers\" of the FlightTravelLocationFilter class", false);
...
//@@@            Debug.Assert(!have_value);
        ...
        public FlightTravelLocationFilterJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<FlightTravelLocationFilterJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<FlightTravelLocationFilterJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<FlightTravelLocationFilterJSON> value;
  };
  };
