/* file "UnitsValue_VisibilityJSON.cs" */
...
public class UnitsValue_VisibilityJSON : JSONBase
  {
    ...
    private void  fromJSONUnits(JSONValue json_value, bool ignore_extras)
      {
        Debug.Assert(json_value != null);
        WeatherDistanceUnitsJSON convert_classy = WeatherDistanceUnitsJSON.from_json(json_value, ignore_extras, true);
    ...
    private void  fromJSONAbbreviatedUnits(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field AbbreviatedUnits of UnitsValue_VisibilityJSON is not a string.");
    ...
    private void  fromJSONWrittenUnits(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field WrittenUnits of UnitsValue_VisibilityJSON is not a string.");
    ...
    private void  fromJSONSpokenUnits(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field SpokenUnits of UnitsValue_VisibilityJSON is not a string.");
    ...
    public UnitsValue_VisibilityJSON()
      {
        flagHasFormat = false;
        flagHasUnits = false;
    ...
    public WeatherDistanceUnitsJSON   getUnits()
      {
        Debug.Assert(flagHasUnits);
        return storeUnits;
      }

    public WeatherDistanceUnitsJSON.TypeValue  getUnitsValue()
      {
    ...
    public virtual int extraUnitsValue_VisibilityComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraUnitsValue_VisibilityComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraUnitsValue_VisibilityComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraUnitsValue_VisibilityLookup(string field_name)
      {
    ...
    public void setUnits(WeatherDistanceUnitsJSON  new_value)
      {
        if (flagHasUnits)
          {
          }
    ...
    public void setUnits(WeatherDistanceUnitsJSON.TypeValue new_value)
      {
        setUnits(new WeatherDistanceUnitsJSON(new_value));
      }
    public void setUnits(string chars)
      {
        WeatherDistanceUnitsJSON.TypeValueKnownValues known = WeatherDistanceUnitsJSON.stringToValue(chars);
        WeatherDistanceUnitsJSON.TypeValue new_value = new WeatherDistanceUnitsJSON.TypeValue();
        if (known == WeatherDistanceUnitsJSON.TypeValueKnownValues.Value__none)
          {
            new_value.in_known_list = false;
            new_value.string_value = chars;
          }
    ...
    public void setValue(double new_value)
      {
        flagHasValue = true;
        if (new_value < 0)
            throw new Exception("The value for field Value of UnitsValue_VisibilityJSON is less than the lower bound (0) for that field.");
    ...
    public void setValueText(string new_value)
      {
        ...
        if (!(JSONWriter.is_valid_number_format(new_value)))
            throw new Exception("The text value for field Value of UnitsValue_VisibilityJSON is not a valid number.");
    ...
    public virtual void extraUnitsValue_VisibilityAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraUnitsValue_VisibilitySetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraUnitsValue_VisibilityLookup(key);
        if (old_field == null)
          {
            extraUnitsValue_VisibilityAppendPair(key, new_component);
          }
        else
          {
    ...
    public static UnitsValue_VisibilityJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        UnitsValue_VisibilityJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UnitsValue_Visibility", ignore_extras);
    ...
    public static UnitsValue_VisibilityJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static UnitsValue_VisibilityJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        UnitsValue_VisibilityJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UnitsValue_Visibility", ignore_extras);
    ...
    public static UnitsValue_VisibilityJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static UnitsValue_VisibilityJSON from_text(string text, bool ignore_extras)
      {
        UnitsValue_VisibilityJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UnitsValue_Visibility", ignore_extras);
            JSONParse.parse_json_value(text, "Text for UnitsValue_VisibilityJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static UnitsValue_VisibilityJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        UnitsValue_VisibilityJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UnitsValue_Visibility", ignore_extras);
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        private WeatherDistanceUnitsJSON.HoldingGenerator fieldGeneratorUnits;
        ...
        protected override void finish()
          {
            UnitsValue_VisibilityJSON result = new UnitsValue_VisibilityJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraUnitsValue_VisibilityAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(UnitsValue_VisibilityJSON result)
          {
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorFormat = new WeatherUnitsFormatJSON.HoldingGenerator("field \"Format\" of the UnitsValue_Visibility class", ignore_extras);
            fieldGeneratorUnits = new WeatherDistanceUnitsJSON.HoldingGenerator("field \"Units\" of the UnitsValue_Visibility class", ignore_extras);
            fieldGeneratorAbbreviatedUnits = new JSONHoldingStringGenerator("field \"AbbreviatedUnits\" of the UnitsValue_Visibility class");
            fieldGeneratorWrittenUnits = new JSONHoldingStringGenerator("field \"WrittenUnits\" of the UnitsValue_Visibility class");
            fieldGeneratorSpokenUnits = new JSONHoldingStringGenerator("field \"SpokenUnits\" of the UnitsValue_Visibility class");
            fieldGeneratorValue = new JSONHoldingNumberTextGenerator("field \"Value\" of the UnitsValue_Visibility class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the UnitsValue_Visibility class");
            allow_incomplete = false;
            allow_unpolished = false;
          }
        public Generator()
          {
            fieldGeneratorFormat = new WeatherUnitsFormatJSON.HoldingGenerator("field \"Format\" of the UnitsValue_Visibility class", false);
            fieldGeneratorUnits = new WeatherDistanceUnitsJSON.HoldingGenerator("field \"Units\" of the UnitsValue_Visibility class", false);
            fieldGeneratorAbbreviatedUnits = new JSONHoldingStringGenerator("field \"AbbreviatedUnits\" of the UnitsValue_Visibility class");
            fieldGeneratorWrittenUnits = new JSONHoldingStringGenerator("field \"WrittenUnits\" of the UnitsValue_Visibility class");
            fieldGeneratorSpokenUnits = new JSONHoldingStringGenerator("field \"SpokenUnits\" of the UnitsValue_Visibility class");
            fieldGeneratorValue = new JSONHoldingNumberTextGenerator("field \"Value\" of the UnitsValue_Visibility class");
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(UnitsValue_VisibilityJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public UnitsValue_VisibilityJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<UnitsValue_VisibilityJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<UnitsValue_VisibilityJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<UnitsValue_VisibilityJSON> value;
  };
  };
