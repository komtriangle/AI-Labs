/* file "WeatherInformationNuggetIntentJSON.cs" */
...
public class WeatherInformationNuggetIntentJSON : InformationNuggetIntentJSON
  {
    ...
    private void  fromJSONWeatherIntentKind(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field WeatherIntentKind of WeatherInformationNuggetIntentJSON is not a string.");
    ...
    private void  fromJSONWeatherQueryType(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field WeatherQueryType of WeatherInformationNuggetIntentJSON is not a string.");
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field IsSearchQuery of WeatherInformationNuggetIntentJSON is not true for false.");
              }
          }
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field IsYesNoQuery of WeatherInformationNuggetIntentJSON is not true for false.");
              }
          }
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field DailyForecastExplicitlyRequested of WeatherInformationNuggetIntentJSON is not true for false.");
              }
          }
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field HourlyForecastExplicitlyRequested of WeatherInformationNuggetIntentJSON is not true for false.");
              }
          }
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field DisplayDaily of WeatherInformationNuggetIntentJSON is not true for false.");
              }
          }
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field DisplayHourly of WeatherInformationNuggetIntentJSON is not true for false.");
              }
          }
    ...
    public WeatherInformationNuggetIntentJSON()
      {
    ...
    public virtual int extraWeatherInformationNuggetIntentComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraWeatherInformationNuggetIntentComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraWeatherInformationNuggetIntentComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraWeatherInformationNuggetIntentLookup(string field_name)
      {
    ...
    public override int extraInformationNuggetIntentComponentCount()
      {
        ...
        if (flagHasSetOfTime)
            ++result;
        result += extraWeatherInformationNuggetIntentComponentCount();
        return result;
      }
    public override string extraInformationNuggetIntentComponentKey(int component_num)
      {
        ...
        return extraWeatherInformationNuggetIntentComponentKey(remainder);
      }
    public override JSONValue extraInformationNuggetIntentComponentValue(int component_num)
      {
        ...
        return extraWeatherInformationNuggetIntentComponentValue(remainder);
      }
    public override JSONValue extraInformationNuggetIntentLookup(string field_name)
      {
        ...
        return extraWeatherInformationNuggetIntentLookup(field_name);
      }
    ...
    public virtual void extraWeatherInformationNuggetIntentAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraWeatherInformationNuggetIntentSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraWeatherInformationNuggetIntentLookup(key);
        if (old_field == null)
          {
            extraWeatherInformationNuggetIntentAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraInformationNuggetIntentSetField(string key, JSONValue new_component)
      {
        ...
        extraWeatherInformationNuggetIntentSetField(key, new_component);
      }
    ...
    public static new WeatherInformationNuggetIntentJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        WeatherInformationNuggetIntentJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type WeatherInformationNuggetIntent", ignore_extras);
    ...
    public static new WeatherInformationNuggetIntentJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new WeatherInformationNuggetIntentJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        WeatherInformationNuggetIntentJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type WeatherInformationNuggetIntent", ignore_extras);
    ...
    public static new WeatherInformationNuggetIntentJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new WeatherInformationNuggetIntentJSON from_text(string text, bool ignore_extras)
      {
        WeatherInformationNuggetIntentJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type WeatherInformationNuggetIntent", ignore_extras);
            JSONParse.parse_json_value(text, "Text for WeatherInformationNuggetIntentJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new WeatherInformationNuggetIntentJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        WeatherInformationNuggetIntentJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type WeatherInformationNuggetIntent", ignore_extras);
    ...
    public new abstract class Generator : InformationNuggetIntentJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getInformationNuggetIntentJSONKey().Equals("Weather")))
                throw new Exception("The key field has a value other than `Weather'.");
            WeatherInformationNuggetIntentJSON result = new WeatherInformationNuggetIntentJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraWeatherInformationNuggetIntentAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(InformationNuggetIntentJSON new_result)
          {
            handle_result((WeatherInformationNuggetIntentJSON )new_result);
          }
        protected void finish(WeatherInformationNuggetIntentJSON result)
          {
        ...
        protected abstract void handle_result(WeatherInformationNuggetIntentJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorWeatherIntentKind = new JSONHoldingStringGenerator("field \"WeatherIntentKind\" of the WeatherInformationNuggetIntent class");
            fieldGeneratorWeatherQueryType = new JSONHoldingStringGenerator("field \"WeatherQueryType\" of the WeatherInformationNuggetIntent class");
            fieldGeneratorRequestedAttribute = new WeatherAttributeJSON.HoldingGenerator("field \"RequestedAttribute\" of the WeatherInformationNuggetIntent class", ignore_extras);
            fieldGeneratorRequestedAttributeAction = new WeatherAttributeActionJSON.HoldingGenerator("field \"RequestedAttributeAction\" of the WeatherInformationNuggetIntent class", ignore_extras);
            fieldGeneratorIsSearchQuery = new JSONHoldingBooleanGenerator("field \"IsSearchQuery\" of the WeatherInformationNuggetIntent class");
            fieldGeneratorMapLocation = new MapLocationJSON.HoldingGenerator("field \"MapLocation\" of the WeatherInformationNuggetIntent class", ignore_extras);
            fieldGeneratorDateTimeRange = new DateTimeRangeSpecJSON.HoldingGenerator("field \"DateTimeRange\" of the WeatherInformationNuggetIntent class", ignore_extras);
            fieldGeneratorUnits = new WeatherUnitsFormatJSON.HoldingGenerator("field \"Units\" of the WeatherInformationNuggetIntent class", ignore_extras);
            fieldGeneratorIsYesNoQuery = new JSONHoldingBooleanGenerator("field \"IsYesNoQuery\" of the WeatherInformationNuggetIntent class");
            fieldGeneratorDailyForecastExplicitlyRequested = new JSONHoldingBooleanGenerator("field \"DailyForecastExplicitlyRequested\" of the WeatherInformationNuggetIntent class");
            fieldGeneratorHourlyForecastExplicitlyRequested = new JSONHoldingBooleanGenerator("field \"HourlyForecastExplicitlyRequested\" of the WeatherInformationNuggetIntent class");
            fieldGeneratorDisplayDaily = new JSONHoldingBooleanGenerator("field \"DisplayDaily\" of the WeatherInformationNuggetIntent class");
            fieldGeneratorDisplayHourly = new JSONHoldingBooleanGenerator("field \"DisplayHourly\" of the WeatherInformationNuggetIntent class");
            fieldGeneratorSetOfTime = new SetOfTimeJSON.HoldingGenerator("field \"SetOfTime\" of the WeatherInformationNuggetIntent class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the WeatherInformationNuggetIntent class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorWeatherIntentKind = new JSONHoldingStringGenerator("field \"WeatherIntentKind\" of the WeatherInformationNuggetIntent class");
            fieldGeneratorWeatherQueryType = new JSONHoldingStringGenerator("field \"WeatherQueryType\" of the WeatherInformationNuggetIntent class");
            fieldGeneratorRequestedAttribute = new WeatherAttributeJSON.HoldingGenerator("field \"RequestedAttribute\" of the WeatherInformationNuggetIntent class", false);
            fieldGeneratorRequestedAttributeAction = new WeatherAttributeActionJSON.HoldingGenerator("field \"RequestedAttributeAction\" of the WeatherInformationNuggetIntent class", false);
            fieldGeneratorIsSearchQuery = new JSONHoldingBooleanGenerator("field \"IsSearchQuery\" of the WeatherInformationNuggetIntent class");
            fieldGeneratorMapLocation = new MapLocationJSON.HoldingGenerator("field \"MapLocation\" of the WeatherInformationNuggetIntent class", false);
            fieldGeneratorDateTimeRange = new DateTimeRangeSpecJSON.HoldingGenerator("field \"DateTimeRange\" of the WeatherInformationNuggetIntent class", false);
            fieldGeneratorUnits = new WeatherUnitsFormatJSON.HoldingGenerator("field \"Units\" of the WeatherInformationNuggetIntent class", false);
            fieldGeneratorIsYesNoQuery = new JSONHoldingBooleanGenerator("field \"IsYesNoQuery\" of the WeatherInformationNuggetIntent class");
            fieldGeneratorDailyForecastExplicitlyRequested = new JSONHoldingBooleanGenerator("field \"DailyForecastExplicitlyRequested\" of the WeatherInformationNuggetIntent class");
            fieldGeneratorHourlyForecastExplicitlyRequested = new JSONHoldingBooleanGenerator("field \"HourlyForecastExplicitlyRequested\" of the WeatherInformationNuggetIntent class");
            fieldGeneratorDisplayDaily = new JSONHoldingBooleanGenerator("field \"DisplayDaily\" of the WeatherInformationNuggetIntent class");
            fieldGeneratorDisplayHourly = new JSONHoldingBooleanGenerator("field \"DisplayHourly\" of the WeatherInformationNuggetIntent class");
            fieldGeneratorSetOfTime = new SetOfTimeJSON.HoldingGenerator("field \"SetOfTime\" of the WeatherInformationNuggetIntent class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(WeatherInformationNuggetIntentJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public WeatherInformationNuggetIntentJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<WeatherInformationNuggetIntentJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<WeatherInformationNuggetIntentJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<WeatherInformationNuggetIntentJSON> value;
  };
  };
