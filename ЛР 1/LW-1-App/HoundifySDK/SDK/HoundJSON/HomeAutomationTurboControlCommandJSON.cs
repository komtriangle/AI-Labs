/* file "HomeAutomationTurboControlCommandJSON.cs" */
...
public class HomeAutomationTurboControlCommandJSON : HomeAutomationControlCommandJSON
  {
    ...
    private JSONValue  extraTurboModeToJSON()
      {
        JSONValueHandler handler_TurboMode = new JSONValueHandler();
    ...
    public HomeAutomationTurboControlCommandJSON()
      {
    ...
    public virtual int extraHomeAutomationTurboControlCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraHomeAutomationTurboControlCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraHomeAutomationTurboControlCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraHomeAutomationTurboControlCommandLookup(string field_name)
      {
    ...
    public override JSONValue extraHomeAutomationControlCommandLookup(string field_name)
      {
        if ((String.Compare(field_name, 0, "TurboMode", 0, 9, false) == 0) && (field_name.Length == 9))
    ...
    public virtual void extraHomeAutomationTurboControlCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraHomeAutomationTurboControlCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public override void extraHomeAutomationControlCommandAppendPair(string key, JSONValue new_component)
      {
        if ((String.Compare(key, 0, "TurboMode", 0, 9, false) == 0) && (key.Length == 9))
            {
    ...
    public override void write_fields_as_json(JSONHandler handler, bool partial_allowed)
      {
        ...
        Debug.Assert(partial_allowed || flagHasTurboMode);
        if (flagHasTurboMode)
          {
    ...
    public static new HomeAutomationTurboControlCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        HomeAutomationTurboControlCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HomeAutomationTurboControlCommand", ignore_extras);
    ...
    public static new HomeAutomationTurboControlCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new HomeAutomationTurboControlCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        HomeAutomationTurboControlCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HomeAutomationTurboControlCommand", ignore_extras);
    ...
    public static new HomeAutomationTurboControlCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new HomeAutomationTurboControlCommandJSON from_text(string text, bool ignore_extras)
      {
        HomeAutomationTurboControlCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HomeAutomationTurboControlCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for HomeAutomationTurboControlCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new HomeAutomationTurboControlCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        HomeAutomationTurboControlCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HomeAutomationTurboControlCommand", ignore_extras);
    ...
    public new abstract class Generator : HomeAutomationControlCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getHomeAutomationControlCommandJSONKey().Equals("HomeAutomationTurboControlCommand")))
                throw new Exception("The key field has a value other than `HomeAutomationTurboControlCommand'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraHomeAutomationTurboControlCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(HomeAutomationTurboControlCommandJSON result)
          {
            ...
            else if ((!(result.hasTurboMode())) && !allow_incomplete)
              {
                error("When parsing the object for %what%, the \"TurboMode\" field was missing.");
              }
            base.finish(result);
          }
        protected abstract void handle_result(HomeAutomationTurboControlCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorTurboMode = new HomeAutomationTurboModeJSON.HoldingGenerator("field \"TurboMode\" of the HomeAutomationTurboControlCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the HomeAutomationTurboControlCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorTurboMode = new HomeAutomationTurboModeJSON.HoldingGenerator("field \"TurboMode\" of the HomeAutomationTurboControlCommand class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(HomeAutomationTurboControlCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public HomeAutomationTurboControlCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<HomeAutomationTurboControlCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<HomeAutomationTurboControlCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<HomeAutomationTurboControlCommandJSON> value;
  };
  };
