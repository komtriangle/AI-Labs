/* file "HomeAutomationWriteUserSettingsCommandJSON.cs" */
...
public class HomeAutomationWriteUserSettingsCommandJSON : HomeAutomationCommandJSON
  {
    ...
    public HomeAutomationWriteUserSettingsCommandJSON()
      {
    ...
    public virtual int extraHomeAutomationWriteUserSettingsCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraHomeAutomationWriteUserSettingsCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraHomeAutomationWriteUserSettingsCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraHomeAutomationWriteUserSettingsCommandLookup(string field_name)
      {
    ...
    public virtual void extraHomeAutomationWriteUserSettingsCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraHomeAutomationWriteUserSettingsCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new HomeAutomationWriteUserSettingsCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        HomeAutomationWriteUserSettingsCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HomeAutomationWriteUserSettingsCommand", ignore_extras);
    ...
    public static new HomeAutomationWriteUserSettingsCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new HomeAutomationWriteUserSettingsCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        HomeAutomationWriteUserSettingsCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HomeAutomationWriteUserSettingsCommand", ignore_extras);
    ...
    public static new HomeAutomationWriteUserSettingsCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new HomeAutomationWriteUserSettingsCommandJSON from_text(string text, bool ignore_extras)
      {
        HomeAutomationWriteUserSettingsCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HomeAutomationWriteUserSettingsCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for HomeAutomationWriteUserSettingsCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new HomeAutomationWriteUserSettingsCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        HomeAutomationWriteUserSettingsCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HomeAutomationWriteUserSettingsCommand", ignore_extras);
    ...
    public new abstract class Generator : HomeAutomationCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getHomeAutomationCommandJSONKey().Equals("HomeAutomationWriteUserSettingsCommand")))
                throw new Exception("The key field has a value other than `HomeAutomationWriteUserSettingsCommand'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraHomeAutomationWriteUserSettingsCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(HomeAutomationWriteUserSettingsCommandJSON result)
          {
        ...
        protected abstract void handle_result(HomeAutomationWriteUserSettingsCommandJSON new_result);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(HomeAutomationWriteUserSettingsCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public HomeAutomationWriteUserSettingsCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<HomeAutomationWriteUserSettingsCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<HomeAutomationWriteUserSettingsCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<HomeAutomationWriteUserSettingsCommandJSON> value;
  };
  };
