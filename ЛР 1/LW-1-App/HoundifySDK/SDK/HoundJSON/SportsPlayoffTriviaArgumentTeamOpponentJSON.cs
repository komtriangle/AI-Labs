/* file "SportsPlayoffTriviaArgumentTeamOpponentJSON.cs" */
...
public class SportsPlayoffTriviaArgumentTeamOpponentJSON : SportsPlayoffTriviaArgumentJSON
  {
    ...
    private void  fromJSONTeamID(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field TeamID of SportsPlayoffTriviaArgumentTeamOpponentJSON is not a string.");
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field ResultReference of SportsPlayoffTriviaArgumentTeamOpponentJSON is not true for false.");
              }
          }
    ...
    public SportsPlayoffTriviaArgumentTeamOpponentJSON()
      {
        flagHasTeamID = false;
    ...
    public override string  getSportsPlayoffTriviaArgumentKind()
      {
        return "TeamOpponent";
      }
    ...
    public virtual int extraSportsPlayoffTriviaArgumentTeamOpponentComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsPlayoffTriviaArgumentTeamOpponentComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsPlayoffTriviaArgumentTeamOpponentComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsPlayoffTriviaArgumentTeamOpponentLookup(string field_name)
      {
    ...
    public override int extraSportsPlayoffTriviaArgumentComponentCount()
      {
        ...
        if (flagHasResultReference)
            ++result;
        result += extraSportsPlayoffTriviaArgumentTeamOpponentComponentCount();
        return result;
      }
    public override string extraSportsPlayoffTriviaArgumentComponentKey(int component_num)
      {
        ...
        return extraSportsPlayoffTriviaArgumentTeamOpponentComponentKey(remainder);
      }
    public override JSONValue extraSportsPlayoffTriviaArgumentComponentValue(int component_num)
      {
        ...
        return extraSportsPlayoffTriviaArgumentTeamOpponentComponentValue(remainder);
      }
    public override JSONValue extraSportsPlayoffTriviaArgumentLookup(string field_name)
      {
        ...
        return extraSportsPlayoffTriviaArgumentTeamOpponentLookup(field_name);
      }
    ...
    public virtual void extraSportsPlayoffTriviaArgumentTeamOpponentAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSportsPlayoffTriviaArgumentTeamOpponentSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraSportsPlayoffTriviaArgumentTeamOpponentLookup(key);
        if (old_field == null)
          {
            extraSportsPlayoffTriviaArgumentTeamOpponentAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraSportsPlayoffTriviaArgumentSetField(string key, JSONValue new_component)
      {
        ...
        extraSportsPlayoffTriviaArgumentTeamOpponentSetField(key, new_component);
      }
    ...
    public static new SportsPlayoffTriviaArgumentTeamOpponentJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsPlayoffTriviaArgumentTeamOpponentJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsPlayoffTriviaArgumentTeamOpponent", ignore_extras);
    ...
    public static new SportsPlayoffTriviaArgumentTeamOpponentJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsPlayoffTriviaArgumentTeamOpponentJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsPlayoffTriviaArgumentTeamOpponentJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsPlayoffTriviaArgumentTeamOpponent", ignore_extras);
    ...
    public static new SportsPlayoffTriviaArgumentTeamOpponentJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsPlayoffTriviaArgumentTeamOpponentJSON from_text(string text, bool ignore_extras)
      {
        SportsPlayoffTriviaArgumentTeamOpponentJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsPlayoffTriviaArgumentTeamOpponent", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SportsPlayoffTriviaArgumentTeamOpponentJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new SportsPlayoffTriviaArgumentTeamOpponentJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SportsPlayoffTriviaArgumentTeamOpponentJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsPlayoffTriviaArgumentTeamOpponent", ignore_extras);
    ...
    public new abstract class Generator : SportsPlayoffTriviaArgumentJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getSportsPlayoffTriviaArgumentJSONKey().Equals("TeamOpponent")))
                throw new Exception("The key field has a value other than `TeamOpponent'.");
            SportsPlayoffTriviaArgumentTeamOpponentJSON result = new SportsPlayoffTriviaArgumentTeamOpponentJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSportsPlayoffTriviaArgumentTeamOpponentAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(SportsPlayoffTriviaArgumentJSON new_result)
          {
            handle_result((SportsPlayoffTriviaArgumentTeamOpponentJSON )new_result);
          }
        protected void finish(SportsPlayoffTriviaArgumentTeamOpponentJSON result)
          {
        ...
        protected abstract void handle_result(SportsPlayoffTriviaArgumentTeamOpponentJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorTeamID = new JSONHoldingStringGenerator("field \"TeamID\" of the SportsPlayoffTriviaArgumentTeamOpponent class");
            fieldGeneratorTeamLeague = new SportsLeagueCodeJSON.HoldingGenerator("field \"TeamLeague\" of the SportsPlayoffTriviaArgumentTeamOpponent class", ignore_extras);
            fieldGeneratorResultReference = new JSONHoldingBooleanGenerator("field \"ResultReference\" of the SportsPlayoffTriviaArgumentTeamOpponent class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the SportsPlayoffTriviaArgumentTeamOpponent class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorTeamID = new JSONHoldingStringGenerator("field \"TeamID\" of the SportsPlayoffTriviaArgumentTeamOpponent class");
            fieldGeneratorTeamLeague = new SportsLeagueCodeJSON.HoldingGenerator("field \"TeamLeague\" of the SportsPlayoffTriviaArgumentTeamOpponent class", false);
            fieldGeneratorResultReference = new JSONHoldingBooleanGenerator("field \"ResultReference\" of the SportsPlayoffTriviaArgumentTeamOpponent class");
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(SportsPlayoffTriviaArgumentTeamOpponentJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public SportsPlayoffTriviaArgumentTeamOpponentJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SportsPlayoffTriviaArgumentTeamOpponentJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<SportsPlayoffTriviaArgumentTeamOpponentJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SportsPlayoffTriviaArgumentTeamOpponentJSON> value;
  };
  };
