/* file "UserMusicAvailableSourcesJSON.cs" */
...
public class UserMusicAvailableSourcesJSON : JSONBase
  {
    ...
    private void  fromJSONValue(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field Value of UserMusicAvailableSourcesJSON is not an array.");
    ...
    public UserMusicAvailableSourcesJSON()
      {
        flagHasValue = false;
    ...
    public static UserMusicAvailableSourcesJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        UserMusicAvailableSourcesJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UserMusicAvailableSources", ignore_extras);
            generator.set_allow_incomplete(allow_incomplete);
            generator.set_allow_unpolished(allow_unpolished);
            if (allow_incomplete || allow_unpolished)
                json_value.write(generator);
    ...
    public static UserMusicAvailableSourcesJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static UserMusicAvailableSourcesJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        UserMusicAvailableSourcesJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UserMusicAvailableSources", ignore_extras);
    ...
    public static UserMusicAvailableSourcesJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static UserMusicAvailableSourcesJSON from_text(string text, bool ignore_extras)
      {
        UserMusicAvailableSourcesJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UserMusicAvailableSources", ignore_extras);
            JSONParse.parse_json_value(text, "Text for UserMusicAvailableSourcesJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static UserMusicAvailableSourcesJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        UserMusicAvailableSourcesJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UserMusicAvailableSources", ignore_extras);
    ...
    public abstract class Generator : TypeValueJSON.HoldingArrayGenerator
      {
        protected void finish()
          {
            Debug.Assert(have_value);
            UserMusicAvailableSourcesJSON result = new UserMusicAvailableSourcesJSON();
            result.initValue();
        ...
        protected abstract void handle_result(UserMusicAvailableSourcesJSON new_result);
        public Generator(bool ignore_extras) : base("Type UserMusicAvailableSources", ignore_extras)
          {
          }
        public void set_allow_incomplete(bool new_allow_incomplete)
          {
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(UserMusicAvailableSourcesJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public UserMusicAvailableSourcesJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    protected class ElementHandler : Generator
    ...
    protected virtual void handle_result(List<UserMusicAvailableSourcesJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<UserMusicAvailableSourcesJSON>();
        base.set_what(what);
      }
    public HoldingArrayGenerator(bool ignore_extras)
      {
    ...
    public bool have_value;
    public List<UserMusicAvailableSourcesJSON> value;
  };
  };
