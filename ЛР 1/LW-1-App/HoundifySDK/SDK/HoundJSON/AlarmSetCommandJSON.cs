...
public class AlarmSetCommandJSON : AlarmCommandJSON
  {
    public class TypeNativeDataJSON : JSONBase
      {
        ...
        public virtual void write_fields_as_json(JSONHandler handler, bool partial_allowed)
          {
            Debug.Assert(partial_allowed || flagHasAlarms);
            if (flagHasAlarms)
              {
        ...
        public virtual string missing_field_error(bool allow_unpolished)
          {
            if (!(hasAlarms()))
              {
                return "When parsing the object for %what%, the \"Alarms\" field was missing.";
              }
            return null;
          }
            ...
            protected void finish(TypeNativeDataJSON result)
              {
                ...
                else if ((!(result.hasAlarms())) && !allow_incomplete)
                  {
                    error("When parsing the object for %what%, the \"Alarms\" field was missing.");
                  }
              }
            protected abstract void handle_result(TypeNativeDataJSON new_result);
            protected virtual JSONHandler start_known_field(string field_name)
              {
                if ((String.Compare(field_name, 0, "Alarms", 0, 6, false) == 0) && (field_name.Length == 6))
    ...
    public virtual int extraAlarmSetCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraAlarmSetCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraAlarmSetCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraAlarmSetCommandLookup(string field_name)
      {
        JSONValue result = (extraIndex.ContainsKey(field_name) ? extraIndex[field_name] : null);
        return result;
      }
    public override int extraAlarmCommandComponentCount()
      {
        ...
        if (flagHasNativeData)
            ++result;
        result += extraAlarmSetCommandComponentCount();
        return result;
      }
    public override string extraAlarmCommandComponentKey(int component_num)
      {
        ...
        return extraAlarmSetCommandComponentKey(remainder);
      }
    public override JSONValue extraAlarmCommandComponentValue(int component_num)
      {
        ...
        return extraAlarmSetCommandComponentValue(remainder);
      }
    public override JSONValue extraAlarmCommandLookup(string field_name)
      {
        ...
        return extraAlarmSetCommandLookup(field_name);
      }
    ...
    public virtual void extraAlarmSetCommandAppendPair(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public virtual void extraAlarmSetCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraAlarmSetCommandLookup(key);
        if (old_field == null)
          {
            extraAlarmSetCommandAppendPair(key, new_component);
          }
        else
          {
            int count = extraKeys.Count;
    ...
    public override void extraAlarmCommandSetField(string key, JSONValue new_component)
      {
        ...
        extraAlarmSetCommandSetField(key, new_component);
      }
    ...
    public static new AlarmSetCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        AlarmSetCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type AlarmSetCommand", ignore_extras);
            generator.set_allow_incomplete(allow_incomplete);
            generator.set_allow_unpolished(allow_unpolished);
            if (allow_incomplete || allow_unpolished)
                json_value.write(generator);
    ...
    public static new AlarmSetCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new AlarmSetCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        AlarmSetCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type AlarmSetCommand", ignore_extras);
    ...
    public static new AlarmSetCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new AlarmSetCommandJSON from_text(string text, bool ignore_extras)
      {
        AlarmSetCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type AlarmSetCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for AlarmSetCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new AlarmSetCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        AlarmSetCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type AlarmSetCommand", ignore_extras);
    ...
    public new abstract class Generator : AlarmCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getAlarmCommandJSONKey().Equals("AlarmSetCommand")))
                throw new Exception("The key field has a value other than `AlarmSetCommand'.");
            AlarmSetCommandJSON result = new AlarmSetCommandJSON();
            Debug.Assert(result != null);
            finish(result);
            int extra_count = unknownFieldGenerator.field_names.Count;
            Debug.Assert(extra_count == unknownFieldGenerator.field_values.Count);
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraAlarmSetCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
            unknownFieldGenerator.field_names.Clear();
            unknownFieldGenerator.field_values.Clear();
            unknownFieldGenerator.index = new Dictionary<string, JSONValue >();
        ...
        protected override void handle_result(AlarmCommandJSON new_result)
          {
            handle_result((AlarmSetCommandJSON )new_result);
          }
        protected void finish(AlarmSetCommandJSON result)
          {
        ...
        protected abstract void handle_result(AlarmSetCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the AlarmSetCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the AlarmSetCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the AlarmSetCommand class", false);
            unknownFieldGenerator = new UnknownFieldGenerator(false);
            set_what("the AlarmSetCommand class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(AlarmSetCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public AlarmSetCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<AlarmSetCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<AlarmSetCommandJSON>();
        base.set_what(what);
      }
    public HoldingArrayGenerator(bool ignore_extras)
      {
    ...
    public bool have_value;
    public List<AlarmSetCommandJSON> value;
  };
  };
