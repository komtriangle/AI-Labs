...
public class SportsTournamentJSON : JSONBase
  {
    ...
    private SportsTournamentCodeJSON  storeTournamentName;
    ...
    private void  fromJSONTournamentName(JSONValue json_value, bool ignore_extras)
      {
        ...
        SportsTournamentCodeJSON convert_classy = SportsTournamentCodeJSON.from_json(json_value, ignore_extras, true);
        setTournamentName(convert_classy);
      }
    ...
    public SportsTournamentCodeJSON   getTournamentName()
      {
        Debug.Assert(flagHasTournamentName);
        return storeTournamentName;
      }

    public SportsTournamentCodeJSON.TypeValue  getTournamentNameValue()
      {
        return getTournamentName().getValue();
      }

    public string  getTournamentNameAsString()
      {
        return getTournamentName().getValueAsString();
      }
    ...
    public void setTournamentName(SportsTournamentCodeJSON  new_value)
      {
    ...
    public void setTournamentName(SportsTournamentCodeJSON.TypeValue new_value)
      {
        setTournamentName(new SportsTournamentCodeJSON(new_value));
      }
        ...
        if (flagHasTournamentName)
          {
            ...
            if (partial_allowed)
                storeTournamentName.write_partial_as_json(handler);
            else
                storeTournamentName.write_as_json(handler);
          }
      }
    ...
    public static SportsTournamentJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        private SportsTournamentCodeJSON.HoldingGenerator fieldGeneratorTournamentName;
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorTournamentName = new SportsTournamentCodeJSON.HoldingGenerator("field \"TournamentName\" of the SportsTournament class", ignore_extras);
        ...
        public Generator()
          {
            fieldGeneratorTournamentName = new SportsTournamentCodeJSON.HoldingGenerator("field \"TournamentName\" of the SportsTournament class", false);
        ...
        public void set_allow_incomplete(bool new_allow_incomplete)
          {
            ...
            fieldGeneratorTournamentName.set_allow_incomplete(new_allow_incomplete);
          }
        public void set_allow_unpolished(bool new_allow_unpolished)
          {
            allow_unpolished = new_allow_unpolished;
            fieldGeneratorTournamentName.set_allow_unpolished(new_allow_unpolished);
          }
      };
