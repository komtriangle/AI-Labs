/* file "NumberGuessGuessNumberCommandJSON.cs" */
...
public class NumberGuessGuessNumberCommandJSON : NumberGuessCommandJSON
  {
        ...
        public void setGuessesMade(BigInteger new_value)
          {
            ...
            if (new_value < 1)
                throw new Exception("The value for field GuessesMade of TypeNativeDataJSON is less than the lower bound (1) for that field.");
        ...
        public virtual void write_fields_as_json(JSONHandler handler, bool partial_allowed)
          {
            ...
            Debug.Assert(partial_allowed || flagHasLowerRangeHint);
            if (flagHasLowerRangeHint)
              {
                handler.start_pair("LowerRangeHint");
                handler.number_value(storeLowerRangeHint);
              }
            Debug.Assert(partial_allowed || flagHasHigherRangeHint);
            ...
            Debug.Assert(partial_allowed || flagHasGuessesMade);
            if (flagHasGuessesMade)
              {
                handler.start_pair("GuessesMade");
                handler.number_value(storeGuessesMade);
              }
            Debug.Assert(partial_allowed || flagHasLastGuess);
            if (flagHasLastGuess)
              {
                handler.start_pair("LastGuess");
                handler.number_value(storeLastGuess);
              }
            Debug.Assert(partial_allowed || flagHasGuessToSolutionComparison);
            ...
            Debug.Assert(partial_allowed || flagHasRoundOver);
            if (flagHasRoundOver)
              {
            ...
            protected void finish(TypeNativeDataJSON result)
              {
                ...
                else if ((!(result.hasLowerRangeHint())) && !allow_incomplete)
                  {
                ...
                else if ((!(result.hasHigherRangeHint())) && !allow_incomplete)
                  {
                ...
                else if ((!(result.hasGuessesMade())) && !allow_incomplete)
                  {
                ...
                else if ((!(result.hasLastGuess())) && !allow_incomplete)
                  {
                ...
                else if ((!(result.hasGuessToSolutionComparison())) && !allow_incomplete)
                  {
                ...
                else if ((!(result.hasRoundOver())) && !allow_incomplete)
                  {
    ...
    public NumberGuessGuessNumberCommandJSON()
      {
    ...
    public virtual int extraNumberGuessGuessNumberCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraNumberGuessGuessNumberCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraNumberGuessGuessNumberCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraNumberGuessGuessNumberCommandLookup(string field_name)
      {
        JSONValue result = (extraIndex.ContainsKey(field_name) ? extraIndex[field_name] : null);
        return result;
      }
    ...
    public virtual void extraNumberGuessGuessNumberCommandAppendPair(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public virtual void extraNumberGuessGuessNumberCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new NumberGuessGuessNumberCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        NumberGuessGuessNumberCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NumberGuessGuessNumberCommand", ignore_extras);
            generator.set_allow_incomplete(allow_incomplete);
            generator.set_allow_unpolished(allow_unpolished);
            if (allow_incomplete || allow_unpolished)
                json_value.write(generator);
    ...
    public static new NumberGuessGuessNumberCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new NumberGuessGuessNumberCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        NumberGuessGuessNumberCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NumberGuessGuessNumberCommand", ignore_extras);
    ...
    public static new NumberGuessGuessNumberCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new NumberGuessGuessNumberCommandJSON from_text(string text, bool ignore_extras)
      {
        NumberGuessGuessNumberCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NumberGuessGuessNumberCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for NumberGuessGuessNumberCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new NumberGuessGuessNumberCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        NumberGuessGuessNumberCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NumberGuessGuessNumberCommand", ignore_extras);
    ...
    public new abstract class Generator : NumberGuessCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getNumberGuessCommandJSONKey().Equals("NumberGuessGuessNumberCommand")))
                throw new Exception("The key field has a value other than `NumberGuessGuessNumberCommand'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraNumberGuessGuessNumberCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
            unknownFieldGenerator.field_names.Clear();
            unknownFieldGenerator.field_values.Clear();
            unknownFieldGenerator.index = new Dictionary<string, JSONValue >();
        ...
        protected void finish(NumberGuessGuessNumberCommandJSON result)
          {
        ...
        protected abstract void handle_result(NumberGuessGuessNumberCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the NumberGuessGuessNumberCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the NumberGuessGuessNumberCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the NumberGuessGuessNumberCommand class", false);
            unknownFieldGenerator = new UnknownFieldGenerator(false);
            set_what("the NumberGuessGuessNumberCommand class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(NumberGuessGuessNumberCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public NumberGuessGuessNumberCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<NumberGuessGuessNumberCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<NumberGuessGuessNumberCommandJSON>();
        base.set_what(what);
      }
    public HoldingArrayGenerator(bool ignore_extras)
      {
    ...
    public bool have_value;
    public List<NumberGuessGuessNumberCommandJSON> value;
  };
  };
