/* file "CarControlDoorSelectionJSON.cs" */
...
public class CarControlDoorSelectionJSON : JSONBase
  {
        ...
        switch (chars[0])
          {
                ...
                if (String.Compare(chars, 1, "ll", 0, 2, false) == 0)
                  {
                    ...
                    switch (chars[3])
                      {
                        case 'E':
                            if ((String.Compare(chars, 4, "xceptDriver", 0, 11, false) == 0) && (chars.Length == 15))
                                return TypeValue.Value_AllExceptDriver;
                            break;
                        default:
                            break;
                      }
            ...
            case 'R':
                ...
                break;
            case 'T':
                if ((String.Compare(chars, 1, "runk", 0, 4, false) == 0) && (chars.Length == 5))
                    return TypeValue.Value_Trunk;
                break;
            default:
                break;
          }
        ...
        switch (the_enum)
          {
            ...
            case TypeValue.Value_Rear:
                return "Rear";
            case TypeValue.Value_Trunk:
                return "Trunk";
            case TypeValue.Value_Hood:
                return "Hood";
            case TypeValue.Value_AllExceptDriver:
    ...
    private void  fromJSONValue(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field Value of CarControlDoorSelectionJSON is not an array.");
        int count1 = json_array1.componentCount();
        if (count1 < 1)
            throw new Exception("The value for field Value of CarControlDoorSelectionJSON has too few elements.");
        List< TypeValue > vector_Value1 = new List< TypeValue >(count1);
        for (int num1 = 0; num1 < count1; ++num1)
          {
            JSONStringValue json_string = json_array1.component(num1).string_value();
            if (json_string == null)
                throw new Exception("The value for an element of field Value of CarControlDoorSelectionJSON is not a string.");
            TypeValue the_enum;
            switch (json_string.getData()[0])
              {
                    ...
                    if (String.Compare(json_string.getData(), 1, "ll", 0, 2, false) == 0)
                      {
                        ...
                        switch (json_string.getData()[3])
                          {
                            case 'E':
                                if ((String.Compare(json_string.getData(), 4, "xceptDriver", 0, 11, false) == 0) && (json_string.getData().Length == 15))
                                      {
                                        the_enum = TypeValue.Value_AllExceptDriver;
                                        goto enum_is_done;
                                      }
                                break;
                            default:
                ...
                case 'R':
                    ...
                    break;
                case 'T':
                    if ((String.Compare(json_string.getData(), 1, "runk", 0, 4, false) == 0) && (json_string.getData().Length == 5))
                          {
                            the_enum = TypeValue.Value_Trunk;
                            goto enum_is_done;
                          }
                    break;
                default:
            ...
            throw new Exception("The value for an element of field Value of CarControlDoorSelectionJSON is not one of the legal strings.");
          enum_is_done:;
            vector_Value1.Add(the_enum);
          }
    ...
    public CarControlDoorSelectionJSON()
      {
        flagHasValue = false;
    ...
    public void appendValue(string chars)
      {
        appendValue(stringToValue(chars));
      }
    ...
    public static CarControlDoorSelectionJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CarControlDoorSelectionJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlDoorSelection", ignore_extras);
    ...
    public static CarControlDoorSelectionJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static CarControlDoorSelectionJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CarControlDoorSelectionJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlDoorSelection", ignore_extras);
    ...
    public static CarControlDoorSelectionJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static CarControlDoorSelectionJSON from_text(string text, bool ignore_extras)
      {
        CarControlDoorSelectionJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlDoorSelection", ignore_extras);
            JSONParse.parse_json_value(text, "Text for CarControlDoorSelectionJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static CarControlDoorSelectionJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        CarControlDoorSelectionJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlDoorSelection", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    public class FieldHoldingArrayGeneratorValue : JSONArrayGenerator
  {
    ...
    public abstract class Generator : FieldHoldingArrayGeneratorValue
      {
        protected void finish()
          {
            Debug.Assert(have_value);
            CarControlDoorSelectionJSON result = new CarControlDoorSelectionJSON();
            result.initValue();
        ...
        protected abstract void handle_result(CarControlDoorSelectionJSON new_result);
        public Generator(bool ignore_extras) : base("Type CarControlDoorSelection")
          {
          }
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(CarControlDoorSelectionJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public CarControlDoorSelectionJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<CarControlDoorSelectionJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<CarControlDoorSelectionJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<CarControlDoorSelectionJSON> value;
  };
  };
