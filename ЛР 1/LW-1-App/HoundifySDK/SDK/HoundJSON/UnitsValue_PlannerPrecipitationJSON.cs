/* file "UnitsValue_PlannerPrecipitationJSON.cs" */
...
public class UnitsValue_PlannerPrecipitationJSON : JSONBase
  {
    private bool flagHasFormat;
    private WeatherUnitsFormatJSON  storeFormat;
    private bool flagHasUnits;
    private WeatherDepthUnitsJSON  storeUnits;
    ...
    private void  fromJSONUnits(JSONValue json_value, bool ignore_extras)
      {
        Debug.Assert(json_value != null);
        WeatherDepthUnitsJSON convert_classy = WeatherDepthUnitsJSON.from_json(json_value, ignore_extras, true);
    ...
    private void  fromJSONAbbreviatedUnits(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field AbbreviatedUnits of UnitsValue_PlannerPrecipitationJSON is not a string.");
    ...
    private void  fromJSONWrittenUnits(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field WrittenUnits of UnitsValue_PlannerPrecipitationJSON is not a string.");
    ...
    private void  fromJSONSpokenUnits(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field SpokenUnits of UnitsValue_PlannerPrecipitationJSON is not a string.");
        ...
        if (json_rational != null)
        ...
        else
          {
            ...
            if (json_integer != null)
              ...
              {
                throw new Exception("The value for field Value of UnitsValue_PlannerPrecipitationJSON is not a number.");
              }
          }
    ...
    public UnitsValue_PlannerPrecipitationJSON()
      {
        flagHasFormat = false;
        flagHasUnits = false;
    ...
    public WeatherDepthUnitsJSON   getUnits()
      {
        Debug.Assert(flagHasUnits);
        return storeUnits;
      }

    public WeatherDepthUnitsJSON.TypeValue  getUnitsValue()
      {
    ...
    public virtual int extraUnitsValue_PlannerPrecipitationComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraUnitsValue_PlannerPrecipitationComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraUnitsValue_PlannerPrecipitationComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraUnitsValue_PlannerPrecipitationLookup(string field_name)
      {
    ...
    public void setUnits(WeatherDepthUnitsJSON  new_value)
      {
        if (flagHasUnits)
          {
          }
    ...
    public void setUnits(WeatherDepthUnitsJSON.TypeValue new_value)
      {
        setUnits(new WeatherDepthUnitsJSON(new_value));
      }
    public void setUnits(string chars)
      {
        WeatherDepthUnitsJSON.TypeValueKnownValues known = WeatherDepthUnitsJSON.stringToValue(chars);
        WeatherDepthUnitsJSON.TypeValue new_value = new WeatherDepthUnitsJSON.TypeValue();
        if (known == WeatherDepthUnitsJSON.TypeValueKnownValues.Value__none)
          {
            new_value.in_known_list = false;
            new_value.string_value = chars;
          }
    ...
    public void setValue(double new_value)
      {
        flagHasValue = true;
        if (new_value < 0)
            throw new Exception("The value for field Value of UnitsValue_PlannerPrecipitationJSON is less than the lower bound (0) for that field.");
    ...
    public void setValueText(string new_value)
      {
        ...
        if (!(JSONWriter.is_valid_number_format(new_value)))
            throw new Exception("The text value for field Value of UnitsValue_PlannerPrecipitationJSON is not a valid number.");
    ...
    public virtual void extraUnitsValue_PlannerPrecipitationAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraUnitsValue_PlannerPrecipitationSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraUnitsValue_PlannerPrecipitationLookup(key);
        if (old_field == null)
          {
            extraUnitsValue_PlannerPrecipitationAppendPair(key, new_component);
          }
        else
          {
    ...
    public static UnitsValue_PlannerPrecipitationJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    ...
    public static UnitsValue_PlannerPrecipitationJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static UnitsValue_PlannerPrecipitationJSON from_text(string text, bool ignore_extras)
      {
        UnitsValue_PlannerPrecipitationJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UnitsValue_PlannerPrecipitation", ignore_extras);
            JSONParse.parse_json_value(text, "Text for UnitsValue_PlannerPrecipitationJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static UnitsValue_PlannerPrecipitationJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        UnitsValue_PlannerPrecipitationJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UnitsValue_PlannerPrecipitation", ignore_extras);
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        private WeatherDepthUnitsJSON.HoldingGenerator fieldGeneratorUnits;
        ...
        protected override void finish()
          {
            UnitsValue_PlannerPrecipitationJSON result = new UnitsValue_PlannerPrecipitationJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraUnitsValue_PlannerPrecipitationAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(UnitsValue_PlannerPrecipitationJSON result)
          {
        ...
        protected abstract void handle_result(UnitsValue_PlannerPrecipitationJSON new_result);
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorFormat = new WeatherUnitsFormatJSON.HoldingGenerator("field \"Format\" of the UnitsValue_PlannerPrecipitation class", ignore_extras);
            fieldGeneratorUnits = new WeatherDepthUnitsJSON.HoldingGenerator("field \"Units\" of the UnitsValue_PlannerPrecipitation class", ignore_extras);
            fieldGeneratorAbbreviatedUnits = new JSONHoldingStringGenerator("field \"AbbreviatedUnits\" of the UnitsValue_PlannerPrecipitation class");
            fieldGeneratorWrittenUnits = new JSONHoldingStringGenerator("field \"WrittenUnits\" of the UnitsValue_PlannerPrecipitation class");
            fieldGeneratorSpokenUnits = new JSONHoldingStringGenerator("field \"SpokenUnits\" of the UnitsValue_PlannerPrecipitation class");
            fieldGeneratorValue = new JSONHoldingNumberTextGenerator("field \"Value\" of the UnitsValue_PlannerPrecipitation class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the UnitsValue_PlannerPrecipitation class");
            allow_incomplete = false;
            allow_unpolished = false;
          }
        public Generator()
          {
            fieldGeneratorFormat = new WeatherUnitsFormatJSON.HoldingGenerator("field \"Format\" of the UnitsValue_PlannerPrecipitation class", false);
            fieldGeneratorUnits = new WeatherDepthUnitsJSON.HoldingGenerator("field \"Units\" of the UnitsValue_PlannerPrecipitation class", false);
            fieldGeneratorAbbreviatedUnits = new JSONHoldingStringGenerator("field \"AbbreviatedUnits\" of the UnitsValue_PlannerPrecipitation class");
            fieldGeneratorWrittenUnits = new JSONHoldingStringGenerator("field \"WrittenUnits\" of the UnitsValue_PlannerPrecipitation class");
            fieldGeneratorSpokenUnits = new JSONHoldingStringGenerator("field \"SpokenUnits\" of the UnitsValue_PlannerPrecipitation class");
            fieldGeneratorValue = new JSONHoldingNumberTextGenerator("field \"Value\" of the UnitsValue_PlannerPrecipitation class");
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(UnitsValue_PlannerPrecipitationJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public UnitsValue_PlannerPrecipitationJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<UnitsValue_PlannerPrecipitationJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<UnitsValue_PlannerPrecipitationJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<UnitsValue_PlannerPrecipitationJSON> value;
  };
  };
