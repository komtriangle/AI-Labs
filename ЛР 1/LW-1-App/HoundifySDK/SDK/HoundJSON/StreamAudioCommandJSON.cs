/* file "StreamAudioCommandJSON.cs" */
...
public abstract class StreamAudioCommandJSON : CommandResultJSON
  {
    ...
    private void  fromJSONFulfillments(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field Fulfillments of StreamAudioCommandJSON is not an array.");
        int count1 = json_array1.componentCount();
        if (count1 < 1)
            throw new Exception("The value for field Fulfillments of StreamAudioCommandJSON has too few elements.");
    ...
    private void  fromJSONDurationType(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field DurationType of StreamAudioCommandJSON is not a string.");
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field DurationInSeconds of StreamAudioCommandJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field DurationInSeconds of StreamAudioCommandJSON is not an integer.");
              }
    ...
    private void  fromJSONLogoImage(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field LogoImage of StreamAudioCommandJSON is not a string.");
    ...
    private void  fromJSONProvider(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field Provider of StreamAudioCommandJSON is not a string.");
    ...
    public abstract int extraStreamAudioCommandComponentCount();
    public abstract string extraStreamAudioCommandComponentKey(int component_num);
    public abstract JSONValue extraStreamAudioCommandComponentValue(int component_num);
    public abstract JSONValue extraStreamAudioCommandLookup(string field_name);
    public override int extraCommandResultComponentCount()
      {
        ...
        if (flagHasSuggestions)
            ++result;
        result += extraStreamAudioCommandComponentCount();
        return result;
      }
    public override string extraCommandResultComponentKey(int component_num)
      {
        ...
        return extraStreamAudioCommandComponentKey(remainder);
      }
    public override JSONValue extraCommandResultComponentValue(int component_num)
      {
        ...
        return extraStreamAudioCommandComponentValue(remainder);
      }
    public override JSONValue extraCommandResultLookup(string field_name)
      {
        switch (field_name[0])
          {
            ...
            case 'S':
                switch (field_name[1])
                  {
                    case 't':
                        if ((String.Compare(field_name, 2, "reamAudioKind", 0, 13, false) == 0) && (field_name.Length == 15))
                            return new JSONStringValue(getStreamAudioKind());
                        break;
                    case 'u':
        ...
        return extraStreamAudioCommandLookup(field_name);
      }
    ...
    public abstract void extraStreamAudioCommandAppendPair(string key, JSONValue new_component);
    public abstract void extraStreamAudioCommandSetField(string key, JSONValue new_component);
    public override void extraCommandResultAppendPair(string key, JSONValue new_component)
      {
        switch (key[0])
          {
            ...
            case 'S':
                switch (key[1])
                  {
                    case 't':
                        if ((String.Compare(key, 2, "reamAudioKind", 0, 13, false) == 0) && (key.Length == 15))
                            return;
                        break;
                    case 'u':
        ...
        extraStreamAudioCommandAppendPair(key, new_component);
      }
    public override void extraCommandResultSetField(string key, JSONValue new_component)
      {
        ...
        extraStreamAudioCommandSetField(key, new_component);
      }
    ...
    public static new StreamAudioCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        StreamAudioCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type StreamAudioCommand", ignore_extras);
    ...
    public static new StreamAudioCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new StreamAudioCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        StreamAudioCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type StreamAudioCommand", ignore_extras);
    ...
    public static new StreamAudioCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new StreamAudioCommandJSON from_text(string text, bool ignore_extras)
      {
        StreamAudioCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type StreamAudioCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for StreamAudioCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new StreamAudioCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        StreamAudioCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type StreamAudioCommand", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorProvider : JSONArrayGenerator
  {
    ...
    public List<TypeProvider> value;
        ...
        protected override void finish()
          {
            ...
            if (!(getCommandResultJSONKey().Equals("StreamAudio")))
                throw new Exception("The key field has a value other than `StreamAudio'.");
            StreamAudioCommandJSON result = createForKey(keyGenerator.value, unknownFieldGenerator.index);
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraStreamAudioCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected string getStreamAudioCommandJSONKey()
          {
            if (!(keyGenerator.have_value))
                throw new Exception("The `StreamAudioKind' field is missing.");
        ...
        protected override void handle_result(CommandResultJSON new_result)
          {
            handle_result((StreamAudioCommandJSON )new_result);
          }
        protected void finish(StreamAudioCommandJSON result)
          {
        ...
        protected abstract void handle_result(StreamAudioCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorFulfillments = new StreamFulfillmentJSON.HoldingArrayGenerator("field \"Fulfillments\" of the StreamAudioCommand class", ignore_extras);
            fieldGeneratorDurationType = new FieldHoldingGeneratorDurationType("field \"DurationType\" of the StreamAudioCommand class");
            fieldGeneratorDurationInSeconds = new FieldHoldingGeneratorDurationInSeconds("field \"DurationInSeconds\" of the StreamAudioCommand class");
            fieldGeneratorLogoImage = new JSONHoldingStringGenerator("field \"LogoImage\" of the StreamAudioCommand class");
            fieldGeneratorAttribution = new AttributionJSON.HoldingGenerator("field \"Attribution\" of the StreamAudioCommand class", ignore_extras);
            fieldGeneratorProvider = new FieldHoldingGeneratorProvider("field \"Provider\" of the StreamAudioCommand class");
            fieldGeneratorSuggestions = new SuggestedStationsJSON.HoldingGenerator("field \"Suggestions\" of the StreamAudioCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            keyGenerator = new JSONHoldingStringGenerator("key field \"StreamAudioKind\" of the StreamAudioCommand class");
            set_what("the StreamAudioCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorFulfillments = new StreamFulfillmentJSON.HoldingArrayGenerator("field \"Fulfillments\" of the StreamAudioCommand class", false);
            fieldGeneratorDurationType = new FieldHoldingGeneratorDurationType("field \"DurationType\" of the StreamAudioCommand class");
            fieldGeneratorDurationInSeconds = new FieldHoldingGeneratorDurationInSeconds("field \"DurationInSeconds\" of the StreamAudioCommand class");
            fieldGeneratorLogoImage = new JSONHoldingStringGenerator("field \"LogoImage\" of the StreamAudioCommand class");
            fieldGeneratorAttribution = new AttributionJSON.HoldingGenerator("field \"Attribution\" of the StreamAudioCommand class", false);
            fieldGeneratorProvider = new FieldHoldingGeneratorProvider("field \"Provider\" of the StreamAudioCommand class");
            fieldGeneratorSuggestions = new SuggestedStationsJSON.HoldingGenerator("field \"Suggestions\" of the StreamAudioCommand class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(StreamAudioCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public StreamAudioCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<StreamAudioCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<StreamAudioCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<StreamAudioCommandJSON> value;
  };
    class GenericStreamAudioCommandJSON : StreamAudioCommandJSON
      {
        private string key;
        private List<string> extraKeys;
        private List<JSONValue > extraValues;
        private Dictionary<string, JSONValue > extraIndex;
        public GenericStreamAudioCommandJSON(string init_key)
          {
            key = init_key;
        ...
        public override int extraStreamAudioCommandComponentCount()
          {
            Debug.Assert(extraKeys.Count == extraValues.Count);
            return extraKeys.Count;
          }
        public override string extraStreamAudioCommandComponentKey(int component_num)
          {
            Debug.Assert(extraKeys.Count == extraValues.Count);
            Debug.Assert(component_num < extraValues.Count);
            return extraKeys[component_num];
          }
        public override JSONValue extraStreamAudioCommandComponentValue(int component_num)
          {
            Debug.Assert(extraKeys.Count == extraValues.Count);
            Debug.Assert(component_num < extraValues.Count);
            return extraValues[component_num];
          }
        public override JSONValue extraStreamAudioCommandLookup(string field_name)
          {
            JSONValue result = (extraIndex.ContainsKey(field_name) ? extraIndex[field_name] : null);
            return result;
          }
        public override void extraStreamAudioCommandAppendPair(string key, JSONValue new_component)
          {
        ...
        public override void extraStreamAudioCommandSetField(string key, JSONValue new_component)
          {
            Debug.Assert(key != null);
            Debug.Assert(new_component != null);

            JSONValue old_field = extraStreamAudioCommandLookup(key);
            if (old_field == null)
              {
                extraStreamAudioCommandAppendPair(key, new_component);
              }
    ...
    public static new StreamAudioCommandJSON createForKey(string key, Dictionary<string, JSONValue > other_field_index)
      {
    if ((String.Compare(key, 0, "StreamLiveStation", 0, 17, false) == 0) && (key.Length == 17))
        return new StreamLiveStationCommandJSON();

        return new GenericStreamAudioCommandJSON(key);
      }
  };
