/* file "DialExactContactCommandJSON.cs" */
...
public class DialExactContactCommandJSON : PhoneCommandJSON
  {
    ...
    private void  fromJSONNumber(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field Number of DialExactContactCommandJSON is not a string.");
    ...
    private void  fromJSONContacts(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field Contacts of DialExactContactCommandJSON is not an array.");
        int count1 = json_array1.componentCount();
        if (count1 < 1)
            throw new Exception("The value for field Contacts of DialExactContactCommandJSON has too few elements.");
    ...
    public DialExactContactCommandJSON()
      {
        flagHasNumber = false;
    ...
    public virtual int extraDialExactContactCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraDialExactContactCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraDialExactContactCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraDialExactContactCommandLookup(string field_name)
      {
    ...
    public virtual void extraDialExactContactCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraDialExactContactCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new DialExactContactCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        DialExactContactCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DialExactContactCommand", ignore_extras);
    ...
    public static new DialExactContactCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new DialExactContactCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        DialExactContactCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DialExactContactCommand", ignore_extras);
    ...
    public static new DialExactContactCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new DialExactContactCommandJSON from_text(string text, bool ignore_extras)
      {
        DialExactContactCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DialExactContactCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for DialExactContactCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new DialExactContactCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        DialExactContactCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DialExactContactCommand", ignore_extras);
    ...
    public new abstract class Generator : PhoneCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getPhoneCommandJSONKey().Equals("DialExactContact")))
                throw new Exception("The key field has a value other than `DialExactContact'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraDialExactContactCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(DialExactContactCommandJSON result)
          {
        ...
        protected abstract void handle_result(DialExactContactCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorNumber = new JSONHoldingStringGenerator("field \"Number\" of the DialExactContactCommand class");
            fieldGeneratorContacts = new OneContactJSON.HoldingArrayGenerator("field \"Contacts\" of the DialExactContactCommand class", ignore_extras);
        ...
        public Generator() : base(false)
          {
            fieldGeneratorNumber = new JSONHoldingStringGenerator("field \"Number\" of the DialExactContactCommand class");
            fieldGeneratorContacts = new OneContactJSON.HoldingArrayGenerator("field \"Contacts\" of the DialExactContactCommand class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(DialExactContactCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public DialExactContactCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<DialExactContactCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<DialExactContactCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<DialExactContactCommandJSON> value;
  };
  };
