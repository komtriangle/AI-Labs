...
public class UnitsValue_PressureJSON : JSONBase
  {
    ...
    private WeatherPressureUnitsJSON  storeUnits;
    ...
    private void  fromJSONUnits(JSONValue json_value, bool ignore_extras)
      {
        Debug.Assert(json_value != null);
        WeatherPressureUnitsJSON convert_classy = WeatherPressureUnitsJSON.from_json(json_value, ignore_extras, true);
    ...
    private void  fromJSONAbbreviatedUnits(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field AbbreviatedUnits of UnitsValue_PressureJSON is not a string.");
    ...
    public WeatherPressureUnitsJSON   getUnits()
      {
        Debug.Assert(flagHasUnits);
        return storeUnits;
      }

    public WeatherPressureUnitsJSON.TypeValue  getUnitsValue()
      {
    ...
    public void setUnits(WeatherPressureUnitsJSON  new_value)
      {
        if (flagHasUnits)
          {
          }
    ...
    public void setUnits(WeatherPressureUnitsJSON.TypeValue new_value)
      {
        setUnits(new WeatherPressureUnitsJSON(new_value));
      }
    public void setUnits(string chars)
      {
        WeatherPressureUnitsJSON.TypeValueKnownValues known = WeatherPressureUnitsJSON.stringToValue(chars);
        WeatherPressureUnitsJSON.TypeValue new_value = new WeatherPressureUnitsJSON.TypeValue();
        if (known == WeatherPressureUnitsJSON.TypeValueKnownValues.Value__none)
          {
            new_value.in_known_list = false;
            new_value.string_value = chars;
          }
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        private WeatherPressureUnitsJSON.HoldingGenerator fieldGeneratorUnits;
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorFormat = new WeatherUnitsFormatJSON.HoldingGenerator("field \"Format\" of the UnitsValue_Pressure class", ignore_extras);
            fieldGeneratorUnits = new WeatherPressureUnitsJSON.HoldingGenerator("field \"Units\" of the UnitsValue_Pressure class", ignore_extras);
            fieldGeneratorAbbreviatedUnits = new JSONHoldingStringGenerator("field \"AbbreviatedUnits\" of the UnitsValue_Pressure class");
        ...
        public Generator()
          {
            fieldGeneratorFormat = new WeatherUnitsFormatJSON.HoldingGenerator("field \"Format\" of the UnitsValue_Pressure class", false);
            fieldGeneratorUnits = new WeatherPressureUnitsJSON.HoldingGenerator("field \"Units\" of the UnitsValue_Pressure class", false);
            fieldGeneratorAbbreviatedUnits = new JSONHoldingStringGenerator("field \"AbbreviatedUnits\" of the UnitsValue_Pressure class");
            fieldGeneratorWrittenUnits = new JSONHoldingStringGenerator("field \"WrittenUnits\" of the UnitsValue_Pressure class");
            fieldGeneratorSpokenUnits = new JSONHoldingStringGenerator("field \"SpokenUnits\" of the UnitsValue_Pressure class");
            fieldGeneratorValue = new JSONHoldingNumberTextGenerator("field \"Value\" of the UnitsValue_Pressure class");
