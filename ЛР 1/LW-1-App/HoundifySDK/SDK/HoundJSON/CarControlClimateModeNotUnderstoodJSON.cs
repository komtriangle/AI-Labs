/* file "CarControlClimateModeNotUnderstoodJSON.cs" */
...
public class CarControlClimateModeNotUnderstoodJSON : CarControlCommandJSON
  {
    ...
    private void  fromJSONCommandType(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field CommandType of CarControlClimateModeNotUnderstoodJSON is not a string.");
        ...
        throw new Exception("The value for field CommandType of CarControlClimateModeNotUnderstoodJSON is not one of the legal strings.");
      enum_is_done:;
        setCommandType(the_enum);
      }


    public CarControlClimateModeNotUnderstoodJSON()
      {
    ...
    public virtual int extraCarControlClimateModeNotUnderstoodComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraCarControlClimateModeNotUnderstoodComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraCarControlClimateModeNotUnderstoodComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraCarControlClimateModeNotUnderstoodLookup(string field_name)
      {
    ...
    public override int extraCarControlCommandComponentCount()
      {
        ...
        if (flagHasCommandType)
            ++result;
        result += extraCarControlClimateModeNotUnderstoodComponentCount();
        return result;
      }
    public override string extraCarControlCommandComponentKey(int component_num)
      {
        ...
        return extraCarControlClimateModeNotUnderstoodComponentKey(remainder);
      }
    public override JSONValue extraCarControlCommandComponentValue(int component_num)
      {
        ...
        return extraCarControlClimateModeNotUnderstoodComponentValue(remainder);
      }
    public override JSONValue extraCarControlCommandLookup(string field_name)
      {
        ...
        return extraCarControlClimateModeNotUnderstoodLookup(field_name);
      }
    ...
    public virtual void extraCarControlClimateModeNotUnderstoodAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraCarControlClimateModeNotUnderstoodSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraCarControlClimateModeNotUnderstoodLookup(key);
        if (old_field == null)
          {
            extraCarControlClimateModeNotUnderstoodAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraCarControlCommandSetField(string key, JSONValue new_component)
      {
        ...
        extraCarControlClimateModeNotUnderstoodSetField(key, new_component);
      }
    ...
    public static new CarControlClimateModeNotUnderstoodJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new CarControlClimateModeNotUnderstoodJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CarControlClimateModeNotUnderstoodJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlClimateModeNotUnderstood", ignore_extras);
    ...
    public static new CarControlClimateModeNotUnderstoodJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new CarControlClimateModeNotUnderstoodJSON from_text(string text, bool ignore_extras)
      {
        CarControlClimateModeNotUnderstoodJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlClimateModeNotUnderstood", ignore_extras);
            JSONParse.parse_json_value(text, "Text for CarControlClimateModeNotUnderstoodJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new CarControlClimateModeNotUnderstoodJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        CarControlClimateModeNotUnderstoodJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlClimateModeNotUnderstood", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorCommandType : JSONArrayGenerator
  {
    ...
    public List<TypeCommandType> value;
        ...
        protected override void finish()
          {
            if (!(getCarControlCommandJSONKey().Equals("CarControlClimateModeNotUnderstood")))
                throw new Exception("The key field has a value other than `CarControlClimateModeNotUnderstood'.");
            CarControlClimateModeNotUnderstoodJSON result = new CarControlClimateModeNotUnderstoodJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraCarControlClimateModeNotUnderstoodAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(CarControlCommandJSON new_result)
          {
            handle_result((CarControlClimateModeNotUnderstoodJSON )new_result);
          }
        protected void finish(CarControlClimateModeNotUnderstoodJSON result)
          {
        ...
        protected abstract void handle_result(CarControlClimateModeNotUnderstoodJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorCommandType = new FieldHoldingGeneratorCommandType("field \"CommandType\" of the CarControlClimateModeNotUnderstood class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the CarControlClimateModeNotUnderstood class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(CarControlClimateModeNotUnderstoodJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public CarControlClimateModeNotUnderstoodJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<CarControlClimateModeNotUnderstoodJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<CarControlClimateModeNotUnderstoodJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<CarControlClimateModeNotUnderstoodJSON> value;
  };
  };
