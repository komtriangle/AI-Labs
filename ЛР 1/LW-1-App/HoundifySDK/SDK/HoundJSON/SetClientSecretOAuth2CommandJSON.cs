/* file "SetClientSecretOAuth2CommandJSON.cs" */
...
public class SetClientSecretOAuth2CommandJSON : OAuth2CommandJSON
  {
    ...
    private JSONValue  extraDescriptionToJSON()
      {
        JSONStringValue generated_string_Description = new JSONStringValue(storeDescription);
        return generated_string_Description;
      }
    ...
    private void  fromJSONStatus(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field Status of SetClientSecretOAuth2CommandJSON is not a string.");
    ...
    private void  fromJSONDescription(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field Description of SetClientSecretOAuth2CommandJSON is not a string.");
        setDescription(json_string.getData());
      }


    public SetClientSecretOAuth2CommandJSON()
      {
    ...
    public override string  getOAuth2CommandKind()
      {
        return "SetClientSecretOAuth2Command";
      }
    ...
    public virtual int extraSetClientSecretOAuth2CommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSetClientSecretOAuth2CommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSetClientSecretOAuth2CommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSetClientSecretOAuth2CommandLookup(string field_name)
      {
    ...
    public override int extraOAuth2CommandComponentCount()
      {
        ...
        if (flagHasDescription)
            ++result;
        result += extraSetClientSecretOAuth2CommandComponentCount();
        return result;
      }
    public override string extraOAuth2CommandComponentKey(int component_num)
      {
        ...
        return extraSetClientSecretOAuth2CommandComponentKey(remainder);
      }
    public override JSONValue extraOAuth2CommandComponentValue(int component_num)
      {
        ...
        return extraSetClientSecretOAuth2CommandComponentValue(remainder);
      }
    public override JSONValue extraOAuth2CommandLookup(string field_name)
      {
        ...
        return extraSetClientSecretOAuth2CommandLookup(field_name);
      }
    ...
    public virtual void extraSetClientSecretOAuth2CommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSetClientSecretOAuth2CommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraSetClientSecretOAuth2CommandLookup(key);
        if (old_field == null)
          {
            extraSetClientSecretOAuth2CommandAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraOAuth2CommandSetField(string key, JSONValue new_component)
      {
        ...
        extraSetClientSecretOAuth2CommandSetField(key, new_component);
      }
    ...
    public static new SetClientSecretOAuth2CommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SetClientSecretOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SetClientSecretOAuth2Command", ignore_extras);
    ...
    public static new SetClientSecretOAuth2CommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SetClientSecretOAuth2CommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SetClientSecretOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SetClientSecretOAuth2Command", ignore_extras);
    ...
    public static new SetClientSecretOAuth2CommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SetClientSecretOAuth2CommandJSON from_text(string text, bool ignore_extras)
      {
        SetClientSecretOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SetClientSecretOAuth2Command", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SetClientSecretOAuth2CommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new SetClientSecretOAuth2CommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SetClientSecretOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SetClientSecretOAuth2Command", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorStatus : JSONArrayGenerator
  {
    ...
    public List<TypeStatus> value;
        ...
        protected override void finish()
          {
            if (!(getOAuth2CommandJSONKey().Equals("SetClientSecretOAuth2Command")))
                throw new Exception("The key field has a value other than `SetClientSecretOAuth2Command'.");
            SetClientSecretOAuth2CommandJSON result = new SetClientSecretOAuth2CommandJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSetClientSecretOAuth2CommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(OAuth2CommandJSON new_result)
          {
            handle_result((SetClientSecretOAuth2CommandJSON )new_result);
          }
        protected void finish(SetClientSecretOAuth2CommandJSON result)
          {
        ...
        protected abstract void handle_result(SetClientSecretOAuth2CommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorServiceType = new OAuth2ServiceTypeJSON.HoldingGenerator("field \"ServiceType\" of the SetClientSecretOAuth2Command class", ignore_extras);
            fieldGeneratorStatus = new FieldHoldingGeneratorStatus("field \"Status\" of the SetClientSecretOAuth2Command class");
            fieldGeneratorDescription = new JSONHoldingStringGenerator("field \"Description\" of the SetClientSecretOAuth2Command class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the SetClientSecretOAuth2Command class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorServiceType = new OAuth2ServiceTypeJSON.HoldingGenerator("field \"ServiceType\" of the SetClientSecretOAuth2Command class", false);
            fieldGeneratorStatus = new FieldHoldingGeneratorStatus("field \"Status\" of the SetClientSecretOAuth2Command class");
            fieldGeneratorDescription = new JSONHoldingStringGenerator("field \"Description\" of the SetClientSecretOAuth2Command class");
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(SetClientSecretOAuth2CommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public SetClientSecretOAuth2CommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SetClientSecretOAuth2CommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<SetClientSecretOAuth2CommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SetClientSecretOAuth2CommandJSON> value;
  };
  };
