/* file "RecipeAidQueryStateJSON.cs" */
...
public class RecipeAidQueryStateJSON : JSONBase
  {
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field CurrentStep of RecipeAidQueryStateJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field CurrentStep of RecipeAidQueryStateJSON is not an integer.");
              }
    ...
    private void  fromJSONProcessedInstructions(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field ProcessedInstructions of RecipeAidQueryStateJSON is not an array.");
    ...
    public RecipeAidQueryStateJSON()
      {
    ...
    public virtual int extraRecipeAidQueryStateComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraRecipeAidQueryStateComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraRecipeAidQueryStateComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraRecipeAidQueryStateLookup(string field_name)
      {
    ...
    public virtual void extraRecipeAidQueryStateAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraRecipeAidQueryStateSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraRecipeAidQueryStateLookup(key);
        if (old_field == null)
          {
            extraRecipeAidQueryStateAppendPair(key, new_component);
          }
        else
          {
    ...
    public static RecipeAidQueryStateJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RecipeAidQueryStateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RecipeAidQueryState", ignore_extras);
    ...
    public static RecipeAidQueryStateJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static RecipeAidQueryStateJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RecipeAidQueryStateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RecipeAidQueryState", ignore_extras);
    ...
    public static RecipeAidQueryStateJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static RecipeAidQueryStateJSON from_text(string text, bool ignore_extras)
      {
        RecipeAidQueryStateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RecipeAidQueryState", ignore_extras);
            JSONParse.parse_json_value(text, "Text for RecipeAidQueryStateJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static RecipeAidQueryStateJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        RecipeAidQueryStateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RecipeAidQueryState", ignore_extras);
    ...
    private class FieldHoldingArrayGeneratorCurrentStep : JSONHoldingIntegerUnboundRangeArrayGenerator
        ...
        protected override void finish()
          {
            RecipeAidQueryStateJSON result = new RecipeAidQueryStateJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraRecipeAidQueryStateAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(RecipeAidQueryStateJSON result)
          {
        ...
        protected abstract void handle_result(RecipeAidQueryStateJSON new_result);
            ...
            switch (field_name[0])
              {
                ...
                case 'P':
                    ...
                    break;
                case 'R':
                    if ((String.Compare(field_name, 1, "ecipe", 0, 5, false) == 0) && (field_name.Length == 6))
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorCurrentStep = new FieldHoldingGeneratorCurrentStep("field \"CurrentStep\" of the RecipeAidQueryState class");
            fieldGeneratorRecipe = new DishDetailsJSON.HoldingGenerator("field \"Recipe\" of the RecipeAidQueryState class", ignore_extras);
            fieldGeneratorProcessedInstructions = new RecipeAidInstructionDetailsJSON.HoldingArrayGenerator("field \"ProcessedInstructions\" of the RecipeAidQueryState class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the RecipeAidQueryState class");
        ...
        public Generator()
          {
            fieldGeneratorCurrentStep = new FieldHoldingGeneratorCurrentStep("field \"CurrentStep\" of the RecipeAidQueryState class");
            fieldGeneratorRecipe = new DishDetailsJSON.HoldingGenerator("field \"Recipe\" of the RecipeAidQueryState class", false);
            fieldGeneratorProcessedInstructions = new RecipeAidInstructionDetailsJSON.HoldingArrayGenerator("field \"ProcessedInstructions\" of the RecipeAidQueryState class", false);
        ...
        public void set_allow_incomplete(bool new_allow_incomplete)
          {
            ...
            fieldGeneratorRecipe.set_allow_incomplete(new_allow_incomplete);
            fieldGeneratorProcessedInstructions.set_allow_incomplete(new_allow_incomplete);
          }
        public void set_allow_unpolished(bool new_allow_unpolished)
          {
            allow_unpolished = new_allow_unpolished;
            fieldGeneratorRecipe.set_allow_unpolished(new_allow_unpolished);
            fieldGeneratorProcessedInstructions.set_allow_unpolished(new_allow_unpolished);
          }
      };
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(RecipeAidQueryStateJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public RecipeAidQueryStateJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<RecipeAidQueryStateJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<RecipeAidQueryStateJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<RecipeAidQueryStateJSON> value;
  };
  };
