/* file "SetClientIDOAuth2CommandJSON.cs" */
...
public class SetClientIDOAuth2CommandJSON : OAuth2CommandJSON
  {
    ...
    private void  fromJSONStatus(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field Status of SetClientIDOAuth2CommandJSON is not a string.");
    ...
    private void  fromJSONDescription(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field Description of SetClientIDOAuth2CommandJSON is not a string.");
        setDescription(json_string.getData());
      }


    public SetClientIDOAuth2CommandJSON()
      {
    ...
    public override string  getOAuth2CommandKind()
      {
        return "SetClientIDOAuth2Command";
      }
    ...
    public virtual int extraSetClientIDOAuth2CommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSetClientIDOAuth2CommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSetClientIDOAuth2CommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSetClientIDOAuth2CommandLookup(string field_name)
      {
    ...
    public override int extraOAuth2CommandComponentCount()
      {
        ...
        if (flagHasDescription)
            ++result;
        result += extraSetClientIDOAuth2CommandComponentCount();
        return result;
      }
    public override string extraOAuth2CommandComponentKey(int component_num)
      {
        ...
        return extraSetClientIDOAuth2CommandComponentKey(remainder);
      }
    public override JSONValue extraOAuth2CommandComponentValue(int component_num)
      {
        ...
        return extraSetClientIDOAuth2CommandComponentValue(remainder);
      }
    public override JSONValue extraOAuth2CommandLookup(string field_name)
      {
        ...
        return extraSetClientIDOAuth2CommandLookup(field_name);
      }
    ...
    public virtual void extraSetClientIDOAuth2CommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSetClientIDOAuth2CommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraSetClientIDOAuth2CommandLookup(key);
        if (old_field == null)
          {
            extraSetClientIDOAuth2CommandAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraOAuth2CommandSetField(string key, JSONValue new_component)
      {
        ...
        extraSetClientIDOAuth2CommandSetField(key, new_component);
      }
    ...
    public static new SetClientIDOAuth2CommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SetClientIDOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SetClientIDOAuth2Command", ignore_extras);
    ...
    public static new SetClientIDOAuth2CommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SetClientIDOAuth2CommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SetClientIDOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SetClientIDOAuth2Command", ignore_extras);
    ...
    public static new SetClientIDOAuth2CommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SetClientIDOAuth2CommandJSON from_text(string text, bool ignore_extras)
      {
        SetClientIDOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SetClientIDOAuth2Command", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SetClientIDOAuth2CommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new SetClientIDOAuth2CommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SetClientIDOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SetClientIDOAuth2Command", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorStatus : JSONArrayGenerator
  {
    ...
    public List<TypeStatus> value;
        ...
        protected override void finish()
          {
            if (!(getOAuth2CommandJSONKey().Equals("SetClientIDOAuth2Command")))
                throw new Exception("The key field has a value other than `SetClientIDOAuth2Command'.");
            SetClientIDOAuth2CommandJSON result = new SetClientIDOAuth2CommandJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSetClientIDOAuth2CommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(OAuth2CommandJSON new_result)
          {
            handle_result((SetClientIDOAuth2CommandJSON )new_result);
          }
        protected void finish(SetClientIDOAuth2CommandJSON result)
          {
        ...
        protected abstract void handle_result(SetClientIDOAuth2CommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorServiceType = new OAuth2ServiceTypeJSON.HoldingGenerator("field \"ServiceType\" of the SetClientIDOAuth2Command class", ignore_extras);
            fieldGeneratorStatus = new FieldHoldingGeneratorStatus("field \"Status\" of the SetClientIDOAuth2Command class");
            fieldGeneratorDescription = new JSONHoldingStringGenerator("field \"Description\" of the SetClientIDOAuth2Command class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the SetClientIDOAuth2Command class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorServiceType = new OAuth2ServiceTypeJSON.HoldingGenerator("field \"ServiceType\" of the SetClientIDOAuth2Command class", false);
            fieldGeneratorStatus = new FieldHoldingGeneratorStatus("field \"Status\" of the SetClientIDOAuth2Command class");
            fieldGeneratorDescription = new JSONHoldingStringGenerator("field \"Description\" of the SetClientIDOAuth2Command class");
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(SetClientIDOAuth2CommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public SetClientIDOAuth2CommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SetClientIDOAuth2CommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<SetClientIDOAuth2CommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SetClientIDOAuth2CommandJSON> value;
  };
  };
