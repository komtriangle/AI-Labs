/* file "RecipientInfoNotUnderstoodCommandJSON.cs" */
...
public class RecipientInfoNotUnderstoodCommandJSON : CommunicationCommandJSON
  {
            ...
            protected virtual JSONHandler start_known_field(string field_name)
              {
                switch (field_name[0])
                  {
                    case 'C':
                        if ((String.Compare(field_name, 1, "ommunicationType", 0, 16, false) == 0) && (field_name.Length == 17))
                            return fieldGeneratorCommunicationType;
                        break;
                    case 'N':
                        if ((String.Compare(field_name, 1, "otUnderstoodWords", 0, 17, false) == 0) && (field_name.Length == 18))
    ...
    public RecipientInfoNotUnderstoodCommandJSON()
      {
    ...
    public override string  getCommunicationCommandKind()
      {
    ...
    public virtual int extraRecipientInfoNotUnderstoodCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraRecipientInfoNotUnderstoodCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraRecipientInfoNotUnderstoodCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraRecipientInfoNotUnderstoodCommandLookup(string field_name)
      {
        JSONValue result = (extraIndex.ContainsKey(field_name) ? extraIndex[field_name] : null);
        return result;
      }
    public override int extraCommunicationCommandComponentCount()
      {
        ...
        if (flagHasNativeData)
            ++result;
        result += extraRecipientInfoNotUnderstoodCommandComponentCount();
        return result;
      }
    public override string extraCommunicationCommandComponentKey(int component_num)
      {
        ...
        return extraRecipientInfoNotUnderstoodCommandComponentKey(remainder);
      }
    public override JSONValue extraCommunicationCommandComponentValue(int component_num)
      {
        ...
        return extraRecipientInfoNotUnderstoodCommandComponentValue(remainder);
      }
    public override JSONValue extraCommunicationCommandLookup(string field_name)
      {
        ...
        return extraRecipientInfoNotUnderstoodCommandLookup(field_name);
      }
    ...
    public virtual void extraRecipientInfoNotUnderstoodCommandAppendPair(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public virtual void extraRecipientInfoNotUnderstoodCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraRecipientInfoNotUnderstoodCommandLookup(key);
        if (old_field == null)
          {
            extraRecipientInfoNotUnderstoodCommandAppendPair(key, new_component);
          }
        else
          {
            int count = extraKeys.Count;
    ...
    public override void extraCommunicationCommandSetField(string key, JSONValue new_component)
      {
        ...
        extraRecipientInfoNotUnderstoodCommandSetField(key, new_component);
      }
    ...
    public static new RecipientInfoNotUnderstoodCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RecipientInfoNotUnderstoodCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RecipientInfoNotUnderstoodCommand", ignore_extras);
            generator.set_allow_incomplete(allow_incomplete);
            generator.set_allow_unpolished(allow_unpolished);
            if (allow_incomplete || allow_unpolished)
                json_value.write(generator);
    ...
    public static new RecipientInfoNotUnderstoodCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RecipientInfoNotUnderstoodCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RecipientInfoNotUnderstoodCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RecipientInfoNotUnderstoodCommand", ignore_extras);
    ...
    public static new RecipientInfoNotUnderstoodCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RecipientInfoNotUnderstoodCommandJSON from_text(string text, bool ignore_extras)
      {
        RecipientInfoNotUnderstoodCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RecipientInfoNotUnderstoodCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for RecipientInfoNotUnderstoodCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new RecipientInfoNotUnderstoodCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        RecipientInfoNotUnderstoodCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RecipientInfoNotUnderstoodCommand", ignore_extras);
    ...
    public new abstract class Generator : CommunicationCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getCommunicationCommandJSONKey().Equals("RecipientInfoNotUnderstoodCommand")))
                throw new Exception("The key field has a value other than `RecipientInfoNotUnderstoodCommand'.");
            RecipientInfoNotUnderstoodCommandJSON result = new RecipientInfoNotUnderstoodCommandJSON();
            Debug.Assert(result != null);
            finish(result);
            int extra_count = unknownFieldGenerator.field_names.Count;
            Debug.Assert(extra_count == unknownFieldGenerator.field_values.Count);
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraRecipientInfoNotUnderstoodCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
            unknownFieldGenerator.field_names.Clear();
            unknownFieldGenerator.field_values.Clear();
            unknownFieldGenerator.index = new Dictionary<string, JSONValue >();
        ...
        protected override void handle_result(CommunicationCommandJSON new_result)
          {
            handle_result((RecipientInfoNotUnderstoodCommandJSON )new_result);
          }
        protected void finish(RecipientInfoNotUnderstoodCommandJSON result)
          {
        ...
        protected abstract void handle_result(RecipientInfoNotUnderstoodCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the RecipientInfoNotUnderstoodCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the RecipientInfoNotUnderstoodCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the RecipientInfoNotUnderstoodCommand class", false);
            unknownFieldGenerator = new UnknownFieldGenerator(false);
            set_what("the RecipientInfoNotUnderstoodCommand class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(RecipientInfoNotUnderstoodCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public RecipientInfoNotUnderstoodCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<RecipientInfoNotUnderstoodCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<RecipientInfoNotUnderstoodCommandJSON>();
        base.set_what(what);
      }
    public HoldingArrayGenerator(bool ignore_extras)
      {
    ...
    public bool have_value;
    public List<RecipientInfoNotUnderstoodCommandJSON> value;
  };
  };
