/* file "DialOneContactNumberAmbiguousCommandJSON.cs" */
...
public class DialOneContactNumberAmbiguousCommandJSON : DisambiguateCommandJSON
  {
    ...
    private void  fromJSONUserSpecifiedName(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field UserSpecifiedName of DialOneContactNumberAmbiguousCommandJSON is not a string.");
        setUserSpecifiedName(json_string.getData());
      }


    public DialOneContactNumberAmbiguousCommandJSON()
      {
    ...
    public virtual int extraDialOneContactNumberAmbiguousCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraDialOneContactNumberAmbiguousCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraDialOneContactNumberAmbiguousCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraDialOneContactNumberAmbiguousCommandLookup(string field_name)
      {
    ...
    public virtual void extraDialOneContactNumberAmbiguousCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraDialOneContactNumberAmbiguousCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new DialOneContactNumberAmbiguousCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    ...
    public static new DialOneContactNumberAmbiguousCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new DialOneContactNumberAmbiguousCommandJSON from_text(string text, bool ignore_extras)
      {
        DialOneContactNumberAmbiguousCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DialOneContactNumberAmbiguousCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for DialOneContactNumberAmbiguousCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new DialOneContactNumberAmbiguousCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        DialOneContactNumberAmbiguousCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DialOneContactNumberAmbiguousCommand", ignore_extras);
    ...
    public new abstract class Generator : DisambiguateCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getDisambiguateCommandJSONKey().Equals("DialOneContactNumberAmbiguous")))
                throw new Exception("The key field has a value other than `DialOneContactNumberAmbiguous'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraDialOneContactNumberAmbiguousCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(DialOneContactNumberAmbiguousCommandJSON result)
          {
        ...
        protected abstract void handle_result(DialOneContactNumberAmbiguousCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorChoices = new ContactNumberChoicesJSON.HoldingGenerator("field \"Choices\" of the DialOneContactNumberAmbiguousCommand class", ignore_extras);
            fieldGeneratorUserSpecifiedName = new JSONHoldingStringGenerator("field \"UserSpecifiedName\" of the DialOneContactNumberAmbiguousCommand class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the DialOneContactNumberAmbiguousCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorChoices = new ContactNumberChoicesJSON.HoldingGenerator("field \"Choices\" of the DialOneContactNumberAmbiguousCommand class", false);
            fieldGeneratorUserSpecifiedName = new JSONHoldingStringGenerator("field \"UserSpecifiedName\" of the DialOneContactNumberAmbiguousCommand class");
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(DialOneContactNumberAmbiguousCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public DialOneContactNumberAmbiguousCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<DialOneContactNumberAmbiguousCommandJSON> result)
    ...
    public bool have_value;
    public List<DialOneContactNumberAmbiguousCommandJSON> value;
  };
  };
