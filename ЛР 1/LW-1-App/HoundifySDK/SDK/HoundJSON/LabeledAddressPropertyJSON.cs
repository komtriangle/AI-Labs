/* file "LabeledAddressPropertyJSON.cs" */
...
public class LabeledAddressPropertyJSON : PropertyJSON
  {
    ...
    private void  fromJSONLabel(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field Label of LabeledAddressPropertyJSON is not a string.");
    ...
    private void  fromJSONAliasLabels(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field AliasLabels of LabeledAddressPropertyJSON is not an array.");
        ...
        for (int num1 = 0; num1 < count1; ++num1)
          {
            ...
            if (json_string == null)
                throw new Exception("The value for an element of field AliasLabels of LabeledAddressPropertyJSON is not a string.");
    ...
    public LabeledAddressPropertyJSON()
      {
        flagHasLabel = false;
    ...
    public virtual int extraLabeledAddressPropertyComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraLabeledAddressPropertyComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraLabeledAddressPropertyComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraLabeledAddressPropertyLookup(string field_name)
      {
    ...
    public override int extraPropertyComponentCount()
      {
        ...
        if (flagHasAliasLabels)
            ++result;
        result += extraLabeledAddressPropertyComponentCount();
        return result;
      }
    public override string extraPropertyComponentKey(int component_num)
      {
        ...
        return extraLabeledAddressPropertyComponentKey(remainder);
      }
    public override JSONValue extraPropertyComponentValue(int component_num)
      {
        ...
        return extraLabeledAddressPropertyComponentValue(remainder);
      }
    public override JSONValue extraPropertyLookup(string field_name)
      {
        ...
        return extraLabeledAddressPropertyLookup(field_name);
      }
    ...
    public virtual void extraLabeledAddressPropertyAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraLabeledAddressPropertySetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraLabeledAddressPropertyLookup(key);
        if (old_field == null)
          {
            extraLabeledAddressPropertyAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraPropertySetField(string key, JSONValue new_component)
      {
        ...
        extraLabeledAddressPropertySetField(key, new_component);
      }
    ...
    public static new LabeledAddressPropertyJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        LabeledAddressPropertyJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type LabeledAddressProperty", ignore_extras);
    ...
    public static new LabeledAddressPropertyJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new LabeledAddressPropertyJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        LabeledAddressPropertyJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type LabeledAddressProperty", ignore_extras);
    ...
    public static new LabeledAddressPropertyJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new LabeledAddressPropertyJSON from_text(string text, bool ignore_extras)
      {
        LabeledAddressPropertyJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type LabeledAddressProperty", ignore_extras);
            JSONParse.parse_json_value(text, "Text for LabeledAddressPropertyJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new LabeledAddressPropertyJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        LabeledAddressPropertyJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type LabeledAddressProperty", ignore_extras);
    ...
    public new abstract class Generator : PropertyJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getPropertyJSONKey().Equals("LabeledAddress")))
                throw new Exception("The key field has a value other than `LabeledAddress'.");
            LabeledAddressPropertyJSON result = new LabeledAddressPropertyJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraLabeledAddressPropertyAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(PropertyJSON new_result)
          {
            handle_result((LabeledAddressPropertyJSON )new_result);
          }
        protected void finish(LabeledAddressPropertyJSON result)
          {
        ...
        protected abstract void handle_result(LabeledAddressPropertyJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorLabel = new JSONHoldingStringGenerator("field \"Label\" of the LabeledAddressProperty class");
            fieldGeneratorAliasLabels = new JSONHoldingStringArrayGenerator("field \"AliasLabels\" of the LabeledAddressProperty class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the LabeledAddressProperty class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(LabeledAddressPropertyJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public LabeledAddressPropertyJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<LabeledAddressPropertyJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<LabeledAddressPropertyJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<LabeledAddressPropertyJSON> value;
  };
  };
