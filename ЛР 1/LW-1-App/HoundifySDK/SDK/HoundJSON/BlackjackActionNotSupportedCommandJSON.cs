/* file "BlackjackActionNotSupportedCommandJSON.cs" */
...
public class BlackjackActionNotSupportedCommandJSON : BlackjackCommandJSON
  {
        ...
        public virtual void write_fields_as_json(JSONHandler handler, bool partial_allowed)
          {
            ...
            Debug.Assert(partial_allowed || flagHasBetAmount);
            if (flagHasBetAmount)
              {
            ...
            Debug.Assert(partial_allowed || flagHasDealerHandTotal);
            ...
            protected void finish(TypeNativeDataJSON result)
              {
                ...
                else if ((!(result.hasBetAmount())) && !allow_incomplete)
                  {
                ...
                else if ((!(result.hasDealerHandTotal())) && !allow_incomplete)
                  {
    ...
    public BlackjackActionNotSupportedCommandJSON()
      {
    ...
    public virtual int extraBlackjackActionNotSupportedCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraBlackjackActionNotSupportedCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraBlackjackActionNotSupportedCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraBlackjackActionNotSupportedCommandLookup(string field_name)
      {
        JSONValue result = (extraIndex.ContainsKey(field_name) ? extraIndex[field_name] : null);
        return result;
      }
    public override int extraBlackjackCommandComponentCount()
      {
        ...
        if (flagHasNativeData)
            ++result;
        result += extraBlackjackActionNotSupportedCommandComponentCount();
        return result;
      }
    public override string extraBlackjackCommandComponentKey(int component_num)
      {
        ...
        return extraBlackjackActionNotSupportedCommandComponentKey(remainder);
      }
    public override JSONValue extraBlackjackCommandComponentValue(int component_num)
      {
        ...
        return extraBlackjackActionNotSupportedCommandComponentValue(remainder);
      }
    public override JSONValue extraBlackjackCommandLookup(string field_name)
      {
        ...
        return extraBlackjackActionNotSupportedCommandLookup(field_name);
      }
    ...
    public virtual void extraBlackjackActionNotSupportedCommandAppendPair(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public virtual void extraBlackjackActionNotSupportedCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraBlackjackActionNotSupportedCommandLookup(key);
        if (old_field == null)
          {
            extraBlackjackActionNotSupportedCommandAppendPair(key, new_component);
          }
        else
          {
            int count = extraKeys.Count;
    ...
    public override void extraBlackjackCommandSetField(string key, JSONValue new_component)
      {
        ...
        extraBlackjackActionNotSupportedCommandSetField(key, new_component);
      }
    ...
    public static new BlackjackActionNotSupportedCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        BlackjackActionNotSupportedCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BlackjackActionNotSupportedCommand", ignore_extras);
            generator.set_allow_incomplete(allow_incomplete);
            generator.set_allow_unpolished(allow_unpolished);
            if (allow_incomplete || allow_unpolished)
                json_value.write(generator);
    ...
    public static new BlackjackActionNotSupportedCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new BlackjackActionNotSupportedCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        BlackjackActionNotSupportedCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BlackjackActionNotSupportedCommand", ignore_extras);
    ...
    public static new BlackjackActionNotSupportedCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new BlackjackActionNotSupportedCommandJSON from_text(string text, bool ignore_extras)
      {
        BlackjackActionNotSupportedCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BlackjackActionNotSupportedCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for BlackjackActionNotSupportedCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new BlackjackActionNotSupportedCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        BlackjackActionNotSupportedCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BlackjackActionNotSupportedCommand", ignore_extras);
    ...
    public new abstract class Generator : BlackjackCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getBlackjackCommandJSONKey().Equals("BlackjackActionNotSupportedCommand")))
                throw new Exception("The key field has a value other than `BlackjackActionNotSupportedCommand'.");
            BlackjackActionNotSupportedCommandJSON result = new BlackjackActionNotSupportedCommandJSON();
            Debug.Assert(result != null);
            finish(result);
            int extra_count = unknownFieldGenerator.field_names.Count;
            Debug.Assert(extra_count == unknownFieldGenerator.field_values.Count);
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraBlackjackActionNotSupportedCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
            unknownFieldGenerator.field_names.Clear();
            unknownFieldGenerator.field_values.Clear();
            unknownFieldGenerator.index = new Dictionary<string, JSONValue >();
        ...
        protected override void handle_result(BlackjackCommandJSON new_result)
          {
            handle_result((BlackjackActionNotSupportedCommandJSON )new_result);
          }
        protected void finish(BlackjackActionNotSupportedCommandJSON result)
          {
        ...
        protected abstract void handle_result(BlackjackActionNotSupportedCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the BlackjackActionNotSupportedCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the BlackjackActionNotSupportedCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the BlackjackActionNotSupportedCommand class", false);
            unknownFieldGenerator = new UnknownFieldGenerator(false);
            set_what("the BlackjackActionNotSupportedCommand class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(BlackjackActionNotSupportedCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public BlackjackActionNotSupportedCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<BlackjackActionNotSupportedCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<BlackjackActionNotSupportedCommandJSON>();
        base.set_what(what);
      }
    public HoldingArrayGenerator(bool ignore_extras)
      {
    ...
    public bool have_value;
    public List<BlackjackActionNotSupportedCommandJSON> value;
  };
  };
