/* file "GuessThatLyricDecadeMenuCommandJSON.cs" */
...
public class GuessThatLyricDecadeMenuCommandJSON : CommandResultJSON
  {
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field Decade of GuessThatLyricDecadeMenuCommandJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field Decade of GuessThatLyricDecadeMenuCommandJSON is not an integer.");
              }
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field GuessedCorrectly of GuessThatLyricDecadeMenuCommandJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field GuessedCorrectly of GuessThatLyricDecadeMenuCommandJSON is not an integer.");
              }
            extracted_integer = json_rational.getInteger()        ;
          }
        else
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field HintsRemaining of GuessThatLyricDecadeMenuCommandJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field HintsRemaining of GuessThatLyricDecadeMenuCommandJSON is not an integer.");
              }
    ...
    private void  fromJSONDifficulty(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field Difficulty of GuessThatLyricDecadeMenuCommandJSON is not a string.");
    ...
    private void  fromJSONCorrectAnswer(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field CorrectAnswer of GuessThatLyricDecadeMenuCommandJSON is not a string.");
    ...
    private void  fromJSONQuestion(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field Question of GuessThatLyricDecadeMenuCommandJSON is not a string.");
    ...
    private void  fromJSONSoundhoundLyricID(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field SoundhoundLyricID of GuessThatLyricDecadeMenuCommandJSON is not a string.");
    ...
    private void  fromJSONGTLSoundhoundTrackID(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field GTLSoundhoundTrackID of GuessThatLyricDecadeMenuCommandJSON is not a string.");
    ...
    private void  fromJSONCorrectTitle(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field CorrectTitle of GuessThatLyricDecadeMenuCommandJSON is not a string.");
    ...
    private void  fromJSONCorrectArtist(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field CorrectArtist of GuessThatLyricDecadeMenuCommandJSON is not a string.");
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field PlayerLost of GuessThatLyricDecadeMenuCommandJSON is not true for false.");
              }
          }
    ...
    private void  fromJSONGuessedTracksList(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field GuessedTracksList of GuessThatLyricDecadeMenuCommandJSON is not an array.");
    ...
    public GuessThatLyricDecadeMenuCommandJSON()
      {
        flagHasDecade = false;
    ...
    public virtual int extraGuessThatLyricDecadeMenuCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraGuessThatLyricDecadeMenuCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraGuessThatLyricDecadeMenuCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraGuessThatLyricDecadeMenuCommandLookup(string field_name)
      {
    ...
    public void setDecade(BigInteger new_value)
      {
        flagHasDecade = true;
        if (new_value < 0)
            throw new Exception("The value for field Decade of GuessThatLyricDecadeMenuCommandJSON is less than the lower bound (0) for that field.");
    ...
    public void setGuessedCorrectly(BigInteger new_value)
      {
        ...
        if (new_value < 0)
            throw new Exception("The value for field GuessedCorrectly of GuessThatLyricDecadeMenuCommandJSON is less than the lower bound (0) for that field.");
    ...
    public void setHintsRemaining(sbyte new_value)
      {
        ...
        if (new_value < 0)
            throw new Exception("The value for field HintsRemaining of GuessThatLyricDecadeMenuCommandJSON is less than the lower bound (0) for that field.");
        if (new_value > 4)
            throw new Exception("The value for field HintsRemaining of GuessThatLyricDecadeMenuCommandJSON is greater than the upper bound (4) for that field.");
    ...
    public virtual void extraGuessThatLyricDecadeMenuCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraGuessThatLyricDecadeMenuCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public override void write_fields_as_json(JSONHandler handler, bool partial_allowed)
      {
        ...
        Debug.Assert(partial_allowed || flagHasGuessedCorrectly);
        if (flagHasGuessedCorrectly)
          {
        ...
        Debug.Assert(partial_allowed || flagHasCorrectAnswer);
        if (flagHasCorrectAnswer)
          {
        ...
        if (flagHasGuessedTracksList)
          {
            ...
            for (int num1 = 0; num1 < storeGuessedTracksList.Count; ++num1)
              {
                if (partial_allowed)
                    storeGuessedTracksList[num1].write_partial_as_json(handler);
                else
    ...
    public static new GuessThatLyricDecadeMenuCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        GuessThatLyricDecadeMenuCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type GuessThatLyricDecadeMenuCommand", ignore_extras);
    ...
    public static new GuessThatLyricDecadeMenuCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new GuessThatLyricDecadeMenuCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        GuessThatLyricDecadeMenuCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type GuessThatLyricDecadeMenuCommand", ignore_extras);
    ...
    public static new GuessThatLyricDecadeMenuCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new GuessThatLyricDecadeMenuCommandJSON from_text(string text, bool ignore_extras)
      {
        GuessThatLyricDecadeMenuCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type GuessThatLyricDecadeMenuCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for GuessThatLyricDecadeMenuCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new GuessThatLyricDecadeMenuCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        GuessThatLyricDecadeMenuCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type GuessThatLyricDecadeMenuCommand", ignore_extras);
    ...
    private class FieldHoldingArrayGeneratorHintsRemaining : JSONHoldingIntegerRangeArrayGenerator
        ...
        protected override void finish()
          {
            if (!(getCommandResultJSONKey().Equals("GuessThatLyricDecadeMenuCommand")))
                throw new Exception("The key field has a value other than `GuessThatLyricDecadeMenuCommand'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraGuessThatLyricDecadeMenuCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(GuessThatLyricDecadeMenuCommandJSON result)
          {
        ...
        protected abstract void handle_result(GuessThatLyricDecadeMenuCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorDecade = new FieldHoldingGeneratorDecade("field \"Decade\" of the GuessThatLyricDecadeMenuCommand class");
            fieldGeneratorGuessedCorrectly = new FieldHoldingGeneratorGuessedCorrectly("field \"GuessedCorrectly\" of the GuessThatLyricDecadeMenuCommand class");
            fieldGeneratorHintsRemaining = new FieldHoldingGeneratorHintsRemaining("field \"HintsRemaining\" of the GuessThatLyricDecadeMenuCommand class");
            fieldGeneratorDifficulty = new JSONHoldingStringGenerator("field \"Difficulty\" of the GuessThatLyricDecadeMenuCommand class");
            fieldGeneratorCorrectAnswer = new JSONHoldingStringGenerator("field \"CorrectAnswer\" of the GuessThatLyricDecadeMenuCommand class");
            fieldGeneratorQuestion = new JSONHoldingStringGenerator("field \"Question\" of the GuessThatLyricDecadeMenuCommand class");
            fieldGeneratorSoundhoundLyricID = new JSONHoldingStringGenerator("field \"SoundhoundLyricID\" of the GuessThatLyricDecadeMenuCommand class");
            fieldGeneratorGTLSoundhoundTrackID = new JSONHoldingStringGenerator("field \"GTLSoundhoundTrackID\" of the GuessThatLyricDecadeMenuCommand class");
            fieldGeneratorCorrectTitle = new JSONHoldingStringGenerator("field \"CorrectTitle\" of the GuessThatLyricDecadeMenuCommand class");
            fieldGeneratorCorrectArtist = new JSONHoldingStringGenerator("field \"CorrectArtist\" of the GuessThatLyricDecadeMenuCommand class");
            fieldGeneratorPlayerLost = new JSONHoldingBooleanGenerator("field \"PlayerLost\" of the GuessThatLyricDecadeMenuCommand class");
            fieldGeneratorGuessedTracksList = new MusicTrackJSON.HoldingArrayGenerator("field \"GuessedTracksList\" of the GuessThatLyricDecadeMenuCommand class", ignore_extras);
        ...
        public Generator() : base(false)
          {
            ...
            fieldGeneratorCorrectArtist = new JSONHoldingStringGenerator("field \"CorrectArtist\" of the GuessThatLyricDecadeMenuCommand class");
            fieldGeneratorPlayerLost = new JSONHoldingBooleanGenerator("field \"PlayerLost\" of the GuessThatLyricDecadeMenuCommand class");
            fieldGeneratorGuessedTracksList = new MusicTrackJSON.HoldingArrayGenerator("field \"GuessedTracksList\" of the GuessThatLyricDecadeMenuCommand class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(GuessThatLyricDecadeMenuCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public GuessThatLyricDecadeMenuCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<GuessThatLyricDecadeMenuCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<GuessThatLyricDecadeMenuCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<GuessThatLyricDecadeMenuCommandJSON> value;
  };
  };
