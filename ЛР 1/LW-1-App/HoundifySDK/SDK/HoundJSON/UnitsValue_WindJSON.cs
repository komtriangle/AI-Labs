...
public class UnitsValue_WindJSON : JSONBase
  {
    ...
    private void  fromJSONUnits(JSONValue json_value, bool ignore_extras)
      {
        Debug.Assert(json_value != null);
        WeatherSpeedUnitsJSON convert_classy = WeatherSpeedUnitsJSON.from_json(json_value, ignore_extras, true);
    ...
    private void  fromJSONAbbreviatedUnits(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field AbbreviatedUnits of UnitsValue_WindJSON is not a string.");
    ...
    private void  fromJSONWrittenUnits(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field WrittenUnits of UnitsValue_WindJSON is not a string.");
    ...
    private void  fromJSONSpokenUnits(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field SpokenUnits of UnitsValue_WindJSON is not a string.");
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field Value of UnitsValue_WindJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field Value of UnitsValue_WindJSON is not an integer.");
              }
    ...
    public WeatherSpeedUnitsJSON   getUnits()
      {
        Debug.Assert(flagHasUnits);
        return storeUnits;
      }

    public WeatherSpeedUnitsJSON.TypeValue  getUnitsValue()
      {
    ...
    public virtual int extraUnitsValue_WindComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraUnitsValue_WindComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraUnitsValue_WindComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraUnitsValue_WindLookup(string field_name)
      {
    ...
    public void setUnits(WeatherSpeedUnitsJSON  new_value)
      {
        if (flagHasUnits)
          {
          }
    ...
    public void setUnits(WeatherSpeedUnitsJSON.TypeValue new_value)
      {
        setUnits(new WeatherSpeedUnitsJSON(new_value));
      }
    public void setUnits(string chars)
      {
        WeatherSpeedUnitsJSON.TypeValueKnownValues known = WeatherSpeedUnitsJSON.stringToValue(chars);
        WeatherSpeedUnitsJSON.TypeValue new_value = new WeatherSpeedUnitsJSON.TypeValue();
        if (known == WeatherSpeedUnitsJSON.TypeValueKnownValues.Value__none)
          {
            new_value.in_known_list = false;
            new_value.string_value = chars;
          }
    ...
    public void setValue(BigInteger new_value)
      {
        flagHasValue = true;
        if (new_value < 0)
            throw new Exception("The value for field Value of UnitsValue_WindJSON is less than the lower bound (0) for that field.");
    ...
    public virtual void extraUnitsValue_WindAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraUnitsValue_WindSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static UnitsValue_WindJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        UnitsValue_WindJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UnitsValue_Wind", ignore_extras);
    ...
    public static UnitsValue_WindJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static UnitsValue_WindJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        UnitsValue_WindJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UnitsValue_Wind", ignore_extras);
    ...
    public static UnitsValue_WindJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static UnitsValue_WindJSON from_text(string text, bool ignore_extras)
      {
        UnitsValue_WindJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UnitsValue_Wind", ignore_extras);
            JSONParse.parse_json_value(text, "Text for UnitsValue_WindJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static UnitsValue_WindJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        UnitsValue_WindJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UnitsValue_Wind", ignore_extras);
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        private WeatherSpeedUnitsJSON.HoldingGenerator fieldGeneratorUnits;
    ...
    private class FieldHoldingArrayGeneratorValue : JSONHoldingIntegerLowerBoundOnlyArrayGenerator
        ...
        protected override void finish()
          {
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraUnitsValue_WindAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(UnitsValue_WindJSON result)
          {
        ...
        protected abstract void handle_result(UnitsValue_WindJSON new_result);
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorFormat = new WeatherUnitsFormatJSON.HoldingGenerator("field \"Format\" of the UnitsValue_Wind class", ignore_extras);
            fieldGeneratorUnits = new WeatherSpeedUnitsJSON.HoldingGenerator("field \"Units\" of the UnitsValue_Wind class", ignore_extras);
            fieldGeneratorAbbreviatedUnits = new JSONHoldingStringGenerator("field \"AbbreviatedUnits\" of the UnitsValue_Wind class");
        ...
        public Generator()
          {
            fieldGeneratorFormat = new WeatherUnitsFormatJSON.HoldingGenerator("field \"Format\" of the UnitsValue_Wind class", false);
            fieldGeneratorUnits = new WeatherSpeedUnitsJSON.HoldingGenerator("field \"Units\" of the UnitsValue_Wind class", false);
            fieldGeneratorAbbreviatedUnits = new JSONHoldingStringGenerator("field \"AbbreviatedUnits\" of the UnitsValue_Wind class");
            fieldGeneratorWrittenUnits = new JSONHoldingStringGenerator("field \"WrittenUnits\" of the UnitsValue_Wind class");
            fieldGeneratorSpokenUnits = new JSONHoldingStringGenerator("field \"SpokenUnits\" of the UnitsValue_Wind class");
            fieldGeneratorValue = new FieldHoldingGeneratorValue("field \"Value\" of the UnitsValue_Wind class");
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(UnitsValue_WindJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public UnitsValue_WindJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<UnitsValue_WindJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<UnitsValue_WindJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<UnitsValue_WindJSON> value;
  };
  };
