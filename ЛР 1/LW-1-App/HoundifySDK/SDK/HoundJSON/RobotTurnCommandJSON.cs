...
public class RobotTurnCommandJSON : RobotCommandJSON
  {
    ...
    public virtual int extraRobotTurnCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraRobotTurnCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraRobotTurnCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraRobotTurnCommandLookup(string field_name)
      {
    ...
    public void setDirection(short new_value)
      {
        ...
        if (new_value < -180)
            throw new Exception("The value for field Direction of RobotTurnCommandJSON is less than the lower bound (-180) for that field.");
        if (new_value > 180)
            throw new Exception("The value for field Direction of RobotTurnCommandJSON is greater than the upper bound (180) for that field.");
    ...
    public virtual void extraRobotTurnCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraRobotTurnCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new RobotTurnCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RobotTurnCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RobotTurnCommand", ignore_extras);
    ...
    public static new RobotTurnCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RobotTurnCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RobotTurnCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RobotTurnCommand", ignore_extras);
    ...
    public static new RobotTurnCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RobotTurnCommandJSON from_text(string text, bool ignore_extras)
      {
        RobotTurnCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RobotTurnCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for RobotTurnCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new RobotTurnCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        RobotTurnCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RobotTurnCommand", ignore_extras);
    ...
    private class FieldHoldingArrayGeneratorDirection : JSONHoldingIntegerRangeArrayGenerator
        ...
        protected override void finish()
          {
            if (!(getRobotCommandJSONKey().Equals("TurnCommand")))
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraRobotTurnCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(RobotTurnCommandJSON result)
          {
        ...
        protected abstract void handle_result(RobotTurnCommandJSON new_result);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(RobotTurnCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public RobotTurnCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<RobotTurnCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<RobotTurnCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<RobotTurnCommandJSON> value;
  };
  };
