/* file "BattleshipPlayCommandJSON.cs" */
...
public class BattleshipPlayCommandJSON : BattleshipCommandJSON
  {
    ...
    public BattleshipPlayCommandJSON()
      {
    ...
    public virtual int extraBattleshipPlayCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraBattleshipPlayCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraBattleshipPlayCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
    ...
    public override int extraBattleshipCommandComponentCount()
      {
        ...
        if (flagHasStartDateAndOrTime)
            ++result;
        result += extraBattleshipPlayCommandComponentCount();
        return result;
      }
    public override string extraBattleshipCommandComponentKey(int component_num)
      {
        ...
        return extraBattleshipPlayCommandComponentKey(remainder);
      }
    public override JSONValue extraBattleshipCommandComponentValue(int component_num)
      {
        ...
        return extraBattleshipPlayCommandComponentValue(remainder);
      }
    public override JSONValue extraBattleshipCommandLookup(string field_name)
      {
        ...
        return extraBattleshipPlayCommandLookup(field_name);
      }
    ...
    public virtual void extraBattleshipPlayCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraBattleshipPlayCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraBattleshipPlayCommandLookup(key);
        if (old_field == null)
          {
            extraBattleshipPlayCommandAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraBattleshipCommandSetField(string key, JSONValue new_component)
      {
        ...
        extraBattleshipPlayCommandSetField(key, new_component);
      }
    ...
    public static new BattleshipPlayCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        BattleshipPlayCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BattleshipPlayCommand", ignore_extras);
    ...
    public static new BattleshipPlayCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    ...
    public static new BattleshipPlayCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        BattleshipPlayCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BattleshipPlayCommand", ignore_extras);
    ...
    public static new BattleshipPlayCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new BattleshipPlayCommandJSON from_text(string text, bool ignore_extras)
      {
        BattleshipPlayCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BattleshipPlayCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for BattleshipPlayCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new BattleshipPlayCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        BattleshipPlayCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BattleshipPlayCommand", ignore_extras);
    ...
    public new abstract class Generator : BattleshipCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getBattleshipCommandJSONKey().Equals("BattleshipPlayCommand")))
                throw new Exception("The key field has a value other than `BattleshipPlayCommand'.");
            BattleshipPlayCommandJSON result = new BattleshipPlayCommandJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraBattleshipPlayCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(BattleshipCommandJSON new_result)
          {
            handle_result((BattleshipPlayCommandJSON )new_result);
          }
        protected void finish(BattleshipPlayCommandJSON result)
          {
        ...
        protected abstract void handle_result(BattleshipPlayCommandJSON new_result);
        ...
        public Generator() : base(false)
          {
            fieldGeneratorUserData = new BattleshipPlayerDataJSON.HoldingGenerator("field \"UserData\" of the BattleshipPlayCommand class", false);
            fieldGeneratorComputerData = new BattleshipPlayerDataJSON.HoldingGenerator("field \"ComputerData\" of the BattleshipPlayCommand class", false);
            fieldGeneratorStartDateAndOrTime = new DateAndOrTimeJSON.HoldingGenerator("field \"StartDateAndOrTime\" of the BattleshipPlayCommand class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(BattleshipPlayCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public BattleshipPlayCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<BattleshipPlayCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<BattleshipPlayCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<BattleshipPlayCommandJSON> value;
  };
  };
