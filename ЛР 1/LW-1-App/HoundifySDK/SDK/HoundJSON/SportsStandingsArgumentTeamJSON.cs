/* file "SportsStandingsArgumentTeamJSON.cs" */
...
public class SportsStandingsArgumentTeamJSON : SportsStandingsArgumentJSON
  {
    ...
    private void  fromJSONTeamID(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field TeamID of SportsStandingsArgumentTeamJSON is not a string.");
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field ResultReference of SportsStandingsArgumentTeamJSON is not true for false.");
              }
          }
    ...
    public SportsStandingsArgumentTeamJSON()
      {
        flagHasTeamID = false;
    ...
    public virtual int extraSportsStandingsArgumentTeamComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsStandingsArgumentTeamComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsStandingsArgumentTeamComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsStandingsArgumentTeamLookup(string field_name)
      {
    ...
    public override int extraSportsStandingsArgumentComponentCount()
      {
        ...
        if (flagHasResultReference)
            ++result;
        result += extraSportsStandingsArgumentTeamComponentCount();
        return result;
      }
    public override string extraSportsStandingsArgumentComponentKey(int component_num)
      {
        ...
        return extraSportsStandingsArgumentTeamComponentKey(remainder);
      }
    public override JSONValue extraSportsStandingsArgumentComponentValue(int component_num)
      {
        ...
        return extraSportsStandingsArgumentTeamComponentValue(remainder);
      }
    public override JSONValue extraSportsStandingsArgumentLookup(string field_name)
      {
        ...
        return extraSportsStandingsArgumentTeamLookup(field_name);
      }
    ...
    public virtual void extraSportsStandingsArgumentTeamAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSportsStandingsArgumentTeamSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraSportsStandingsArgumentTeamLookup(key);
        if (old_field == null)
          {
            extraSportsStandingsArgumentTeamAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraSportsStandingsArgumentSetField(string key, JSONValue new_component)
      {
        ...
        extraSportsStandingsArgumentTeamSetField(key, new_component);
      }
    ...
    public static new SportsStandingsArgumentTeamJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsStandingsArgumentTeamJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsStandingsArgumentTeam", ignore_extras);
    ...
    public static new SportsStandingsArgumentTeamJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsStandingsArgumentTeamJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsStandingsArgumentTeamJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsStandingsArgumentTeam", ignore_extras);
    ...
    public static new SportsStandingsArgumentTeamJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsStandingsArgumentTeamJSON from_text(string text, bool ignore_extras)
      {
        SportsStandingsArgumentTeamJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsStandingsArgumentTeam", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SportsStandingsArgumentTeamJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new SportsStandingsArgumentTeamJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SportsStandingsArgumentTeamJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsStandingsArgumentTeam", ignore_extras);
    ...
    public new abstract class Generator : SportsStandingsArgumentJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getSportsStandingsArgumentJSONKey().Equals("Team")))
                throw new Exception("The key field has a value other than `Team'.");
            SportsStandingsArgumentTeamJSON result = new SportsStandingsArgumentTeamJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSportsStandingsArgumentTeamAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(SportsStandingsArgumentJSON new_result)
          {
            handle_result((SportsStandingsArgumentTeamJSON )new_result);
          }
        protected void finish(SportsStandingsArgumentTeamJSON result)
          {
        ...
        protected abstract void handle_result(SportsStandingsArgumentTeamJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorTeamID = new JSONHoldingStringGenerator("field \"TeamID\" of the SportsStandingsArgumentTeam class");
            fieldGeneratorTeamLeague = new SportsLeagueCodeJSON.HoldingGenerator("field \"TeamLeague\" of the SportsStandingsArgumentTeam class", ignore_extras);
            fieldGeneratorResultReference = new JSONHoldingBooleanGenerator("field \"ResultReference\" of the SportsStandingsArgumentTeam class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the SportsStandingsArgumentTeam class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorTeamID = new JSONHoldingStringGenerator("field \"TeamID\" of the SportsStandingsArgumentTeam class");
            fieldGeneratorTeamLeague = new SportsLeagueCodeJSON.HoldingGenerator("field \"TeamLeague\" of the SportsStandingsArgumentTeam class", false);
            fieldGeneratorResultReference = new JSONHoldingBooleanGenerator("field \"ResultReference\" of the SportsStandingsArgumentTeam class");
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(SportsStandingsArgumentTeamJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public SportsStandingsArgumentTeamJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SportsStandingsArgumentTeamJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<SportsStandingsArgumentTeamJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SportsStandingsArgumentTeamJSON> value;
  };
  };
