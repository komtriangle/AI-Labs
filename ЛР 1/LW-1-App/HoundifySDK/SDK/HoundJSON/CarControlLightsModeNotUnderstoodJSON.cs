/* file "CarControlLightsModeNotUnderstoodJSON.cs" */
...
public class CarControlLightsModeNotUnderstoodJSON : CarControlCommandJSON
  {
    ...
    private void  fromJSONCommandType(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field CommandType of CarControlLightsModeNotUnderstoodJSON is not a string.");
        ...
        throw new Exception("The value for field CommandType of CarControlLightsModeNotUnderstoodJSON is not one of the legal strings.");
      enum_is_done:;
        setCommandType(the_enum);
      }


    public CarControlLightsModeNotUnderstoodJSON()
      {
    ...
    public virtual int extraCarControlLightsModeNotUnderstoodComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraCarControlLightsModeNotUnderstoodComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraCarControlLightsModeNotUnderstoodComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraCarControlLightsModeNotUnderstoodLookup(string field_name)
      {
    ...
    public override int extraCarControlCommandComponentCount()
      {
        ...
        if (flagHasCommandType)
            ++result;
        result += extraCarControlLightsModeNotUnderstoodComponentCount();
        return result;
      }
    public override string extraCarControlCommandComponentKey(int component_num)
      {
        ...
        return extraCarControlLightsModeNotUnderstoodComponentKey(remainder);
      }
    public override JSONValue extraCarControlCommandComponentValue(int component_num)
      {
        ...
        return extraCarControlLightsModeNotUnderstoodComponentValue(remainder);
      }
    public override JSONValue extraCarControlCommandLookup(string field_name)
      {
        ...
        return extraCarControlLightsModeNotUnderstoodLookup(field_name);
      }
    ...
    public virtual void extraCarControlLightsModeNotUnderstoodAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraCarControlLightsModeNotUnderstoodSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraCarControlLightsModeNotUnderstoodLookup(key);
        if (old_field == null)
          {
            extraCarControlLightsModeNotUnderstoodAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraCarControlCommandSetField(string key, JSONValue new_component)
      {
        ...
        extraCarControlLightsModeNotUnderstoodSetField(key, new_component);
      }
    ...
    public static new CarControlLightsModeNotUnderstoodJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
    ...
    public static new CarControlLightsModeNotUnderstoodJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    ...
    public static new CarControlLightsModeNotUnderstoodJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new CarControlLightsModeNotUnderstoodJSON from_text(string text, bool ignore_extras)
      {
        CarControlLightsModeNotUnderstoodJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlLightsModeNotUnderstood", ignore_extras);
            JSONParse.parse_json_value(text, "Text for CarControlLightsModeNotUnderstoodJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new CarControlLightsModeNotUnderstoodJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        CarControlLightsModeNotUnderstoodJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlLightsModeNotUnderstood", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorCommandType : JSONArrayGenerator
  {
    ...
    public List<TypeCommandType> value;
        ...
        protected override void finish()
          {
            if (!(getCarControlCommandJSONKey().Equals("CarControlLightsModeNotUnderstood")))
                throw new Exception("The key field has a value other than `CarControlLightsModeNotUnderstood'.");
            CarControlLightsModeNotUnderstoodJSON result = new CarControlLightsModeNotUnderstoodJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraCarControlLightsModeNotUnderstoodAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(CarControlCommandJSON new_result)
          {
            handle_result((CarControlLightsModeNotUnderstoodJSON )new_result);
          }
        protected void finish(CarControlLightsModeNotUnderstoodJSON result)
          {
        ...
        protected abstract void handle_result(CarControlLightsModeNotUnderstoodJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorCommandType = new FieldHoldingGeneratorCommandType("field \"CommandType\" of the CarControlLightsModeNotUnderstood class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the CarControlLightsModeNotUnderstood class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(CarControlLightsModeNotUnderstoodJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public CarControlLightsModeNotUnderstoodJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<CarControlLightsModeNotUnderstoodJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<CarControlLightsModeNotUnderstoodJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<CarControlLightsModeNotUnderstoodJSON> value;
  };
  };
