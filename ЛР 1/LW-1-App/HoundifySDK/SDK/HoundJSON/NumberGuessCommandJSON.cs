/* file "NumberGuessCommandJSON.cs" */
...
public abstract class NumberGuessCommandJSON : CommandResultJSON
  {
    ...
    private void  fromJSONGameName(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field GameName of NumberGuessCommandJSON is not a string.");
        setGameName(json_string.getData());
      }


    public NumberGuessCommandJSON()
      {
    ...
    public abstract string getNumberGuessCommandKind();
    ...
    public abstract int extraNumberGuessCommandComponentCount();
    public abstract string extraNumberGuessCommandComponentKey(int component_num);
    public abstract JSONValue extraNumberGuessCommandComponentValue(int component_num);
    public abstract JSONValue extraNumberGuessCommandLookup(string field_name);
        ...
        switch (field_name[0])
          {
            case 'G':
                ...
                break;
            case 'N':
                if ((String.Compare(field_name, 1, "umberGuessCommandKind", 0, 21, false) == 0) && (field_name.Length == 22))
                    return new JSONStringValue(getNumberGuessCommandKind());
                break;
            default:
                break;
    ...
    public abstract void extraNumberGuessCommandAppendPair(string key, JSONValue new_component);
    public abstract void extraNumberGuessCommandSetField(string key, JSONValue new_component);
        ...
        switch (key[0])
          {
            case 'G':
                ...
                break;
            case 'N':
                if ((String.Compare(key, 1, "umberGuessCommandKind", 0, 21, false) == 0) && (key.Length == 22))
                    return;
                break;
            default:
                break;
    ...
    public static new NumberGuessCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        NumberGuessCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NumberGuessCommand", ignore_extras);
    ...
    public static new NumberGuessCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new NumberGuessCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        NumberGuessCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NumberGuessCommand", ignore_extras);
    ...
    public static new NumberGuessCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new NumberGuessCommandJSON from_text(string text, bool ignore_extras)
      {
        NumberGuessCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NumberGuessCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for NumberGuessCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new NumberGuessCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        NumberGuessCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NumberGuessCommand", ignore_extras);
    ...
    public new abstract class Generator : CommandResultJSON.Generator
      {
        ...
        protected override void finish()
          {
            ...
            if (!(getCommandResultJSONKey().Equals("NumberGuessCommand")))
                throw new Exception("The key field has a value other than `NumberGuessCommand'.");
            NumberGuessCommandJSON result = createForKey(keyGenerator.value, unknownFieldGenerator.index);
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraNumberGuessCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected string getNumberGuessCommandJSONKey()
          {
            if (!(keyGenerator.have_value))
                throw new Exception("The `NumberGuessCommandKind' field is missing.");
        ...
        protected void finish(NumberGuessCommandJSON result)
          {
        ...
        protected abstract void handle_result(NumberGuessCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorGameName = new JSONHoldingStringGenerator("field \"GameName\" of the NumberGuessCommand class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            keyGenerator = new JSONHoldingStringGenerator("key field \"NumberGuessCommandKind\" of the NumberGuessCommand class");
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(NumberGuessCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public NumberGuessCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<NumberGuessCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<NumberGuessCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<NumberGuessCommandJSON> value;
  };
    class GenericNumberGuessCommandJSON : NumberGuessCommandJSON
      {
        private string key;
        private List<string> extraKeys;
        private List<JSONValue > extraValues;
        private Dictionary<string, JSONValue > extraIndex;
        public GenericNumberGuessCommandJSON(string init_key)
          {
            key = init_key;
        ...
        public override string getNumberGuessCommandKind()  { return key; }
    ...
    public static new NumberGuessCommandJSON createForKey(string key, Dictionary<string, JSONValue > other_field_index)
      {
    if (String.Compare(key, 0, "NumberGuess", 0, 11, false) == 0)
      {
        switch (key[11])
          {
            case 'G':
                if ((String.Compare(key, 12, "uessNumberCommand", 0, 17, false) == 0) && (key.Length == 29))
            ...
            case 'N':
                ...
                break;
            case 'Q':
                if ((String.Compare(key, 12, "uitCommand", 0, 10, false) == 0) && (key.Length == 22))
            ...
            case 'S':
                switch (key[12])
                  {
                    case 'e':
                        if ((String.Compare(key, 13, "tDifficultyCommand", 0, 18, false) == 0) && (key.Length == 31))
