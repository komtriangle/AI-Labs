/* file "BlackjackInformationNuggetJSON.cs" */
...
public abstract class BlackjackInformationNuggetJSON : InformationNuggetJSON
  {
    ...
    private void  fromJSONGameName(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field GameName of BlackjackInformationNuggetJSON is not a string.");
        setGameName(json_string.getData());
      }


    public BlackjackInformationNuggetJSON()
      {
    ...
    public abstract string getBlackjackNuggetKind();
    ...
    public abstract int extraBlackjackInformationNuggetComponentCount();
    public abstract string extraBlackjackInformationNuggetComponentKey(int component_num);
    public abstract JSONValue extraBlackjackInformationNuggetComponentValue(int component_num);
    public abstract JSONValue extraBlackjackInformationNuggetLookup(string field_name);
    ...
    public override JSONValue extraInformationNuggetLookup(string field_name)
      {
        switch (field_name[0])
          {
            case 'B':
                if ((String.Compare(field_name, 1, "lackjackNuggetKind", 0, 18, false) == 0) && (field_name.Length == 19))
                    return new JSONStringValue(getBlackjackNuggetKind());
                break;
            case 'G':
    ...
    public abstract void extraBlackjackInformationNuggetAppendPair(string key, JSONValue new_component);
    public abstract void extraBlackjackInformationNuggetSetField(string key, JSONValue new_component);
    public override void extraInformationNuggetAppendPair(string key, JSONValue new_component)
      {
        switch (key[0])
          {
            case 'B':
                if ((String.Compare(key, 1, "lackjackNuggetKind", 0, 18, false) == 0) && (key.Length == 19))
                    return;
                break;
            case 'G':
    ...
    public static new BlackjackInformationNuggetJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        BlackjackInformationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BlackjackInformationNugget", ignore_extras);
    ...
    public static new BlackjackInformationNuggetJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new BlackjackInformationNuggetJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        BlackjackInformationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BlackjackInformationNugget", ignore_extras);
    ...
    public static new BlackjackInformationNuggetJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new BlackjackInformationNuggetJSON from_text(string text, bool ignore_extras)
      {
        BlackjackInformationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BlackjackInformationNugget", ignore_extras);
            JSONParse.parse_json_value(text, "Text for BlackjackInformationNuggetJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new BlackjackInformationNuggetJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        BlackjackInformationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BlackjackInformationNugget", ignore_extras);
    ...
    public new abstract class Generator : InformationNuggetJSON.Generator
      {
        ...
        protected string getBlackjackInformationNuggetJSONKey()
          {
            if (!(keyGenerator.have_value))
                throw new Exception("The `BlackjackNuggetKind' field is missing.");
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorGameName = new JSONHoldingStringGenerator("field \"GameName\" of the BlackjackInformationNugget class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            keyGenerator = new JSONHoldingStringGenerator("key field \"BlackjackNuggetKind\" of the BlackjackInformationNugget class");
...
//@@@            Debug.Assert(!have_value);
        ...
        public BlackjackInformationNuggetJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<BlackjackInformationNuggetJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<BlackjackInformationNuggetJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<BlackjackInformationNuggetJSON> value;
  };
    class GenericBlackjackInformationNuggetJSON : BlackjackInformationNuggetJSON
      {
        private string key;
        private List<string> extraKeys;
        private List<JSONValue > extraValues;
        private Dictionary<string, JSONValue > extraIndex;
        public GenericBlackjackInformationNuggetJSON(string init_key)
          {
            key = init_key;
        ...
        public override string getBlackjackNuggetKind()  { return key; }
    ...
    public static new BlackjackInformationNuggetJSON createForKey(string key, Dictionary<string, JSONValue > other_field_index)
      {
    if (String.Compare(key, 0, "Blackjack", 0, 9, false) == 0)
      {
        switch (key[9])
          {
            case 'D':
                if ((String.Compare(key, 10, "oubledownCommand", 0, 16, false) == 0) && (key.Length == 26))
            ...
            case 'Q':
                ...
                break;
            case 'S':
                if ((String.Compare(key, 10, "tandCommand", 0, 11, false) == 0) && (key.Length == 21))
