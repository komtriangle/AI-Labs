...
public class ShowWeatherForecastDailyInformationNuggetJSON : WeatherInformationNuggetJSON
  {
    ...
    private bool flagHasAverageDailyForecast;
    private DailyForecastJSON  storeAverageDailyForecast;
    ...
    private JSONValue  extraAverageDailyForecastToJSON()
      {
        JSONValueHandler handler_AverageDailyForecast = new JSONValueHandler();
        storeAverageDailyForecast.write_as_json(handler_AverageDailyForecast);
        return handler_AverageDailyForecast.result;
      }
    ...
    private void  fromJSONAverageDailyForecast(JSONValue json_value, bool ignore_extras)
      {
        Debug.Assert(json_value != null);
        DailyForecastJSON convert_classy = DailyForecastJSON.from_json(json_value, ignore_extras, true);
        setAverageDailyForecast(convert_classy);
      }
    ...
    private void  fromJSONHourlyForecasts(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONArrayValue json_array1 = json_value.array_value();
        if (json_array1 == null)
            throw new Exception("The value for field HourlyForecasts of ShowWeatherForecastDailyInformationNuggetJSON is not an array.");
        int count1 = json_array1.componentCount();
    ...
    public ShowWeatherForecastDailyInformationNuggetJSON()
      {
        ...
        flagHasAverageDailyForecast = false;
    ...
    public bool  hasAverageDailyForecast()
      {
        return flagHasAverageDailyForecast;
      }

    public DailyForecastJSON   getAverageDailyForecast()
      {
        Debug.Assert(flagHasAverageDailyForecast);
        return storeAverageDailyForecast;
      }
    ...
    public override int extraWeatherInformationNuggetComponentCount()
      {
        ...
        if (flagHasDailyForecasts)
            ++result;
        if (flagHasAverageDailyForecast)
            ++result;
    ...
    public override JSONValue extraWeatherInformationNuggetComponentValue(int component_num)
      {
        ...
        if (flagHasAverageDailyForecast)
          {
            if (remainder == 0)
                return extraAverageDailyForecastToJSON();
            --remainder;
          }
        if (flagHasHourlyForecasts)
          {
                ...
                switch (field_name[1])
                  {
                    ...
                    case 't':
                        ...
                        break;
                    case 'v':
                        if ((String.Compare(field_name, 2, "erageDailyForecast", 0, 18, false) == 0) && (field_name.Length == 20))
                            return (flagHasAverageDailyForecast ? extraAverageDailyForecastToJSON() : null);
                        break;
                    default:
                        break;
                  }
    ...
    public void setAverageDailyForecast(DailyForecastJSON  new_value)
      {
        if (flagHasAverageDailyForecast)
          {
          }
        flagHasAverageDailyForecast = true;
        storeAverageDailyForecast = new_value;
      }
    public void unsetAverageDailyForecast()
      {
        if (flagHasAverageDailyForecast)
          {
          }
                ...
                switch (key[1])
                  {
                    ...
                    case 't':
                        ...
                        break;
                    case 'v':
                        if ((String.Compare(key, 2, "erageDailyForecast", 0, 18, false) == 0) && (key.Length == 20))
                            {
                            fromJSONAverageDailyForecast(new_component, false);
                            return;
                            }
                        break;
                    default:
    ...
    public override void write_fields_as_json(JSONHandler handler, bool partial_allowed)
      {
        ...
        if (flagHasAverageDailyForecast)
          {
            handler.start_pair("AverageDailyForecast");
            if (partial_allowed)
                storeAverageDailyForecast.write_partial_as_json(handler);
            else
                storeAverageDailyForecast.write_as_json(handler);
          }
        if (flagHasHourlyForecasts)
          {
    ...
    public new abstract class Generator : WeatherInformationNuggetJSON.Generator
      {
        ...
        private DailyForecastJSON.HoldingGenerator fieldGeneratorAverageDailyForecast;
        ...
        protected void finish(ShowWeatherForecastDailyInformationNuggetJSON result)
          {
            ...
            if (fieldGeneratorAverageDailyForecast.have_value)
              {
                result.setAverageDailyForecast(fieldGeneratorAverageDailyForecast.value);
                fieldGeneratorAverageDailyForecast.have_value = false;
              }
                    ...
                    switch (field_name[1])
                      {
                        ...
                        case 'v':
                            if ((String.Compare(field_name, 2, "erageDailyForecast", 0, 18, false) == 0) && (field_name.Length == 20))
                                return fieldGeneratorAverageDailyForecast;
                            break;
                        default:
                            break;
                      }
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            ...
            fieldGeneratorRequestedAttribute = new WeatherAttributeJSON.HoldingGenerator("field \"RequestedAttribute\" of the ShowWeatherForecastDailyInformationNugget class", ignore_extras);
            fieldGeneratorRequestedAttributeAction = new WeatherAttributeActionJSON.HoldingGenerator("field \"RequestedAttributeAction\" of the ShowWeatherForecastDailyInformationNugget class", ignore_extras);
            ...
            fieldGeneratorAverageDailyForecast = new DailyForecastJSON.HoldingGenerator("field \"AverageDailyForecast\" of the ShowWeatherForecastDailyInformationNugget class", ignore_extras);
            fieldGeneratorHourlyForecasts = new HourlyForecastJSON.HoldingArrayGenerator("field \"HourlyForecasts\" of the ShowWeatherForecastDailyInformationNugget class", ignore_extras);
        ...
        public Generator() : base(false)
          {
            ...
            fieldGeneratorRequestedAttribute = new WeatherAttributeJSON.HoldingGenerator("field \"RequestedAttribute\" of the ShowWeatherForecastDailyInformationNugget class", false);
            fieldGeneratorRequestedAttributeAction = new WeatherAttributeActionJSON.HoldingGenerator("field \"RequestedAttributeAction\" of the ShowWeatherForecastDailyInformationNugget class", false);
            fieldGeneratorIsSearchQuery = new JSONHoldingBooleanGenerator("field \"IsSearchQuery\" of the ShowWeatherForecastDailyInformationNugget class");
            fieldGeneratorIsYesNoQuery = new JSONHoldingBooleanGenerator("field \"IsYesNoQuery\" of the ShowWeatherForecastDailyInformationNugget class");
            ...
            fieldGeneratorAverageDailyForecast = new DailyForecastJSON.HoldingGenerator("field \"AverageDailyForecast\" of the ShowWeatherForecastDailyInformationNugget class", false);
            fieldGeneratorHourlyForecasts = new HourlyForecastJSON.HoldingArrayGenerator("field \"HourlyForecasts\" of the ShowWeatherForecastDailyInformationNugget class", false);
        ...
        public override void reset()
          {
            ...
            fieldGeneratorAverageDailyForecast.reset();
