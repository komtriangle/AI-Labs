/* file "SetClientUberClientIdCommandJSON.cs" */
...
public class SetClientUberClientIdCommandJSON : UberCommandJSON
  {
    ...
    public SetClientUberClientIdCommandJSON()
      {
    ...
    public virtual int extraSetClientUberClientIdCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSetClientUberClientIdCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSetClientUberClientIdCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSetClientUberClientIdCommandLookup(string field_name)
      {
        JSONValue result = (extraIndex.ContainsKey(field_name) ? extraIndex[field_name] : null);
        return result;
      }
    public override int extraUberCommandComponentCount()
      {
        ...
        if (flagHasNativeData)
            ++result;
        result += extraSetClientUberClientIdCommandComponentCount();
        return result;
      }
    public override string extraUberCommandComponentKey(int component_num)
      {
        ...
        return extraSetClientUberClientIdCommandComponentKey(remainder);
      }
    public override JSONValue extraUberCommandComponentValue(int component_num)
      {
        ...
        return extraSetClientUberClientIdCommandComponentValue(remainder);
      }
    public override JSONValue extraUberCommandLookup(string field_name)
      {
        ...
        return extraSetClientUberClientIdCommandLookup(field_name);
      }
    ...
    public virtual void extraSetClientUberClientIdCommandAppendPair(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public virtual void extraSetClientUberClientIdCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraSetClientUberClientIdCommandLookup(key);
        if (old_field == null)
          {
            extraSetClientUberClientIdCommandAppendPair(key, new_component);
          }
        else
          {
            int count = extraKeys.Count;
    ...
    public override void extraUberCommandSetField(string key, JSONValue new_component)
      {
        ...
        extraSetClientUberClientIdCommandSetField(key, new_component);
      }
    ...
    public static new SetClientUberClientIdCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SetClientUberClientIdCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SetClientUberClientIdCommand", ignore_extras);
            generator.set_allow_incomplete(allow_incomplete);
            generator.set_allow_unpolished(allow_unpolished);
            if (allow_incomplete || allow_unpolished)
                json_value.write(generator);
    ...
    public static new SetClientUberClientIdCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SetClientUberClientIdCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SetClientUberClientIdCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SetClientUberClientIdCommand", ignore_extras);
    ...
    public static new SetClientUberClientIdCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SetClientUberClientIdCommandJSON from_text(string text, bool ignore_extras)
      {
        SetClientUberClientIdCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SetClientUberClientIdCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SetClientUberClientIdCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new SetClientUberClientIdCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SetClientUberClientIdCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SetClientUberClientIdCommand", ignore_extras);
    ...
    public new abstract class Generator : UberCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getUberCommandJSONKey().Equals("SetClientUberClientId")))
                throw new Exception("The key field has a value other than `SetClientUberClientId'.");
            SetClientUberClientIdCommandJSON result = new SetClientUberClientIdCommandJSON();
            Debug.Assert(result != null);
            finish(result);
            int extra_count = unknownFieldGenerator.field_names.Count;
            Debug.Assert(extra_count == unknownFieldGenerator.field_values.Count);
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSetClientUberClientIdCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
            unknownFieldGenerator.field_names.Clear();
            unknownFieldGenerator.field_values.Clear();
            unknownFieldGenerator.index = new Dictionary<string, JSONValue >();
        ...
        protected override void handle_result(UberCommandJSON new_result)
          {
            handle_result((SetClientUberClientIdCommandJSON )new_result);
          }
        protected void finish(SetClientUberClientIdCommandJSON result)
          {
        ...
        protected abstract void handle_result(SetClientUberClientIdCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the SetClientUberClientIdCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the SetClientUberClientIdCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the SetClientUberClientIdCommand class", false);
            unknownFieldGenerator = new UnknownFieldGenerator(false);
            set_what("the SetClientUberClientIdCommand class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(SetClientUberClientIdCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public SetClientUberClientIdCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SetClientUberClientIdCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<SetClientUberClientIdCommandJSON>();
        base.set_what(what);
      }
    public HoldingArrayGenerator(bool ignore_extras)
      {
    ...
    public bool have_value;
    public List<SetClientUberClientIdCommandJSON> value;
  };
  };
