/* file "RadioToSpotifyCommandJSON.cs" */
...
public class RadioToSpotifyCommandJSON : RadioCommandJSON
  {
    ...
    public RadioToSpotifyCommandJSON()
      {
    ...
    public virtual int extraRadioToSpotifyCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraRadioToSpotifyCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraRadioToSpotifyCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraRadioToSpotifyCommandLookup(string field_name)
      {
    ...
    public virtual void extraRadioToSpotifyCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraRadioToSpotifyCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new RadioToSpotifyCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RadioToSpotifyCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RadioToSpotifyCommand", ignore_extras);
    ...
    public static new RadioToSpotifyCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RadioToSpotifyCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RadioToSpotifyCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RadioToSpotifyCommand", ignore_extras);
    ...
    public static new RadioToSpotifyCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RadioToSpotifyCommandJSON from_text(string text, bool ignore_extras)
      {
        RadioToSpotifyCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RadioToSpotifyCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for RadioToSpotifyCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new RadioToSpotifyCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        RadioToSpotifyCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RadioToSpotifyCommand", ignore_extras);
    ...
    public new abstract class Generator : RadioCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getRadioCommandJSONKey().Equals("RadioToSpotify")))
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraRadioToSpotifyCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(RadioToSpotifyCommandJSON result)
          {
        ...
        protected abstract void handle_result(RadioToSpotifyCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorAlreadyOnResult = new DynamicResponseJSON.HoldingGenerator("field \"AlreadyOnResult\" of the RadioToSpotifyCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the RadioToSpotifyCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorAlreadyOnResult = new DynamicResponseJSON.HoldingGenerator("field \"AlreadyOnResult\" of the RadioToSpotifyCommand class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(RadioToSpotifyCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public RadioToSpotifyCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<RadioToSpotifyCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<RadioToSpotifyCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<RadioToSpotifyCommandJSON> value;
  };
  };
