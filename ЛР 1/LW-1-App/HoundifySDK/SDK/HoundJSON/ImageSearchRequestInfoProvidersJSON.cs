/* file "ImageSearchRequestInfoProvidersJSON.cs" */
...
public class ImageSearchRequestInfoProvidersJSON : JSONBase
  {
    ...
    public static TypeProvidersKnownValues  stringToProviders(string chars)
      {
        switch (chars[0])
          {
            case 'F':
                if ((String.Compare(chars, 1, "lickr", 0, 5, false) == 0) && (chars.Length == 6))
                    return TypeProvidersKnownValues.Providers_Flickr;
                break;
            case 'G':
    ...
    public static string  stringFromProviders(TypeProvidersKnownValues the_enum)
      {
        switch (the_enum)
          {
            case TypeProvidersKnownValues.Providers_Flickr:
                return "Flickr";
    ...
    private void  fromJSONProviders(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field Providers of ImageSearchRequestInfoProvidersJSON is not an array.");
        ...
        for (int num1 = 0; num1 < count1; ++num1)
          {
            ...
            if (json_string == null)
                throw new Exception("The value for an element of field Providers of ImageSearchRequestInfoProvidersJSON is not a string.");
            TypeProviders the_open_enum = new TypeProviders();
            switch (json_string.getData()[0])
              {
                case 'F':
                    if ((String.Compare(json_string.getData(), 1, "lickr", 0, 5, false) == 0) && (json_string.getData().Length == 6))
                          {
                            the_open_enum.in_known_list = true;
                            the_open_enum.list_value = TypeProvidersKnownValues.Providers_Flickr;
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field OverrideExplicitlyNamedProviders of ImageSearchRequestInfoProvidersJSON is not true for false.");
              }
          }
    ...
    public ImageSearchRequestInfoProvidersJSON()
      {
    ...
    public virtual int extraImageSearchRequestInfoProvidersComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraImageSearchRequestInfoProvidersComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraImageSearchRequestInfoProvidersComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraImageSearchRequestInfoProvidersLookup(string field_name)
      {
    ...
    public virtual void extraImageSearchRequestInfoProvidersAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraImageSearchRequestInfoProvidersSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraImageSearchRequestInfoProvidersLookup(key);
        if (old_field == null)
          {
            extraImageSearchRequestInfoProvidersAppendPair(key, new_component);
          }
        else
          {
    ...
    public static ImageSearchRequestInfoProvidersJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ImageSearchRequestInfoProvidersJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ImageSearchRequestInfoProviders", ignore_extras);
    ...
    public static ImageSearchRequestInfoProvidersJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static ImageSearchRequestInfoProvidersJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ImageSearchRequestInfoProvidersJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ImageSearchRequestInfoProviders", ignore_extras);
    ...
    public static ImageSearchRequestInfoProvidersJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static ImageSearchRequestInfoProvidersJSON from_text(string text, bool ignore_extras)
      {
        ImageSearchRequestInfoProvidersJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ImageSearchRequestInfoProviders", ignore_extras);
            JSONParse.parse_json_value(text, "Text for ImageSearchRequestInfoProvidersJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static ImageSearchRequestInfoProvidersJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        ImageSearchRequestInfoProvidersJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ImageSearchRequestInfoProviders", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorProviders : JSONArrayGenerator
  {
    ...
    public List<TypeProviders> value;
        ...
        protected override void finish()
          {
            ImageSearchRequestInfoProvidersJSON result = new ImageSearchRequestInfoProvidersJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraImageSearchRequestInfoProvidersAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(ImageSearchRequestInfoProvidersJSON result)
          {
        ...
        protected abstract void handle_result(ImageSearchRequestInfoProvidersJSON new_result);
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorProviders = new FieldHoldingArrayGeneratorProviders("field \"Providers\" of the ImageSearchRequestInfoProviders class");
            fieldGeneratorOverrideExplicitlyNamedProviders = new JSONHoldingBooleanGenerator("field \"OverrideExplicitlyNamedProviders\" of the ImageSearchRequestInfoProviders class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the ImageSearchRequestInfoProviders class");
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(ImageSearchRequestInfoProvidersJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public ImageSearchRequestInfoProvidersJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<ImageSearchRequestInfoProvidersJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<ImageSearchRequestInfoProvidersJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<ImageSearchRequestInfoProvidersJSON> value;
  };
  };
