/* file "ScientificNotationQuantityJSON.cs" */
...
public class ScientificNotationQuantityJSON : QuantityJSON
  {
        ...
        if (textStoreValue != "")
          {
            ...
            generated_rational_Value = handler.result;
          }
        else if (((double)(long)storeValue) == storeValue)
            generated_rational_Value = new JSONIntegerValue((long)(storeValue));
        else
            generated_rational_Value = new JSONRationalValue(storeValue, 15);
        ...
        if (json_rational != null)
        ...
        else
          {
            ...
            if (json_integer != null)
              ...
              {
                throw new Exception("The value for field Value of ScientificNotationQuantityJSON is not a number.");
              }
          }
    ...
    public ScientificNotationQuantityJSON()
      {
        flagHasValue = false;
    ...
    public virtual int extraScientificNotationQuantityComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraScientificNotationQuantityComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraScientificNotationQuantityComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraScientificNotationQuantityLookup(string field_name)
      {
    ...
    public void setValueText(string new_value)
      {
        ...
        if (!(JSONWriter.is_valid_number_format(new_value)))
            throw new Exception("The text value for field Value of ScientificNotationQuantityJSON is not a valid number.");
    ...
    public virtual void extraScientificNotationQuantityAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraScientificNotationQuantitySetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new ScientificNotationQuantityJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ScientificNotationQuantityJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ScientificNotationQuantity", ignore_extras);
    ...
    public static new ScientificNotationQuantityJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new ScientificNotationQuantityJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ScientificNotationQuantityJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ScientificNotationQuantity", ignore_extras);
    ...
    public static new ScientificNotationQuantityJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new ScientificNotationQuantityJSON from_text(string text, bool ignore_extras)
      {
        ScientificNotationQuantityJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ScientificNotationQuantity", ignore_extras);
            JSONParse.parse_json_value(text, "Text for ScientificNotationQuantityJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new ScientificNotationQuantityJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        ScientificNotationQuantityJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ScientificNotationQuantity", ignore_extras);
    ...
    public new abstract class Generator : QuantityJSON.Generator
      {
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorValue = new JSONHoldingNumberTextGenerator("field \"Value\" of the ScientificNotationQuantity class");
...
//@@@            Debug.Assert(!have_value);
        ...
        public ScientificNotationQuantityJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<ScientificNotationQuantityJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<ScientificNotationQuantityJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<ScientificNotationQuantityJSON> value;
  };
  };
