/* file "NumberGuessQuitGameCommandJSON.cs" */
...
public class NumberGuessQuitGameCommandJSON : NumberGuessCommandJSON
  {
    ...
    public NumberGuessQuitGameCommandJSON()
      {
    ...
    public virtual int extraNumberGuessQuitGameCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraNumberGuessQuitGameCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraNumberGuessQuitGameCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraNumberGuessQuitGameCommandLookup(string field_name)
      {
        JSONValue result = (extraIndex.ContainsKey(field_name) ? extraIndex[field_name] : null);
        return result;
      }
    public override int extraNumberGuessCommandComponentCount()
      {
        ...
        if (flagHasNativeData)
            ++result;
        result += extraNumberGuessQuitGameCommandComponentCount();
        return result;
      }
    public override string extraNumberGuessCommandComponentKey(int component_num)
      {
        ...
        return extraNumberGuessQuitGameCommandComponentKey(remainder);
      }
    public override JSONValue extraNumberGuessCommandComponentValue(int component_num)
      {
        ...
        return extraNumberGuessQuitGameCommandComponentValue(remainder);
      }
    public override JSONValue extraNumberGuessCommandLookup(string field_name)
      {
        ...
        return extraNumberGuessQuitGameCommandLookup(field_name);
      }
    ...
    public virtual void extraNumberGuessQuitGameCommandAppendPair(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public virtual void extraNumberGuessQuitGameCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraNumberGuessQuitGameCommandLookup(key);
        if (old_field == null)
          {
            extraNumberGuessQuitGameCommandAppendPair(key, new_component);
          }
        else
          {
            int count = extraKeys.Count;
    ...
    public override void extraNumberGuessCommandSetField(string key, JSONValue new_component)
      {
        ...
        extraNumberGuessQuitGameCommandSetField(key, new_component);
      }
    ...
    public static new NumberGuessQuitGameCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        NumberGuessQuitGameCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NumberGuessQuitGameCommand", ignore_extras);
            generator.set_allow_incomplete(allow_incomplete);
            generator.set_allow_unpolished(allow_unpolished);
            if (allow_incomplete || allow_unpolished)
                json_value.write(generator);
    ...
    public static new NumberGuessQuitGameCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new NumberGuessQuitGameCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        NumberGuessQuitGameCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NumberGuessQuitGameCommand", ignore_extras);
    ...
    public static new NumberGuessQuitGameCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new NumberGuessQuitGameCommandJSON from_text(string text, bool ignore_extras)
      {
        NumberGuessQuitGameCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NumberGuessQuitGameCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for NumberGuessQuitGameCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new NumberGuessQuitGameCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        NumberGuessQuitGameCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type NumberGuessQuitGameCommand", ignore_extras);
    ...
    public new abstract class Generator : NumberGuessCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getNumberGuessCommandJSONKey().Equals("NumberGuessQuitCommand")))
                throw new Exception("The key field has a value other than `NumberGuessQuitCommand'.");
            NumberGuessQuitGameCommandJSON result = new NumberGuessQuitGameCommandJSON();
            Debug.Assert(result != null);
            finish(result);
            int extra_count = unknownFieldGenerator.field_names.Count;
            Debug.Assert(extra_count == unknownFieldGenerator.field_values.Count);
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraNumberGuessQuitGameCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
            unknownFieldGenerator.field_names.Clear();
            unknownFieldGenerator.field_values.Clear();
            unknownFieldGenerator.index = new Dictionary<string, JSONValue >();
        ...
        protected override void handle_result(NumberGuessCommandJSON new_result)
          {
            handle_result((NumberGuessQuitGameCommandJSON )new_result);
          }
        protected void finish(NumberGuessQuitGameCommandJSON result)
          {
        ...
        protected abstract void handle_result(NumberGuessQuitGameCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the NumberGuessQuitGameCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the NumberGuessQuitGameCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the NumberGuessQuitGameCommand class", false);
            unknownFieldGenerator = new UnknownFieldGenerator(false);
            set_what("the NumberGuessQuitGameCommand class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(NumberGuessQuitGameCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public NumberGuessQuitGameCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<NumberGuessQuitGameCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<NumberGuessQuitGameCommandJSON>();
        base.set_what(what);
      }
    public HoldingArrayGenerator(bool ignore_extras)
      {
    ...
    public bool have_value;
    public List<NumberGuessQuitGameCommandJSON> value;
  };
  };
