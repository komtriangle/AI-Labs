/* file "RadioControlOtherFMBandsJSON.cs" */
...
public class RadioControlOtherFMBandsJSON : JSONBase
  {
        ...
        public void setMinimum(double new_value)
          {
            flagHasMinimum = true;
            if (new_value < 65.8)
                throw new Exception("The value for field Minimum of TypeValueJSON is less than the lower bound (65.8) for that field.");
            if (new_value > 108)
                throw new Exception("The value for field Minimum of TypeValueJSON is greater than the upper bound (108) for that field.");
        ...
        public void setMaximum(double new_value)
          {
            flagHasMaximum = true;
            if (new_value < 65.8)
                throw new Exception("The value for field Maximum of TypeValueJSON is less than the lower bound (65.8) for that field.");
            if (new_value > 108)
                throw new Exception("The value for field Maximum of TypeValueJSON is greater than the upper bound (108) for that field.");
        ...
        public void setStep(double new_value)
          {
            flagHasStep = true;
            if (new_value < 0.001)
                throw new Exception("The value for field Step of TypeValueJSON is less than the lower bound (0.001) for that field.");
            if (new_value > 1)
                throw new Exception("The value for field Step of TypeValueJSON is greater than the upper bound (1) for that field.");
            storeStep = new_value;
            textStoreStep = "";
          }
        public void setStepText(string new_value)
          {
            ...
            if (JSONWriter.compare_number_text_to_repeating_fraction(new_value, false, "1", "", true, "2") < 0)
                throw new Exception("The value for field Step of TypeValueJSON is less than the lower bound (0.001) for that field.");
    ...
    private void  fromJSONValue(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field Value of RadioControlOtherFMBandsJSON is not an array.");
    ...
    public RadioControlOtherFMBandsJSON()
      {
        flagHasValue = false;
    ...
    public static RadioControlOtherFMBandsJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RadioControlOtherFMBandsJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RadioControlOtherFMBands", ignore_extras);
            generator.set_allow_incomplete(allow_incomplete);
            generator.set_allow_unpolished(allow_unpolished);
            if (allow_incomplete || allow_unpolished)
                json_value.write(generator);
    ...
    public static RadioControlOtherFMBandsJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static RadioControlOtherFMBandsJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RadioControlOtherFMBandsJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RadioControlOtherFMBands", ignore_extras);
    ...
    public static RadioControlOtherFMBandsJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static RadioControlOtherFMBandsJSON from_text(string text, bool ignore_extras)
      {
        RadioControlOtherFMBandsJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RadioControlOtherFMBands", ignore_extras);
            JSONParse.parse_json_value(text, "Text for RadioControlOtherFMBandsJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static RadioControlOtherFMBandsJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        RadioControlOtherFMBandsJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RadioControlOtherFMBands", ignore_extras);
    ...
    public abstract class Generator : TypeValueJSON.HoldingArrayGenerator
      {
        protected void finish()
          {
            Debug.Assert(have_value);
            RadioControlOtherFMBandsJSON result = new RadioControlOtherFMBandsJSON();
            result.initValue();
        ...
        protected abstract void handle_result(RadioControlOtherFMBandsJSON new_result);
        public Generator(bool ignore_extras) : base("Type RadioControlOtherFMBands", ignore_extras)
          {
          }
        public void set_allow_incomplete(bool new_allow_incomplete)
          {
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(RadioControlOtherFMBandsJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public RadioControlOtherFMBandsJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    protected class ElementHandler : Generator
    ...
    protected virtual void handle_result(List<RadioControlOtherFMBandsJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<RadioControlOtherFMBandsJSON>();
        base.set_what(what);
      }
    public HoldingArrayGenerator(bool ignore_extras)
      {
    ...
    public bool have_value;
    public List<RadioControlOtherFMBandsJSON> value;
  };
  };
