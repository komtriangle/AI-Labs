/* file "CarControlDrivingTooAmbiguousJSON.cs" */
...
public class CarControlDrivingTooAmbiguousJSON : CarControlCommandJSON
  {
    ...
    public static TypeCommandType  stringToCommandType(string chars)
      {
        if (String.Compare(chars, 0, "CruiseControl", 0, 13, false) == 0)
          {
            switch (chars[13])
              {
                case 'O':
    ...
    private void  fromJSONCommandType(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field CommandType of CarControlDrivingTooAmbiguousJSON is not a string.");
        TypeCommandType the_enum;
        if (String.Compare(json_string.getData(), 0, "CruiseControl", 0, 13, false) == 0)
          {
        ...
        throw new Exception("The value for field CommandType of CarControlDrivingTooAmbiguousJSON is not one of the legal strings.");
      enum_is_done:;
        setCommandType(the_enum);
      }


    public CarControlDrivingTooAmbiguousJSON()
      {
    ...
    public override string  getCarControlCommandKind()
      {
        return "CarControlDrivingTooAmbiguous";
      }
    ...
    public virtual int extraCarControlDrivingTooAmbiguousComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraCarControlDrivingTooAmbiguousComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraCarControlDrivingTooAmbiguousComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraCarControlDrivingTooAmbiguousLookup(string field_name)
      {
    ...
    public override int extraCarControlCommandComponentCount()
      {
        ...
        if (flagHasCommandType)
            ++result;
        result += extraCarControlDrivingTooAmbiguousComponentCount();
        return result;
      }
    public override string extraCarControlCommandComponentKey(int component_num)
      {
        ...
        return extraCarControlDrivingTooAmbiguousComponentKey(remainder);
      }
    public override JSONValue extraCarControlCommandComponentValue(int component_num)
      {
        ...
        return extraCarControlDrivingTooAmbiguousComponentValue(remainder);
      }
    public override JSONValue extraCarControlCommandLookup(string field_name)
      {
        ...
        return extraCarControlDrivingTooAmbiguousLookup(field_name);
      }
    ...
    public virtual void extraCarControlDrivingTooAmbiguousAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraCarControlDrivingTooAmbiguousSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraCarControlDrivingTooAmbiguousLookup(key);
        if (old_field == null)
          {
            extraCarControlDrivingTooAmbiguousAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraCarControlCommandSetField(string key, JSONValue new_component)
      {
        ...
        extraCarControlDrivingTooAmbiguousSetField(key, new_component);
      }
    ...
    public static new CarControlDrivingTooAmbiguousJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CarControlDrivingTooAmbiguousJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlDrivingTooAmbiguous", ignore_extras);
    ...
    public static new CarControlDrivingTooAmbiguousJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new CarControlDrivingTooAmbiguousJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CarControlDrivingTooAmbiguousJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlDrivingTooAmbiguous", ignore_extras);
    ...
    public static new CarControlDrivingTooAmbiguousJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new CarControlDrivingTooAmbiguousJSON from_text(string text, bool ignore_extras)
      {
        CarControlDrivingTooAmbiguousJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlDrivingTooAmbiguous", ignore_extras);
            JSONParse.parse_json_value(text, "Text for CarControlDrivingTooAmbiguousJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new CarControlDrivingTooAmbiguousJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        CarControlDrivingTooAmbiguousJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlDrivingTooAmbiguous", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorCommandType : JSONArrayGenerator
  {
    ...
    public List<TypeCommandType> value;
        ...
        protected override void finish()
          {
            if (!(getCarControlCommandJSONKey().Equals("CarControlDrivingTooAmbiguous")))
                throw new Exception("The key field has a value other than `CarControlDrivingTooAmbiguous'.");
            CarControlDrivingTooAmbiguousJSON result = new CarControlDrivingTooAmbiguousJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraCarControlDrivingTooAmbiguousAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(CarControlCommandJSON new_result)
          {
            handle_result((CarControlDrivingTooAmbiguousJSON )new_result);
          }
        protected void finish(CarControlDrivingTooAmbiguousJSON result)
          {
        ...
        protected abstract void handle_result(CarControlDrivingTooAmbiguousJSON new_result);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(CarControlDrivingTooAmbiguousJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public CarControlDrivingTooAmbiguousJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<CarControlDrivingTooAmbiguousJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<CarControlDrivingTooAmbiguousJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<CarControlDrivingTooAmbiguousJSON> value;
  };
  };
