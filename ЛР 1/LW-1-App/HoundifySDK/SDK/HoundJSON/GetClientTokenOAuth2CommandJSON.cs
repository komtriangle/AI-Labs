/* file "GetClientTokenOAuth2CommandJSON.cs" */
...
public class GetClientTokenOAuth2CommandJSON : OAuth2CommandJSON
  {
    ...
    private bool flagHasClientToken;
    private OAuth2ClientTokenJSON  storeClientToken;
    ...
    private JSONValue  extraClientTokenToJSON()
      {
        JSONValueHandler handler_ClientToken = new JSONValueHandler();
        storeClientToken.write_as_json(handler_ClientToken);
        return handler_ClientToken.result;
      }
    ...
    private void  fromJSONStatus(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field Status of GetClientTokenOAuth2CommandJSON is not a string.");
    ...
    private void  fromJSONClientToken(JSONValue json_value, bool ignore_extras)
      {
        Debug.Assert(json_value != null);
        OAuth2ClientTokenJSON convert_classy = OAuth2ClientTokenJSON.from_json(json_value, ignore_extras, true);
        setClientToken(convert_classy);
      }


    public GetClientTokenOAuth2CommandJSON()
      {
        flagHasServiceType = false;
        flagHasStatus = false;
        flagHasClientToken = false;
    ...
    public override string  getOAuth2CommandKind()
      {
        return "GetClientTokenOAuth2Command";
      }
    ...
    public bool  hasClientToken()
      {
        return flagHasClientToken;
      }

    public OAuth2ClientTokenJSON   getClientToken()
      {
        Debug.Assert(flagHasClientToken);
        return storeClientToken;
      }


    public virtual int extraGetClientTokenOAuth2CommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraGetClientTokenOAuth2CommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraGetClientTokenOAuth2CommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraGetClientTokenOAuth2CommandLookup(string field_name)
      {
    ...
    public override int extraOAuth2CommandComponentCount()
      {
        ...
        if (flagHasStatus)
            ++result;
        if (flagHasClientToken)
            ++result;
        result += extraGetClientTokenOAuth2CommandComponentCount();
        return result;
      }
    public override string extraOAuth2CommandComponentKey(int component_num)
      {
        ...
        return extraGetClientTokenOAuth2CommandComponentKey(remainder);
      }
    public override JSONValue extraOAuth2CommandComponentValue(int component_num)
      {
        ...
        if (flagHasClientToken)
          {
            if (remainder == 0)
                return extraClientTokenToJSON();
            --remainder;
          }
        return extraGetClientTokenOAuth2CommandComponentValue(remainder);
      }
    public override JSONValue extraOAuth2CommandLookup(string field_name)
      {
        switch (field_name[0])
          {
            case 'C':
                if ((String.Compare(field_name, 1, "lientToken", 0, 10, false) == 0) && (field_name.Length == 11))
                    return (flagHasClientToken ? extraClientTokenToJSON() : null);
                break;
            case 'S':
                switch (field_name[1])
                  {
        ...
        return extraGetClientTokenOAuth2CommandLookup(field_name);
      }
    ...
    public void setClientToken(OAuth2ClientTokenJSON  new_value)
      {
        if (flagHasClientToken)
          {
          }
        flagHasClientToken = true;
        storeClientToken = new_value;
      }
    ...
    public virtual void extraGetClientTokenOAuth2CommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraGetClientTokenOAuth2CommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraGetClientTokenOAuth2CommandLookup(key);
        if (old_field == null)
          {
            extraGetClientTokenOAuth2CommandAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraOAuth2CommandAppendPair(string key, JSONValue new_component)
      {
        switch (key[0])
          {
            case 'C':
                if ((String.Compare(key, 1, "lientToken", 0, 10, false) == 0) && (key.Length == 11))
                    {
                    fromJSONClientToken(new_component, false);
                    return;
                    }
                break;
            case 'S':
    ...
    public override void extraOAuth2CommandSetField(string key, JSONValue new_component)
      {
        ...
        extraGetClientTokenOAuth2CommandSetField(key, new_component);
      }
    ...
    public override void write_fields_as_json(JSONHandler handler, bool partial_allowed)
      {
        ...
        if (flagHasClientToken)
          {
            handler.start_pair("ClientToken");
            if (partial_allowed)
                storeClientToken.write_partial_as_json(handler);
            else
                storeClientToken.write_as_json(handler);
          }
      }
    ...
    public static new GetClientTokenOAuth2CommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        GetClientTokenOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type GetClientTokenOAuth2Command", ignore_extras);
    ...
    public static new GetClientTokenOAuth2CommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new GetClientTokenOAuth2CommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        GetClientTokenOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type GetClientTokenOAuth2Command", ignore_extras);
    ...
    public static new GetClientTokenOAuth2CommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new GetClientTokenOAuth2CommandJSON from_text(string text, bool ignore_extras)
      {
        GetClientTokenOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type GetClientTokenOAuth2Command", ignore_extras);
            JSONParse.parse_json_value(text, "Text for GetClientTokenOAuth2CommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new GetClientTokenOAuth2CommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        GetClientTokenOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type GetClientTokenOAuth2Command", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorStatus : JSONArrayGenerator
  {
    ...
    public List<TypeStatus> value;
        ...
        private OAuth2ClientTokenJSON.HoldingGenerator fieldGeneratorClientToken;
        ...
        protected override void finish()
          {
            if (!(getOAuth2CommandJSONKey().Equals("GetClientTokenOAuth2Command")))
                throw new Exception("The key field has a value other than `GetClientTokenOAuth2Command'.");
            GetClientTokenOAuth2CommandJSON result = new GetClientTokenOAuth2CommandJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraGetClientTokenOAuth2CommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(OAuth2CommandJSON new_result)
          {
            handle_result((GetClientTokenOAuth2CommandJSON )new_result);
          }
        protected void finish(GetClientTokenOAuth2CommandJSON result)
          {
            ...
            if (fieldGeneratorClientToken.have_value)
              {
                result.setClientToken(fieldGeneratorClientToken.value);
                fieldGeneratorClientToken.have_value = false;
              }
            base.finish(result);
          }
        protected abstract void handle_result(GetClientTokenOAuth2CommandJSON new_result);
            ...
            switch (field_name[0])
              {
                case 'C':
                    if ((String.Compare(field_name, 1, "lientToken", 0, 10, false) == 0) && (field_name.Length == 11))
                        return fieldGeneratorClientToken;
                    break;
                case 'S':
                    switch (field_name[1])
                      {
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorServiceType = new OAuth2ServiceTypeJSON.HoldingGenerator("field \"ServiceType\" of the GetClientTokenOAuth2Command class", ignore_extras);
            fieldGeneratorStatus = new FieldHoldingGeneratorStatus("field \"Status\" of the GetClientTokenOAuth2Command class");
            fieldGeneratorClientToken = new OAuth2ClientTokenJSON.HoldingGenerator("field \"ClientToken\" of the GetClientTokenOAuth2Command class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the GetClientTokenOAuth2Command class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorServiceType = new OAuth2ServiceTypeJSON.HoldingGenerator("field \"ServiceType\" of the GetClientTokenOAuth2Command class", false);
            fieldGeneratorStatus = new FieldHoldingGeneratorStatus("field \"Status\" of the GetClientTokenOAuth2Command class");
            fieldGeneratorClientToken = new OAuth2ClientTokenJSON.HoldingGenerator("field \"ClientToken\" of the GetClientTokenOAuth2Command class", false);
        ...
        public override void reset()
          {
            ...
            fieldGeneratorClientToken.reset();
            base.reset();
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(GetClientTokenOAuth2CommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public GetClientTokenOAuth2CommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<GetClientTokenOAuth2CommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<GetClientTokenOAuth2CommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<GetClientTokenOAuth2CommandJSON> value;
  };
  };
