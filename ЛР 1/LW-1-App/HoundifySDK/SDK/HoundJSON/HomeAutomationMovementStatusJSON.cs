/* file "HomeAutomationMovementStatusJSON.cs" */
...
public class HomeAutomationMovementStatusJSON : JSONBase
  {
    ...
    public static TypeRecentStatusKnownValues  stringToRecentStatus(string chars)
      {
        switch (chars[0])
          {
            case 'M':
                if ((String.Compare(chars, 1, "ovementDetected", 0, 15, false) == 0) && (chars.Length == 16))
                    return TypeRecentStatusKnownValues.RecentStatus_MovementDetected;
                break;
            case 'N':
                if ((String.Compare(chars, 1, "oMovementDetected", 0, 17, false) == 0) && (chars.Length == 18))
                    return TypeRecentStatusKnownValues.RecentStatus_NoMovementDetected;
                break;
            default:
                break;
          }
    ...
    public static string  stringFromRecentStatus(TypeRecentStatusKnownValues the_enum)
      {
        switch (the_enum)
          {
            case TypeRecentStatusKnownValues.RecentStatus_NoMovementDetected:
                return "NoMovementDetected";
            case TypeRecentStatusKnownValues.RecentStatus_MovementDetected:
    ...
    private void  fromJSONRecentStatus(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field RecentStatus of HomeAutomationMovementStatusJSON is not a string.");
        TypeRecentStatus the_open_enum = new TypeRecentStatus();
        switch (json_string.getData()[0])
          {
            case 'M':
                if ((String.Compare(json_string.getData(), 1, "ovementDetected", 0, 15, false) == 0) && (json_string.getData().Length == 16))
                      {
                        the_open_enum.in_known_list = true;
                        the_open_enum.list_value = TypeRecentStatusKnownValues.RecentStatus_MovementDetected;
                        goto open_enum_is_done;
                      }
                break;
            case 'N':
                if ((String.Compare(json_string.getData(), 1, "oMovementDetected", 0, 17, false) == 0) && (json_string.getData().Length == 18))
                      {
                        the_open_enum.in_known_list = true;
                        the_open_enum.list_value = TypeRecentStatusKnownValues.RecentStatus_NoMovementDetected;
                        goto open_enum_is_done;
                      }
                break;
            default:
    ...
    public HomeAutomationMovementStatusJSON()
      {
    ...
    public virtual int extraHomeAutomationMovementStatusComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraHomeAutomationMovementStatusComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraHomeAutomationMovementStatusComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraHomeAutomationMovementStatusLookup(string field_name)
      {
    ...
    public virtual void extraHomeAutomationMovementStatusAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraHomeAutomationMovementStatusSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static HomeAutomationMovementStatusJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        HomeAutomationMovementStatusJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HomeAutomationMovementStatus", ignore_extras);
    ...
    public static HomeAutomationMovementStatusJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static HomeAutomationMovementStatusJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        HomeAutomationMovementStatusJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HomeAutomationMovementStatus", ignore_extras);
    ...
    public static HomeAutomationMovementStatusJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static HomeAutomationMovementStatusJSON from_text(string text, bool ignore_extras)
      {
        HomeAutomationMovementStatusJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HomeAutomationMovementStatus", ignore_extras);
            JSONParse.parse_json_value(text, "Text for HomeAutomationMovementStatusJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static HomeAutomationMovementStatusJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        HomeAutomationMovementStatusJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HomeAutomationMovementStatus", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorRecentStatus : JSONArrayGenerator
  {
    ...
    public List<TypeRecentStatus> value;
        ...
        protected override void finish()
          {
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraHomeAutomationMovementStatusAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(HomeAutomationMovementStatusJSON result)
          {
        ...
        protected abstract void handle_result(HomeAutomationMovementStatusJSON new_result);
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorRecentStatus = new FieldHoldingGeneratorRecentStatus("field \"RecentStatus\" of the HomeAutomationMovementStatus class");
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(HomeAutomationMovementStatusJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public HomeAutomationMovementStatusJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<HomeAutomationMovementStatusJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<HomeAutomationMovementStatusJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<HomeAutomationMovementStatusJSON> value;
  };
  };
