/* file "BattleshipNotUnderstoodCommandJSON.cs" */
...
public class BattleshipNotUnderstoodCommandJSON : BattleshipCommandJSON
  {
    ...
    public BattleshipNotUnderstoodCommandJSON()
      {
    ...
    public virtual int extraBattleshipNotUnderstoodCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraBattleshipNotUnderstoodCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraBattleshipNotUnderstoodCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraBattleshipNotUnderstoodCommandLookup(string field_name)
      {
    ...
    public virtual void extraBattleshipNotUnderstoodCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraBattleshipNotUnderstoodCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new BattleshipNotUnderstoodCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        BattleshipNotUnderstoodCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BattleshipNotUnderstoodCommand", ignore_extras);
    ...
    public static new BattleshipNotUnderstoodCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new BattleshipNotUnderstoodCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        BattleshipNotUnderstoodCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BattleshipNotUnderstoodCommand", ignore_extras);
    ...
    public static new BattleshipNotUnderstoodCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new BattleshipNotUnderstoodCommandJSON from_text(string text, bool ignore_extras)
      {
        BattleshipNotUnderstoodCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BattleshipNotUnderstoodCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for BattleshipNotUnderstoodCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new BattleshipNotUnderstoodCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        BattleshipNotUnderstoodCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BattleshipNotUnderstoodCommand", ignore_extras);
    ...
    public new abstract class Generator : BattleshipCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getBattleshipCommandJSONKey().Equals("BattleshipNotUnderstoodCommand")))
                throw new Exception("The key field has a value other than `BattleshipNotUnderstoodCommand'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraBattleshipNotUnderstoodCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(BattleshipNotUnderstoodCommandJSON result)
          {
        ...
        protected abstract void handle_result(BattleshipNotUnderstoodCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorUserData = new BattleshipPlayerDataJSON.HoldingGenerator("field \"UserData\" of the BattleshipNotUnderstoodCommand class", ignore_extras);
            fieldGeneratorComputerData = new BattleshipPlayerDataJSON.HoldingGenerator("field \"ComputerData\" of the BattleshipNotUnderstoodCommand class", ignore_extras);
            fieldGeneratorStartDateAndOrTime = new DateAndOrTimeJSON.HoldingGenerator("field \"StartDateAndOrTime\" of the BattleshipNotUnderstoodCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the BattleshipNotUnderstoodCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorUserData = new BattleshipPlayerDataJSON.HoldingGenerator("field \"UserData\" of the BattleshipNotUnderstoodCommand class", false);
            fieldGeneratorComputerData = new BattleshipPlayerDataJSON.HoldingGenerator("field \"ComputerData\" of the BattleshipNotUnderstoodCommand class", false);
            fieldGeneratorStartDateAndOrTime = new DateAndOrTimeJSON.HoldingGenerator("field \"StartDateAndOrTime\" of the BattleshipNotUnderstoodCommand class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(BattleshipNotUnderstoodCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public BattleshipNotUnderstoodCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<BattleshipNotUnderstoodCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<BattleshipNotUnderstoodCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<BattleshipNotUnderstoodCommandJSON> value;
  };
  };
