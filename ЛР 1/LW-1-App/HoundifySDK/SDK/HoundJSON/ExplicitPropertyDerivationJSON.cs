/* file "ExplicitPropertyDerivationJSON.cs" */
...
public class ExplicitPropertyDerivationJSON : DerivationJSON
  {
    ...
    public ExplicitPropertyDerivationJSON()
      {
        flagHasBase = false;
    ...
    public override string  getDerivationKind()
      {
        return "ExplicitPropertyDerivation";
      }
    ...
    public virtual int extraExplicitPropertyDerivationComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraExplicitPropertyDerivationComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraExplicitPropertyDerivationComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraExplicitPropertyDerivationLookup(string field_name)
      {
    ...
    public override int extraDerivationComponentCount()
      {
        ...
        if (flagHasProperty)
            ++result;
        result += extraExplicitPropertyDerivationComponentCount();
        return result;
      }
    public override string extraDerivationComponentKey(int component_num)
      {
        ...
        return extraExplicitPropertyDerivationComponentKey(remainder);
      }
    public override JSONValue extraDerivationComponentValue(int component_num)
      {
        ...
        return extraExplicitPropertyDerivationComponentValue(remainder);
      }
    public override JSONValue extraDerivationLookup(string field_name)
      {
        ...
        return extraExplicitPropertyDerivationLookup(field_name);
      }
    ...
    public virtual void extraExplicitPropertyDerivationAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraExplicitPropertyDerivationSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraExplicitPropertyDerivationLookup(key);
        if (old_field == null)
          {
            extraExplicitPropertyDerivationAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraDerivationSetField(string key, JSONValue new_component)
      {
        ...
        extraExplicitPropertyDerivationSetField(key, new_component);
      }
    ...
    public static new ExplicitPropertyDerivationJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ExplicitPropertyDerivationJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ExplicitPropertyDerivation", ignore_extras);
    ...
    public static new ExplicitPropertyDerivationJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new ExplicitPropertyDerivationJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ExplicitPropertyDerivationJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ExplicitPropertyDerivation", ignore_extras);
    ...
    public static new ExplicitPropertyDerivationJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new ExplicitPropertyDerivationJSON from_text(string text, bool ignore_extras)
      {
        ExplicitPropertyDerivationJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ExplicitPropertyDerivation", ignore_extras);
            JSONParse.parse_json_value(text, "Text for ExplicitPropertyDerivationJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new ExplicitPropertyDerivationJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        ExplicitPropertyDerivationJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ExplicitPropertyDerivation", ignore_extras);
    ...
    public new abstract class Generator : DerivationJSON.Generator
      {
        ...
        protected override void handle_result(DerivationJSON new_result)
          {
            handle_result((ExplicitPropertyDerivationJSON )new_result);
          }
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorBase = new DerivedGeneralizedThingJSON.HoldingGenerator("field \"Base\" of the ExplicitPropertyDerivation class", ignore_extras);
            fieldGeneratorProperty = new PropertyJSON.HoldingGenerator("field \"Property\" of the ExplicitPropertyDerivation class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the ExplicitPropertyDerivation class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorBase = new DerivedGeneralizedThingJSON.HoldingGenerator("field \"Base\" of the ExplicitPropertyDerivation class", false);
            fieldGeneratorProperty = new PropertyJSON.HoldingGenerator("field \"Property\" of the ExplicitPropertyDerivation class", false);
...
//@@@            Debug.Assert(!have_value);
        ...
        public ExplicitPropertyDerivationJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<ExplicitPropertyDerivationJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<ExplicitPropertyDerivationJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<ExplicitPropertyDerivationJSON> value;
  };
  };
