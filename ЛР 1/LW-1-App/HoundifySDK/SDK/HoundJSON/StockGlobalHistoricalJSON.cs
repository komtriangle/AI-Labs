/* file "StockGlobalHistoricalJSON.cs" */
...
public class StockGlobalHistoricalJSON : JSONBase
  {
    ...
    private bool flagHasHistoricalQuotes;
    private List< StockGlobalHistoricalQuoteV3JSON  > storeHistoricalQuotes;
    ...
    private void  fromJSONOutcome(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field Outcome of StockGlobalHistoricalJSON is not a string.");
    ...
    private void  fromJSONMessage(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (!or_done)
            throw new Exception("The value for field Message of StockGlobalHistoricalJSON is not one of the allowed values.");
    ...
    private void  fromJSONDelay(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (!or_done)
            throw new Exception("The value for field Delay of StockGlobalHistoricalJSON is not one of the allowed values.");
        setDelay(or_result);
        switch (or_result.key)
          {
            case 0:
    ...
    public StockGlobalHistoricalJSON()
      {
        flagHasOutcome = false;
        flagHasMessage = false;
        flagHasDelay = false;
        flagHasHistoricalQuotes = false;
        storeHistoricalQuotes = new List< StockGlobalHistoricalQuoteV3JSON  >();
    ...
    public bool  hasHistoricalQuotes()
      {
        return flagHasHistoricalQuotes;
      }

    public int  countOfHistoricalQuotes()
      {
        Debug.Assert(flagHasHistoricalQuotes);
        return storeHistoricalQuotes.Count;
      }

    public StockGlobalHistoricalQuoteV3JSON   elementOfHistoricalQuotes(int element_num)
      {
        Debug.Assert(flagHasHistoricalQuotes);
        return storeHistoricalQuotes[element_num];
      }

    public List< StockGlobalHistoricalQuoteV3JSON  >  getHistoricalQuotes()
      {
        Debug.Assert(flagHasHistoricalQuotes);
        return storeHistoricalQuotes;
      }


    public virtual int extraStockGlobalHistoricalComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraStockGlobalHistoricalComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraStockGlobalHistoricalComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraStockGlobalHistoricalLookup(string field_name)
      {
    ...
    public void initHistoricalQuotes()
      {
        if (flagHasHistoricalQuotes)
          {
            for (int num1 = 0; num1 < storeHistoricalQuotes.Count; ++num1)
              {
              }
          }
    ...
    public void unsetHistoricalQuotes()
      {
        if (flagHasHistoricalQuotes)
          {
            for (int num2 = 0; num2 < storeHistoricalQuotes.Count; ++num2)
              {
              }
          }
        flagHasHistoricalQuotes = false;
    ...
    public virtual void extraStockGlobalHistoricalAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraStockGlobalHistoricalSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public virtual void write_fields_as_json(JSONHandler handler, bool partial_allowed)
      {
        ...
        Debug.Assert(partial_allowed || flagHasHistoricalQuotes);
        if (flagHasHistoricalQuotes)
          {
            handler.start_pair("HistoricalQuotes");
            handler.start_array();
            for (int num1 = 0; num1 < storeHistoricalQuotes.Count; ++num1)
              {
                if (partial_allowed)
                    storeHistoricalQuotes[num1].write_partial_as_json(handler);
                else
                    storeHistoricalQuotes[num1].write_as_json(handler);
              }
    ...
    public virtual string missing_field_error(bool allow_unpolished)
      {
        ...
        if (!(hasHistoricalQuotes()))
          {
            return "When parsing the object for %what%, the \"HistoricalQuotes\" field was missing.";
          }
        return null;
      }

    public static StockGlobalHistoricalJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        StockGlobalHistoricalJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type StockGlobalHistorical", ignore_extras);
    ...
    public static StockGlobalHistoricalJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static StockGlobalHistoricalJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        StockGlobalHistoricalJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type StockGlobalHistorical", ignore_extras);
    ...
    public static StockGlobalHistoricalJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static StockGlobalHistoricalJSON from_text(string text, bool ignore_extras)
      {
        StockGlobalHistoricalJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type StockGlobalHistorical", ignore_extras);
            JSONParse.parse_json_value(text, "Text for StockGlobalHistoricalJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static StockGlobalHistoricalJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        StockGlobalHistoricalJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type StockGlobalHistorical", ignore_extras);
    ...
    private class FieldHoldingArrayGeneratorDelay : JSONArrayGenerator
  {
    ...
    public List<TypeDelay> value;
        ...
        private StockGlobalHistoricalQuoteV3JSON.HoldingArrayGenerator fieldGeneratorHistoricalQuotes;
        ...
        protected override void finish()
          {
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraStockGlobalHistoricalAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(StockGlobalHistoricalJSON result)
          {
            ...
            if (fieldGeneratorHistoricalQuotes.have_value)
              {
                result.initHistoricalQuotes();
                int count = fieldGeneratorHistoricalQuotes.value.Count;
                for (int num = 0; num < count; ++num)
                  {
                    result.appendHistoricalQuotes(fieldGeneratorHistoricalQuotes.value[num]);
                  }
                fieldGeneratorHistoricalQuotes.value.Clear();
                fieldGeneratorHistoricalQuotes.have_value = false;
              }
            else if ((!(result.hasHistoricalQuotes())) && !allow_incomplete)
              {
                error("When parsing the object for %what%, the \"HistoricalQuotes\" field was missing.");
              }
          }
        protected abstract void handle_result(StockGlobalHistoricalJSON new_result);
            ...
            switch (field_name[0])
              {
                case 'D':
                    ...
                    break;
                case 'H':
                    if ((String.Compare(field_name, 1, "istoricalQuotes", 0, 15, false) == 0) && (field_name.Length == 16))
                        return fieldGeneratorHistoricalQuotes;
                    break;
                case 'M':
        ...
        public Generator()
          {
            fieldGeneratorOutcome = new JSONHoldingStringGenerator("field \"Outcome\" of the StockGlobalHistorical class");
            fieldGeneratorMessage = new FieldHoldingGeneratorMessage("field \"Message\" of the StockGlobalHistorical class", false);
            fieldGeneratorDelay = new FieldHoldingGeneratorDelay("field \"Delay\" of the StockGlobalHistorical class", false);
            fieldGeneratorHistoricalQuotes = new StockGlobalHistoricalQuoteV3JSON.HoldingArrayGenerator("field \"HistoricalQuotes\" of the StockGlobalHistorical class", false);
        ...
        public override void reset()
          {
            ...
            fieldGeneratorHistoricalQuotes.reset();
            base.reset();
        ...
        public void set_allow_incomplete(bool new_allow_incomplete)
          {
            ...
            fieldGeneratorHistoricalQuotes.set_allow_incomplete(new_allow_incomplete);
          }
        public void set_allow_unpolished(bool new_allow_unpolished)
          {
            allow_unpolished = new_allow_unpolished;
            fieldGeneratorHistoricalQuotes.set_allow_unpolished(new_allow_unpolished);
          }
      };
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(StockGlobalHistoricalJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public StockGlobalHistoricalJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<StockGlobalHistoricalJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<StockGlobalHistoricalJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<StockGlobalHistoricalJSON> value;
  };
  };
