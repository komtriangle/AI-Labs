/* file "UnambiguousSMSRecipientJSON.cs" */
...
public class UnambiguousSMSRecipientJSON : JSONBase
  {
    ...
    private void  fromJSONPhoneNumber(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field PhoneNumber of UnambiguousSMSRecipientJSON is not a string.");
    ...
    private void  fromJSONContacts(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field Contacts of UnambiguousSMSRecipientJSON is not an array.");
    ...
    private void  fromJSONToUserWrittenName(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field ToUserWrittenName of UnambiguousSMSRecipientJSON is not a string.");
    ...
    private void  fromJSONToUserSpokenName(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field ToUserSpokenName of UnambiguousSMSRecipientJSON is not a string.");
        setToUserSpokenName(json_string.getData());
      }


    public UnambiguousSMSRecipientJSON()
      {
    ...
    public virtual int extraUnambiguousSMSRecipientComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraUnambiguousSMSRecipientComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraUnambiguousSMSRecipientComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraUnambiguousSMSRecipientLookup(string field_name)
      {
    ...
    public virtual void extraUnambiguousSMSRecipientAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraUnambiguousSMSRecipientSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static UnambiguousSMSRecipientJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        UnambiguousSMSRecipientJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UnambiguousSMSRecipient", ignore_extras);
    ...
    public static UnambiguousSMSRecipientJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static UnambiguousSMSRecipientJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        UnambiguousSMSRecipientJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UnambiguousSMSRecipient", ignore_extras);
    ...
    public static UnambiguousSMSRecipientJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static UnambiguousSMSRecipientJSON from_text(string text, bool ignore_extras)
      {
        UnambiguousSMSRecipientJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UnambiguousSMSRecipient", ignore_extras);
            JSONParse.parse_json_value(text, "Text for UnambiguousSMSRecipientJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static UnambiguousSMSRecipientJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        UnambiguousSMSRecipientJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UnambiguousSMSRecipient", ignore_extras);
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        protected override void finish()
          {
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraUnambiguousSMSRecipientAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(UnambiguousSMSRecipientJSON result)
          {
        ...
        protected abstract void handle_result(UnambiguousSMSRecipientJSON new_result);
        ...
        public Generator(bool ignore_extras)
          {
            ...
            fieldGeneratorContacts = new OneContactJSON.HoldingArrayGenerator("field \"Contacts\" of the UnambiguousSMSRecipient class", ignore_extras);
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(UnambiguousSMSRecipientJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public UnambiguousSMSRecipientJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<UnambiguousSMSRecipientJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<UnambiguousSMSRecipientJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<UnambiguousSMSRecipientJSON> value;
  };
  };
