/* file "BlackjackStandCommandJSON.cs" */
...
public class BlackjackStandCommandJSON : BlackjackCommandJSON
  {
        ...
        public void setDealerHandTotal(sbyte new_value)
          {
            ...
            if (new_value < 17)
                throw new Exception("The value for field DealerHandTotal of TypeNativeDataJSON is less than the lower bound (17) for that field.");
            if (new_value > 26)
    ...
    public BlackjackStandCommandJSON()
      {
    ...
    public virtual int extraBlackjackStandCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraBlackjackStandCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraBlackjackStandCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraBlackjackStandCommandLookup(string field_name)
      {
        JSONValue result = (extraIndex.ContainsKey(field_name) ? extraIndex[field_name] : null);
        return result;
      }
    public override int extraBlackjackCommandComponentCount()
      {
        ...
        if (flagHasNativeData)
            ++result;
        result += extraBlackjackStandCommandComponentCount();
        return result;
      }
    public override string extraBlackjackCommandComponentKey(int component_num)
      {
        ...
        return extraBlackjackStandCommandComponentKey(remainder);
      }
    public override JSONValue extraBlackjackCommandComponentValue(int component_num)
      {
        ...
        return extraBlackjackStandCommandComponentValue(remainder);
      }
    public override JSONValue extraBlackjackCommandLookup(string field_name)
      {
        ...
        return extraBlackjackStandCommandLookup(field_name);
      }
    ...
    public virtual void extraBlackjackStandCommandAppendPair(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public virtual void extraBlackjackStandCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraBlackjackStandCommandLookup(key);
        if (old_field == null)
          {
            extraBlackjackStandCommandAppendPair(key, new_component);
          }
        else
          {
            int count = extraKeys.Count;
    ...
    public override void extraBlackjackCommandSetField(string key, JSONValue new_component)
      {
        ...
        extraBlackjackStandCommandSetField(key, new_component);
      }
    ...
    public static new BlackjackStandCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        BlackjackStandCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BlackjackStandCommand", ignore_extras);
            generator.set_allow_incomplete(allow_incomplete);
            generator.set_allow_unpolished(allow_unpolished);
            if (allow_incomplete || allow_unpolished)
                json_value.write(generator);
    ...
    public static new BlackjackStandCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new BlackjackStandCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        BlackjackStandCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BlackjackStandCommand", ignore_extras);
    ...
    public static new BlackjackStandCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new BlackjackStandCommandJSON from_text(string text, bool ignore_extras)
      {
        BlackjackStandCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BlackjackStandCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for BlackjackStandCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new BlackjackStandCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        BlackjackStandCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BlackjackStandCommand", ignore_extras);
    ...
    public new abstract class Generator : BlackjackCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getBlackjackCommandJSONKey().Equals("BlackjackStandCommand")))
                throw new Exception("The key field has a value other than `BlackjackStandCommand'.");
            BlackjackStandCommandJSON result = new BlackjackStandCommandJSON();
            Debug.Assert(result != null);
            finish(result);
            int extra_count = unknownFieldGenerator.field_names.Count;
            Debug.Assert(extra_count == unknownFieldGenerator.field_values.Count);
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraBlackjackStandCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
            unknownFieldGenerator.field_names.Clear();
            unknownFieldGenerator.field_values.Clear();
            unknownFieldGenerator.index = new Dictionary<string, JSONValue >();
        ...
        protected override void handle_result(BlackjackCommandJSON new_result)
          {
            handle_result((BlackjackStandCommandJSON )new_result);
          }
        protected void finish(BlackjackStandCommandJSON result)
          {
        ...
        protected abstract void handle_result(BlackjackStandCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the BlackjackStandCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the BlackjackStandCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the BlackjackStandCommand class", false);
            unknownFieldGenerator = new UnknownFieldGenerator(false);
            set_what("the BlackjackStandCommand class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(BlackjackStandCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public BlackjackStandCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<BlackjackStandCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<BlackjackStandCommandJSON>();
        base.set_what(what);
      }
    public HoldingArrayGenerator(bool ignore_extras)
      {
    ...
    public bool have_value;
    public List<BlackjackStandCommandJSON> value;
  };
  };
