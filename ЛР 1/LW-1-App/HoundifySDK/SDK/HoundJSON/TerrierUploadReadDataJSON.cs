...
public class TerrierUploadReadDataJSON : JSONBase
  {
    ...
    private bool flagHasReadMetadata;
    private bool storeReadMetadata;
    ...
    private void  fromJSONReadMetadata(JSONValue json_value, bool ignore_extras)
      {
        Debug.Assert(json_value != null);
        JSONTrueValue json_true = json_value.true_value();
        bool the_bool;
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field ReadMetadata of TerrierUploadReadDataJSON is not true for false.");
              }
          }
        setReadMetadata(the_bool);
      }
    ...
    public bool  hasReadMetadata()
      {
        return flagHasReadMetadata;
      }

    public bool  getReadMetadata()
      {
        Debug.Assert(flagHasReadMetadata);
        return storeReadMetadata;
      }
    ...
    public void setReadMetadata(bool new_value)
      {
        flagHasReadMetadata = true;
        storeReadMetadata = new_value;
      }
    public void unsetReadMetadata()
      {
        flagHasReadMetadata = false;
      }
    ...
    public virtual void write_fields_as_json(JSONHandler handler, bool partial_allowed)
      {
        ...
        if (flagHasReadMetadata)
          {
            handler.start_pair("ReadMetadata");
            handler.boolean_value(storeReadMetadata);
          }
      }
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        private JSONHoldingBooleanGenerator fieldGeneratorReadMetadata;
        ...
        protected void finish(TerrierUploadReadDataJSON result)
          {
            ...
            if (fieldGeneratorReadMetadata.have_value)
              {
                result.setReadMetadata(fieldGeneratorReadMetadata.value);
                fieldGeneratorReadMetadata.have_value = false;
              }
          }
            ...
            switch (field_name[0])
              {
                case 'B':
                    ...
                    break;
                case 'R':
                    if (String.Compare(field_name, 1, "ead", 0, 3, false) == 0)
                      {
                        switch (field_name[4])
                          {
                            case 'B':
                                if ((String.Compare(field_name, 5, "lockList", 0, 8, false) == 0) && (field_name.Length == 13))
                                    return fieldGeneratorReadBlockList;
                                break;
                            case 'M':
                                if ((String.Compare(field_name, 5, "etadata", 0, 7, false) == 0) && (field_name.Length == 12))
                                    return fieldGeneratorReadMetadata;
                                break;
                            default:
                                break;
                          }
        ...
        public Generator(bool ignore_extras)
          {
            ...
            fieldGeneratorReadMetadata = new JSONHoldingBooleanGenerator("field \"ReadMetadata\" of the TerrierUploadReadData class");
        ...
        public override void reset()
          {
            ...
            fieldGeneratorReadMetadata.reset();
            base.reset();
