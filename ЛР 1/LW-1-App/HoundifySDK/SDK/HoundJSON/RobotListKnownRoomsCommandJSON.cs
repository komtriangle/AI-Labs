/* file "RobotListKnownRoomsCommandJSON.cs" */
...
public class RobotListKnownRoomsCommandJSON : RobotCommandJSON
  {
    ...
    public RobotListKnownRoomsCommandJSON()
      {
    ...
    public virtual int extraRobotListKnownRoomsCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraRobotListKnownRoomsCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraRobotListKnownRoomsCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraRobotListKnownRoomsCommandLookup(string field_name)
      {
    ...
    public virtual void extraRobotListKnownRoomsCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraRobotListKnownRoomsCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new RobotListKnownRoomsCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RobotListKnownRoomsCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RobotListKnownRoomsCommand", ignore_extras);
    ...
    public static new RobotListKnownRoomsCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RobotListKnownRoomsCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RobotListKnownRoomsCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RobotListKnownRoomsCommand", ignore_extras);
    ...
    public static new RobotListKnownRoomsCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RobotListKnownRoomsCommandJSON from_text(string text, bool ignore_extras)
      {
        RobotListKnownRoomsCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RobotListKnownRoomsCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for RobotListKnownRoomsCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new RobotListKnownRoomsCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        RobotListKnownRoomsCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RobotListKnownRoomsCommand", ignore_extras);
    ...
    public new abstract class Generator : RobotCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getRobotCommandJSONKey().Equals("ListKnownRoomsCommand")))
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraRobotListKnownRoomsCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(RobotListKnownRoomsCommandJSON result)
          {
        ...
        protected abstract void handle_result(RobotListKnownRoomsCommandJSON new_result);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(RobotListKnownRoomsCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public RobotListKnownRoomsCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<RobotListKnownRoomsCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<RobotListKnownRoomsCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<RobotListKnownRoomsCommandJSON> value;
  };
  };
