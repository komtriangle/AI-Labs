/* file "WikidataAPIDatavalueMonolingualTextJSON.cs" */
...
public class WikidataAPIDatavalueMonolingualTextJSON : WikidataAPIDatavalueJSON
  {
        ...
        private void  fromJSONtext(JSONValue json_value, bool ignore_extras)
          {
            ...
            if (json_string == null)
                throw new Exception("The value for field text of TypevalueJSON is not a string.");
        ...
        private void  fromJSONlanguage(JSONValue json_value, bool ignore_extras)
          {
            ...
            JSONStringValue json_string = json_value.string_value();
            if (json_string == null)
                throw new Exception("The value for field language of TypevalueJSON is not a string.");
        ...
        public abstract class Generator : JSONObjectGenerator
          {
            ...
            public Generator(bool ignore_extras)
              {
                fieldGeneratortext = new JSONHoldingStringGenerator("field \"text\" of the Typevalue class");
                fieldGeneratorlanguage = new JSONHoldingStringGenerator("field \"language\" of the Typevalue class");
    ...
    public WikidataAPIDatavalueMonolingualTextJSON()
      {
        flagHasvalue = false;
        extraKeys = new List<string>();
    extraValues = new List<JSONValue >();
    ...
    public virtual int extraWikidataAPIDatavalueMonolingualTextComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraWikidataAPIDatavalueMonolingualTextComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraWikidataAPIDatavalueMonolingualTextComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraWikidataAPIDatavalueMonolingualTextLookup(string field_name)
      {
        JSONValue result = (extraIndex.ContainsKey(field_name) ? extraIndex[field_name] : null);
        return result;
      }
    public override int extraWikidataAPIDatavalueComponentCount()
      {
        ...
        if (flagHasvalue)
            ++result;
        result += extraWikidataAPIDatavalueMonolingualTextComponentCount();
        return result;
      }
    public override string extraWikidataAPIDatavalueComponentKey(int component_num)
      {
        ...
        return extraWikidataAPIDatavalueMonolingualTextComponentKey(remainder);
      }
    public override JSONValue extraWikidataAPIDatavalueComponentValue(int component_num)
      {
        ...
        return extraWikidataAPIDatavalueMonolingualTextComponentValue(remainder);
      }
    public override JSONValue extraWikidataAPIDatavalueLookup(string field_name)
      {
        ...
        return extraWikidataAPIDatavalueMonolingualTextLookup(field_name);
      }
    ...
    public virtual void extraWikidataAPIDatavalueMonolingualTextAppendPair(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public virtual void extraWikidataAPIDatavalueMonolingualTextSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraWikidataAPIDatavalueMonolingualTextLookup(key);
        if (old_field == null)
          {
            extraWikidataAPIDatavalueMonolingualTextAppendPair(key, new_component);
          }
        else
          {
            int count = extraKeys.Count;
    ...
    public override void extraWikidataAPIDatavalueSetField(string key, JSONValue new_component)
      {
        ...
        extraWikidataAPIDatavalueMonolingualTextSetField(key, new_component);
      }
    ...
    public static new WikidataAPIDatavalueMonolingualTextJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        WikidataAPIDatavalueMonolingualTextJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type WikidataAPIDatavalueMonolingualText", ignore_extras);
            generator.set_allow_incomplete(allow_incomplete);
            generator.set_allow_unpolished(allow_unpolished);
            if (allow_incomplete || allow_unpolished)
                json_value.write(generator);
    ...
    public static new WikidataAPIDatavalueMonolingualTextJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new WikidataAPIDatavalueMonolingualTextJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        WikidataAPIDatavalueMonolingualTextJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type WikidataAPIDatavalueMonolingualText", ignore_extras);
    ...
    public static new WikidataAPIDatavalueMonolingualTextJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new WikidataAPIDatavalueMonolingualTextJSON from_text(string text, bool ignore_extras)
      {
        WikidataAPIDatavalueMonolingualTextJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type WikidataAPIDatavalueMonolingualText", ignore_extras);
            JSONParse.parse_json_value(text, "Text for WikidataAPIDatavalueMonolingualTextJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new WikidataAPIDatavalueMonolingualTextJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        WikidataAPIDatavalueMonolingualTextJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type WikidataAPIDatavalueMonolingualText", ignore_extras);
    ...
    public new abstract class Generator : WikidataAPIDatavalueJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getWikidataAPIDatavalueJSONKey().Equals("monolingualtext")))
                throw new Exception("The key field has a value other than `monolingualtext'.");
            WikidataAPIDatavalueMonolingualTextJSON result = new WikidataAPIDatavalueMonolingualTextJSON();
            Debug.Assert(result != null);
            finish(result);
            int extra_count = unknownFieldGenerator.field_names.Count;
            Debug.Assert(extra_count == unknownFieldGenerator.field_values.Count);
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraWikidataAPIDatavalueMonolingualTextAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
            unknownFieldGenerator.field_names.Clear();
            unknownFieldGenerator.field_values.Clear();
            unknownFieldGenerator.index = new Dictionary<string, JSONValue >();
        ...
        protected override void handle_result(WikidataAPIDatavalueJSON new_result)
          {
            handle_result((WikidataAPIDatavalueMonolingualTextJSON )new_result);
          }
        protected void finish(WikidataAPIDatavalueMonolingualTextJSON result)
          {
        ...
        protected abstract void handle_result(WikidataAPIDatavalueMonolingualTextJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorvalue = new TypevalueJSON.HoldingGenerator("field \"value\" of the WikidataAPIDatavalueMonolingualText class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the WikidataAPIDatavalueMonolingualText class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorvalue = new TypevalueJSON.HoldingGenerator("field \"value\" of the WikidataAPIDatavalueMonolingualText class", false);
            unknownFieldGenerator = new UnknownFieldGenerator(false);
            set_what("the WikidataAPIDatavalueMonolingualText class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(WikidataAPIDatavalueMonolingualTextJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public WikidataAPIDatavalueMonolingualTextJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<WikidataAPIDatavalueMonolingualTextJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<WikidataAPIDatavalueMonolingualTextJSON>();
        base.set_what(what);
      }
    public HoldingArrayGenerator(bool ignore_extras)
      {
    ...
    public bool have_value;
    public List<WikidataAPIDatavalueMonolingualTextJSON> value;
  };
  };
