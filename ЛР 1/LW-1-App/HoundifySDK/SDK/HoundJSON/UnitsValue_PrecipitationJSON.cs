/* file "UnitsValue_PrecipitationJSON.cs" */
...
public class UnitsValue_PrecipitationJSON : JSONBase
  {
    ...
    private void  fromJSONAbbreviatedUnits(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field AbbreviatedUnits of UnitsValue_PrecipitationJSON is not a string.");
    ...
    private void  fromJSONWrittenUnits(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field WrittenUnits of UnitsValue_PrecipitationJSON is not a string.");
    ...
    private void  fromJSONSpokenUnits(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field SpokenUnits of UnitsValue_PrecipitationJSON is not a string.");
        ...
        if (json_rational != null)
        ...
        else
          {
            ...
            if (json_integer != null)
              ...
              {
                throw new Exception("The value for field Value of UnitsValue_PrecipitationJSON is not a number.");
              }
          }
    ...
    public UnitsValue_PrecipitationJSON()
      {
        flagHasFormat = false;
        flagHasUnits = false;
    ...
    public virtual int extraUnitsValue_PrecipitationComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraUnitsValue_PrecipitationComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraUnitsValue_PrecipitationComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraUnitsValue_PrecipitationLookup(string field_name)
      {
    ...
    public void setValue(double new_value)
      {
        flagHasValue = true;
        if (new_value < 0)
            throw new Exception("The value for field Value of UnitsValue_PrecipitationJSON is less than the lower bound (0) for that field.");
    ...
    public void setValueText(string new_value)
      {
        ...
        if (!(JSONWriter.is_valid_number_format(new_value)))
            throw new Exception("The text value for field Value of UnitsValue_PrecipitationJSON is not a valid number.");
    ...
    public virtual void extraUnitsValue_PrecipitationAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraUnitsValue_PrecipitationSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraUnitsValue_PrecipitationLookup(key);
        if (old_field == null)
          {
            extraUnitsValue_PrecipitationAppendPair(key, new_component);
          }
        else
          {
    ...
    public static UnitsValue_PrecipitationJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        UnitsValue_PrecipitationJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UnitsValue_Precipitation", ignore_extras);
    ...
    public static UnitsValue_PrecipitationJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static UnitsValue_PrecipitationJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        UnitsValue_PrecipitationJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UnitsValue_Precipitation", ignore_extras);
    ...
    public static UnitsValue_PrecipitationJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static UnitsValue_PrecipitationJSON from_text(string text, bool ignore_extras)
      {
        UnitsValue_PrecipitationJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UnitsValue_Precipitation", ignore_extras);
            JSONParse.parse_json_value(text, "Text for UnitsValue_PrecipitationJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static UnitsValue_PrecipitationJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        UnitsValue_PrecipitationJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UnitsValue_Precipitation", ignore_extras);
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorFormat = new WeatherUnitsFormatJSON.HoldingGenerator("field \"Format\" of the UnitsValue_Precipitation class", ignore_extras);
            fieldGeneratorUnits = new WeatherShallowDepthUnitsJSON.HoldingGenerator("field \"Units\" of the UnitsValue_Precipitation class", ignore_extras);
            fieldGeneratorAbbreviatedUnits = new JSONHoldingStringGenerator("field \"AbbreviatedUnits\" of the UnitsValue_Precipitation class");
            fieldGeneratorWrittenUnits = new JSONHoldingStringGenerator("field \"WrittenUnits\" of the UnitsValue_Precipitation class");
            fieldGeneratorSpokenUnits = new JSONHoldingStringGenerator("field \"SpokenUnits\" of the UnitsValue_Precipitation class");
            fieldGeneratorValue = new JSONHoldingNumberTextGenerator("field \"Value\" of the UnitsValue_Precipitation class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the UnitsValue_Precipitation class");
            allow_incomplete = false;
            allow_unpolished = false;
          }
        public Generator()
          {
            fieldGeneratorFormat = new WeatherUnitsFormatJSON.HoldingGenerator("field \"Format\" of the UnitsValue_Precipitation class", false);
            fieldGeneratorUnits = new WeatherShallowDepthUnitsJSON.HoldingGenerator("field \"Units\" of the UnitsValue_Precipitation class", false);
            fieldGeneratorAbbreviatedUnits = new JSONHoldingStringGenerator("field \"AbbreviatedUnits\" of the UnitsValue_Precipitation class");
            fieldGeneratorWrittenUnits = new JSONHoldingStringGenerator("field \"WrittenUnits\" of the UnitsValue_Precipitation class");
            fieldGeneratorSpokenUnits = new JSONHoldingStringGenerator("field \"SpokenUnits\" of the UnitsValue_Precipitation class");
            fieldGeneratorValue = new JSONHoldingNumberTextGenerator("field \"Value\" of the UnitsValue_Precipitation class");
...
//@@@            Debug.Assert(!have_value);
        ...
        public UnitsValue_PrecipitationJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<UnitsValue_PrecipitationJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<UnitsValue_PrecipitationJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<UnitsValue_PrecipitationJSON> value;
  };
  };
