/* file "HangmanNotUnderstoodCommandJSON.cs" */
...
public class HangmanNotUnderstoodCommandJSON : HangmanCommandJSON
  {
    ...
    public HangmanNotUnderstoodCommandJSON()
      {
    ...
    public virtual int extraHangmanNotUnderstoodCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraHangmanNotUnderstoodCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraHangmanNotUnderstoodCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraHangmanNotUnderstoodCommandLookup(string field_name)
      {
        JSONValue result = (extraIndex.ContainsKey(field_name) ? extraIndex[field_name] : null);
        return result;
      }
    public override int extraHangmanCommandComponentCount()
      {
        ...
        if (flagHasNativeData)
            ++result;
        result += extraHangmanNotUnderstoodCommandComponentCount();
        return result;
      }
    public override string extraHangmanCommandComponentKey(int component_num)
      {
        ...
        return extraHangmanNotUnderstoodCommandComponentKey(remainder);
      }
    public override JSONValue extraHangmanCommandComponentValue(int component_num)
      {
        ...
        return extraHangmanNotUnderstoodCommandComponentValue(remainder);
      }
    public override JSONValue extraHangmanCommandLookup(string field_name)
      {
        ...
        return extraHangmanNotUnderstoodCommandLookup(field_name);
      }
    ...
    public virtual void extraHangmanNotUnderstoodCommandAppendPair(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public virtual void extraHangmanNotUnderstoodCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraHangmanNotUnderstoodCommandLookup(key);
        if (old_field == null)
          {
            extraHangmanNotUnderstoodCommandAppendPair(key, new_component);
          }
        else
          {
            int count = extraKeys.Count;
    ...
    public override void extraHangmanCommandSetField(string key, JSONValue new_component)
      {
        ...
        extraHangmanNotUnderstoodCommandSetField(key, new_component);
      }
    ...
    public static new HangmanNotUnderstoodCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        HangmanNotUnderstoodCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HangmanNotUnderstoodCommand", ignore_extras);
            generator.set_allow_incomplete(allow_incomplete);
            generator.set_allow_unpolished(allow_unpolished);
            if (allow_incomplete || allow_unpolished)
                json_value.write(generator);
    ...
    public static new HangmanNotUnderstoodCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new HangmanNotUnderstoodCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        HangmanNotUnderstoodCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HangmanNotUnderstoodCommand", ignore_extras);
    ...
    public static new HangmanNotUnderstoodCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new HangmanNotUnderstoodCommandJSON from_text(string text, bool ignore_extras)
      {
        HangmanNotUnderstoodCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HangmanNotUnderstoodCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for HangmanNotUnderstoodCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new HangmanNotUnderstoodCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        HangmanNotUnderstoodCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type HangmanNotUnderstoodCommand", ignore_extras);
    ...
    public new abstract class Generator : HangmanCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getHangmanCommandJSONKey().Equals("HangmanNotUnderstoodGameCommand")))
                throw new Exception("The key field has a value other than `HangmanNotUnderstoodGameCommand'.");
            HangmanNotUnderstoodCommandJSON result = new HangmanNotUnderstoodCommandJSON();
            Debug.Assert(result != null);
            finish(result);
            int extra_count = unknownFieldGenerator.field_names.Count;
            Debug.Assert(extra_count == unknownFieldGenerator.field_values.Count);
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraHangmanNotUnderstoodCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
            unknownFieldGenerator.field_names.Clear();
            unknownFieldGenerator.field_values.Clear();
            unknownFieldGenerator.index = new Dictionary<string, JSONValue >();
        ...
        protected override void handle_result(HangmanCommandJSON new_result)
          {
            handle_result((HangmanNotUnderstoodCommandJSON )new_result);
          }
        protected void finish(HangmanNotUnderstoodCommandJSON result)
          {
        ...
        protected abstract void handle_result(HangmanNotUnderstoodCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the HangmanNotUnderstoodCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the HangmanNotUnderstoodCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the HangmanNotUnderstoodCommand class", false);
            unknownFieldGenerator = new UnknownFieldGenerator(false);
            set_what("the HangmanNotUnderstoodCommand class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(HangmanNotUnderstoodCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public HangmanNotUnderstoodCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<HangmanNotUnderstoodCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<HangmanNotUnderstoodCommandJSON>();
        base.set_what(what);
      }
    public HoldingArrayGenerator(bool ignore_extras)
      {
    ...
    public bool have_value;
    public List<HangmanNotUnderstoodCommandJSON> value;
  };
  };
