/* file "BlackjackStandInformationNuggetJSON.cs" */
...
public class BlackjackStandInformationNuggetJSON : BlackjackInformationNuggetJSON
  {
    ...
    private void  fromJSONImageURL(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field ImageURL of BlackjackStandInformationNuggetJSON is not a string.");
        ...
        if (json_rational != null)
        ...
        else
          {
            ...
            if (json_integer != null)
              ...
              {
                throw new Exception("The value for field Bankroll of BlackjackStandInformationNuggetJSON is not a number.");
              }
          }
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field PlayerHandTotal of BlackjackStandInformationNuggetJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field PlayerHandTotal of BlackjackStandInformationNuggetJSON is not an integer.");
              }
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field DealerHandTotal of BlackjackStandInformationNuggetJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field DealerHandTotal of BlackjackStandInformationNuggetJSON is not an integer.");
              }
            extracted_integer = (sbyte)(json_rational.getLongInt())        ;
          }
        else
    ...
    public BlackjackStandInformationNuggetJSON()
      {
    ...
    public virtual int extraBlackjackStandInformationNuggetComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraBlackjackStandInformationNuggetComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraBlackjackStandInformationNuggetComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraBlackjackStandInformationNuggetLookup(string field_name)
      {
    ...
    public override int extraBlackjackInformationNuggetComponentCount()
      {
        ...
        if (flagHasDealerHandTotal)
            ++result;
        result += extraBlackjackStandInformationNuggetComponentCount();
        return result;
      }
    public override string extraBlackjackInformationNuggetComponentKey(int component_num)
      {
        ...
        return extraBlackjackStandInformationNuggetComponentKey(remainder);
      }
    public override JSONValue extraBlackjackInformationNuggetComponentValue(int component_num)
      {
        ...
        return extraBlackjackStandInformationNuggetComponentValue(remainder);
      }
    public override JSONValue extraBlackjackInformationNuggetLookup(string field_name)
      {
        ...
        return extraBlackjackStandInformationNuggetLookup(field_name);
      }
    ...
    public void setBankroll(double new_value)
      {
        ...
        if (new_value < 0)
            throw new Exception("The value for field Bankroll of BlackjackStandInformationNuggetJSON is less than the lower bound (0) for that field.");
    ...
    public void setBankrollText(string new_value)
      {
        ...
        if (!(JSONWriter.is_valid_number_format(new_value)))
            throw new Exception("The text value for field Bankroll of BlackjackStandInformationNuggetJSON is not a valid number.");
    ...
    public void setPlayerHandTotal(sbyte new_value)
      {
        ...
        if (new_value < 4)
            throw new Exception("The value for field PlayerHandTotal of BlackjackStandInformationNuggetJSON is less than the lower bound (4) for that field.");
        if (new_value > 20)
            throw new Exception("The value for field PlayerHandTotal of BlackjackStandInformationNuggetJSON is greater than the upper bound (20) for that field.");
    ...
    public void setDealerHandTotal(sbyte new_value)
      {
        ...
        if (new_value < 17)
            throw new Exception("The value for field DealerHandTotal of BlackjackStandInformationNuggetJSON is less than the lower bound (17) for that field.");
        if (new_value > 26)
            throw new Exception("The value for field DealerHandTotal of BlackjackStandInformationNuggetJSON is greater than the upper bound (26) for that field.");
    ...
    public virtual void extraBlackjackStandInformationNuggetAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraBlackjackStandInformationNuggetSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraBlackjackStandInformationNuggetLookup(key);
        if (old_field == null)
          {
            extraBlackjackStandInformationNuggetAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraBlackjackInformationNuggetSetField(string key, JSONValue new_component)
      {
        ...
        extraBlackjackStandInformationNuggetSetField(key, new_component);
      }
    ...
    public static new BlackjackStandInformationNuggetJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        BlackjackStandInformationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BlackjackStandInformationNugget", ignore_extras);
    ...
    public static new BlackjackStandInformationNuggetJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new BlackjackStandInformationNuggetJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        BlackjackStandInformationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BlackjackStandInformationNugget", ignore_extras);
    ...
    public static new BlackjackStandInformationNuggetJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new BlackjackStandInformationNuggetJSON from_text(string text, bool ignore_extras)
      {
        BlackjackStandInformationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BlackjackStandInformationNugget", ignore_extras);
            JSONParse.parse_json_value(text, "Text for BlackjackStandInformationNuggetJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new BlackjackStandInformationNuggetJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        BlackjackStandInformationNuggetJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BlackjackStandInformationNugget", ignore_extras);
    ...
    private class FieldHoldingGeneratorDealerHandTotal : JSONHoldingIntegerRangeGenerator
          {
            public FieldHoldingGeneratorDealerHandTotal(String what) : base(what, 17, 26)
              {
              }
          };
    private class FieldHoldingArrayGeneratorDealerHandTotal : JSONHoldingIntegerRangeArrayGenerator
          {
            public FieldHoldingArrayGeneratorDealerHandTotal(String what) : base(what, 17, 26)
              {
              }
          };
        ...
        protected override void finish()
          {
            if (!(getBlackjackInformationNuggetJSONKey().Equals("BlackjackStandCommand")))
                throw new Exception("The key field has a value other than `BlackjackStandCommand'.");
            BlackjackStandInformationNuggetJSON result = new BlackjackStandInformationNuggetJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraBlackjackStandInformationNuggetAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(BlackjackInformationNuggetJSON new_result)
          {
            handle_result((BlackjackStandInformationNuggetJSON )new_result);
          }
        protected void finish(BlackjackStandInformationNuggetJSON result)
          {
        ...
        protected abstract void handle_result(BlackjackStandInformationNuggetJSON new_result);
        ...
        public Generator() : base(false)
          {
            fieldGeneratorImageURL = new JSONHoldingStringGenerator("field \"ImageURL\" of the BlackjackStandInformationNugget class");
            fieldGeneratorBankroll = new JSONHoldingNumberTextGenerator("field \"Bankroll\" of the BlackjackStandInformationNugget class");
            fieldGeneratorPlayerHand = new BlackjackHandJSON.HoldingGenerator("field \"PlayerHand\" of the BlackjackStandInformationNugget class", false);
            fieldGeneratorPlayerHandTotal = new FieldHoldingGeneratorPlayerHandTotal("field \"PlayerHandTotal\" of the BlackjackStandInformationNugget class");
            fieldGeneratorDealerHand = new BlackjackHandJSON.HoldingGenerator("field \"DealerHand\" of the BlackjackStandInformationNugget class", false);
            fieldGeneratorDealerHandTotal = new FieldHoldingGeneratorDealerHandTotal("field \"DealerHandTotal\" of the BlackjackStandInformationNugget class");
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(BlackjackStandInformationNuggetJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public BlackjackStandInformationNuggetJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<BlackjackStandInformationNuggetJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<BlackjackStandInformationNuggetJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<BlackjackStandInformationNuggetJSON> value;
  };
  };
