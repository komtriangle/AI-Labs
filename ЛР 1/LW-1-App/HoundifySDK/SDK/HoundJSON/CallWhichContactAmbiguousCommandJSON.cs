/* file "CallWhichContactAmbiguousCommandJSON.cs" */
...
public class CallWhichContactAmbiguousCommandJSON : DisambiguateCommandJSON
  {
    ...
    private void  fromJSONUserSpecifiedName(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field UserSpecifiedName of CallWhichContactAmbiguousCommandJSON is not a string.");
        setUserSpecifiedName(json_string.getData());
      }


    public CallWhichContactAmbiguousCommandJSON()
      {
    ...
    public virtual int extraCallWhichContactAmbiguousCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraCallWhichContactAmbiguousCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraCallWhichContactAmbiguousCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraCallWhichContactAmbiguousCommandLookup(string field_name)
      {
    ...
    public virtual void extraCallWhichContactAmbiguousCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraCallWhichContactAmbiguousCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new CallWhichContactAmbiguousCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CallWhichContactAmbiguousCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CallWhichContactAmbiguousCommand", ignore_extras);
    ...
    public static new CallWhichContactAmbiguousCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new CallWhichContactAmbiguousCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CallWhichContactAmbiguousCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CallWhichContactAmbiguousCommand", ignore_extras);
    ...
    public static new CallWhichContactAmbiguousCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new CallWhichContactAmbiguousCommandJSON from_text(string text, bool ignore_extras)
      {
        CallWhichContactAmbiguousCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CallWhichContactAmbiguousCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for CallWhichContactAmbiguousCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new CallWhichContactAmbiguousCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        CallWhichContactAmbiguousCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CallWhichContactAmbiguousCommand", ignore_extras);
    ...
    public new abstract class Generator : DisambiguateCommandJSON.Generator
      {
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorChoices = new WhichContactChoicesJSON.HoldingGenerator("field \"Choices\" of the CallWhichContactAmbiguousCommand class", ignore_extras);
            fieldGeneratorUserSpecifiedName = new JSONHoldingStringGenerator("field \"UserSpecifiedName\" of the CallWhichContactAmbiguousCommand class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the CallWhichContactAmbiguousCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorChoices = new WhichContactChoicesJSON.HoldingGenerator("field \"Choices\" of the CallWhichContactAmbiguousCommand class", false);
            fieldGeneratorUserSpecifiedName = new JSONHoldingStringGenerator("field \"UserSpecifiedName\" of the CallWhichContactAmbiguousCommand class");
...
//@@@            Debug.Assert(!have_value);
        ...
        public CallWhichContactAmbiguousCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<CallWhichContactAmbiguousCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<CallWhichContactAmbiguousCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<CallWhichContactAmbiguousCommandJSON> value;
  };
  };
