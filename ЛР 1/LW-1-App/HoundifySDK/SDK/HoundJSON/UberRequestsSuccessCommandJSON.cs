/* file "UberRequestsSuccessCommandJSON.cs" */
...
public class UberRequestsSuccessCommandJSON : UberRequestsCommandJSON
  {
        ...
        public virtual void write_fields_as_json(JSONHandler handler, bool partial_allowed)
          {
            ...
            Debug.Assert(partial_allowed || flagHasUberRequest);
            if (flagHasUberRequest)
              {
        ...
        public virtual string missing_field_error(bool allow_unpolished)
          {
            ...
            if (!(hasUberRequest()))
              {
                return "When parsing the object for %what%, the \"UberRequest\" field was missing.";
              }
            return null;
          }
            ...
            protected void finish(TypeNativeDataJSON result)
              {
                ...
                else if ((!(result.hasUberRequest())) && !allow_incomplete)
                  {
                    error("When parsing the object for %what%, the \"UberRequest\" field was missing.");
                  }
              }
                    ...
                    switch (field_name[4])
                      {
                        case 'P':
                            ...
                            break;
                        case 'R':
                            if (String.Compare(field_name, 5, "equest", 0, 6, false) == 0)
                              {
                                ...
                                switch (field_name[11])
                                  {
                                    case 's':
                                        if ((String.Compare(field_name, 12, "Spec", 0, 4, false) == 0) && (field_name.Length == 16))
    ...
    public UberRequestsSuccessCommandJSON()
      {
    ...
    public virtual int extraUberRequestsSuccessCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraUberRequestsSuccessCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraUberRequestsSuccessCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraUberRequestsSuccessCommandLookup(string field_name)
      {
        JSONValue result = (extraIndex.ContainsKey(field_name) ? extraIndex[field_name] : null);
        return result;
      }
    public override int extraUberRequestsCommandComponentCount()
      {
        ...
        if (flagHasNativeData)
            ++result;
        result += extraUberRequestsSuccessCommandComponentCount();
        return result;
      }
    public override string extraUberRequestsCommandComponentKey(int component_num)
      {
        ...
        return extraUberRequestsSuccessCommandComponentKey(remainder);
      }
    public override JSONValue extraUberRequestsCommandComponentValue(int component_num)
      {
        ...
        return extraUberRequestsSuccessCommandComponentValue(remainder);
      }
    public override JSONValue extraUberRequestsCommandLookup(string field_name)
      {
        ...
        return extraUberRequestsSuccessCommandLookup(field_name);
      }
    ...
    public virtual void extraUberRequestsSuccessCommandAppendPair(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public virtual void extraUberRequestsSuccessCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraUberRequestsSuccessCommandLookup(key);
        if (old_field == null)
          {
            extraUberRequestsSuccessCommandAppendPair(key, new_component);
          }
        else
          {
            int count = extraKeys.Count;
    ...
    public override void extraUberRequestsCommandSetField(string key, JSONValue new_component)
      {
        ...
        extraUberRequestsSuccessCommandSetField(key, new_component);
      }
    ...
    public static new UberRequestsSuccessCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        UberRequestsSuccessCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UberRequestsSuccessCommand", ignore_extras);
            generator.set_allow_incomplete(allow_incomplete);
            generator.set_allow_unpolished(allow_unpolished);
            if (allow_incomplete || allow_unpolished)
                json_value.write(generator);
    ...
    public static new UberRequestsSuccessCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new UberRequestsSuccessCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        UberRequestsSuccessCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UberRequestsSuccessCommand", ignore_extras);
    ...
    public static new UberRequestsSuccessCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new UberRequestsSuccessCommandJSON from_text(string text, bool ignore_extras)
      {
        UberRequestsSuccessCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UberRequestsSuccessCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for UberRequestsSuccessCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new UberRequestsSuccessCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        UberRequestsSuccessCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type UberRequestsSuccessCommand", ignore_extras);
    ...
    public new abstract class Generator : UberRequestsCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getUberRequestsCommandJSONKey().Equals("UberRequestsSuccess")))
                throw new Exception("The key field has a value other than `UberRequestsSuccess'.");
            UberRequestsSuccessCommandJSON result = new UberRequestsSuccessCommandJSON();
            Debug.Assert(result != null);
            finish(result);
            int extra_count = unknownFieldGenerator.field_names.Count;
            Debug.Assert(extra_count == unknownFieldGenerator.field_values.Count);
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraUberRequestsSuccessCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
            unknownFieldGenerator.field_names.Clear();
            unknownFieldGenerator.field_values.Clear();
            unknownFieldGenerator.index = new Dictionary<string, JSONValue >();
        ...
        protected override void handle_result(UberRequestsCommandJSON new_result)
          {
            handle_result((UberRequestsSuccessCommandJSON )new_result);
          }
        protected void finish(UberRequestsSuccessCommandJSON result)
          {
        ...
        protected abstract void handle_result(UberRequestsSuccessCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the UberRequestsSuccessCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the UberRequestsSuccessCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the UberRequestsSuccessCommand class", false);
            unknownFieldGenerator = new UnknownFieldGenerator(false);
            set_what("the UberRequestsSuccessCommand class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(UberRequestsSuccessCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public UberRequestsSuccessCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<UberRequestsSuccessCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<UberRequestsSuccessCommandJSON>();
        base.set_what(what);
      }
    public HoldingArrayGenerator(bool ignore_extras)
      {
    ...
    public bool have_value;
    public List<UberRequestsSuccessCommandJSON> value;
  };
  };
