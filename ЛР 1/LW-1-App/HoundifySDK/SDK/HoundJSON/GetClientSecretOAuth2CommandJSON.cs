/* file "GetClientSecretOAuth2CommandJSON.cs" */
...
public class GetClientSecretOAuth2CommandJSON : OAuth2CommandJSON
  {
    ...
    private JSONValue  extraSecretToJSON()
      {
        JSONStringValue generated_string_Secret = new JSONStringValue(storeSecret);
        return generated_string_Secret;
      }
    ...
    private void  fromJSONStatus(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field Status of GetClientSecretOAuth2CommandJSON is not a string.");
    ...
    private void  fromJSONSecret(JSONValue json_value, bool ignore_extras)
      {
        Debug.Assert(json_value != null);
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field Secret of GetClientSecretOAuth2CommandJSON is not a string.");
        setSecret(json_string.getData());
      }


    public GetClientSecretOAuth2CommandJSON()
      {
    ...
    public override string  getOAuth2CommandKind()
      {
        return "GetClientSecretOAuth2Command";
      }
    ...
    public bool  hasSecret()
      {
        return flagHasSecret;
      }

    public string  getSecret()
      {
        Debug.Assert(flagHasSecret);
        return storeSecret;
      }


    public virtual int extraGetClientSecretOAuth2CommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraGetClientSecretOAuth2CommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraGetClientSecretOAuth2CommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraGetClientSecretOAuth2CommandLookup(string field_name)
      {
    ...
    public override int extraOAuth2CommandComponentCount()
      {
        ...
        if (flagHasSecret)
            ++result;
        result += extraGetClientSecretOAuth2CommandComponentCount();
        return result;
      }
    public override string extraOAuth2CommandComponentKey(int component_num)
      {
        ...
        return extraGetClientSecretOAuth2CommandComponentKey(remainder);
      }
    public override JSONValue extraOAuth2CommandComponentValue(int component_num)
      {
        ...
        if (flagHasSecret)
          {
            if (remainder == 0)
                return extraSecretToJSON();
            --remainder;
          }
        return extraGetClientSecretOAuth2CommandComponentValue(remainder);
      }
    public override JSONValue extraOAuth2CommandLookup(string field_name)
      {
            ...
            switch (field_name[1])
              {
                case 'e':
                    switch (field_name[2])
                      {
                        case 'c':
                            if ((String.Compare(field_name, 3, "ret", 0, 3, false) == 0) && (field_name.Length == 6))
                                return (flagHasSecret ? extraSecretToJSON() : null);
                            break;
                        case 'r':
                            if ((String.Compare(field_name, 3, "viceType", 0, 8, false) == 0) && (field_name.Length == 11))
        ...
        return extraGetClientSecretOAuth2CommandLookup(field_name);
      }
    ...
    public void setSecret(string new_value)
      {
        flagHasSecret = true;
        storeSecret = new_value;
      }
    ...
    public virtual void extraGetClientSecretOAuth2CommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraGetClientSecretOAuth2CommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraGetClientSecretOAuth2CommandLookup(key);
        if (old_field == null)
          {
            extraGetClientSecretOAuth2CommandAppendPair(key, new_component);
          }
        else
          {
            ...
            switch (key[1])
              {
                case 'e':
                    switch (key[2])
                      {
                        case 'c':
                            if ((String.Compare(key, 3, "ret", 0, 3, false) == 0) && (key.Length == 6))
                                {
                                fromJSONSecret(new_component, false);
                                return;
                                }
                            break;
                        case 'r':
                            if ((String.Compare(key, 3, "viceType", 0, 8, false) == 0) && (key.Length == 11))
                                {
    ...
    public override void extraOAuth2CommandSetField(string key, JSONValue new_component)
      {
        ...
        extraGetClientSecretOAuth2CommandSetField(key, new_component);
      }
    ...
    public override void write_fields_as_json(JSONHandler handler, bool partial_allowed)
      {
        ...
        if (flagHasSecret)
          {
            handler.start_pair("Secret");
            handler.string_value(storeSecret);
          }
      }
    ...
    public static new GetClientSecretOAuth2CommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        GetClientSecretOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type GetClientSecretOAuth2Command", ignore_extras);
    ...
    public static new GetClientSecretOAuth2CommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new GetClientSecretOAuth2CommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        GetClientSecretOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type GetClientSecretOAuth2Command", ignore_extras);
    ...
    public static new GetClientSecretOAuth2CommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new GetClientSecretOAuth2CommandJSON from_text(string text, bool ignore_extras)
      {
        GetClientSecretOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type GetClientSecretOAuth2Command", ignore_extras);
            JSONParse.parse_json_value(text, "Text for GetClientSecretOAuth2CommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new GetClientSecretOAuth2CommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        GetClientSecretOAuth2CommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type GetClientSecretOAuth2Command", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorStatus : JSONArrayGenerator
  {
    ...
    public List<TypeStatus> value;
        ...
        private JSONHoldingStringGenerator fieldGeneratorSecret;
        ...
        protected override void finish()
          {
            if (!(getOAuth2CommandJSONKey().Equals("GetClientSecretOAuth2Command")))
                throw new Exception("The key field has a value other than `GetClientSecretOAuth2Command'.");
            GetClientSecretOAuth2CommandJSON result = new GetClientSecretOAuth2CommandJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraGetClientSecretOAuth2CommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(OAuth2CommandJSON new_result)
          {
            handle_result((GetClientSecretOAuth2CommandJSON )new_result);
          }
        protected void finish(GetClientSecretOAuth2CommandJSON result)
          {
            ...
            if (fieldGeneratorSecret.have_value)
              {
                result.setSecret(fieldGeneratorSecret.value);
                fieldGeneratorSecret.have_value = false;
              }
            base.finish(result);
          }
        protected abstract void handle_result(GetClientSecretOAuth2CommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorServiceType = new OAuth2ServiceTypeJSON.HoldingGenerator("field \"ServiceType\" of the GetClientSecretOAuth2Command class", ignore_extras);
            fieldGeneratorStatus = new FieldHoldingGeneratorStatus("field \"Status\" of the GetClientSecretOAuth2Command class");
            fieldGeneratorSecret = new JSONHoldingStringGenerator("field \"Secret\" of the GetClientSecretOAuth2Command class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the GetClientSecretOAuth2Command class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorServiceType = new OAuth2ServiceTypeJSON.HoldingGenerator("field \"ServiceType\" of the GetClientSecretOAuth2Command class", false);
            fieldGeneratorStatus = new FieldHoldingGeneratorStatus("field \"Status\" of the GetClientSecretOAuth2Command class");
            fieldGeneratorSecret = new JSONHoldingStringGenerator("field \"Secret\" of the GetClientSecretOAuth2Command class");
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(GetClientSecretOAuth2CommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public GetClientSecretOAuth2CommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<GetClientSecretOAuth2CommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<GetClientSecretOAuth2CommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<GetClientSecretOAuth2CommandJSON> value;
  };
  };
