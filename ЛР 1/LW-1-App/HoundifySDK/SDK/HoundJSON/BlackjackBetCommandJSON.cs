/* file "BlackjackBetCommandJSON.cs" */
...
public class BlackjackBetCommandJSON : BlackjackCommandJSON
  {
    public class TypeNativeDataJSON : JSONBase
      {
        ...
        private bool flagHasPlayerHasBlackjack;
        private bool storePlayerHasBlackjack;
        private bool flagHasDealerHasBlackjack;
        private bool storeDealerHasBlackjack;
        ...
        private void  fromJSONPlayerHasBlackjack(JSONValue json_value, bool ignore_extras)
          {
            Debug.Assert(json_value != null);
            ...
            if (json_true != null)
            ...
            else
              {
                ...
                if (json_false != null)
                  ...
                  {
                    throw new Exception("The value for field PlayerHasBlackjack of TypeNativeDataJSON is not true for false.");
                  }
              }
        ...
        private void  fromJSONDealerHasBlackjack(JSONValue json_value, bool ignore_extras)
          {
            Debug.Assert(json_value != null);
            JSONTrueValue json_true = json_value.true_value();
            bool the_bool;
            if (json_true != null)
            ...
            else
              {
                ...
                if (json_false != null)
                  ...
                  {
                    throw new Exception("The value for field DealerHasBlackjack of TypeNativeDataJSON is not true for false.");
                  }
              }
        ...
        public bool  hasPlayerHasBlackjack()
          {
            return flagHasPlayerHasBlackjack;
          }

        public bool  getPlayerHasBlackjack()
          {
            Debug.Assert(flagHasPlayerHasBlackjack);
            return storePlayerHasBlackjack;
          }

        public bool  hasDealerHasBlackjack()
          {
        ...
        public bool  getDealerHasBlackjack()
          {
            Debug.Assert(flagHasDealerHasBlackjack);
        ...
        public void setPlayerHandTotal(sbyte new_value)
          {
            ...
            if (new_value > 21)
                throw new Exception("The value for field PlayerHandTotal of TypeNativeDataJSON is greater than the upper bound (21) for that field.");
        ...
        public void setDealerHandTotal(sbyte new_value)
          {
            ...
            if (new_value > 21)
                throw new Exception("The value for field DealerHandTotal of TypeNativeDataJSON is greater than the upper bound (21) for that field.");
        ...
        public void setPlayerHasBlackjack(bool new_value)
          {
            flagHasPlayerHasBlackjack = true;
            storePlayerHasBlackjack = new_value;
          }
        public void unsetPlayerHasBlackjack()
          {
            flagHasPlayerHasBlackjack = false;
          }
        public void setDealerHasBlackjack(bool new_value)
          {
            flagHasDealerHasBlackjack = true;
            storeDealerHasBlackjack = new_value;
          }
        public void unsetDealerHasBlackjack()
          {
            flagHasDealerHasBlackjack = false;
          }
        ...
        public virtual void write_fields_as_json(JSONHandler handler, bool partial_allowed)
          {
            ...
            if (flagHasPlayerHasBlackjack)
              {
                handler.start_pair("PlayerHasBlackjack");
                handler.boolean_value(storePlayerHasBlackjack);
              }
            if (flagHasDealerHasBlackjack)
              {
                handler.start_pair("DealerHasBlackjack");
                handler.boolean_value(storeDealerHasBlackjack);
              }
          }
        ...
        public static TypeNativeDataJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
      {
        ...
        private class FieldHoldingGeneratorPlayerHandTotal : JSONHoldingIntegerRangeGenerator
              {
                public FieldHoldingGeneratorPlayerHandTotal(String what) : base(what, 4, 21)
                  {
                  }
              };
        private class FieldHoldingArrayGeneratorPlayerHandTotal : JSONHoldingIntegerRangeArrayGenerator
              {
                public FieldHoldingArrayGeneratorPlayerHandTotal(String what) : base(what, 4, 21)
                  {
                  }
              };
        ...
        private class FieldHoldingGeneratorDealerHandTotal : JSONHoldingIntegerRangeGenerator
              {
                public FieldHoldingGeneratorDealerHandTotal(String what) : base(what, 2, 21)
                  {
                  }
              };
        private class FieldHoldingArrayGeneratorDealerHandTotal : JSONHoldingIntegerRangeArrayGenerator
              {
                public FieldHoldingArrayGeneratorDealerHandTotal(String what) : base(what, 2, 21)
                  {
                  }
              };
            private FieldHoldingGeneratorDealerHandTotal fieldGeneratorDealerHandTotal;
            private JSONHoldingBooleanGenerator fieldGeneratorPlayerHasBlackjack;
            private JSONHoldingBooleanGenerator fieldGeneratorDealerHasBlackjack;
            ...
            protected void finish(TypeNativeDataJSON result)
              {
                ...
                if (fieldGeneratorPlayerHasBlackjack.have_value)
                  {
                    result.setPlayerHasBlackjack(fieldGeneratorPlayerHasBlackjack.value);
                    fieldGeneratorPlayerHasBlackjack.have_value = false;
                  }
                if (fieldGeneratorDealerHasBlackjack.have_value)
                  {
                    result.setDealerHasBlackjack(fieldGeneratorDealerHasBlackjack.value);
                    fieldGeneratorDealerHasBlackjack.have_value = false;
                  }
              }
                ...
                switch (field_name[0])
                  {
                    case 'B':
                        ...
                        break;
                    case 'D':
                        if (String.Compare(field_name, 1, "ealerHa", 0, 7, false) == 0)
                          {
                            switch (field_name[8])
                              {
                                case 'n':
                                    if (String.Compare(field_name, 9, "d", 0, 1, false) == 0)
                                      {
                                    ...
                                    break;
                                case 's':
                                    if ((String.Compare(field_name, 9, "Blackjack", 0, 9, false) == 0) && (field_name.Length == 18))
                                        return fieldGeneratorDealerHasBlackjack;
                                    break;
                                default:
                                    break;
                              }
                    ...
                    case 'I':
                        ...
                        break;
                    case 'P':
                        if (String.Compare(field_name, 1, "layerHa", 0, 7, false) == 0)
                          {
                            switch (field_name[8])
                              {
                                case 'n':
                                ...
                                case 's':
                                    if ((String.Compare(field_name, 9, "Blackjack", 0, 9, false) == 0) && (field_name.Length == 18))
                                        return fieldGeneratorPlayerHasBlackjack;
                                    break;
                                default:
                                    break;
                              }
            ...
            public Generator(bool ignore_extras)
              {
                ...
                fieldGeneratorPlayerHasBlackjack = new JSONHoldingBooleanGenerator("field \"PlayerHasBlackjack\" of the TypeNativeData class");
                fieldGeneratorDealerHasBlackjack = new JSONHoldingBooleanGenerator("field \"DealerHasBlackjack\" of the TypeNativeData class");
            ...
            public override void reset()
              {
                ...
                fieldGeneratorPlayerHasBlackjack.reset();
                fieldGeneratorDealerHasBlackjack.reset();
                base.reset();
    ...
    public BlackjackBetCommandJSON()
      {
    ...
    public virtual int extraBlackjackBetCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraBlackjackBetCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraBlackjackBetCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraBlackjackBetCommandLookup(string field_name)
      {
        JSONValue result = (extraIndex.ContainsKey(field_name) ? extraIndex[field_name] : null);
        return result;
      }
    public override int extraBlackjackCommandComponentCount()
      {
        ...
        if (flagHasNativeData)
            ++result;
        result += extraBlackjackBetCommandComponentCount();
        return result;
      }
    public override string extraBlackjackCommandComponentKey(int component_num)
      {
        ...
        return extraBlackjackBetCommandComponentKey(remainder);
      }
    public override JSONValue extraBlackjackCommandComponentValue(int component_num)
      {
        ...
        return extraBlackjackBetCommandComponentValue(remainder);
      }
    public override JSONValue extraBlackjackCommandLookup(string field_name)
      {
        ...
        return extraBlackjackBetCommandLookup(field_name);
      }
    ...
    public virtual void extraBlackjackBetCommandAppendPair(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public virtual void extraBlackjackBetCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraBlackjackBetCommandLookup(key);
        if (old_field == null)
          {
            extraBlackjackBetCommandAppendPair(key, new_component);
          }
        else
          {
            int count = extraKeys.Count;
    ...
    public override void extraBlackjackCommandSetField(string key, JSONValue new_component)
      {
        ...
        extraBlackjackBetCommandSetField(key, new_component);
      }
    ...
    public static new BlackjackBetCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        BlackjackBetCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BlackjackBetCommand", ignore_extras);
            generator.set_allow_incomplete(allow_incomplete);
            generator.set_allow_unpolished(allow_unpolished);
            if (allow_incomplete || allow_unpolished)
                json_value.write(generator);
    ...
    public static new BlackjackBetCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new BlackjackBetCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        BlackjackBetCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BlackjackBetCommand", ignore_extras);
    ...
    public static new BlackjackBetCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new BlackjackBetCommandJSON from_text(string text, bool ignore_extras)
      {
        BlackjackBetCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BlackjackBetCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for BlackjackBetCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new BlackjackBetCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        BlackjackBetCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type BlackjackBetCommand", ignore_extras);
    ...
    public new abstract class Generator : BlackjackCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getBlackjackCommandJSONKey().Equals("BlackjackBetCommand")))
                throw new Exception("The key field has a value other than `BlackjackBetCommand'.");
            BlackjackBetCommandJSON result = new BlackjackBetCommandJSON();
            Debug.Assert(result != null);
            finish(result);
            int extra_count = unknownFieldGenerator.field_names.Count;
            Debug.Assert(extra_count == unknownFieldGenerator.field_values.Count);
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraBlackjackBetCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
            unknownFieldGenerator.field_names.Clear();
            unknownFieldGenerator.field_values.Clear();
            unknownFieldGenerator.index = new Dictionary<string, JSONValue >();
        ...
        protected override void handle_result(BlackjackCommandJSON new_result)
          {
            handle_result((BlackjackBetCommandJSON )new_result);
          }
        protected void finish(BlackjackBetCommandJSON result)
          {
        ...
        protected abstract void handle_result(BlackjackBetCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the BlackjackBetCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the BlackjackBetCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the BlackjackBetCommand class", false);
            unknownFieldGenerator = new UnknownFieldGenerator(false);
            set_what("the BlackjackBetCommand class");
          }
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(BlackjackBetCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public BlackjackBetCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<BlackjackBetCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<BlackjackBetCommandJSON>();
        base.set_what(what);
      }
    public HoldingArrayGenerator(bool ignore_extras)
      {
    ...
    public bool have_value;
    public List<BlackjackBetCommandJSON> value;
  };
  };
