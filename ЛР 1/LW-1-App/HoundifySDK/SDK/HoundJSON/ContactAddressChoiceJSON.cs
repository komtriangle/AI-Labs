/* file "ContactAddressChoiceJSON.cs" */
...
public class ContactAddressChoiceJSON : JSONBase
  {
    ...
    private void  fromJSONFromUserNames(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field FromUserNames of ContactAddressChoiceJSON is not an array.");
        ...
        for (int num1 = 0; num1 < count1; ++num1)
          {
            ...
            if (json_string == null)
                throw new Exception("The value for an element of field FromUserNames of ContactAddressChoiceJSON is not a string.");
    ...
    private void  fromJSONDefiningCategory(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field DefiningCategory of ContactAddressChoiceJSON is not a string.");
    ...
    private void  fromJSONCategories(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONArrayValue json_array1 = json_value.array_value();
        if (json_array1 == null)
            throw new Exception("The value for field Categories of ContactAddressChoiceJSON is not an array.");
        int count1 = json_array1.componentCount();
        ...
        for (int num1 = 0; num1 < count1; ++num1)
          {
            JSONStringValue json_string = json_array1.component(num1).string_value();
            if (json_string == null)
                throw new Exception("The value for an element of field Categories of ContactAddressChoiceJSON is not a string.");
    ...
    public ContactAddressChoiceJSON()
      {
    ...
    public virtual int extraContactAddressChoiceComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraContactAddressChoiceComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraContactAddressChoiceComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraContactAddressChoiceLookup(string field_name)
      {
    ...
    public virtual void extraContactAddressChoiceAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraContactAddressChoiceSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraContactAddressChoiceLookup(key);
        if (old_field == null)
          {
            extraContactAddressChoiceAppendPair(key, new_component);
          }
        else
          {
    ...
    public static ContactAddressChoiceJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ContactAddressChoiceJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ContactAddressChoice", ignore_extras);
    ...
    public static ContactAddressChoiceJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static ContactAddressChoiceJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ContactAddressChoiceJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ContactAddressChoice", ignore_extras);
    ...
    public static ContactAddressChoiceJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static ContactAddressChoiceJSON from_text(string text, bool ignore_extras)
      {
        ContactAddressChoiceJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ContactAddressChoice", ignore_extras);
            JSONParse.parse_json_value(text, "Text for ContactAddressChoiceJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static ContactAddressChoiceJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        ContactAddressChoiceJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ContactAddressChoice", ignore_extras);
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        protected override void finish()
          {
            ContactAddressChoiceJSON result = new ContactAddressChoiceJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraContactAddressChoiceAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(ContactAddressChoiceJSON result)
          {
        ...
        protected abstract void handle_result(ContactAddressChoiceJSON new_result);
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorAddress = new MapLocationForContactsJSON.HoldingGenerator("field \"Address\" of the ContactAddressChoice class", ignore_extras);
            fieldGeneratorFromUserNames = new JSONHoldingStringArrayGenerator("field \"FromUserNames\" of the ContactAddressChoice class");
            fieldGeneratorDefiningCategory = new JSONHoldingStringGenerator("field \"DefiningCategory\" of the ContactAddressChoice class");
            fieldGeneratorCategories = new JSONHoldingStringArrayGenerator("field \"Categories\" of the ContactAddressChoice class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the ContactAddressChoice class");
            allow_incomplete = false;
            allow_unpolished = false;
          }
        public Generator()
          {
            fieldGeneratorAddress = new MapLocationForContactsJSON.HoldingGenerator("field \"Address\" of the ContactAddressChoice class", false);
            fieldGeneratorFromUserNames = new JSONHoldingStringArrayGenerator("field \"FromUserNames\" of the ContactAddressChoice class");
            fieldGeneratorDefiningCategory = new JSONHoldingStringGenerator("field \"DefiningCategory\" of the ContactAddressChoice class");
            fieldGeneratorCategories = new JSONHoldingStringArrayGenerator("field \"Categories\" of the ContactAddressChoice class");
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(ContactAddressChoiceJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public ContactAddressChoiceJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<ContactAddressChoiceJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<ContactAddressChoiceJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<ContactAddressChoiceJSON> value;
  };
  };
