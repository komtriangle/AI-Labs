...
public class RadioOnCommandJSON : RadioCommandJSON
  {
    ...
    public virtual int extraRadioOnCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraRadioOnCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraRadioOnCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraRadioOnCommandLookup(string field_name)
      {
    ...
    public virtual void extraRadioOnCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraRadioOnCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new RadioOnCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RadioOnCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RadioOnCommand", ignore_extras);
    ...
    public static new RadioOnCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RadioOnCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        RadioOnCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RadioOnCommand", ignore_extras);
    ...
    public static new RadioOnCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new RadioOnCommandJSON from_text(string text, bool ignore_extras)
      {
        RadioOnCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RadioOnCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for RadioOnCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new RadioOnCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        RadioOnCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type RadioOnCommand", ignore_extras);
    ...
    public new abstract class Generator : RadioCommandJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getRadioCommandJSONKey().Equals("RadioOn")))
                throw new Exception("The key field has a value other than `RadioOn'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraRadioOnCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(RadioOnCommandJSON result)
          {
        ...
        protected abstract void handle_result(RadioOnCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorAlreadyOnResult = new DynamicResponseJSON.HoldingGenerator("field \"AlreadyOnResult\" of the RadioOnCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the RadioOnCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorAlreadyOnResult = new DynamicResponseJSON.HoldingGenerator("field \"AlreadyOnResult\" of the RadioOnCommand class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(RadioOnCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public RadioOnCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<RadioOnCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<RadioOnCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<RadioOnCommandJSON> value;
  };
  };
