/* file "CarControlMirrorCommandJSON.cs" */
...
public class CarControlMirrorCommandJSON : CarControlCommandJSON
  {
    ...
    private void  fromJSONCommandType(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field CommandType of CarControlMirrorCommandJSON is not a string.");
        ...
        throw new Exception("The value for field CommandType of CarControlMirrorCommandJSON is not one of the legal strings.");
      enum_is_done:;
    ...
    public CarControlMirrorCommandJSON()
      {
    ...
    public virtual int extraCarControlMirrorCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraCarControlMirrorCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraCarControlMirrorCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraCarControlMirrorCommandLookup(string field_name)
      {
    ...
    public virtual void extraCarControlMirrorCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraCarControlMirrorCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public override void write_fields_as_json(JSONHandler handler, bool partial_allowed)
      {
        ...
        Debug.Assert(partial_allowed || flagHasMirrorSelection);
        if (flagHasMirrorSelection)
          {
    ...
    public static new CarControlMirrorCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CarControlMirrorCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlMirrorCommand", ignore_extras);
    ...
    public static new CarControlMirrorCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new CarControlMirrorCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        CarControlMirrorCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlMirrorCommand", ignore_extras);
    ...
    public static new CarControlMirrorCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new CarControlMirrorCommandJSON from_text(string text, bool ignore_extras)
      {
        CarControlMirrorCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlMirrorCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for CarControlMirrorCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new CarControlMirrorCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        CarControlMirrorCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type CarControlMirrorCommand", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorCommandType : JSONArrayGenerator
  {
    ...
    public List<TypeCommandType> value;
        ...
        protected override void finish()
          {
            if (!(getCarControlCommandJSONKey().Equals("CarControlMirrorCommand")))
                throw new Exception("The key field has a value other than `CarControlMirrorCommand'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraCarControlMirrorCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(CarControlMirrorCommandJSON result)
          {
            ...
            else if ((!(result.hasMirrorSelection())) && !allow_incomplete)
              {
                error("When parsing the object for %what%, the \"MirrorSelection\" field was missing.");
              }
            base.finish(result);
          }
        protected abstract void handle_result(CarControlMirrorCommandJSON new_result);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(CarControlMirrorCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public CarControlMirrorCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<CarControlMirrorCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<CarControlMirrorCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<CarControlMirrorCommandJSON> value;
  };
  };
