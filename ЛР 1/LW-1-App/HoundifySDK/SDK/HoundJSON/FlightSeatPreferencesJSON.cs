/* file "FlightSeatPreferencesJSON.cs" */
...
public class FlightSeatPreferencesJSON : JSONBase
  {
    private bool flagHasIncludes;
    private List< FlightSeatTypeJSON  > storeIncludes;
    private bool flagHasExcludes;
    private List< FlightSeatTypeJSON  > storeExcludes;
    ...
    private void  fromJSONIncludes(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field Includes of FlightSeatPreferencesJSON is not an array.");
        int count1 = json_array1.componentCount();
        if (count1 < 1)
            throw new Exception("The value for field Includes of FlightSeatPreferencesJSON has too few elements.");
        List< FlightSeatTypeJSON  > vector_Includes1 = new List< FlightSeatTypeJSON  >(count1);
    ...
    public FlightSeatPreferencesJSON()
      {
        flagHasIncludes = false;
        flagHasExcludes = false;
        flagHasDefaultForOthers = false;
        storeIncludes = new List< FlightSeatTypeJSON  >();
        storeExcludes = new List< FlightSeatTypeJSON  >();
    ...
    public FlightSeatTypeJSON   elementOfIncludes(int element_num)
      {
        Debug.Assert(flagHasIncludes);
        return storeIncludes[element_num];
      }

    public List< FlightSeatTypeJSON  >  getIncludes()
      {
        Debug.Assert(flagHasIncludes);
    ...
    public FlightSeatTypeJSON   elementOfExcludes(int element_num)
      {
        Debug.Assert(flagHasExcludes);
        return storeExcludes[element_num];
      }

    public List< FlightSeatTypeJSON  >  getExcludes()
      {
        Debug.Assert(flagHasExcludes);
    ...
    public virtual int extraFlightSeatPreferencesComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraFlightSeatPreferencesComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraFlightSeatPreferencesComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraFlightSeatPreferencesLookup(string field_name)
      {
    ...
    public void appendIncludes(FlightSeatTypeJSON  to_append)
      {
        if (!flagHasIncludes)
          {
            flagHasIncludes = true;
    ...
    public void appendIncludes(FlightSeatTypeJSON.TypeValue new_value)
      {
        appendIncludes(new FlightSeatTypeJSON(new_value));
      }
    public void appendIncludes(string chars)
      {
    ...
    public virtual void extraFlightSeatPreferencesAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraFlightSeatPreferencesSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraFlightSeatPreferencesLookup(key);
        if (old_field == null)
          {
            extraFlightSeatPreferencesAppendPair(key, new_component);
          }
        else
          {
    ...
    public static FlightSeatPreferencesJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        FlightSeatPreferencesJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type FlightSeatPreferences", ignore_extras);
    ...
    public static FlightSeatPreferencesJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static FlightSeatPreferencesJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        FlightSeatPreferencesJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type FlightSeatPreferences", ignore_extras);
    ...
    public static FlightSeatPreferencesJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static FlightSeatPreferencesJSON from_text(string text, bool ignore_extras)
      {
        FlightSeatPreferencesJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type FlightSeatPreferences", ignore_extras);
            JSONParse.parse_json_value(text, "Text for FlightSeatPreferencesJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static FlightSeatPreferencesJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        FlightSeatPreferencesJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type FlightSeatPreferences", ignore_extras);
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        private FlightSeatTypeJSON.HoldingArrayGenerator fieldGeneratorIncludes;
        private FlightSeatTypeJSON.HoldingArrayGenerator fieldGeneratorExcludes;
        ...
        protected override void finish()
          {
            FlightSeatPreferencesJSON result = new FlightSeatPreferencesJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraFlightSeatPreferencesAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(FlightSeatPreferencesJSON result)
          {
        ...
        protected abstract void handle_result(FlightSeatPreferencesJSON new_result);
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorIncludes = new FlightSeatTypeJSON.HoldingArrayGenerator("field \"Includes\" of the FlightSeatPreferences class", ignore_extras);
            fieldGeneratorExcludes = new FlightSeatTypeJSON.HoldingArrayGenerator("field \"Excludes\" of the FlightSeatPreferences class", ignore_extras);
            fieldGeneratorDefaultForOthers = new IncludeExcludeStateJSON.HoldingGenerator("field \"DefaultForOthers\" of the FlightSeatPreferences class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the FlightSeatPreferences class");
            allow_incomplete = false;
            allow_unpolished = false;
          }
        public Generator()
          {
            fieldGeneratorIncludes = new FlightSeatTypeJSON.HoldingArrayGenerator("field \"Includes\" of the FlightSeatPreferences class", false);
            fieldGeneratorExcludes = new FlightSeatTypeJSON.HoldingArrayGenerator("field \"Excludes\" of the FlightSeatPreferences class", false);
            fieldGeneratorDefaultForOthers = new IncludeExcludeStateJSON.HoldingGenerator("field \"DefaultForOthers\" of the FlightSeatPreferences class", false);
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(FlightSeatPreferencesJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public FlightSeatPreferencesJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<FlightSeatPreferencesJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<FlightSeatPreferencesJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<FlightSeatPreferencesJSON> value;
  };
  };
