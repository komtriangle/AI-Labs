...
public class AmountPropertyJSON : GeneralizedThingJSON
  {
    ...
    private JSONValue  extraAmountToJSON()
      {
        JSONValueHandler handler_Amount = new JSONValueHandler();
    ...
    public virtual int extraAmountPropertyComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraAmountPropertyComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraAmountPropertyComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraAmountPropertyLookup(string field_name)
      {
    ...
    public virtual void extraAmountPropertyAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraAmountPropertySetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new AmountPropertyJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        AmountPropertyJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type AmountProperty", ignore_extras);
    ...
    public static new AmountPropertyJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new AmountPropertyJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        AmountPropertyJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type AmountProperty", ignore_extras);
    ...
    public static new AmountPropertyJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new AmountPropertyJSON from_text(string text, bool ignore_extras)
      {
        AmountPropertyJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type AmountProperty", ignore_extras);
            JSONParse.parse_json_value(text, "Text for AmountPropertyJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new AmountPropertyJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        AmountPropertyJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type AmountProperty", ignore_extras);
    ...
    public new abstract class Generator : GeneralizedThingJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getGeneralizedThingJSONKey().Equals("AmountProperty")))
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraAmountPropertyAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected abstract void handle_result(AmountPropertyJSON new_result);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(AmountPropertyJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public AmountPropertyJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<AmountPropertyJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<AmountPropertyJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<AmountPropertyJSON> value;
  };
  };
