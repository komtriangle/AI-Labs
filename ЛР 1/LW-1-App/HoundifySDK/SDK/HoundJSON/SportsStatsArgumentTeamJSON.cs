/* file "SportsStatsArgumentTeamJSON.cs" */
...
public class SportsStatsArgumentTeamJSON : SportsStatsArgumentJSON
  {
    ...
    private void  fromJSONTeamID(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field TeamID of SportsStatsArgumentTeamJSON is not a string.");
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field ResultReference of SportsStatsArgumentTeamJSON is not true for false.");
              }
          }
    ...
    public SportsStatsArgumentTeamJSON()
      {
        flagHasTeamID = false;
    ...
    public virtual int extraSportsStatsArgumentTeamComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsStatsArgumentTeamComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsStatsArgumentTeamComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsStatsArgumentTeamLookup(string field_name)
      {
    ...
    public override int extraSportsStatsArgumentComponentCount()
      {
        ...
        if (flagHasResultReference)
            ++result;
        result += extraSportsStatsArgumentTeamComponentCount();
        return result;
      }
    public override string extraSportsStatsArgumentComponentKey(int component_num)
      {
        ...
        return extraSportsStatsArgumentTeamComponentKey(remainder);
      }
    public override JSONValue extraSportsStatsArgumentComponentValue(int component_num)
      {
        ...
        return extraSportsStatsArgumentTeamComponentValue(remainder);
      }
    public override JSONValue extraSportsStatsArgumentLookup(string field_name)
      {
        ...
        return extraSportsStatsArgumentTeamLookup(field_name);
      }
    ...
    public virtual void extraSportsStatsArgumentTeamAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSportsStatsArgumentTeamSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraSportsStatsArgumentTeamLookup(key);
        if (old_field == null)
          {
            extraSportsStatsArgumentTeamAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraSportsStatsArgumentSetField(string key, JSONValue new_component)
      {
        ...
        extraSportsStatsArgumentTeamSetField(key, new_component);
      }
    ...
    public static new SportsStatsArgumentTeamJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsStatsArgumentTeamJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsStatsArgumentTeam", ignore_extras);
    ...
    public static new SportsStatsArgumentTeamJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsStatsArgumentTeamJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsStatsArgumentTeamJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsStatsArgumentTeam", ignore_extras);
    ...
    public static new SportsStatsArgumentTeamJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsStatsArgumentTeamJSON from_text(string text, bool ignore_extras)
      {
        SportsStatsArgumentTeamJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsStatsArgumentTeam", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SportsStatsArgumentTeamJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new SportsStatsArgumentTeamJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SportsStatsArgumentTeamJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsStatsArgumentTeam", ignore_extras);
    ...
    public new abstract class Generator : SportsStatsArgumentJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getSportsStatsArgumentJSONKey().Equals("Team")))
                throw new Exception("The key field has a value other than `Team'.");
            SportsStatsArgumentTeamJSON result = new SportsStatsArgumentTeamJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSportsStatsArgumentTeamAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(SportsStatsArgumentJSON new_result)
          {
            handle_result((SportsStatsArgumentTeamJSON )new_result);
          }
        protected void finish(SportsStatsArgumentTeamJSON result)
          {
        ...
        protected abstract void handle_result(SportsStatsArgumentTeamJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorTeamID = new JSONHoldingStringGenerator("field \"TeamID\" of the SportsStatsArgumentTeam class");
            fieldGeneratorTeamLeague = new SportsLeagueCodeJSON.HoldingGenerator("field \"TeamLeague\" of the SportsStatsArgumentTeam class", ignore_extras);
            fieldGeneratorResultReference = new JSONHoldingBooleanGenerator("field \"ResultReference\" of the SportsStatsArgumentTeam class");
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the SportsStatsArgumentTeam class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorTeamID = new JSONHoldingStringGenerator("field \"TeamID\" of the SportsStatsArgumentTeam class");
            fieldGeneratorTeamLeague = new SportsLeagueCodeJSON.HoldingGenerator("field \"TeamLeague\" of the SportsStatsArgumentTeam class", false);
            fieldGeneratorResultReference = new JSONHoldingBooleanGenerator("field \"ResultReference\" of the SportsStatsArgumentTeam class");
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(SportsStatsArgumentTeamJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public SportsStatsArgumentTeamJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SportsStatsArgumentTeamJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<SportsStatsArgumentTeamJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SportsStatsArgumentTeamJSON> value;
  };
  };
