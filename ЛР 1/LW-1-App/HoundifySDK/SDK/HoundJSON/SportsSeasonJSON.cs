...
public class SportsSeasonJSON : JSONBase
  {
    ...
    public static TypeArgumentType  stringToArgumentType(string chars)
      {
        if ((String.Compare(chars, 0, "SportsSeason", 0, 12, false) == 0) && (chars.Length == 12))
            return TypeArgumentType.ArgumentType_SportsSeason;
    ...
    public static string  stringFromArgumentType(TypeArgumentType the_enum)
      {
        switch (the_enum)
          {
            case TypeArgumentType.ArgumentType_SportsSeason:
                return "SportsSeason";
            default:
                Debug.Assert(false);
                return null;
    ...
    public enum TypeSeasonPhrasingKnownValues
      {
    ...
    public struct TypeSeasonPhrasing
      {
        public bool in_known_list;
        public string string_value;
        public TypeSeasonPhrasingKnownValues list_value;
      };

    public static TypeSeasonPhrasingKnownValues  stringToSeasonPhrasing(string chars)
      {
        switch (chars[0])
          {
            case 'C':
                if ((String.Compare(chars, 1, "urrentSeason", 0, 12, false) == 0) && (chars.Length == 13))
                    return TypeSeasonPhrasingKnownValues.SeasonPhrasing_CurrentSeason;
                break;
            case 'L':
                if ((String.Compare(chars, 1, "astSeason", 0, 9, false) == 0) && (chars.Length == 10))
                    return TypeSeasonPhrasingKnownValues.SeasonPhrasing_LastSeason;
                break;
            case 'Y':
                if ((String.Compare(chars, 1, "ear", 0, 3, false) == 0) && (chars.Length == 4))
                    return TypeSeasonPhrasingKnownValues.SeasonPhrasing_Year;
                break;
            default:
                break;
          }
        return TypeSeasonPhrasingKnownValues.SeasonPhrasing__none;
      }

    public static string  stringFromSeasonPhrasing(TypeSeasonPhrasingKnownValues the_enum)
      {
        switch (the_enum)
          {
            case TypeSeasonPhrasingKnownValues.SeasonPhrasing_CurrentSeason:
                return "CurrentSeason";
            case TypeSeasonPhrasingKnownValues.SeasonPhrasing_LastSeason:
                return "LastSeason";
            case TypeSeasonPhrasingKnownValues.SeasonPhrasing_Year:
                return "Year";
            default:
                Debug.Assert(false);
                return null;
    ...
    private bool flagHasSeasonPhrasing;
    private TypeSeasonPhrasing storeSeasonPhrasing;
    ...
    private void  fromJSONArgumentType(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field ArgumentType of SportsSeasonJSON is not a string.");
        if (!(json_string.getData().Equals("SportsSeason")))
            throw new Exception("The value for field ArgumentType of SportsSeasonJSON is not `SportsSeason'.");
        setArgumentType();
      }
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field Year of SportsSeasonJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field Year of SportsSeasonJSON is not an integer.");
              }
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field YearEnd of SportsSeasonJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field YearEnd of SportsSeasonJSON is not an integer.");
              }
            extracted_integer = json_rational.getInteger()        ;
          }
        else
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field IsCurrentSeason of SportsSeasonJSON is not true for false.");
              }
          }
    ...
    public bool  hasSeasonPhrasing()
      {
        return flagHasSeasonPhrasing;
      }

    public TypeSeasonPhrasing  getSeasonPhrasing()
      {
        Debug.Assert(flagHasSeasonPhrasing);
    ...
    public virtual int extraSportsSeasonComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsSeasonComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsSeasonComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsSeasonLookup(string field_name)
      {
    ...
    public void setYear(BigInteger new_value)
      {
        flagHasYear = true;
        if (new_value < 1)
            throw new Exception("The value for field Year of SportsSeasonJSON is less than the lower bound (1) for that field.");
        storeYear = new_value;
      }
    ...
    public void setYearEnd(BigInteger new_value)
      {
        flagHasYearEnd = true;
        if (new_value < 1)
            throw new Exception("The value for field YearEnd of SportsSeasonJSON is less than the lower bound (1) for that field.");
    ...
    public void unsetSeasonPhrasing()
      {
        flagHasSeasonPhrasing = false;
      }

    public virtual void extraSportsSeasonAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSportsSeasonSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static SportsSeasonJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsSeasonJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsSeason", ignore_extras);
    ...
    public static SportsSeasonJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static SportsSeasonJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsSeasonJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsSeason", ignore_extras);
    ...
    public static SportsSeasonJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static SportsSeasonJSON from_text(string text, bool ignore_extras)
      {
        SportsSeasonJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsSeason", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SportsSeasonJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static SportsSeasonJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SportsSeasonJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsSeason", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorArgumentType : JSONArrayGenerator
  {
    ...
    private abstract class FieldGeneratorSeasonPhrasing : JSONStringGenerator
          {
            protected FieldGeneratorSeasonPhrasing(string what)
              {
                set_what(what);
              }
            protected FieldGeneratorSeasonPhrasing()
              {
              }
            protected override void handle_result(string result)
              {
    ...
    private class FieldHoldingGeneratorSeasonPhrasing : FieldGeneratorSeasonPhrasing
  {
...
//@@@        Debug.Assert(!have_value);
    ...
    public FieldHoldingGeneratorSeasonPhrasing(String what)
      {
        have_value = false;
        base.set_what(what);
      }
    ...
    public bool have_value;
    public TypeSeasonPhrasing value;
  };
    private class FieldHoldingArrayGeneratorSeasonPhrasing : JSONArrayGenerator
  {
    protected class ElementHandler : FieldGeneratorSeasonPhrasing
      {
        private FieldHoldingArrayGeneratorSeasonPhrasing top;
        ...
        public ElementHandler(FieldHoldingArrayGeneratorSeasonPhrasing init_top)
          {
            top = init_top;
          }
      };
    ...
    protected virtual void handle_result(List<TypeSeasonPhrasing> result)
      {
      }

    public FieldHoldingArrayGeneratorSeasonPhrasing(string what)
      {
        element_handler = new ElementHandler(this);
        have_value = false;
        value = new List<TypeSeasonPhrasing>();
        base.set_what(what);
      }
    public FieldHoldingArrayGeneratorSeasonPhrasing()
      {
        element_handler = new ElementHandler(this);
        have_value = false;
        value = new List<TypeSeasonPhrasing>();
    ...
    public bool have_value;
    public List<TypeSeasonPhrasing> value;
  };
        private FieldHoldingGeneratorSeasonPhrasing fieldGeneratorSeasonPhrasing;
        ...
        protected override void finish()
          {
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSportsSeasonAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(SportsSeasonJSON result)
          {
        ...
        protected abstract void handle_result(SportsSeasonJSON new_result);
            ...
            switch (field_name[0])
              {
                ...
                case 'I':
                    ...
                    break;
                case 'S':
                    if ((String.Compare(field_name, 1, "easonPhrasing", 0, 13, false) == 0) && (field_name.Length == 14))
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorArgumentType = new FieldHoldingGeneratorArgumentType("field \"ArgumentType\" of the SportsSeason class");
            fieldGeneratorYear = new FieldHoldingGeneratorYear("field \"Year\" of the SportsSeason class");
            fieldGeneratorYearEnd = new FieldHoldingGeneratorYearEnd("field \"YearEnd\" of the SportsSeason class");
            fieldGeneratorIsCurrentSeason = new JSONHoldingBooleanGenerator("field \"IsCurrentSeason\" of the SportsSeason class");
            fieldGeneratorType = new SportsSeasonTypeJSON.HoldingGenerator("field \"Type\" of the SportsSeason class", ignore_extras);
            fieldGeneratorSeasonPhrasing = new FieldHoldingGeneratorSeasonPhrasing("field \"SeasonPhrasing\" of the SportsSeason class");
        ...
        public Generator()
          {
            ...
            fieldGeneratorYearEnd = new FieldHoldingGeneratorYearEnd("field \"YearEnd\" of the SportsSeason class");
            fieldGeneratorIsCurrentSeason = new JSONHoldingBooleanGenerator("field \"IsCurrentSeason\" of the SportsSeason class");
            fieldGeneratorType = new SportsSeasonTypeJSON.HoldingGenerator("field \"Type\" of the SportsSeason class", false);
            fieldGeneratorSeasonPhrasing = new FieldHoldingGeneratorSeasonPhrasing("field \"SeasonPhrasing\" of the SportsSeason class");
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(SportsSeasonJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
    ...
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SportsSeasonJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<SportsSeasonJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SportsSeasonJSON> value;
  };
  };
