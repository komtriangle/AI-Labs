/* file "MusicChartsCommandJSON.cs" */
...
public class MusicChartsCommandJSON : MusicCommandJSON
  {
    private bool flagHasNativeData;
    private MusicChartsCommandNativeDataJSON  storeNativeData;
    ...
    private void  fromJSONNativeData(JSONValue json_value, bool ignore_extras)
      {
        ...
        MusicChartsCommandNativeDataJSON convert_classy = MusicChartsCommandNativeDataJSON.from_json(json_value, ignore_extras, true);
        setNativeData(convert_classy);
      }


    public MusicChartsCommandJSON()
      {
    ...
    public new MusicChartsCommandNativeDataJSON   getNativeData()
      {
    ...
    public virtual int extraMusicChartsCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraMusicChartsCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraMusicChartsCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraMusicChartsCommandLookup(string field_name)
      {
    ...
    public new void setNativeData(MusicChartsCommandNativeDataJSON  new_value)
      {
    ...
    public virtual void extraMusicChartsCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraMusicChartsCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new MusicChartsCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        MusicChartsCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MusicChartsCommand", ignore_extras);
    ...
    public static new MusicChartsCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new MusicChartsCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        MusicChartsCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MusicChartsCommand", ignore_extras);
    ...
    public static new MusicChartsCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new MusicChartsCommandJSON from_text(string text, bool ignore_extras)
      {
        MusicChartsCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MusicChartsCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for MusicChartsCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new MusicChartsCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        MusicChartsCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type MusicChartsCommand", ignore_extras);
    ...
    public new abstract class Generator : MusicCommandJSON.Generator
      {
        private MusicChartsCommandNativeDataJSON.HoldingGenerator fieldGeneratorNativeData;
        ...
        protected override void finish()
          {
            if (!(getMusicCommandJSONKey().Equals("MusicChartsCommand")))
                throw new Exception("The key field has a value other than `MusicChartsCommand'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraMusicChartsCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(MusicChartsCommandJSON result)
          {
        ...
        protected abstract void handle_result(MusicChartsCommandJSON new_result);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(MusicChartsCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public MusicChartsCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<MusicChartsCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<MusicChartsCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<MusicChartsCommandJSON> value;
  };
  };
