...
public class DisambiguateEmailJSON : JSONBase
  {
    private bool flagHasContactQueryName;
    private string storeContactQueryName;
    private bool flagHasDisambiguationCandidates;
    private List< EmailDisambiguationCandidateJSON  > storeDisambiguationCandidates;
    ...
    private void  fromJSONContactQueryName(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field ContactQueryName of DisambiguateEmailJSON is not a string.");
    ...
    public DisambiguateEmailJSON()
      {
        flagHasContactQueryName = false;
        flagHasDisambiguationCandidates = false;
        storeDisambiguationCandidates = new List< EmailDisambiguationCandidateJSON  >();
      }
    ...
    public EmailDisambiguationCandidateJSON   elementOfDisambiguationCandidates(int element_num)
      {
        Debug.Assert(flagHasDisambiguationCandidates);
        return storeDisambiguationCandidates[element_num];
      }

    public List< EmailDisambiguationCandidateJSON  >  getDisambiguationCandidates()
      {
        Debug.Assert(flagHasDisambiguationCandidates);
    ...
    public static DisambiguateEmailJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        DisambiguateEmailJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DisambiguateEmail", ignore_extras);
    ...
    public static DisambiguateEmailJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static DisambiguateEmailJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        DisambiguateEmailJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DisambiguateEmail", ignore_extras);
    ...
    public static DisambiguateEmailJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static DisambiguateEmailJSON from_text(string text, bool ignore_extras)
      {
        DisambiguateEmailJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DisambiguateEmail", ignore_extras);
            JSONParse.parse_json_value(text, "Text for DisambiguateEmailJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static DisambiguateEmailJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        DisambiguateEmailJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type DisambiguateEmail", ignore_extras);
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        private EmailDisambiguationCandidateJSON.HoldingArrayGenerator fieldGeneratorDisambiguationCandidates;
        ...
        protected void finish(DisambiguateEmailJSON result)
          {
        ...
        protected abstract void handle_result(DisambiguateEmailJSON new_result);
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorContactQueryName = new JSONHoldingStringGenerator("field \"ContactQueryName\" of the DisambiguateEmail class");
            fieldGeneratorDisambiguationCandidates = new EmailDisambiguationCandidateJSON.HoldingArrayGenerator("field \"DisambiguationCandidates\" of the DisambiguateEmail class", ignore_extras);
        ...
        public Generator()
          {
            fieldGeneratorContactQueryName = new JSONHoldingStringGenerator("field \"ContactQueryName\" of the DisambiguateEmail class");
            fieldGeneratorDisambiguationCandidates = new EmailDisambiguationCandidateJSON.HoldingArrayGenerator("field \"DisambiguationCandidates\" of the DisambiguateEmail class", false);
            set_what("the DisambiguateEmail class");
            allow_incomplete = false;
            allow_unpolished = false;
          }
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(DisambiguateEmailJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public DisambiguateEmailJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<DisambiguateEmailJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<DisambiguateEmailJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<DisambiguateEmailJSON> value;
  };
  };
